...
const projectName = 'Cypress - Disabled Delete Project';
  ...
  context('Given a project with a specific name', () => {
    ...
    context('When we try to delete the project from the project browser view', () => {
      ...
      it('Then the delete button should be disabled', () => {
        new Projects().getActionMenu(projectName).getDeleteButton().should('have.class', 'Mui-disabled');
      });
    });
    ...
    context('When we try to delete the project from the workbench', () => {
      ...
      it('Then the delete button should be disabled', () => {
        new Project().getProjectNavigationBar(projectName).getDeleteButton().should('have.class', 'Mui-disabled');
      });
    });
  });
});
