    ...
    context('When we create a new instance project', () => {
      ...
      it('Then child node are correctly initialized to respect growable nodes', () => {
        ...
        diagram
          ...
          .invoke('css', 'height')
          .then((nodeHeight) => {
            expect(parseFloat(nodeHeight.toString())).to.approximately(352, 5);
          });
        diagram
          ...
          .invoke('css', 'height')
          .then((nodeHeight) => {
            expect(parseFloat(nodeHeight.toString())).to.approximately(140, 5);
          });
        diagram
        ...
        diagram
          ...
          .invoke('css', 'height')
          .then((nodeHeight) => {
            expect(parseFloat(nodeHeight.toString())).to.approximately(328, 5);
          });
      });
