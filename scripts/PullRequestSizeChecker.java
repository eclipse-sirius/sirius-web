...
public class PullRequestSizeChecker {
    ...
    private static boolean shouldIgnoreFile(String line) {
        ...
        return List.of(
                ...
                "packages/domain/backend/sirius-components-domain",
                "packages/domain/backend/sirius-components-domain-edit",
                "packages/task/backend/sirius-components-task",
                "packages/task/backend/sirius-components-task-edit",
