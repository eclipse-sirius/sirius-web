...
var moduleCoverageData = List.of(
  ...
  new ModuleCoverage("sirius-components-diagrams-graphql", 75.0),
  ...
  new ModuleCoverage("sirius-components-interpreter", 86.0),
  ...
  new ModuleCoverage("sirius-components-view-builder", 67.0),
