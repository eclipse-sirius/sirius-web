...
var moduleCoverageData = List.of(
  ...
  new ModuleCoverage("sirius-components-view", 58.0),
  ...
  new ModuleCoverage("sirius-components-view-emf", 63.0),
  new ModuleCoverage("sirius-components-view-builder", 28.0),
