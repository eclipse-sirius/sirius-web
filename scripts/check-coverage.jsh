...
var moduleCoverageData = List.of(
  ...
  new ModuleCoverage("sirius-components-trees", 82.0),
  new ModuleCoverage("sirius-components-collaborative-trees", 65.0),
  new ModuleCoverage("sirius-components-trees-graphql", 52.0),
