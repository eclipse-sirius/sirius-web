...
var moduleCoverageData = List.of(
  ...
  new ModuleCoverage("sirius-components-collaborative-diagrams", 83.0),
  ...
  new ModuleCoverage("sirius-components-collaborative-tables", 88.0),
  ...
  new ModuleCoverage("sirius-components-view-tree", 64.0),
  new ModuleCoverage("sirius-components-view-tree-edit", 21.0),
  new ModuleCoverage("sirius-components-view-emf", 75.0),
  new ModuleCoverage("sirius-components-view-builder", 55.0),
