...
var moduleCoverageData = List.of(
  ...
  new ModuleCoverage("sirius-components-representations", 82.0),
  new ModuleCoverage("sirius-components-core", 81.0),
  ...
  new ModuleCoverage("sirius-components-selection", 94.0),
  new ModuleCoverage("sirius-components-collaborative-selection", 99.0),
  new ModuleCoverage("sirius-components-selection-graphql", 100.0),
  new ModuleCoverage("sirius-components-validation", 87.0),
  new ModuleCoverage("sirius-components-collaborative-validation", 83.0),
  new ModuleCoverage("sirius-components-validation-graphql", 100.0),
  new ModuleCoverage("sirius-components-palette", 100.0),
  ...
  new ModuleCoverage("sirius-components-domain-edit", 67.0),
  new ModuleCoverage("sirius-components-domain-emf", 98.0),
  new ModuleCoverage("sirius-components-view", 64.0),
  new ModuleCoverage("sirius-components-view-edit", 50.0),
  ...
  new ModuleCoverage("sirius-components-widget-reference-view-edit", 2.0),
  ...
  new ModuleCoverage("sirius-components-view-deck-edit", 27.0),
