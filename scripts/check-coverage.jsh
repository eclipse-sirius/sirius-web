...
var moduleCoverageData = List.of(
  ...
  new ModuleCoverage("sirius-components-view", 66.0),
  new ModuleCoverage("sirius-components-view-edit", 55.0),
  new ModuleCoverage("sirius-components-view-diagram", 62.0),
  new ModuleCoverage("sirius-components-view-diagram-edit", 39.0),
  new ModuleCoverage("sirius-components-view-form", 46.0),
  new ModuleCoverage("sirius-components-view-form-edit", 4.0),
