...
var moduleCoverageData = List.of(
  ...
  new ModuleCoverage("sirius-components-forms-graphql", 69.0),
  new ModuleCoverage("sirius-components-widget-reference", 79.0),
  ...
  new ModuleCoverage("sirius-components-view-emf", 69.0),
  ...
  new ModuleCoverage("sirius-web-domain", 87.0),
