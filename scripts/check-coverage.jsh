...
var moduleCoverageData = List.of(
  ...
  new ModuleCoverage("sirius-components-forms-graphql", 59.0),
  ...
  new ModuleCoverage("sirius-components-view-emf", 67.0),
  new ModuleCoverage("sirius-components-view-builder", 30.0),
