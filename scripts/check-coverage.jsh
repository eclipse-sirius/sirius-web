...
var moduleCoverageData = List.of(
  ...
  new ModuleCoverage("sirius-components-collaborative-widget-reference", 72.0),
  new ModuleCoverage("sirius-components-widget-reference-graphql", 52.0),
  ...
  new ModuleCoverage("sirius-web-domain", 92.0),
