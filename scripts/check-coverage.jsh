...
var moduleCoverageData = List.of(
  ...
  new ModuleCoverage("sirius-components-diagrams-graphql", 67.0),
  ...
  new ModuleCoverage("sirius-components-emf", 87.0),
  ...
  new ModuleCoverage("sirius-components-view-diagram-edit", 36.0),
