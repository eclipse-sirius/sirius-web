...
var moduleCoverageData = List.of(
  ...
  new ModuleCoverage("sirius-components-core", 67.0),
  new ModuleCoverage("sirius-components-collaborative", 85.0),
  ...
  new ModuleCoverage("sirius-components-gantt-graphql", 53.0),
  ...
  new ModuleCoverage("sirius-components-collaborative-forms", 90.0),
  new ModuleCoverage("sirius-components-forms-graphql", 67.0),
  ...
  new ModuleCoverage("sirius-components-validation", 55.0),
  ...
  new ModuleCoverage("sirius-components-emf", 82.0),
