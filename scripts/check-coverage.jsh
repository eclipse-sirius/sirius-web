...
var moduleCoverageData = List.of(
  ...
  new ModuleCoverage("sirius-components-collaborative-diagrams", 88.0),
  ...
  new ModuleCoverage("sirius-components-interpreter", 87.0),
  ...
  new ModuleCoverage("sirius-components-domain-edit", 74.0),
  ...
  new ModuleCoverage("sirius-components-view-emf", 83.0),
  ...
  new ModuleCoverage("sirius-web-infrastructure", 57.0),
