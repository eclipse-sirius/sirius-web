...
export * from './details/DetailsView';
...
export * from './properties/FormBasedView';
export * from './properties/FormBasedView.types';
export * from './related-elements/RelatedElementsView';
