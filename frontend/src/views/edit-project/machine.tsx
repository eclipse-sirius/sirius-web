...
export const HANDLE_REPRESENTATION_CLOSED__ACTION = 'HANDLE_REPRESENTATION_CLOSED__ACTION';
...
export const machine = {
  ...
  PROJECT_LOADED_AND_REPRESENTATION_DISPLAYED__STATE: {
    ...
    HANDLE_REPRESENTATION_CLOSED__ACTION: [PROJECT_LOADED__STATE, PROJECT_LOADED_AND_REPRESENTATION_DISPLAYED__STATE],
  },
};
