...
export const HANDLE_SELECTIONS__ACTION = 'HANDLE_SELECTIONS__ACTION';
...
export const machine = {
  ...
  PROJECT_LOADED__STATE: {
    HANDLE_SELECTIONS__ACTION: [PROJECT_LOADED__STATE, PROJECT_LOADED_AND_REPRESENTATION_DISPLAYED__STATE],
