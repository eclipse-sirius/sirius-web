...
export const SET_CONTEXTUAL_MENU__ACTION = 'SET_CONTEXTUAL_MENU__ACTION';
export const SET_DIRTY__ACTION = 'SET_DIRTY__ACTION';
...
export const SELECTIONS__ACTION = 'SELECTIONS__ACTION';
export const SELECTED_ELEMENTS__ACTION = 'SELECTED_ELEMENTS__ACTION';
...
export const machine = {
  ...
  READY__STATE: {
    ...
    SET_DIRTY__ACTION: [READY__STATE],
    SET_SOURCE_ELEMENT__ACTION: [READY__STATE],
    SET_CURRENT_ROOT__ACTION: [READY__STATE],
    SET_CONTEXTUAL_PALETTE__ACTION: [READY__STATE],
    SET_CONTEXTUAL_MENU__ACTION: [READY__STATE],
    SELECTIONS__ACTION: [READY__STATE],
    SELECTED_ELEMENTS__ACTION: [READY__STATE],
