...
export type SetActiveToolEvent = { type: 'SET_ACTIVE_TOOL'; activeTool: Tool };
export type SetContextualPaletteEvent = { type: 'SET_CONTEXTUAL_PALETTE'; contextualPalette: Palette };
