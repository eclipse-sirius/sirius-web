...
This API is used to contribute the _xref:user-manual:core-concepts.adoc#_stereotypes[Stereotypes]_.
...
----
<1> This assumes that helper class `XXXModels` also used in xref:developer-guide:studio-development/api-workbench.adoc#_{project}_template_initializer_apis[the section about Project Template Initializer APIs] is accessible.
<2> This assumes that helper class `StereotypeBuilder` also used in xref:developer-guide:studio-development/api-workbench.adoc#_{project}_template_initializer_apis[the section about Project Template Initializer APIs] is accessible.