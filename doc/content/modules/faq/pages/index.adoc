...
[%collapsible%open]
====
To understand the intent of {product}, see the xref:user-manual:overview.adoc[overview] section in the user manual.
====
...
For more details, see xref:user-manual:features/versioning.adoc[Version control and change management].
====
...
[%collapsible%open]
====
Read the xref:developer-guide:interoperability.adoc#import-export[Import and Export] section of the documentation.
====
...
[%collapsible%open]
====
To import or export models, read the xref:developer-guide:interoperability.adoc[Interoperability] section in the user manual.
====
