...
. Iterate quickly by reopening your test projects so that {product} reloads the latest domain.

For a detailed, click-by-click tutorial see xref:studio-maker-guide:hands-on/tutorials/domain-tutorial.adoc[].
