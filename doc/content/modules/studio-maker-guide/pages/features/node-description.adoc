...
Border nodes can themselves contain child nodes and other border nodes when their style supports children.
Nodes using an icon label style remain leaf nodes and ignore their configured child and border node descriptions.
