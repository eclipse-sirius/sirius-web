...
* Follow the xref:studio-maker-guide:hands-on/tutorials/domain-tutorial.adoc[Domain tutorial] to practice authoring meta-models in the browser.
* Once the domain is solid, move on to xref:studio-maker-guide:features/view-description.adoc[] to create representations (forms, tables, diagrams, etc.).
