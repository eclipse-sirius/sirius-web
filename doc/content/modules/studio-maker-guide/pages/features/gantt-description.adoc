...
This page explains how the Gantt description can be configured in {product}.

== Introduction

Gantt descriptions focus on describing task hierarchies, scheduling expressions, and task dependency tools.
...
1. Configure the description’s metadata (name, domain type, precondition, title).
...
image::representations/gantt-description-overview.png[Gantt description overview]
...
image::representations/gantt-tools.png[Gantt tools]
...
image::representations/gantt-task-tools.png[Task palette tools]
...
image::representations/gantt-task-handlers.png[Task handlers]
...
image::representations/gantt-task-relation-tool.png[Create Task Dependency Tool]
...
image::representations/gantt-task-dependency-palette.png[Task Dependency Contextual Palette]
