...
a|image::sprint.svg[xref=studio-maker-guide:hands-on/tutorials/studio-tutorial.adoc]

*Follow a quick start guide for new users ?*

Create your first studio in 5 minutes.

xref:studio-maker-guide:hands-on/tutorials/studio-tutorial.adoc[Ready to start]
