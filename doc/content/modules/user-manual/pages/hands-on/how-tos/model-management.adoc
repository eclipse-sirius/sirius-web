...
{product} is able to upload JSON files.
...
[TIP]
====
A powerful syntax exists for editing element properties directly through the direct edit tool; refer to xref:user-manual:hands-on/how-tos/model-management.adoc#direct-edit[Direct Edit Tool and Shortcuts] for details.
====
...
The {product} supports textual syntax, which allows you to update several elements simultaneously.
