...
Refer to the xref:features/workbench.adoc[{workbench} page] to understand how to use it for xref:user-manual:hands-on/how-tos/model-management.adoc#create-model[creating your own models] and xref:user-manual:hands-on/how-tos/representation-operations.adoc#create-representation[representations].
...
+
--
The first three templates are directly visible in the {project-browser} top region.
...
[NOTE]
====
The newly created project will have the same name as the template, so it's a good practice to xref:user-manual:hands-on/how-tos/project-management.adoc#rename-project[rename] it to avoid confusion.
====
...
Ensure that your projects are exported using the xref:user-manual:hands-on/how-tos/project-management.adoc#download-project[Download Project] action to enable successful re-uploading to {product}.
====
...
Refer to the xref:features/workbench.adoc[{project-workbench} page] to understand how to use it for xref:user-manual:hands-on/how-tos/model-management.adoc#create-model[creating your own models] and xref:user-manual:hands-on/how-tos/representation-operations.adoc#create-representation[representations].
...
+
image::hands-on-delete-project-homepage.png[Delete Project from the {project-browser}]
+
...
. Select the `Delete` option.
+
image::hands-on-delete-project-editor.png[Delete Project from the {project-workbench}]
+
. Confirm the deletion by clicking on the `Delete` button in the modal.
...
+
image::hands-on-rename-project-homepage.png[Rename Project from the {project-browser}]
+
...
. Select the `Rename` option.
+
image::hands-on-rename-project-editor.png[Rename Project from the {project-workbench}]
+
. Update the name in the editable field.
. Click `Rename`.
...
image::hands-on-download-project-homepage.png[Download Project from the {project-browser}]
...
image::hands-on-download-project-editor.png[Download Project from the {project-workbench}]
