...
Refer to the xref:user-manual:concepts.adoc#_domain[Domain], xref:user-manual:concepts.adoc#_view[View], xref:user-manual:concepts.adoc#_data[Data], and xref:user-manual:concepts.adoc#_representation[Representation] sections for detailed examples.
...
Using a graphical interface, they can configure diagrams, tables, forms, and trees among others, benefiting from rapid feedback loops and a low technical barrier to entry.
