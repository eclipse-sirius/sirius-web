...
* For each version or iteration of your project, you can download it as a zip archive by following these instructions: xref:user-manual:hands-on/how-tos/project-management.adoc#download-project[download project].
