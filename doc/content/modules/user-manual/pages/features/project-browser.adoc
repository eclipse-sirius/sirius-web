:homepage: Project browser
= {project-browser}

include::ROOT:partial$before-you-start-experimental-all.adoc[]

== What's the {project-browser}?

The **{project-browser}** page serves as the pivotal starting point for your modeling endeavors and is the homepage of the {product} application.
...
image::homepage.png[{project-browser}]

=== Toolbar

The toolbar consists of two groups, each featuring a single action: _Homepage_ and _Help_.

* *Homepage*: The Homepage action, visible on all pages of the application, provides a convenient way to navigate back to the {project-browser}, serving as the application’s main homepage.
* *Help*: The Help action, accessible on every page of the application, offers a convenient pathway to navigate to the online help resources for {product}.

Derivative product can use that place to add extra information or actions.

image::homepage-toolbar.png[{project-browser} Toolbar]
...
For now, there exist three available DSL templates : _Studio_, _Flow_ and _Papaya_.
...
[NOTE]
====
Every project you create have its own xref:features/workbench.adoc[Project Workbench].
====

Explore further by referring to the following how-tos for xref:user-manual:hands-on/how-tos/project-management.adoc#create-blank-project[creating blank projects], generating xref:user-manual:hands-on/how-tos/project-management.adoc#create-template-project[projects from templates], or xref:user-manual:hands-on/how-tos/project-management.adoc#upload-project[uploading] existing ones.
...
It facilitates the opening of pre-existing projects and provides essential actions for project management, including options to _xref:user-manual:hands-on/how-tos/project-management.adoc#rename-project[rename]_, _xref:user-manual:hands-on/how-tos/project-management.adoc#download-project[download]_, and _xref:user-manual:hands-on/how-tos/project-management.adoc#delete-project[delete]_ projects using the "3 dots" icon on the right side of each project.