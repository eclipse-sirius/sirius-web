...
The left sidebar has different views such as the xref:features/end-user/explorer.adoc[{explorer}] and the xref:features/end-user/validation.adoc[{validation}] to assist you working on your project.
...
The right sidebar contains different views such as the xref:features/end-user/details.adoc[{details}], the xref:features/end-user/query-view.adoc[{query-view}], the xref:features/end-user/representations-view.adoc[{representations-view}] and the xref:features/end-user/related-elements.adoc[{related-elements}] views to ...
