...
For now, there exist two available templates : _Flow_ and _Papaya_.
_Flow_ template is a complete SysML project with several concepts of each SysML type (kind of _Definitions_ and _Usages_ with relationships).
