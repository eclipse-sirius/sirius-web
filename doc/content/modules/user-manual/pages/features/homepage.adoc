...
* *Homepage*: The Homepage action, visible on all pages of the application, provides a convenient way to navigate back to the {homepage}, serving as the application’s main homepage.
...
For now, there exist two available DSL templates : _Flow_ and _Papaya_.
