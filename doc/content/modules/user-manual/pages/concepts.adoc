...
A description defines how a specific domain concept is projected into a representation.
...
A style controls the visual appearance of elements in a representation.
It is attached to a description and determines how each instance of a mapped element should look.
...
Published libraries have a _namespace_, _name_ and _version_.
...
image::publication-libraries-menu.png[Libraries menu, width=80%,height=80%]
