...
- All palette contributed tools from sirius web (the list of tools is available on the documentation) expects to have their label declared on the backend side.
