...
In that case you take a dependency only on the Sirius Components modules that compute and render representations, alongside their optional building blocks (collaboration lifecycle, low code representation descriptions, semantic constraints, etc.).
