...
Note: A follow-up ADR (#200) will focus on the possibility to share the internal state of a part (e.g. which filters of the 'Explorer' view are enabled), but this is out of the scope of this ADR.
