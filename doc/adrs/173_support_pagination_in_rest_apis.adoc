= [ADR-173] Support Pagination in REST APIs
...
The REST APIs don't support pagination options in Sirius Web.
...
For example, with the SystemsModelingAPI specification, the following request `\http://sysml2-api-host:9000/projects?page[size]=3` would be `\http://sysml2-api-host:9000/projects?page=0&size=3`
with spring data.
