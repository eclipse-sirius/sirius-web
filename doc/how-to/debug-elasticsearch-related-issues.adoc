...
If it is not the case, you can follow https://www.elastic.co/docs/deploy-manage/deploy/self-managed/local-development-installation-quickstart[this tutorial] to start a development instance of Elasticsearch.
