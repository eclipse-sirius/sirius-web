...
Sirius Web allows specifier to add an impact analysis on tools executed on diagrams, but not on tools in contextual menus of trees.
...
All the suers will now see the impact of the change in their representations.
