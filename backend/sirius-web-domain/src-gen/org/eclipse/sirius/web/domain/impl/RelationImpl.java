...
public class RelationImpl extends MinimalEObjectImpl.Container implements Relation {
	...
	public EList<Entity> getTargetTypes() {
		if (targetTypes == null) {
			targetTypes = new EObjectResolvingEList<Entity>(Entity.class, this, DomainPackage.RELATION__TARGET_TYPES);
		}
		return targetTypes;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case DomainPackage.RELATION__TARGET_TYPES:
			...
			getTargetTypes().addAll((Collection<? extends Entity>) newValue);
			return;
		}
