...
public interface DomainPackage extends EPackage {
    ...
    /**
     * The feature id for the '<em><b>Target Types</b></em>' reference list. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @generated
     * @ordered
    ...
    /**
     * Returns the meta object for the reference list '{@link org.eclipse.sirius.web.domain.Relation#getTargetTypes
     * <em>Target Types</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    interface Literals {
        ...
        /**
         * The meta object literal for the '<em><b>Target Types</b></em>' reference list feature. <!-- begin-user-doc
         * --> <!-- end-user-doc -->
         *
         * @generated
         */
