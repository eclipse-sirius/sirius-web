...
public final class RenameRepresentationSuccessPayload implements IPayload {
    ...
    public RenameRepresentationSuccessPayload(UUID id, IRepresentationMetadata representationMetadata) {
    ...
    public String toString() {
        ...
        return MessageFormat.format(pattern, this.getClass().getSimpleName(), this.id, this.representationMetadata.getId());
    }
}
