 ...
 * <li>{@link org.eclipse.sirius.components.view.impl.EdgeStyleImpl#getSourceArrowStyle <em>Source Arrow Style</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.EdgeStyleImpl#getTargetArrowStyle <em>Target Arrow Style</em>}</li>
