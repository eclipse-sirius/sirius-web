...
import org.eclipse.sirius.components.collaborative.trees.dto.DeleteTreeItemSuccessPayload;
 ...
 */
@Service
public class DeleteTreeItemEventHandler implements ITreeEventHandler {
    ...
    public boolean canHandle(ITreeInput treeInput) {
        return treeInput instanceof DeleteTreeItemInput;
    }
