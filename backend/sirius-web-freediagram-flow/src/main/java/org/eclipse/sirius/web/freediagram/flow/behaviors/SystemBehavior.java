 ...
 * @author hmarchadour
 */
public class SystemBehavior implements ICreateInstanceBehavior {
    ...
    public Optional<EObject> createEObject(VariableManager variableManager) {
        System instance = (System) EcoreUtil.create(FlowPackage.Literals.SYSTEM);
        ...
        instance.setName("CompositeProcessor" + suffix); //$NON-NLS-1$
