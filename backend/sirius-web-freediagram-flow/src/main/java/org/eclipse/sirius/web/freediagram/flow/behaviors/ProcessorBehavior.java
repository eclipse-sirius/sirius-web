 ...
 * @author hmarchadour
 */
public class ProcessorBehavior implements ICreateInstanceBehavior {
    ...
    public Optional<EObject> createEObject(VariableManager variableManager) {
        Processor instance = (Processor) EcoreUtil.create(FlowPackage.Literals.PROCESSOR);
        ...
        instance.setName("Processor" + suffix); //$NON-NLS-1$
