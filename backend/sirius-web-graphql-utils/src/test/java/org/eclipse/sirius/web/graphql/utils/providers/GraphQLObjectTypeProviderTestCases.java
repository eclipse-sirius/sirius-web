 ...
 * @author sbegaudeau
 */
public class GraphQLObjectTypeProviderTestCases {
    /**
     ...
     * @author sbegaudeau
     */
    @org.eclipse.sirius.web.annotations.graphql.GraphQLObjectType
    ...
    public static class ObjectTypeWithNonNullString {
        ...
        @org.eclipse.sirius.web.annotations.graphql.GraphQLNonNull
        @org.eclipse.sirius.web.annotations.graphql.GraphQLField
        public String getName() {
            return this.name;
        }
    ...
    public static class ObjectTypeWithNonNullListOfNonNullStrings {
        ...
        @org.eclipse.sirius.web.annotations.graphql.GraphQLNonNull
        @org.eclipse.sirius.web.annotations.graphql.GraphQLField
        public List<@org.eclipse.sirius.web.annotations.graphql.GraphQLNonNull String> getNonNullListOfNonNullStrings() {
            return this.nonNullListOfNonNullStrings;
        }
    }
     ...
     * @author sbegaudeau
     */
    @org.eclipse.sirius.web.annotations.graphql.GraphQLObjectType(name = "AnotherName")
    ...
    public static class ObjectTypeWithID {
        ...
        @org.eclipse.sirius.web.annotations.graphql.GraphQLID
        @org.eclipse.sirius.web.annotations.graphql.GraphQLField
        public String getId() {
            return this.id;
        }
