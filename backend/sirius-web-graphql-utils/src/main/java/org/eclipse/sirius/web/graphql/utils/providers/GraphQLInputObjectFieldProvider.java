...
public class GraphQLInputObjectFieldProvider {
    ...
    private GraphQLInputType getInputType(Method method) {
        ...
        } else if (method.isAnnotationPresent(org.eclipse.sirius.web.annotations.graphql.GraphQLUpload.class)) {
    ...
    private GraphQLInputType getRawInputType(Class<?> type) {
        return this.graphQLScalarConverter.getScalar(type).map(GraphQLInputType.class::cast).orElseGet(() -> {
            ...
            org.eclipse.sirius.web.annotations.graphql.GraphQLInputObjectType inputObjectTypeAnnotation = type.getAnnotation(org.eclipse.sirius.web.annotations.graphql.GraphQLInputObjectType.class);
