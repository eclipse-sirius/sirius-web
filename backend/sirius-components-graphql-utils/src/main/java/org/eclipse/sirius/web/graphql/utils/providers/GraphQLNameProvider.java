...
public class GraphQLNameProvider {
    ...
    public String getEnumTypeName(Class<?> javaClass) {
        ...
        var annotation = javaClass.getAnnotation(org.eclipse.sirius.web.annotations.graphql.GraphQLEnumType.class);
    ...
    public String getObjectTypeName(Class<?> javaClass) {
        ...
        var annotation = javaClass.getAnnotation(org.eclipse.sirius.web.annotations.graphql.GraphQLObjectType.class);
        if (annotation != null && !annotation.name().isBlank()) {
            name = annotation.name();
        }
        return name;
    ...
    public String getInterfaceTypeName(Class<?> javaClass) {
        ...
        var annotation = javaClass.getAnnotation(org.eclipse.sirius.web.annotations.graphql.GraphQLInterfaceType.class);
        if (annotation != null && !annotation.name().isBlank()) {
            name = annotation.name();
        }
        return name;
    ...
    public String getInputObjectTypeName(Class<?> javaClass) {
        ...
        var annotation = javaClass.getAnnotation(org.eclipse.sirius.web.annotations.graphql.GraphQLInputObjectType.class);
        if (annotation != null && !annotation.name().isBlank()) {
            name = annotation.name();
        }
        return name;
