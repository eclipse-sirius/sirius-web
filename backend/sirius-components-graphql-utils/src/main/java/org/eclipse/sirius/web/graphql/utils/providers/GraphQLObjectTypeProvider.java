...
public class GraphQLObjectTypeProvider {
    ...
    public GraphQLObjectType getType(Class<?> javaClass) {
        ...
        if (superClass.isAnnotationPresent(org.eclipse.sirius.web.annotations.graphql.GraphQLInterfaceType.class)) {
        ...
        Arrays.stream(javaClass.getInterfaces()).forEach(anInterface -> {
            if (anInterface.isAnnotationPresent(org.eclipse.sirius.web.annotations.graphql.GraphQLInterfaceType.class)) {
