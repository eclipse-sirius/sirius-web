...
public class MutationEditRadioDataFetcher implements IDataFetcherWithFieldCoordinates<IPayload> {
    ...
    public MutationEditRadioDataFetcher(IDataFetchingEnvironmentService dataFetchingEnvironmentService, IProjectEventProcessorRegistry projectEventProcessorRegistry,
