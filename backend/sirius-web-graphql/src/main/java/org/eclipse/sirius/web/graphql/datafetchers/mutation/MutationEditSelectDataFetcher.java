...
public class MutationEditSelectDataFetcher implements IDataFetcherWithFieldCoordinates<IPayload> {
    ...
    public MutationEditSelectDataFetcher(ObjectMapper objectMapper, IEditingContextEventProcessorRegistry editingContextEventProcessorRegistry, IGraphQLMessageService messageService) {
