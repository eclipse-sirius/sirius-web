...
public class MutationInvokeDropToolOnDiagramDataFetcher implements IDataFetcherWithFieldCoordinates<IPayload> {
    ...
    public MutationInvokeDropToolOnDiagramDataFetcher(IDataFetchingEnvironmentService dataFetchingEnvironmentService, IProjectEventProcessorRegistry projectEventProcessorRegistry,
