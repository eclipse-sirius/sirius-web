...
/**
 * The data fetcher used to concatenate the server image URL to the magic create edge tool image path.
 * <p>
 * It will be used to fetch the data for the following GraphQL field:
 * </p>
 *
 * <pre>
 * type MagicCreateEdgeTool {
 *   imageURL: String!
 * }
 * </pre>
 *
 * @author hmarchadour
 */
@QueryDataFetcher(type = DiagramTypesProvider.MAGIC_CREATE_EDGE_TOOL_TYPE, field = ImageURLFieldProvider.IMAGE_URL_FIELD)
public class MagicCreateEdgeToolURLPathDataFetcher implements IDataFetcherWithFieldCoordinates<String> {
