...
public class MutationEditTextfieldDataFetcher implements IDataFetcherWithFieldCoordinates<IPayload> {
    ...
    public MutationEditTextfieldDataFetcher(IDataFetchingEnvironmentService dataFetchingEnvironmentService, IProjectEventProcessorRegistry projectEventProcessorRegistry,
