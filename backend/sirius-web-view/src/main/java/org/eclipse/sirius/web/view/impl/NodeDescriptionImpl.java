 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.web.view.impl.NodeDescriptionImpl#getChildrenDescriptions <em>Children Descriptions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NodeDescriptionImpl extends DiagramElementDescriptionImpl implements NodeDescription {
	...
	public EList<NodeDescription> getChildrenDescriptions() {
		if (childrenDescriptions == null) {
			childrenDescriptions = new EObjectContainmentEList<NodeDescription>(NodeDescription.class, this,
					ViewPackage.NODE_DESCRIPTION__CHILDREN_DESCRIPTIONS);
		}
