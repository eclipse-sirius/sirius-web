 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.web.view.impl.DeleteViewImpl#getViewExpression <em>View Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeleteViewImpl extends OperationImpl implements DeleteView {
     ...
     * @ordered
     */
    protected static final String VIEW_EXPRESSION_EDEFAULT = "aql:selectedNode"; //$NON-NLS-1$
    ...
    public String toString() {
        ...
        result.append(" (viewExpression: "); //$NON-NLS-1$
