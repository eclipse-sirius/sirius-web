...
public interface Feature extends NamedElement {
     ...
     * @see org.eclipse.sirius.components.domain.DomainPackage#getFeature_Optional()
     ...
     * @see #setMany(boolean)
     * @see org.eclipse.sirius.components.domain.DomainPackage#getFeature_Many()
     * @model default="false" required="true"
     * @generated
     */
    boolean isMany();
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.domain.Feature#isMany <em>Many</em>}' attribute. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
