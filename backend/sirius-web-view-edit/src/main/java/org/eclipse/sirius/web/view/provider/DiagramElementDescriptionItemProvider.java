...
public class DiagramElementDescriptionItemProvider extends ItemProviderAdapter
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(ViewPackage.Literals.DIAGRAM_ELEMENT_DESCRIPTION__STYLE);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.DIAGRAM_ELEMENT_DESCRIPTION__STYLE, ViewFactory.eINSTANCE.createStyle()));
    }
