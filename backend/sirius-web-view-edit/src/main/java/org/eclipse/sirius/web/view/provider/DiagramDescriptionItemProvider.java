...
public class DiagramDescriptionItemProvider extends RepresentationDescriptionItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ViewPackage.Literals.DIAGRAM_DESCRIPTION__NODE_DESCRIPTIONS);
			childrenFeatures.add(ViewPackage.Literals.DIAGRAM_DESCRIPTION__EDGE_DESCRIPTIONS);
		}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_DiagramDescription_type") //$NON-NLS-1$
				: getString("_UI_DiagramDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ViewPackage.Literals.DIAGRAM_DESCRIPTION__NODE_DESCRIPTIONS,
				ViewFactory.eINSTANCE.createNodeDescription()));

		newChildDescriptors.add(createChildParameter(ViewPackage.Literals.DIAGRAM_DESCRIPTION__EDGE_DESCRIPTIONS,
				ViewFactory.eINSTANCE.createEdgeDescription()));
	}
