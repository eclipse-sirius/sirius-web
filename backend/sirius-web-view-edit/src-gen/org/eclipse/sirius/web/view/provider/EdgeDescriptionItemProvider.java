...
public class EdgeDescriptionItemProvider extends DiagramElementDescriptionItemProvider {
	...
	protected void addIsDomainBasedEdgePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_EdgeDescription_isDomainBasedEdge_feature",
						"_UI_EdgeDescription_type"),
	...
	protected void addSourceNodeDescriptionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_EdgeDescription_sourceNodeDescriptions_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_EdgeDescription_sourceNodeDescriptions_feature",
						"_UI_EdgeDescription_type"),
	...
	protected void addTargetNodeDescriptionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_EdgeDescription_targetNodeDescriptions_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_EdgeDescription_targetNodeDescriptions_feature",
						"_UI_EdgeDescription_type"),
	...
	protected void addSourceNodesExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_EdgeDescription_sourceNodesExpression_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_EdgeDescription_sourceNodesExpression_feature",
						"_UI_EdgeDescription_type"),
	...
	protected void addTargetNodesExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_EdgeDescription_targetNodesExpression_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_EdgeDescription_targetNodesExpression_feature",
						"_UI_EdgeDescription_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_EdgeDescription_type")
