...
public class ConditionalRadioDescriptionStyleItemProvider extends ConditionalItemProvider {
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ConditionalRadioDescriptionStyle_type") : //$NON-NLS-1$
                this.getString("_UI_ConditionalRadioDescriptionStyle_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
