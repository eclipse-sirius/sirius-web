 ...
 * {@link org.eclipse.sirius.components.view.ConditionalMultiSelectDescriptionStyle} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class ConditionalMultiSelectDescriptionStyleItemProvider extends ConditionalItemProvider {
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ConditionalMultiSelectDescriptionStyle_type") : //$NON-NLS-1$
                this.getString("_UI_ConditionalMultiSelectDescriptionStyle_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
