...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.MultiSelectDescriptionStyle}
...
public class MultiSelectDescriptionStyleItemProvider extends WidgetDescriptionStyleItemProvider {
    ...
    protected void addBackgroundColorPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_MultiSelectDescriptionStyle_backgroundColor_feature"), //$NON-NLS-1$
                this.getString("_UI_PropertyDescriptor_description", "_UI_MultiSelectDescriptionStyle_backgroundColor_feature", "_UI_MultiSelectDescriptionStyle_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                ViewPackage.Literals.MULTI_SELECT_DESCRIPTION_STYLE__BACKGROUND_COLOR, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addForegroundColorPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_MultiSelectDescriptionStyle_foregroundColor_feature"), //$NON-NLS-1$
                this.getString("_UI_PropertyDescriptor_description", "_UI_MultiSelectDescriptionStyle_foregroundColor_feature", "_UI_MultiSelectDescriptionStyle_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                ViewPackage.Literals.MULTI_SELECT_DESCRIPTION_STYLE__FOREGROUND_COLOR, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }

    /**
     * This returns MultiSelectDescriptionStyle.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    ...
    public String getText(Object object) {
        ...
        return this.getString("_UI_MultiSelectDescriptionStyle_type") + " " + multiSelectDescriptionStyle.getFontSize(); //$NON-NLS-1$ //$NON-NLS-2$
    }
