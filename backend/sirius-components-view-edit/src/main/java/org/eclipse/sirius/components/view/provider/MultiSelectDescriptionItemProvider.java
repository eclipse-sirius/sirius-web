...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.MultiSelectDescription} object.
...
public class MultiSelectDescriptionItemProvider extends WidgetDescriptionItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(ViewPackage.Literals.MULTI_SELECT_DESCRIPTION__CONDITIONAL_STYLES);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.MULTI_SELECT_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createChangeContext()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.MULTI_SELECT_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createCreateInstance()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.MULTI_SELECT_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createSetValue()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.MULTI_SELECT_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createUnsetValue()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.MULTI_SELECT_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createDeleteElement()));
