...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.UnsetValue} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 *
 * @generated
 */
public class UnsetValueItemProvider extends OperationItemProvider {
    ...
    protected void addFeatureNamePropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_UnsetValue_featureName_feature"), //$NON-NLS-1$
                this.getString("_UI_PropertyDescriptor_description", "_UI_UnsetValue_featureName_feature", "_UI_UnsetValue_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    protected void addElementExpressionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_UnsetValue_elementExpression_feature"), //$NON-NLS-1$
                this.getString("_UI_PropertyDescriptor_description", "_UI_UnsetValue_elementExpression_feature", "_UI_UnsetValue_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_UnsetValue_type") : //$NON-NLS-1$
                this.getString("_UI_UnsetValue_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
