...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.CheckboxDescription} object. <!--
...
public class CheckboxDescriptionItemProvider extends WidgetDescriptionItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(ViewPackage.Literals.CHECKBOX_DESCRIPTION__CONDITIONAL_STYLES);
        }
    ...
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/CheckboxDescription")); //$NON-NLS-1$
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.CHECKBOX_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createChangeContext()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.CHECKBOX_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createCreateInstance()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.CHECKBOX_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createSetValue()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.CHECKBOX_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createUnsetValue()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.CHECKBOX_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createDeleteElement()));
        ...
        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.CHECKBOX_DESCRIPTION__STYLE, ViewFactory.eINSTANCE.createConditionalCheckboxDescriptionStyle()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.CHECKBOX_DESCRIPTION__CONDITIONAL_STYLES, ViewFactory.eINSTANCE.createConditionalCheckboxDescriptionStyle()));
    }
