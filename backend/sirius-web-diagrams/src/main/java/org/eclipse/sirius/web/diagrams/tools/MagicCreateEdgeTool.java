...
/**
 * A magic create edge Tool implementation.
 *
 * @author pcdavid
 * @author hmarchadour
 */
@Immutable
@GraphQLObjectType
public final class MagicCreateEdgeTool implements ITool {
    ...
    private List<CreateEdgeTool> createEdgeTools;

    private MagicCreateEdgeTool() {
        // Prevent instantiation
    }

    @GraphQLField
    @GraphQLNonNull
    public List<CreateEdgeTool> getCreateEdgeTools() {
        return this.createEdgeTools;
    }
    ...
    public static Builder newMagicCreateEdgeTool(String id) {
    ...
    public static final class Builder {
        ...
        public Builder createEdgeTools(List<CreateEdgeTool> createEdgeTools) {
            this.createEdgeTools = createEdgeTools;
            return this;
        }
        ...
        public MagicCreateEdgeTool build() {
            MagicCreateEdgeTool tool = new MagicCreateEdgeTool();
            ...
            tool.createEdgeTools = this.createEdgeTools;
            return tool;
        }
    }
}
