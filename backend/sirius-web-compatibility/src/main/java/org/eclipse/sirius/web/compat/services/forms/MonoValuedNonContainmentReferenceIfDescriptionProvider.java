...
import org.eclipse.sirius.web.compat.forms.EStructuralFeatureChoiceOfValueProvider;
import org.eclipse.sirius.web.compat.forms.EStructuralFeatureLabelProvider;
...
public class MonoValuedNonContainmentReferenceIfDescriptionProvider {
    ...
    private Function<VariableManager, Boolean> getPredicate() {
        return variableManager -> {
            var optionalEReference = variableManager.get(DefaultFormDescriptionProvider.ESTRUCTURAL_FEATURE, EReference.class);
    ...
    private Function<VariableManager, String> getLabelProvider() {
        return new EStructuralFeatureLabelProvider(DefaultFormDescriptionProvider.ESTRUCTURAL_FEATURE, this.composedAdapterFactory);
    }

    private Function<VariableManager, String> getValueProvider() {
        return variableManager -> {
            Object object = variableManager.getVariables().get(VariableManager.SELF);
            Object eStructuralFeature = variableManager.getVariables().get(DefaultFormDescriptionProvider.ESTRUCTURAL_FEATURE);
    ...
    private Function<VariableManager, List<Object>> getOptionsProvider() {
        return new EStructuralFeatureChoiceOfValueProvider(DefaultFormDescriptionProvider.ESTRUCTURAL_FEATURE, this.composedAdapterFactory);
    }
