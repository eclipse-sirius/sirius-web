...
import org.eclipse.sirius.components.charts.hierarchy.renderer.HierarchyComponentPropsValidator;
...
public class FormComponentPropsValidator implements IComponentPropsValidator {
    ...
    public boolean validateComponentProps(Class<?> componentType, IProps props) {
        ...
        if (FormComponent.class.equals(componentType)) {
            ...
            checkValidProps = new HierarchyComponentPropsValidator().validateComponentProps(componentType, props);
        }
