 ...
 *******************************************************************************/
package org.eclipse.sirius.components.forms.architecture;
...
public final class ArchitectureConstants {
    public static final String SIRIUS_COMPONENTS_FORMS_ROOT_PACKAGE = "org.eclipse.sirius.components.forms.."; //$NON-NLS-1$
