...
Docker will automatically download and start both the database (PostgreSQL) image and the latest version of Sirius Web published https://hub.docker.com/repository/docker/eclipsesirius/sirius-web[on Docker Hub].
