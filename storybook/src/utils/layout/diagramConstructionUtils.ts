...
} from "@eclipse-sirius/sirius-components-diagrams/graphql/subscription/diagramFragment.types";
import type { GQLEdgeStyle } from "@eclipse-sirius/sirius-components-diagrams/graphql/subscription/edgeFragment.types";
import type {
  GQLInsideLabel,
  GQLLabelStyle,
} from "@eclipse-sirius/sirius-components-diagrams/graphql/subscription/labelFragment.types";
import type {
  GQLNodeStyle,
  GQLRectangularNodeStyle,
} from "@eclipse-sirius/sirius-components-diagrams/graphql/subscription/nodeFragment.types";
