...
test.describe('diagram - growable list', () => {
  ...
  test('when a sub node is hide, then the parent node is resized', async ({ page }) => {
    ...
    expect(growableListNodeSize.height).toBe(426.5);
