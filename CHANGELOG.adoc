...
** _addReferenceValues_ mutation: to several reference values to a reference (only used with mutli-valued references)
...
- https://github.com/eclipse-sirius/sirius-web/issues/2267[#2267] [diagram] Support auto ELK layout with React Flow.
