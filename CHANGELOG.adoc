...
- https://github.com/eclipse-sirius/sirius-web/issues/5745[#5745] [sirius-web] Add support for importing libraries when creating a project (Unable to choose libraries to import without https://github.com/eclipse-sirius/sirius-web/issues/5748[#5748])
Rely on a transactional event listener to add libraries in a project.
