...
- https://github.com/eclipse-sirius/sirius-web/issues/6981[#6981] [projects] Add a new module `sirius-web-projects-stylecustomizations-application` containing the backend API to retrieve style customizations.
- https://github.com/eclipse-sirius/sirius-web/issues/6965[#6965] [projects] Display the contributed style customizations in the project _Appearances_ settings tab.
Contribute an implementation of `IStyleCustomizationDescriptionProvider` to provide style customization descriptions.
Style customizations cannot be enabled or disabled.
