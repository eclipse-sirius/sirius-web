...
- https://github.com/eclipse-sirius/sirius-web/issues/4866[#4866] [diagram] When opening the palette, if the last tool executed is not available in the current state, it is still displayed for information, but disabled.
