...
- https://github.com/eclipse-sirius/sirius-web/issues/6806[#6806] [diagram] Add `IDiagramToolbarFilterSelectionProvider` API & `filterSelectionMenuItems` field in GraphQL type `DiagramToolbar`.
This API can be used to add menu items to the Manage Selection diagram toolbar button.
