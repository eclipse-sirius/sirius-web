...
- https://github.com/eclipse-sirius/sirius-web/issues/3205[#3205] [sirius-web] Fix an issue where the project rename dialog displayed an outdated name is the current value
