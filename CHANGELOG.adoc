...
- https://github.com/eclipse-sirius/sirius-web/issues/3829[#3829] [table] Add a dependency to `material-react-table "2.13.3"` and `export-to-csv "1.3.0"`
...
- https://github.com/eclipse-sirius/sirius-web/issues/3829[#3829] [form][table] Add table widget in form.
