...
- [releng] Switch to https://github.com/vitejs/vite/releases/tag/v8.2.2[Vite 8.2.2] and https://github.com/vitejs/vite-plugin-react/releases/tag/plugin-react%406.1.1[@vitejs/plugin-react 6.1.1]
