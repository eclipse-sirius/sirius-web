...
- https://github.com/eclipse-sirius/sirius-web/issues/3781[#3781] [diagram] Allow the use of custom variables in the `VariableManager` initialized by the DiagramDescription.
