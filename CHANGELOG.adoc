...
- https://github.com/eclipse-sirius/sirius-web/issues/2440[#2440] [form] Avoid an npe when rendering a reference widget without previously setting its "Reference Owner Expression".
