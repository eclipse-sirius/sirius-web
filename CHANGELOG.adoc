...
- https://github.com/eclipse-sirius/sirius-components/issues/1437[#1437] [formdescriptioneditors] The default widget styles are now applied in the visual editor.
