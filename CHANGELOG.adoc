...
+ For now the only workbench state that is shareable is: the opened representations, the active representation, and the active views on the left and right panels.
