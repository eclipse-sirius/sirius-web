...
- https://github.com/eclipse-sirius/sirius-web/issues/2204[#2204] [diagram] Added getStyledLabel method in IObjectService and IDefaultObjectService. The graphql type TreeItem will now return a StyledString unstead of a label, queries that are using this type are impacted.
...
- https://github.com/eclipse-sirius/sirius-web/issues/2204[#2204] [diagram] Added emf StyledString provider support, IStyledStringConverter can be used in an objectservice to convert an EMF StyledString to a SiriusWeb StyledString.
+
.Example of StyledString
image:doc/screenshots/treeItemLabelStyled.jpg[Example of StyledString,70%]
