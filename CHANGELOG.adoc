...
- https://github.com/eclipse-sirius/sirius-web/issues/6726[#6726] [releng] Move overridden code from generated code into a spec package.
- https://github.com/eclipse-sirius/sirius-web/issues/6115[#6115] [releng] Add a module to generate code from genmodel files.
