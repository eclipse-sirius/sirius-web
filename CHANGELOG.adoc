...
- https://github.com/eclipse-sirius/sirius-web/issues/2857[#2857] [form] Fix default reference widget bugs. Now, for a multi-valued feature, the values are properly displayed and the delete is properly handled.
...
- https://github.com/eclipse-sirius/sirius-web/issues/2776[#2776] [gantt] Enhance the action to share Gantt representation URL to by computing the URL inside ShareGanttModal.
