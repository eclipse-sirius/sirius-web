...
- https://github.com/eclipse-sirius/sirius-web/issues/5091[#5091] [sirius-web] Remove state machine from EditProjectNavbar and from modals used to manage project images
