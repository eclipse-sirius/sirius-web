...
- https://github.com/eclipse-sirius/sirius-web/issues/6969[#6969] [diagram] Fix an issue where the global selection was not correctly updated after opening the palette on the diagram.
