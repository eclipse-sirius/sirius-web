...
- https://github.com/eclipse-sirius/sirius-web/issues/4779[#4779] [diagram] Fix an issue where the connection line cannot not be made if a node label is hovered
...
- https://github.com/eclipse-sirius/sirius-web/issues/4779[#4779] [diagram] The connection line now snap to the parent element if an icon label node is hovered
