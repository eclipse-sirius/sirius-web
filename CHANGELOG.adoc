...
- https://github.com/eclipse-sirius/sirius-components/issues/1625[#1625] [core] Fix upload document when a dedicated factory is used to instanciate and load the resource correctly
