...
- https://github.com/eclipse-sirius/sirius-web/issues/6818[#6818] [tree] Improve Explorer view component responsibilities by splitting the rendering between an `ExplorerToolbarRenderer` & `ExplorerTreeRenderer`.
Export `FilterBarContext` from `sirius-components-trees` in order to reuse filter bar logic in the explorer view.
