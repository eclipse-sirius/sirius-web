...
The `omnibox.graphqls` schema has been changed to make explicit the fact that the current APIs are aimed at the integration of the command palette in the workbench:
...
- https://github.com/eclipse-sirius/sirius-web/issues/5731[#5731] [sirius-web] Add the command palette on the projects page
