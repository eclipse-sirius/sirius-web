...
- https://github.com/eclipse-sirius/sirius-web/issues/4578[#4578] [diagram] Fix an issue where the selected attribute of a node was lost during the conversion of the diagram
