...
- https://github.com/eclipse-sirius/sirius-web/issues/5928[#5928] [workbench] Contributed views should now use the new `ViewAccordion` component.
cf Papaya view and Related Element view to see how.
...
- https://github.com/eclipse-sirius/sirius-web/issues/5928[#5928] [workbench] Papaya view and Related Element view are now collapsible.
