...
- https://github.com/eclipse-sirius/sirius-web/issues/5531[#5531] [palette] The old hard-coded tool sections `Appearance`, `Layout` and `Show in` are now contributed via an extension point in the `defaultExtensionRegistry`.
...
- https://github.com/eclipse-sirius/sirius-web/issues/5531[#5531] [palette] Add an extension point to contribute palette tool sections
