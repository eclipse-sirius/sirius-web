...
- https://github.com/eclipse-sirius/sirius-web/issues/4657[#4657] [diagram] Resize parent node when a compartment is hidden even when the node has been manually resize
