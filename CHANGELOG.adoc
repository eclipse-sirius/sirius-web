...
- https://github.com/eclipse-sirius/sirius-web/issues/5560[#5560] [diagram] Fix an issue where a mutation could be sent when ending a connection on an invalid target
