...
- https://github.com/eclipse-sirius/sirius-web/issues/6123[#6123] [diagram] `PaletteToolList` & `PaletteToolSectionList` are no longer exported, `PaletteToolSection`, `ToolSectionEntry` & `ToolSectionHeader` are now exported.
This changes improve the palette section reusability and make the frontend capable of handling nested tool sections.
...
- https://github.com/eclipse-sirius/sirius-web/issues/6552[#6552] [diagram] Add `DiagramPaletteToolExtensionPoints` to contribute tools on a palette, you can contribute tools on a specific tool section, contributing a tool with an id that match a tool from the backend will override the backend tool.
- https://github.com/eclipse-sirius/sirius-web/issues/6555[#6555] [diagram] Add `DiagramPaletteToolSectionExtensionPoints` to contribute tools sections on a palette.
