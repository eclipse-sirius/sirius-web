...
- https://github.com/eclipse-sirius/sirius-web/issues/5114[#5114] [diagrams] Remove the long deprecated properties `targetObjectLabel` and `targetObjectKind` from diagram elements
