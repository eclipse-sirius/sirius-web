...
- https://github.com/eclipse-sirius/sirius-web/issues/6527[#6527] [gantt] Add support for custom holidays in Gantt. Add two providers that can be contributed to specify custom non-working days.
