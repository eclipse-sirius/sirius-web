...
- https://github.com/eclipse-sirius/sirius-web/issues/5502[#5502] [sirius-web] Relax the constraints on the primary keys of `representation_metadata` and `representation_content`.
As a result, the id of the `semantic_data` is required for `representation_content` as it was the case for `representation_metadata`.
