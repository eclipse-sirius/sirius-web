...
- https://github.com/eclipse-sirius/sirius-web/issues/6973[#6973] [form] The clear button of the widget reference is now driven by a dedicated EClass in the View DSL.
All existing representations are automatically migrated as well as the details view of Sirius Web.
However, programmatic form descriptions should manually add it through `ReferenceWidgetDescription.Builder#clearButtonDescription`.
...
- https://github.com/eclipse-sirius/sirius-web/issues/6973[#6973] [form] We can now customize the widget reference clear button through the View DSL.
