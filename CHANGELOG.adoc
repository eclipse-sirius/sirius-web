...
- https://github.com/eclipse-sirius/sirius-web/issues/3790[#3790] [test] Enforce a minimum frontend line coverage for `sirius-components-diagrams` using the Playwright diagram tests.
