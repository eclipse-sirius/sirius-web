...
- https://github.com/eclipse-sirius/sirius-web/issues/4348[#4348] [diagram] `IPaletteToolsProvider` signature method has been changed to `List<ToolSection> createExtraToolSections(DiagramContext diagramContext, Object diagramElementDescription, Object diagramElement);`.
The parameter `DiagramContext diagramContext` has been added.
