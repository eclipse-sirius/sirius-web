...
- https://github.com/eclipse-sirius/sirius-web/issues/4098[#4098] [core] Cache the AQL services for a given `EPackage`.
This improves the time needed to open a project.
The improvement will be proportional to the size/complexity of the metamodels and the number of View-based representations available in the project.
