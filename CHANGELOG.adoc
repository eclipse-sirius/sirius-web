...
- https://github.com/eclipse-sirius/sirius-web/issues/6973[#6973] [form] The reference widget clear button is now driven by a dedicated View DSL EClass.
Its body defines the clear behavior; an empty body does nothing.
New Studio widgets contain a default clear operation.
All existing representations and the Sirius Web details view are automatically migrated.
Programmatic form descriptions should manually add it through `ReferenceWidgetDescription.Builder#clearButtonDescription`.
- https://github.com/eclipse-sirius/sirius-web/issues/6973[#6973] [form] Reference widget EMF edit classes have been moved from `org.eclipse.sirius.components.widgets` to `org.eclipse.sirius.components.view.widget` to match their domain classes.
...
- https://github.com/eclipse-sirius/sirius-web/issues/6973[#6973] [form] We can now customize the reference widget clear button behavior through the View DSL.
