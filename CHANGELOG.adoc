...
- [releng] Switch to https://github.com/bvaughn/react-resizable-panels/releases/tag/4.6.2[React Resizable Panels 4.6.2].
...
- https://github.com/eclipse-sirius/sirius-web/issues/5928[#5928] [sirius-web] Add collapsible view in workbench panels, merge view header and toolbar inside the same bar.
