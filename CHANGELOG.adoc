...
- https://github.com/eclipse-sirius/sirius-web/issues/5070[#5070] [diagram] The _boolean_ `isDraggedNode` has been add to `NodeData`.
...
- https://github.com/eclipse-sirius/sirius-web/issues/5070[#5070] [diagram] Prevent node to dropped on the diagram during a move inside its parent
