...
- https://github.com/eclipse-sirius/sirius-web/issues/2823[#2823] [diagram] Some changes has been made for node layout, there may be an impact on the custom node.
...
- https://github.com/eclipse-sirius/sirius-web/issues/2823[#2823] [diagram] Fix an issue that prevents nodes to be resize smaller than their default size.
