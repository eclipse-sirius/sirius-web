...
- https://github.com/eclipse-sirius/sirius-web/issues/4849[#4849] [diagram] Node actions can have a browser behavior through an extension point's contributions
