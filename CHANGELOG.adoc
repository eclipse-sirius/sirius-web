...
- https://github.com/eclipse-sirius/sirius-web/issues/6229[#6229] [selection] Rework the selection dialog.
+ It comes with small improvements in the filter bar for better reuse
