...
- https://github.com/eclipse-sirius/sirius-web/issues/2418[#2418] [sirius-web] [tree] Extract synchronize with selection into a hook.
The component `SynchronizedWithSelectionContribution` should be contributed to the `TreeToolBar` thanks to a `TreeToolBarContribution`.
[source,jsx]
----
...
The component `SynchronizeWithSelectionContextProvider` should be put around the component that use the contribution:
[source, jsx]
----

/**
 * The explorer contains the tree tool
 */
