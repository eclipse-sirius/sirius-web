...
- https://github.com/eclipse-sirius/sirius-web/issues/5766[#5766] [diagram] `DiagramElementPalette` is no longer exported.
- https://github.com/eclipse-sirius/sirius-web/issues/5531[#5531] [diagram] `diagramPaletteToolExtensionPoint` has been rename to `paletteQuickToolExtensionPoint`, you can refer to the ADR 212 for more details.
...
- https://github.com/eclipse-sirius/sirius-web/issues/5748[#5748] [sirius-web] Add support for choosing libraries to import when creating a project (does not add libraries without https://github.com/eclipse-sirius/sirius-web/issues/5745[#5745])
...
- https://github.com/eclipse-sirius/sirius-web/issues/5531[#5531] [diagram] You can now contribute `tool`, `toolSection` and `quicktool` to a palette with these frontend extension point `paletteToolExtensionPoint`, `paletteToolSectionExtensionPoint` and `paletteQuickToolExtensionPoint`, you can refer to the ADR 212 for more details.
...
- https://github.com/eclipse-sirius/sirius-web/issues/5766[#5766] [diagram] Merge DiagramPalette and DiagramElementPalette into one component.
