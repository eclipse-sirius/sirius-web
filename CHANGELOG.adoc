...
- https://github.com/eclipse-sirius/sirius-web/issues/5063[#5063] [diagram] Modify the custom edge algorithm to create new bend point only when source or target segment exceeds
the limits of its node borders.
