...
- https://github.com/eclipse-sirius/sirius-web/issues/6808[#6808] [diagram] Add `invokeFilterSelection mutation` in diagram GraphQL schema.
- https://github.com/eclipse-sirius/sirius-web/issues/6808[#6808] [diagram] Add frontend rendering & execution of `filterSelectionMenuItems` & `invokeFilterSelection`.
