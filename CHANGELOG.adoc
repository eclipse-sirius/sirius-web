...
- [releng] https://github.com/eclipse-sirius/sirius-web/issues/6403[#6403] Use pepper-mm instead of the old internal task metamodel used in the tests and task-starter
