...
- [ADR-60] Add support for the edition of routing points
- [ADR-61] Add support for edge reconnection
...
- https://github.com/eclipse-sirius/sirius-components/issues/997[#997] [diagram] Add the support for edition of edges routing points.
