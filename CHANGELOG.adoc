...
- https://github.com/eclipse-sirius/sirius-web/issues/6868[#6868] [core] Add a new module named `sirius-web-core-domain` to start extracting the core reusable parts of `sirius-web-domain`.
