...
- https://github.com/eclipse-sirius/sirius-web/issues/5024[#5024] [sirius-web] Add the ability to support image computed dynamically.
A new API named `IImageResourceProvider` can be used to return a Spring resource for a given image path instead of the regular image from the classpath.
