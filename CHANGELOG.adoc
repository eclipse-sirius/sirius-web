...
- https://github.com/eclipse-sirius/sirius-web/issues/2443[#2443] [diagram] Add dedicated handles to create edges.
Hide handles between edges and each edges are now placed in differents positions around the node.
Allow the creation of an edge by dropping the connection line on a node.
