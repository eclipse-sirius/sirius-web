...
- https://github.com/eclipse-sirius/sirius-components/issues/1890[1890]  [view] Making sirius-components-view-emf less dependent of sirius-components-compatibility-emf
+
