...
- https://github.com/eclipse-sirius/sirius-web/issues/4376[#4376] [sirius-web] Add current workbench selection to the URL.
Reversely, when resolving a URL, the specified elements automatically get selected.
