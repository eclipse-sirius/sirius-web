...
- https://github.com/eclipse-sirius/sirius-web/issues/5531[#5531] [diagram] The `diagramPaletteToolExtensionPoint` has been renamed to `paletteQuickToolExtensionPoint` and has now no coupling with XYFlow types, see breaking change section for more details.
