...
- https://github.com/eclipse-sirius/sirius-web/issues/3895[#3895] [explorer] Reduce the number & scope of re-renders of the Explorer view for better reactivity of the UI.
