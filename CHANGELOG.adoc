...
- https://github.com/eclipse-sirius/sirius-web/issues/5928[#5928] [workbench] Contributed workbench views must now use the new `ViewAccordion` component.
Their content must be provided with `ViewAccordionContent` and, when present, their toolbar with `ViewAccordionToolbar`.
See the Sirius Web workbench views for examples.
...
- https://github.com/eclipse-sirius/sirius-web/issues/5928[#5928] [workbench] Workbench views are now collapsible, with their title and toolbar displayed in a single compact header.
