...
- [releng] Removed the dependency to Google Guava, which was only used in a single location in `sirius-components-interpreter`.
...
- https://github.com/eclipse-sirius/sirius-web/issues/4590[#4590] [diagram] It is now possible to repeat the last tool invoked in a particular context on a diagram with a single _Alt-left click_.
