...
- https://github.com/eclipse-sirius/sirius-web/issues/2283[#2279] [starter] The `sirius-components-starter` is now providing as a dependency everything in the Sirius Components parts of the repository except for domain and view support.
Another starter has been introduced for now to support domain and view.
As a result, the starter is now scanning additional Sirius Components packages which were not scanned before.
For applications which are only reusing a very specific subset of Sirius Components, this may be a change in behavior.
...
- https://github.com/eclipse-sirius/sirius-web/issues/2283[#2279] [starter] Update the `sirius-components-starter` to make it work properly with the current state of the project.
Another starter named `sirius-components-studio-starter` has also been introduced in order to bring support for domain and view related projects.
