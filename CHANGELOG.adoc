...
- https://github.com/eclipse-sirius/sirius-components/issues/699[#699] [core] Update `IRepresentationMetadataSearchService` to allow the retrieval of the `RepresentationMetadata` without having to retrieve the representation first
