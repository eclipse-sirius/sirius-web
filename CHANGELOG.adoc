...
- https://github.com/eclipse-sirius/sirius-web/issues/4616[#4616] [sirius-web] Allow to see the content of a library in a workbench, the path of the url is `/library/:namespace/:name/:version`
