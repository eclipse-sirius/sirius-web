...
- https://github.com/eclipse-sirius/sirius-web/issues/3455[#3455] [core] `getCSSColor` now accept the value `undefined` as color value and can return an `undefined` value.
...
- https://github.com/eclipse-sirius/sirius-web/issues/3455[#3455] [diagram] Fix a bug where the background color was not updated switching from a rectangle node to an image node.
