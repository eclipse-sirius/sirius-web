...
- https://github.com/eclipse-sirius/sirius-web/issues/6997[#6997] [diagram] Define edge source variables and null edge target variables when evaluating edge-tool preconditions in a diagram element palette, so tools remain available before a target is selected.
