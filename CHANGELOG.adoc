...
- https://github.com/eclipse-sirius/sirius-web/issues/6978[#6978] [releng] Add a Dockerfile to build the Docker image from the sources with `docker compose up --build`.
