...
- [releng] Add a dependency to https://github.com/ObeoNetwork/pepper-mm[pepper-mm 2026.4.0]
...
- https://github.com/eclipse-sirius/sirius-web/issues/6403[#6403] [releng] Use pepper-mm instead of the old internal task metamodel used in the tests and task-starter
...
- https://github.com/eclipse-sirius/sirius-web/issues/6400[#6400] [gantt] Use pepper-mm 2026.4.0 to introduce the concept of dependencyLink, which will be used to extends dependency management for the Gantt tasks
