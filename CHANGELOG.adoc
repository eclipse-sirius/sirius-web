...
- https://github.com/eclipse-sirius/sirius-web/issues/5707[#5707] [emf] `EditingContextCrossReferenceAdapter` has been deleted.
...
- https://github.com/eclipse-sirius/sirius-web/issues/5707[#5707] [emf] Fix an issue about undo/redo by removing `EditingContextCrossReferenceAdapter`.
