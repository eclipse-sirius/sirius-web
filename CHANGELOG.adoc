...
The extension point signature has also changed to take edges into account: `canHandle: (nodeElement: Node<NodeData> | undefined, edgeElement: Edge<EdgeData> | undefined) => boolean;`
