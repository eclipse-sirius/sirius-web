...
- https://github.com/eclipse-sirius/sirius-web/issues/6765[#6765] [tree] Persist expanded and selected tree description state of the explorer in local storage
...
- https://github.com/eclipse-sirius/sirius-web/issues/6761[#6761] [form] Extract the explorer subscription in a dedicated component in order to reduce the number of rerender.
