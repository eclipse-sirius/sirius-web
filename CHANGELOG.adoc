 ...
 * `Flux<IPayload> getSubscription(String editingContextId, IRepresentationConfiguration representationConfiguration, IInput input);`
 ...
 - https://github.com/eclipse-sirius/sirius-web/issues/3708[#3708] [diagram] Added `minimumWidth` properrty to `NodeLayoutData` and `NodeData`
...
- https://github.com/eclipse-sirius/sirius-web/issues/3708[#3708] [diagram] A list node cannot be resized to a size that would be incoherent with the size of his childs.
