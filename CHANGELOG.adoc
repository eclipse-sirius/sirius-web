...
- https://github.com/eclipse-sirius/sirius-web/issues/5272[#5272] The parameters of `ITreeFilterProvider#get` have been updated to `IEditingContext`, `TreeDescription`, `Tree`.
