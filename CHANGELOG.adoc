...
- https://github.com/eclipse-sirius/sirius-web/issues/3827[#3827] [core] Improved loading time of projects with multiple documents by loading the documents in multiple threads in parallel.
