...
- [ADR-51] Add the ability to minimize the content of a site
...
- https://github.com/eclipse-sirius/sirius-components/issues/1138[#1138] [workbench] `WorkbenchViewContribution` now require an `icon` prop.
