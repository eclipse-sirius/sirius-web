...
- https://github.com/eclipse-sirius/sirius-web/issues/6047[#6047] [form] Simplify the lifecycle of the Form representation event processor.
The Form event processor now only manages collaboration state and publishes refreshed forms. Initial rendering and refresh are handled by dedicated services.
