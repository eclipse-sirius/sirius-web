...
- [ADR-119] Improve label component API
...
- https://github.com/eclipse-sirius/sirius-web/issues/2589[#2589] [diagram] The declaration of labels in diagrams has evolved and must be adapted for custom nodes.
See [ADR-119] _Improve label component API_ for details.
...
- https://github.com/eclipse-sirius/sirius-web/issues/2589[#2589] [diagram] Improve the label component API to facilitate its customization
