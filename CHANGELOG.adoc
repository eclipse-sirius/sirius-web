...
- https://github.com/eclipse-sirius/sirius-web/issues/1361[#1361] [diagram] The API `deleteFromDiagram` will be removed.
The deletion tool is now a classic tool that operates entirely in the backend.
