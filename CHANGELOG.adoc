...
=== Dependency update
- https://github.com/eclipse-sirius/sirius-web/issues/3277[#3277] [gantt] Move to @ObeoNetwork/gantt-task-react 0.4.6 to benefit for enhancements
...
- https://github.com/eclipse-sirius/sirius-web/issues/3279[#3279] Improve the new architecture to reach feature partity with the old one
