...
- https://github.com/eclipse-sirius/sirius-web/issues/5531[#5531] [diagram] `diagramPaletteToolExtensionPoint` has been rename to `paletteQuickToolExtensionPoint`, you will need to use the `DiagramPaletteContributionContext` in order to get the current values of the opened palette, you can refer to the ADR 212 for more details.
