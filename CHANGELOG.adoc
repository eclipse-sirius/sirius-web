...
- https://github.com/eclipse-sirius/sirius-web/issues/5595[#5595] Provide an extension to compute the containment references instead of relying only on the current metamodel.
