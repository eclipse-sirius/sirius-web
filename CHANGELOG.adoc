...
- https://github.com/eclipse-sirius/sirius-components/issues/1431[#1431] The default implementation of the Property View should not try to handle a multi valuated EStructuralFeature of type String
