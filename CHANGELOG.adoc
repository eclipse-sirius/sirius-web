...
- https://github.com/eclipse-sirius/sirius-web/issues/2161[#2161] [form] Improves flexbox customization possibilities by adding the following CSS properties:
margin, padding, gap, alignItems and justifyContent
