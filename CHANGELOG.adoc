...
- https://github.com/eclipse-sirius/sirius-web/issues/6479[#6479] [diagram] Prevent the application to crash displaying deleted representation by being more strict on Typescript typings.
Also fix the resulting infinite React rendering.
