...
- https://github.com/eclipse-sirius/sirius-web/issues/5140[#5140] [diagram] Add support for the management of the appearance of custom nodes with the extension point `PaletteAppearanceSectionContribution`, an exemple is available on elipse node.
