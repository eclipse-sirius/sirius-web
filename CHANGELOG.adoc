...
- https://github.com/eclipse-sirius/sirius-web/issues/5015[#5015] [sirius-web] Add the ability to duplicate projects: Backend contribution only.
...
- https://github.com/eclipse-sirius/sirius-web/issues/5015[#5015] [sirius-web] Provide the backend to duplicate projects.
