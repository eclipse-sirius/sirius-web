...
Added IRepresentationEventProcessorRegistry, it can be used to retreive any `RepresentationEventProcessor`
...
- https://github.com/eclipse-sirius/sirius-web/issues/5141[#5141] [core] Added IRepresentationEventProcessorRegistry, it can be used to retreive any RepresentationEventProcessor
