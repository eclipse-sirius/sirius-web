...
- https://github.com/eclipse-sirius/sirius-web/issues/4590[#4590] [diagram] Alt-left click now automatically repeats the last tool invoked in the context (or opens the palette if there is none).
This is equivalent to opening the palette and manually choosing the shortcut to the last tool invoked, only faster.
