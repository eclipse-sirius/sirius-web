...
- [ADR-051] Add the support of custom anchors on the frontend side
...
- https://github.com/eclipse-sirius/sirius-components/issues/1065[#1065] [core] The source and target edge anchor are not considered as routing points anymore. Edges of old diagrams may have unexpected behavior since new edges will have two less routing points than existing edges in old diagrams. For further explanation see ADR-051.
...
- https://github.com/eclipse-sirius/sirius-components/issues/1130[#1130] [diagram] This is a part of https://github.com/eclipse-sirius/sirius-components/issues/966[#966]
- https://github.com/eclipse-sirius/sirius-components/issues/1065[#1065] [core] With https://github.com/eclipse-sirius/sirius-components/issues/1130[#1130], they are a part of https://github.com/eclipse-sirius/sirius-components/issues/966[#966]

=== Improvements

- https://github.com/eclipse-sirius/sirius-components/issues/1130[#1130] [diagram] Add the support source and target edge position ratio on the frontend side. For further explanation see ADR-050.
