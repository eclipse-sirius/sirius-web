...
- https://github.com/eclipse-sirius/sirius-web/issues/5270[#5270] [diagram] Export `EditColorAppearanceSection`, `EditEnumSelectAppearanceSection` and `EditNumberAppearanceSection` to use in custom node appearance
