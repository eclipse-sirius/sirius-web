...
- https://github.com/eclipse-sirius/sirius-web/issues/5863[#5863] Add `precondition` expression to `toolSection` and `toolSections` to groupPalette in the view dsl.
