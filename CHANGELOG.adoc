...
- https://github.com/eclipse-sirius/sirius-web/issues/4886[#4886] [core] Add in the shared URL for a project, if the "Query" view is opened, the query text.
- https://github.com/eclipse-sirius/sirius-web/issues/4886[#4886] [core] Add in the shared URL for a project, if the "Explorer" view is opened, the active tree description ID and the active filter IDs.
