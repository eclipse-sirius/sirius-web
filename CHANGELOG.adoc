...
- [releng] Remove xstate and @xstate/react dependencies
...
- https://github.com/eclipse-sirius/sirius-web/issues/5093[#5093] [sirius-web] Remove state machine from TextfieldPropertySection
