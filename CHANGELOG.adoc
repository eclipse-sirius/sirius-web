...
- https://github.com/eclipse-sirius/sirius-web/issues/6004[#6004] [sirius-web] Downstream project are able to contribute their own implementation of `ICreateProjectInput` in order to add new attributes that fit their needs.
** They have to update their GraphQL schema:
[source,graphql]
----
...
----
** They have to declare a Java Bean named `createProjectInputModuleJsonCustomizer` with something like this:
[source,java]
----
@Bean(name = "createProjectInputModuleJsonCustomizer")
public Jackson2ObjectMapperBuilderCustomizer customCreateProjectInputModuleJsonCustomizer() {
    SimpleModule module = new SimpleModule();
    module.addAbstractTypeMapping(ICreateProjectInput.class, CustomProjectInput.class);
    return builder -> builder.modules(existing -> existing.add(module));
}
----
