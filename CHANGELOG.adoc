...
- [cleanup] The signature of the `getChildNodePosition` method has been changed.
The `child`, `headerHeightFootprint`, and `borderWidth` parameters have been removed, as the footprint of border nodes is now taken into account directly in the layout of nodes.
You can find an example of usage in `FreeFormNodeLayoutHandler.ts`.
