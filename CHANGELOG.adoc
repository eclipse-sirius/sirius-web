...
- https://github.com/eclipse-sirius/sirius-web/issues/4214[#4214] [sirius-web] In the _Explorer_ view, replace "Synchronize with representation" mode with an explicit "Reveal selection" action button
