...
- https://github.com/eclipse-sirius/sirius-web/issues/5673[#5673] [emf] `IRepresentationDescriptionConverter` and `IViewConverter` `convert method` now return `ViewConverterResult` and a `list of ViewConverterResult`.
...
- https://github.com/eclipse-sirius/sirius-web/issues/5684[#5684] //TODO
...
- https://github.com/eclipse-sirius/sirius-web/issues/5673[#5673] [sirius-web] The EditingContext expose a new attribute `Map<String, IViewConversionData> representationDescriptionIdToConverterResult`
This can be use to retrieve a `ViewDiagramConversionData` that contains a `ViewDiagramDescriptionConverterContext` representing the mapping between `view IDiagramElementDescription` and `programmatic IDiagramElementDescription`.
- https://github.com/eclipse-sirius/sirius-web/issues/5684[#5684] //TODO
