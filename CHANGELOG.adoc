...
- https://github.com/eclipse-sirius/sirius-web/issues/5863[#5863] Add selectedNodes and selectedEdges ....
...
- https://github.com/eclipse-sirius/sirius-web/issues/5863[#5863] Add precondition expression to tool section.
