...
- https://github.com/eclipse-sirius/sirius-web/issues/6991[#6991] [tree] The Explorer text filter now searches inside the whole tree when the filter button inside the filter is activated.
...
- https://github.com/eclipse-sirius/sirius-web/issues/6995[#6995] [tree] Added `collapsedIds` to the `representationId` of the explorer subscription in order to collapse element when a search is active.
