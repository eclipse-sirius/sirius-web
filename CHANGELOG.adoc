...
- https://github.com/eclipse-sirius/sirius-web/issues/5418[#5418] [tree] Add the `ProjectsCapabilities` capability `useExplorerPalette` to replace the tree item contextual menu with a basic palette (this palette has very limited functionality for now)
...
- https://github.com/eclipse-sirius/sirius-web/issues/5416[#5416] [diagram] Move PaletteToolList component to diagram package
