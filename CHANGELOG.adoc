...
- https://github.com/eclipse-sirius/sirius-web/issues/5507[#5507] [form] All GraphQL schema using the type `FormRefreshedEventPayload` may need to also add `FormCapabilitiesRefreshedEventPayload` to their union.
