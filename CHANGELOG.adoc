...
- https://github.com/eclipse-sirius/sirius-web/issues/4700[#4700] [view-diagram] The following attributes of `EdgeDescription` have been renamed : `sourceNodesDescriptions to sourceDescriptions`, `targetNodeDescriptions to nodeDescription`, `sourceNodeExpression to sourceExpression` and `targetNodesExpression to targetExpression`.
