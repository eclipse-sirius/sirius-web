...
- https://github.com/eclipse-sirius/sirius-web/issues/3840[#3840] [diagram] Exsisting component that uses ReactFlow must migrate to use ReactFlow 12
...
- https://github.com/eclipse-sirius/sirius-web/issues/3840[#3840] [diagram] Bump to ReactFlow 12
