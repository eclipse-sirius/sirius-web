...
- https://github.com/eclipse-sirius/sirius-web/issues/5063[#5063] [diagram] Modify the custom edge algorithm to create new bending points are now added only when the source or target handle would change position (top, left, ...).
