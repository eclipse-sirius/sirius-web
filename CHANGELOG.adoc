...
- https://github.com/eclipse-sirius/sirius-web/issues/6035[#6035] [tree] Fix an issue where explorer subscription was initiated before retrieving explorer filters
...
- https://github.com/eclipse-sirius/sirius-web/issues/6761[#6761] [tree] Extract the explorer subscription in a dedicated component in order to reduce the number of rerender.
