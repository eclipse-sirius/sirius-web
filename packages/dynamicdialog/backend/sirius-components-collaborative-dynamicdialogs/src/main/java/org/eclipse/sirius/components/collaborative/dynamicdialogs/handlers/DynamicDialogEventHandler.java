...
/**
 * Handler used to execute query for dynamic dialog.
 *
 * @author lfasani
 */
@Service
public class DynamicDialogEventHandler implements IEditingContextEventHandler {
    ...
    public DynamicDialogEventHandler(ICollaborativeMessageService messageService, MeterRegistry meterRegistry, IDynamicDialogService dynamicDialogService) {
    ...
    public boolean canHandle(IEditingContext editingContext, IInput input) {
        return input instanceof DynamicDialogInput;
    }
    ...
    public void handle(One<IPayload> payloadSink, Many<ChangeDescription> changeDescriptionSink, IEditingContext editingContext, IInput input) {
        ...
        if (input instanceof DynamicDialogInput dynamicDialogInput) {
            payload = this.dynamicDialogService.renderDynamicDialog(editingContext, dynamicDialogInput);
        }
