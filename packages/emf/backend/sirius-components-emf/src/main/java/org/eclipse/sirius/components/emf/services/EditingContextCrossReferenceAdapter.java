...
public class EditingContextCrossReferenceAdapter extends ECrossReferenceAdapter {
    ...
    private void handleRemoveEObject(EObject eObject) {
        ...
        this.removeProxyFromInverseReference(eObject);
        ...
        while (allProperContents.hasNext()) {
            ...
            if (object instanceof EObject) {
                this.removeProxyFromInverseReference((EObject) object);
            }
        }
    ...
    private void removeProxyFromInverseReference(EObject referencedObject) {
        ...
        if (settings != null) {
            ...
            for (Setting setting : nonContainmentReferences) {
                try {
