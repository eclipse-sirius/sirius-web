...
export const FiveNodes: StoryObj<DiagramStoryArgs> = {
  ...
  render: (args) => (
    <div style={{ width: '100vw', height: '100vh' }}>
      <DiagramStoryWrapper args={args} diagram={FiveNodeDiagram} layoutOptions={getElkAllAlgorithmsOptions(args)} />
    </div>
  ),
};
...
export const TwoNodesGroups: StoryObj<DiagramStoryArgs> = {
  ...
  render: (args) => (
    <div style={{ width: '100vw', height: '100vh' }}>
      <DiagramStoryWrapper args={args} diagram={TwoNodeGroupDiagram} layoutOptions={getElkAllAlgorithmsOptions(args)} />
    </div>
  ),
};
