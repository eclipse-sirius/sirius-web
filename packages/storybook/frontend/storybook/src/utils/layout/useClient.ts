...
import { GQLDiagram, GQLLabel, GQLPalette } from '@eclipse-sirius/sirius-components-diagrams';
import { useMemo } from 'react';
import { createDefaultDescription, createDefaultPalette } from './diagramConstructionUtils';
