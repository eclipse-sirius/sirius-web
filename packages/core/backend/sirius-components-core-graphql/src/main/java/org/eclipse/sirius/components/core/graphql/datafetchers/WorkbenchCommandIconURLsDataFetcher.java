 ...
 * @author gcoutable
 */
@QueryDataFetcher(type = "WorkbenchCommand", field = "iconURLs")
public class WorkbenchCommandIconURLsDataFetcher implements IDataFetcherWithFieldCoordinates<List<String>> {

    private final IImageURLSanitizer imageURLSanitizer;

    public WorkbenchCommandIconURLsDataFetcher(IImageURLSanitizer imageURLSanitizer) {
