...
public class EditingContextRepresentationDescriptionDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IRepresentationDescription>> {

    private static final String REPRESENTATION_DESCRIPTION_ID = "representationDescriptionId";

    private final IEditingContextDispatcher editingContextDispatcher;

    public EditingContextRepresentationDescriptionDataFetcher(IEditingContextDispatcher editingContextDispatcher) {
