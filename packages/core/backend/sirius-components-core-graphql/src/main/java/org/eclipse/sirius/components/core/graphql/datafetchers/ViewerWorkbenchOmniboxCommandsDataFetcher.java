...
public class ViewerWorkbenchOmniboxCommandsDataFetcher implements IDataFetcherWithFieldCoordinates<Connection<OmniboxCommand>> {
    ...
    private final IWorkbenchOmniboxCommandSearchService workbenchOmniboxCommandSearchService;

    private final ObjectMapper objectMapper;

    public ViewerWorkbenchOmniboxCommandsDataFetcher(IWorkbenchOmniboxCommandSearchService workbenchOmniboxCommandSearchService, ObjectMapper objectMapper) {
        this.workbenchOmniboxCommandSearchService = Objects.requireNonNull(workbenchOmniboxCommandSearchService);
