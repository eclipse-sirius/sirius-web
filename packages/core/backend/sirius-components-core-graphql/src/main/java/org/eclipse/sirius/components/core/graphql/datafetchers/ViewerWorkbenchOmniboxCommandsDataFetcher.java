 ...
 * @author gcoutable
 */
@QueryDataFetcher(type = "Viewer", field = "workbenchOmniboxCommands")
public class ViewerWorkbenchOmniboxCommandsDataFetcher implements IDataFetcherWithFieldCoordinates<Connection<IOmniboxCommand>> {
    ...
    public ViewerWorkbenchOmniboxCommandsDataFetcher(IOmniboxCommandSeachService omniboxCommandSeachService, ObjectMapper objectMapper) {
        this.omniboxCommandSeachService = Objects.requireNonNull(omniboxCommandSeachService);
        this.objectMapper = Objects.requireNonNull(objectMapper);
    }

    @Override
    public Connection<IOmniboxCommand> get(DataFetchingEnvironment environment) throws Exception {
        ...
        List<? extends IOmniboxCommand> omniboxCommands = this.omniboxCommandSeachService.findAll(editingContextId, selectedObjectIds, query);
