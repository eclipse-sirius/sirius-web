...
/**
 * Interface for the default edition of the domain objects.
 *
 * @author arichard
 */
public interface IDefaultEditService {
    ...
    void clearReference(Object object, String referenceName);
     ...
     * @author arichard
     */
    class NoOp implements IDefaultEditService {
