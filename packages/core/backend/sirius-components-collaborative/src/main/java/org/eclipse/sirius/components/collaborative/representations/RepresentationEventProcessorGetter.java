 ...
 */
@Service
public class RepresentationEventProcessorGetter implements IRepresentationEventProcessorGetter {

    public static final String REPRESENTATION_ID = "representationId";

    private final Logger logger = LoggerFactory.getLogger(RepresentationEventProcessorGetter.class);
    ...
    public RepresentationEventProcessorGetter(IRepresentationEventProcessorRegistry representationEventProcessorRegistry, IRepresentationEventProcessorComposedFactory representationEventProcessorComposedFactory, MeterRegistry meterRegistry) {
