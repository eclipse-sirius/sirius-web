...
public class EditingContextEventProcessor implements IEditingContextEventProcessor {
    ...
    public EditingContextEventProcessor(IEditingContext editingContext, IEditingContextEventProcessorExecutorServiceProvider executorServiceProvider, IRepresentationEventProcessorRegistry representationEventProcessorRegistry, IRepresentationEventProcessorChangeListener representationEventProcessorChangeListener, MeterRegistry meterRegistry) {
    ...
    private Disposable setupChangeDescriptionSinkConsumer() {
        Consumer<ChangeDescription> consumer = changeDescription ->
                this.representationEventProcessorChangeListener.onChange(executorService, sink, canBeDisposedSink, changeDescriptionSink, editingContext, changeDescription);
    ...
    public Mono<IPayload> handle(IInput input) {
        ...
        Future<?> future = this.executorService.submit(() ->
                this.representationEventProcessorChangeListener.doHandle(this.executorService, this.editingContext, this.canBeDisposedSink, payloadSink, this.changeDescriptionSink, input));
        try {
        ...
        var timeoutFallback = Mono.just(new ErrorPayload(input.id(), ""))
    ...
    public Optional<IRepresentationEventProcessor> acquireRepresentationEventProcessor(String representationId, IInput input) {
        return this.representationEventProcessorChangeListener.acquireRepresentationEventProcessor(this.executorService, this.editingContext, canBeDisposedSink, representationId, input);
    }
