...
public record EditingContextEventProcessorParameters(
        ...
        IRepresentationEventProcessorChangeListener representationEventProcessorChangeListener,
    ...
    public EditingContextEventProcessorParameters {
        ...
        Objects.requireNonNull(representationEventProcessorChangeListener);
    ...
    public static final class EditingContextEventProcessorParametersBuilder {
        ...
        private IRepresentationEventProcessorChangeListener representationEventProcessorChangeListener;
        ...
        public EditingContextEventProcessorParametersBuilder representationEventProcessorChangeListener(IRepresentationEventProcessorChangeListener representationEventProcessorChangeListener) {
        ...
        public EditingContextEventProcessorParameters build() {
            return new EditingContextEventProcessorParameters(
                    ...
                    this.representationEventProcessorChangeListener,
