...
export const OmniboxProvider = ({
  ...
  }, [open]); // GH comment: we need to have a dependency to open otherwise the value read from the props is always false. This change will attach/detach the listener everytime an user opens the omnibox
