...
import {
  ...
  WorkbenchMainPanelConfigurationSupplier,
  WorkbenchProps,
  WorkbenchSidePanelConfiguration,
  WorkbenchSidePanelConfigurationsSupplier,
  WorkbenchState,
...
export const Workbench = forwardRef<WorkbenchConfigurationSupplier | null, WorkbenchProps>(
  (
    {
      editingContextId,
    ...
    workbenchConfigurationSupplierRef: ForwardedRef<WorkbenchConfigurationSupplier | null>
  ) => {
    ...
    const refWorkbenchSidePanelConfigurationsSupplier: RefObject<WorkbenchSidePanelConfigurationsSupplier | null> =
      useRef<WorkbenchSidePanelConfigurationsSupplier | null>(null);
    const refWorkbenchMainPanelConfigurationSupplier: RefObject<WorkbenchMainPanelConfigurationSupplier | null> =
      useRef<WorkbenchMainPanelConfigurationSupplier | null>(null);

    useImperativeHandle(workbenchConfigurationSupplierRef, () => {
      return {
        getConfiguration: () => {
          return {
            sidePanels: refWorkbenchSidePanelConfigurationsSupplier.current?.getSidePanelConfigurations() ?? [],
            mainPanel: refWorkbenchMainPanelConfigurationSupplier.current?.getMainPanelConfiguration() ?? null,
          };
        },
      };
    });
    ...
    const mainAreaConfiguration: WorkbenchMainPanelConfiguration | null =
      initialWorkbenchConfiguration?.mainPanel ?? null;
    ...
    let main = (
      <MainComponent
        ...
        readOnly={readOnly}
        initialConfiguration={mainAreaConfiguration}
      />
    );
        ...
        main = (
          <div className={classes.representationArea} data-testid="representation-area">
            <RepresentationNavigation
              ...
              onClose={onClose}
              initialConfiguration={mainAreaConfiguration}
              ref={refWorkbenchMainPanelConfigurationSupplier}
            />
    ...
    return (
      <ImpactAnalysisDialogContextProvider>
        <Panels
          ...
          mainArea={main}
          ref={refWorkbenchSidePanelConfigurationsSupplier}
        />
      </ImpactAnalysisDialogContextProvider>
    );
  }
