...
import { RepresentationMetadata, WorkbenchMainPanelConfigurationSupplier } from './Workbench.types';
...
export const RepresentationNavigation = forwardRef<
  WorkbenchMainPanelConfigurationSupplier | null,
...
>(
  (
    ...
    workbenchMainPanelConfigurationSupplierRef: ForwardedRef<WorkbenchMainPanelConfigurationSupplier | null>
  ) => {
    ...
    useImperativeHandle(
      workbenchMainPanelConfigurationSupplierRef,
      () => {
        return {
