...
export const Panels = forwardRef<WorkbenchSidePanelConfigurationsSupplier | null, PanelsProps>(
  (
    {
      editingContextId,
      readOnly,
    ...
    workbenchSidePanelConfigurationsSupplierRef: ForwardedRef<WorkbenchSidePanelConfigurationsSupplier | null>
  ) => {
    disableGlobalCursorStyles();
    ...
    useImperativeHandle(
      workbenchSidePanelConfigurationsSupplierRef,
      () => {
        return {
