...
}: RepresentationComponentProps): React.JSX.Element => {
  return (
    <div data-testid={representationId}>
      {representationId}
      <button data-testid={`${representationId}-unavailable`} onClick={onRepresentationUnavailable}>
        Unavailable
      </button>
    </div>
  );
