...
import { GQLImpactAnalysisReport, ReportViewerProps } from './useImpactAnalysis.types';
    ...
    <>
      <Dialog
        ...
        <div className={classes.title}>
          ...
          <DialogTitle data-testid="impact-analysis-dialog-title">{`You are about to ${toolLabel}`}</DialogTitle>
        </div>
        <DialogContent>
          {report != null ? (
            <ReportViewer
...
const ReportViewer = ({
  ...
  return (
    <Box>
      <Typography>{`The ${toolLabel} tool will have the following effects on your model:`}</Typography>
