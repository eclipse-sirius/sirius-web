 ...
 * @author sbegaudeau
 */
public class RepositoryItemProviderSpec extends RepositoryItemProvider {
    public RepositoryItemProviderSpec(AdapterFactory adapterFactory) {
    ...
    public Object getStyledText(Object object) {
        if (object instanceof Repository repository) {
            return new NamedElementStyledTextProvider().getStyledText(repository, this.getString("_UI_Repository_type"));
        }
