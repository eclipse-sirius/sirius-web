...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.papaya.Link} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_kind_feature", "_UI_Link_type"),
				 PapayaPackage.Literals.LINK__KIND,
				 true,
				 false,
				 false,
