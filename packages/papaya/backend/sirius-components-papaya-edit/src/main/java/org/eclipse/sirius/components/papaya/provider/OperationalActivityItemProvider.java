...
public class OperationalActivityItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperationalActivity_precondition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperationalActivity_precondition_feature", "_UI_OperationalActivity_type"),
				 PapayaPackage.Literals.OPERATIONAL_ACTIVITY__PRECONDITION,
				 true,
				 false,
				 false,
    ...
    protected void addPostconditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperationalActivity_postcondition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperationalActivity_postcondition_feature", "_UI_OperationalActivity_type"),
				 PapayaPackage.Literals.OPERATIONAL_ACTIVITY__POSTCONDITION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OperationalActivity"));
	}
    ...
    public Object getStyledText(Object object) {
		...
		{
			styledLabel.append(getString("_UI_OperationalActivity_type"), StyledString.Style.QUALIFIER_STYLER); 
		} else {
			styledLabel.append(getString("_UI_OperationalActivity_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
		}
		return styledLabel;
	}
