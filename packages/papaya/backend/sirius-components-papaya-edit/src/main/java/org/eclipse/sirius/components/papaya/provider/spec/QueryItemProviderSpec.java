...
import org.eclipse.sirius.components.papaya.provider.QueryItemProvider;
...
public class QueryItemProviderSpec extends QueryItemProvider {
    ...
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("papaya/full/obj16/Query.svg"));
    }

    @Override
    public Object getStyledText(Object object) {
        if (object instanceof Query query) {
            return new NamedElementStyledTextProvider().getStyledText(query, this.getString("_UI_Query_type"));
        }
