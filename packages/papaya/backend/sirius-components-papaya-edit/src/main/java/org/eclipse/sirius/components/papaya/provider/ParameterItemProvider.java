...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.papaya.Parameter} object. <!--
...
public class ParameterItemProvider extends TypedElementItemProvider {
    ...
    public Object getStyledText(Object object) {
        ...
        if (label == null || label.length() == 0) {
            styledLabel.append(this.getString("_UI_Parameter_type"), StyledString.Style.QUALIFIER_STYLER);
        } else {
            styledLabel.append(this.getString("_UI_Parameter_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
        }
        return styledLabel;
    }
