...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.papaya.Service} object. <!--
...
public class ServiceItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_calls_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_calls_feature", "_UI_Service_type"),
				 PapayaPackage.Literals.SERVICE__CALLS,
				 true,
				 false,
				 true,
				 null,
    ...
    public Object getStyledText(Object object) {
		...
		{
			styledLabel.append(getString("_UI_Service_type"), StyledString.Style.QUALIFIER_STYLER); 
		} else {
			styledLabel.append(getString("_UI_Service_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
		}
		return styledLabel;
	}
