...
public class ConstructorItemProvider extends ItemProviderAdapter
    ...
    protected void addParametersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constructor_parameters_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constructor_parameters_feature", "_UI_Constructor_type"),
				 PapayaPackage.Literals.CONSTRUCTOR__PARAMETERS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PapayaPackage.Literals.CONSTRUCTOR__VISIBILITY,
				 true,
				 false,
				 false,
    ...
    public Object getStyledText(Object object) {
		...
		{
			styledLabel.append(getString("_UI_Constructor_type"), StyledString.Style.QUALIFIER_STYLER); 
		} else {
			styledLabel.append(getString("_UI_Constructor_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
		}
		return styledLabel;
	}
