		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PapayaPackage.Literals.ATTRIBUTE__VISIBILITY,
				 true,
				 false,
				 false,
    ...
    protected void addFinalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_final_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_final_feature", "_UI_Attribute_type"),
				 PapayaPackage.Literals.ATTRIBUTE__FINAL,
				 true,
				 false,
				 false,
    ...
    protected void addStaticPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_static_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_static_feature", "_UI_Attribute_type"),
				 PapayaPackage.Literals.ATTRIBUTE__STATIC,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
