...
public class ProvidedServiceItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProvidedService_contracts_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ProvidedService_contracts_feature", "_UI_ProvidedService_type"),
				 PapayaPackage.Literals.PROVIDED_SERVICE__CONTRACTS,
				 true,
				 false,
				 true,
				 null,
    ...
    public Object getStyledText(Object object) {
		...
		{
			styledLabel.append(getString("_UI_ProvidedService_type"), StyledString.Style.QUALIFIER_STYLER); 
		} else {
			styledLabel.append(getString("_UI_ProvidedService_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
		}
		return styledLabel;
	}
