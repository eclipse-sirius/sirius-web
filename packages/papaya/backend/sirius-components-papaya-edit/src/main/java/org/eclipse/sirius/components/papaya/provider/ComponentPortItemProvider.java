...
public class ComponentPortItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentPort_protocol_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentPort_protocol_feature", "_UI_ComponentPort_type"),
				 PapayaPackage.Literals.COMPONENT_PORT__PROTOCOL,
				 true,
				 false,
				 false,
    ...
    public Object getStyledText(Object object) {
		...
		{
			styledLabel.append(getString("_UI_ComponentPort_type"), StyledString.Style.QUALIFIER_STYLER); 
		} else {
			styledLabel.append(getString("_UI_ComponentPort_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
		}
		return styledLabel;
	}
