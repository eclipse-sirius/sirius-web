 ...
 * @author sbegaudeau
 */
public class IterationItemProviderSpec extends IterationItemProvider {
    public IterationItemProviderSpec(AdapterFactory adapterFactory) {
    ...
    public Object getStyledText(Object object) {
        if (object instanceof Iteration iteration) {
            return new NamedElementStyledTextProvider().getStyledText(iteration, this.getString("_UI_Iteration_type"));
        }
