...
public class RepositoryItemProvider extends NamedElementItemProvider {
    ...
    public Object getStyledText(Object object) {
		...
		{
			styledLabel.append(getString("_UI_Repository_type"), StyledString.Style.QUALIFIER_STYLER); 
		} else {
			styledLabel.append(getString("_UI_Repository_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
		}
		return styledLabel;
	}
