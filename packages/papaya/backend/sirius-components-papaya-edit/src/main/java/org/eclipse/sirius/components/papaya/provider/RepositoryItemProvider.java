...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.papaya.Repository} object. <!--
...
public class RepositoryItemProvider extends NamedElementItemProvider {
    ...
    public Object getStyledText(Object object) {
        ...
        if (label == null || label.length() == 0) {
            styledLabel.append(this.getString("_UI_Repository_type"), StyledString.Style.QUALIFIER_STYLER);
        } else {
            styledLabel.append(this.getString("_UI_Repository_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
        }
        return styledLabel;
    }
