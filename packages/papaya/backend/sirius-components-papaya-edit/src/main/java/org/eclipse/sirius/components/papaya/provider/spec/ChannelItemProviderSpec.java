 ...
 * @author sbegaudeau
 */
public class ChannelItemProviderSpec extends ChannelItemProvider {
    public ChannelItemProviderSpec(AdapterFactory adapterFactory) {
    ...
    public Object getStyledText(Object object) {
        if (object instanceof Channel channel) {
            return new NamedElementStyledTextProvider().getStyledText(channel, this.getString("_UI_Channel_type"));
        }
