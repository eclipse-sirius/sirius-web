...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.papaya.ModelElement} object. <!--
...
public class ModelElementItemProvider extends ItemProviderAdapter
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(PapayaPackage.Literals.MODEL_ELEMENT__TAGS);
			childrenFeatures.add(PapayaPackage.Literals.MODEL_ELEMENT__LINKS);
		}
    ...
    public Object getStyledText(Object object) {
		return new StyledString(getString("_UI_ModelElement_type"));
	}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PapayaPackage.Literals.MODEL_ELEMENT__TAGS,
				 PapayaFactory.eINSTANCE.createTag()));

		newChildDescriptors.add
			(createChildParameter
				(PapayaPackage.Literals.MODEL_ELEMENT__LINKS,
				 PapayaFactory.eINSTANCE.createReferencingLink()));

		newChildDescriptors.add
			(createChildParameter
				(PapayaPackage.Literals.MODEL_ELEMENT__LINKS,
				 PapayaFactory.eINSTANCE.createContainingLink()));
	}
