...
import org.eclipse.sirius.components.papaya.provider.PackageItemProvider;
 ...
 * @author sbegaudeau
 */
public class PackageItemProviderSpec extends PackageItemProvider {
    public PackageItemProviderSpec(AdapterFactory adapterFactory) {
    ...
    public Object getStyledText(Object object) {
        if (object instanceof Package aPackage) {
            return new NamedElementStyledTextProvider().getStyledText(aPackage, this.getString("_UI_Package_type"));
        }
