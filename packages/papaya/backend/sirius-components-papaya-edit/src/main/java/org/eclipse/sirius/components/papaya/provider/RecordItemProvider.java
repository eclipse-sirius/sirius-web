...
public class RecordItemProvider extends ClassifierItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(PapayaPackage.Literals.RECORD__COMPONENTS);
            this.childrenFeatures.add(PapayaPackage.Literals.RECORD__OPERATIONS);
        }
    ...
    /**
     * This returns Record.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/Record"));
    }
    ...
    public Object getStyledText(Object object) {
        ...
        if (label == null || label.length() == 0) {
            styledLabel.append(this.getString("_UI_Record_type"), StyledString.Style.QUALIFIER_STYLER);
        } else {
            styledLabel.append(this.getString("_UI_Record_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
        }
        return styledLabel;
    }
