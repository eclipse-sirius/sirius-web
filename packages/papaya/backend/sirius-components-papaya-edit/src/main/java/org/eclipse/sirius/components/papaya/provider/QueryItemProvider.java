...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.papaya.Query} object. <!--
...
public class QueryItemProvider extends NamedElementItemProvider {
    ...
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/Query"));
    }
    ...
    public Object getStyledText(Object object) {
        ...
        if (label == null || label.length() == 0) {
            styledLabel.append(this.getString("_UI_Query_type"), StyledString.Style.QUALIFIER_STYLER);
        } else {
            styledLabel.append(this.getString("_UI_Query_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
        }
        return styledLabel;
    }
