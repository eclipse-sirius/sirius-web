...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.papaya.TypedElement} object. <!--
...
public class TypedElementItemProvider extends NamedElementItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(PapayaPackage.Literals.TYPED_ELEMENT__TYPE);
        }
    ...
    public Object getStyledText(Object object) {
        ...
        if (label == null || label.length() == 0) {
            styledLabel.append(this.getString("_UI_TypedElement_type"), StyledString.Style.QUALIFIER_STYLER);
        } else {
            styledLabel.append(this.getString("_UI_TypedElement_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
        }
        return styledLabel;
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(PapayaPackage.Literals.TYPED_ELEMENT__TYPE, PapayaFactory.eINSTANCE.createGenericType()));
    }
