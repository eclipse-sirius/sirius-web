...
public class SubscriptionItemProvider extends ItemProviderAdapter
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Subscription_channel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Subscription_channel_feature", "_UI_Subscription_type"),
				 PapayaPackage.Literals.SUBSCRIPTION__CHANNEL,
				 true,
				 false,
				 true,
				 null,
    ...
    protected void addMessagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Subscription_message_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Subscription_message_feature", "_UI_Subscription_type"),
				 PapayaPackage.Literals.SUBSCRIPTION__MESSAGE,
				 true,
				 false,
				 true,
				 null,
    ...
    public Object getStyledText(Object object) {
		return new StyledString(getString("_UI_Subscription_type"));
	}
