...
public class PackageItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PapayaPackage.Literals.PACKAGE__QUALIFIED_NAME,
				 false,
				 false,
				 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(PapayaPackage.Literals.PACKAGE__TYPES);
			childrenFeatures.add(PapayaPackage.Literals.PACKAGE__PACKAGES);
		}
    ...
    public Object getStyledText(Object object) {
		...
		{
			styledLabel.append(getString("_UI_Package_type"), StyledString.Style.QUALIFIER_STYLER); 
		} else {
			styledLabel.append(getString("_UI_Package_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
		}
		return styledLabel;
	}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PapayaPackage.Literals.PACKAGE__TYPES,
		...
		newChildDescriptors.add
			(createChildParameter
				(PapayaPackage.Literals.PACKAGE__PACKAGES,
