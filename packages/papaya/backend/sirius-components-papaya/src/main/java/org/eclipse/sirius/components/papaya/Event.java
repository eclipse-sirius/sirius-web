...
public interface Event extends Message {
    /**
     * Returns the value of the '<em><b>Caused By</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the value of the '<em>Caused By</em>' reference.
     * @see #setCausedBy(Message)
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.papaya.Event#getCausedBy <em>Caused By</em>}'
     * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Caused By</em>' reference.
     * @see #getCausedBy()
     * @generated
     */
    void setCausedBy(Message value);
