...
public class TaskImpl extends NamedElementImpl implements Task {
    ...
    public EList<DependencyLink> getDependencies() {
		...
		{
			dependencies = new EObjectContainmentEList<DependencyLink>(DependencyLink.class, this, PapayaPackage.TASK__DEPENDENCIES);
		}
		return dependencies;
	}
    ...
    public void setProgress(int newProgress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PapayaPackage.TASK__PROGRESS, oldProgress, progress));
	}
