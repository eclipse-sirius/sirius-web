...
public class FolderImpl extends NamedElementImpl implements Folder {
    ...
    public EList<Folder> getFolders() {
		if (folders == null)
		{
			folders = new EObjectContainmentEList<Folder>(Folder.class, this, PapayaPackage.FOLDER__FOLDERS);
		}
		return folders;
	}
    ...
    public EList<FolderElement> getElements() {
		if (elements == null)
		{
			elements = new EObjectContainmentEList<FolderElement>(FolderElement.class, this, PapayaPackage.FOLDER__ELEMENTS);
		}
		return elements;
	}
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == org.eclipse.sirius.components.papaya.Container.class)
		{
			...
			{
				case PapayaPackage.FOLDER__FOLDERS: return PapayaPackage.CONTAINER__FOLDERS;
				case PapayaPackage.FOLDER__ELEMENTS: return PapayaPackage.CONTAINER__ELEMENTS;
				default: return -1;
			}
		}
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == org.eclipse.sirius.components.papaya.Container.class)
		{
			...
			{
				case PapayaPackage.CONTAINER__FOLDERS: return PapayaPackage.FOLDER__FOLDERS;
				case PapayaPackage.CONTAINER__ELEMENTS: return PapayaPackage.FOLDER__ELEMENTS;
				default: return -1;
			}
		}
