...
public enum StartOrEnd implements Enumerator {
    ...
    /**
	 * An array of all the '<em><b>Start Or End</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    private static final StartOrEnd[] VALUES_ARRAY = new StartOrEnd[]
		{
			START,
			END,
		};
    ...
    /**
	 * A public read-only list of all the '<em><b>Start Or End</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @generated
	 */
    ...
    /**
	 * Returns the '<em><b>Start Or End</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Returns the '<em><b>Start Or End</b></em>' literal with the specified name.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
    ...
    /**
	 * Returns the '<em><b>Start Or End</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
