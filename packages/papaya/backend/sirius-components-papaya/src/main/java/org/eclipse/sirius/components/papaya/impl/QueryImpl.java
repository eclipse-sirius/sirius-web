...
public class QueryImpl extends NamedElementImpl implements Query {
    ...
    public EList<MessageEmitter> getEmittedBy() {
        if (this.emittedBy == null) {
            this.emittedBy = new EObjectWithInverseResolvingEList.ManyInverse<>(MessageEmitter.class, this, PapayaPackage.QUERY__EMITTED_BY, PapayaPackage.MESSAGE_EMITTER__EMITTED_MESSAGES);
        }
    ...
    public EList<MessageListener> getListenedBy() {
        if (this.listenedBy == null) {
            this.listenedBy = new EObjectWithInverseResolvingEList.ManyInverse<>(MessageListener.class, this, PapayaPackage.QUERY__LISTENED_BY, PapayaPackage.MESSAGE_LISTENER__LISTENED_MESSAGES);
        }
