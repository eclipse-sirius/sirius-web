...
import org.eclipse.sirius.components.compatibility.emf.modeloperations.MoveElementOperationHandler;
...
public class MoveElementOperationHandlerTests {
    ...
    public void initialize() {
        ...
        this.moveElementOperationHandler = new MoveElementOperationHandler(this.operationTestContext.getObjectService(),
