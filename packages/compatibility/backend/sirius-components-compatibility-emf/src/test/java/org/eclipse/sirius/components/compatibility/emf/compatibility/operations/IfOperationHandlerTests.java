...
import org.eclipse.sirius.components.compatibility.emf.modeloperations.IfOperationHandler;
...
public class IfOperationHandlerTests {
    ...
    public void initialize() {
        ...
        this.ifOperationHandler = new IfOperationHandler(this.operationTestContext.getObjectService(),
