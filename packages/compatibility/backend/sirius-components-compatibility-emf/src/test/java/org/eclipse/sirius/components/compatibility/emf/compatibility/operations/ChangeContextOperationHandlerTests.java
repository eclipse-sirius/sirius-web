...
import org.eclipse.sirius.components.compatibility.emf.modeloperations.ChangeContextOperationHandler;
...
public class ChangeContextOperationHandlerTests {
    ...
    public void initialize() {
        ...
        this.changeContextOperationHandler = new ChangeContextOperationHandler(this.operationTestContext.getObjectService(), this.operationTestContext.getRepresentationMetadataSearchService(),
                this.operationTestContext.getIdentifierProvider(), this.operationTestContext.getInterpreter(), new ChildModelOperationHandler(List.of()), this.changeContext);
    }
