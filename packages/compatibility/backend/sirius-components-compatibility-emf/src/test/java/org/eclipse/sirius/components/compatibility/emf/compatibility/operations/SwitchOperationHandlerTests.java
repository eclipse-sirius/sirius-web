...
import org.eclipse.sirius.components.compatibility.emf.modeloperations.SwitchOperationHandler;
...
public class SwitchOperationHandlerTests {
    ...
    public void initialize() {
        ...
        this.switchOperationHandler = new SwitchOperationHandler(this.operationTestContext.getObjectService(),
