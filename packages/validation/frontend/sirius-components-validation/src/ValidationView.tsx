...
import { ValidationRepresentationState, ValidationViewHandle } from './Validation.types';
...
export const ValidationView = forwardRef<ValidationViewHandle | null, WorkbenchViewComponentProps>(
  (
    { editingContextId }: WorkbenchViewComponentProps,
    _refValidationViewHandle: ForwardedRef<WorkbenchViewHandle | null>
  ) => {
