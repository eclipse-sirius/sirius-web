...
import { ValidationRepresentationState, ValidationViewConfigurationSupplier } from './Validation.types';
...
export const ValidationView = forwardRef<ValidationViewConfigurationSupplier | null, WorkbenchViewComponentProps>(
  (
    { editingContextId }: WorkbenchViewComponentProps,
    _validationViewConfigurationSupplierRef: ForwardedRef<WorkbenchViewConfigurationSupplier | null>
  ) => {
