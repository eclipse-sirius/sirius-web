 ...
 *******************************************************************************/
package org.eclipse.sirius.web.projects.semanticdata.domain.events;
...
/**
 * Event fired when the project semantic data name is updated.
 *
 * @author frouene
 */
public record ProjectSemanticDataNameUpdatedEvent(
        @NotNull UUID id,
