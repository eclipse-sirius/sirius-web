...
/**
 * Used to register descriptions of style customization in the backend.
 * This only consider the style customization metadata, see all style customizer like implementation of {@link org.eclipse.sirius.components.diagrams.renderer.api.INodeStyleCustomizer}.
 *
 * @author gcoutable
 * @since v2026.11.0
 */
