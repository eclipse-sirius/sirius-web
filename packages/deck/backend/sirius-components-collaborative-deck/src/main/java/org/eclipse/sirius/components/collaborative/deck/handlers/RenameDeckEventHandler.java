    ...
    public void handle(One<IPayload> payloadSink, Many<ChangeDescription> changeDescriptionSink, IEditingContext editingContext, Deck deck, IDeckInput deckInput) {
        ...
        if (deckInput instanceof RenameDeckInput renameDeckInput) {
            ...
            if (optionalDiagram.isPresent()) {
                ...
                Deck renamedDeck = new Deck(representationId, currentDeck.descriptionId(), currentDeck.targetObjectId(), newLabel, currentDeck.lanes());
                this.representationPersistenceService.save(editingContext, renamedDeck);
