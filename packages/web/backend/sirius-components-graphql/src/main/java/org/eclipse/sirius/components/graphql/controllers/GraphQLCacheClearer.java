...
public class GraphQLCacheClearer implements CommandLineRunner {
    ...
    private final Logger logger = LoggerFactory.getLogger(GraphQLCacheClearer.class);

    @Override
    public void run(String... args) throws Exception {
        this.logger.atInfo()
                .setMessage("Clearing the GraphQL cache: PropertyDataFetcher#clearReflectionCache()")
                .log();
