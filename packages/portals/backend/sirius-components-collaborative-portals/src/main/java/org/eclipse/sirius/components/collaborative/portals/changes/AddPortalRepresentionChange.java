 ...
 * @author mcharfadi
 */
public record AddPortalRepresentionChange(UUID representationId, List<PortalViewLayoutData> oldValue, PortalViewLayoutData portalViewLayoutData) implements IRepresentationChangeEvent {
}
