...
import { ResetManuallyLayoutedHandlesToolProps } from './ResetManuallyLayoutedHandlesTool.types';
...
export const ResetManuallyLayoutedHandlesTool = ({ diagramElementId }: ResetManuallyLayoutedHandlesToolProps) => {
  ...
  const areHandlesLayouted = nodes.flatMap((node) => node.data.connectionHandles).find((handle) => handle?.XYPosition);
