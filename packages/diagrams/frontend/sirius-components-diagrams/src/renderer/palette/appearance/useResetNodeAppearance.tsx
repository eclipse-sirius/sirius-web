...
import { GQLResetNodeApparenceData, GQLResetNodeApparenceVariables } from './useResetNodeAppearance.types';
...
export const useResetNodeAppearance = (editingContextId: string, representationId: string, nodeId: string) => {
