...
export const PaletteAppearanceSection = ({
  ...
  const nodeElement: InternalNode<Node<NodeData>> | undefined = nodeLookup.get(diagramElementId);
  const edgeElement: Edge<EdgeData> | undefined = nodeElement ? undefined : edgeLookup.get(diagramElementId);
