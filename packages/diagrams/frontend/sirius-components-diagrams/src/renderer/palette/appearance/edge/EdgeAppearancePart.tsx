    ...
    <ListItem disablePadding sx={(theme) => ({ paddingX: theme.spacing(1) })}>
      <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
        ...
        <EditColorAppearanceSection
          ...
          onReset={() => handleResetProperty('COLOR')}></EditColorAppearanceSection>
        ...
        <EditNumberAppearanceSection
          ...
          onReset={() => handleResetProperty('SIZE')}></EditNumberAppearanceSection>
        ...
        <EditEnumSelectAppearanceSection
          ...
          onReset={() => handleResetProperty('LINESTYLE')}></EditEnumSelectAppearanceSection>
        ...
        <EditEnumSelectAppearanceSection
          ...
          onReset={() => handleResetProperty('SOURCE_ARROW')}></EditEnumSelectAppearanceSection>
        ...
        <EditEnumSelectAppearanceSection
          ...
          onReset={() => handleResetProperty('TARGET_ARROW')}></EditEnumSelectAppearanceSection>
      </Box>
    </ListItem>
  );
};
