    ...
    <ListItem disablePadding sx={(theme) => ({ paddingX: theme.spacing(1) })}>
      <Box sx={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
        ...
        <EditNumberAppearanceSection
          ...
          onReset={() => handleResetProperty('FONT_SIZE')}></EditNumberAppearanceSection>
        ...
        <EditNumberAppearanceSection
          ...
          onReset={() => handleResetProperty('BORDER_SIZE')}></EditNumberAppearanceSection>
        ...
        <EditEnumSelectAppearanceSection
          ...
          onReset={() => handleResetProperty('BORDER_STYLE')}></EditEnumSelectAppearanceSection>
