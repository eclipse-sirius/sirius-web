...
import { GQLAction } from './useManageVisibilityActions.types';
import {
  GQLErrorPayload,
...
export const useManageVisibilityInvokeAction = (diagramElementId: string): UseManageVisibilityInvokeActionValue => {
  ...
  useEffect(() => {
    ...
    if (invokeActionData) {
      ...
      if (isErrorPayload(invokeManageVisibilityAction)) {
        addMessages(invokeManageVisibilityAction.messages);
      }
    }
