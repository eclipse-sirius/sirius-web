...
const getOffsetFromPreviousNewSibling = (
  node: Node<NodeData | EdgeAnchorNodeData, DiagramNodeType>,
  nodeIndex: number,
...
const getPositionFromReferencedNode = (
  node: Node<NodeData | EdgeAnchorNodeData, DiagramNodeType>,
  referencedNode: Node<NodeData | EdgeAnchorNodeData, DiagramNodeType>,
  layoutDirection: GQLArrangeLayoutDirection
) => {
...
export const computeNewlyNodePosition = (
  nodes: Node<NodeData | EdgeAnchorNodeData, DiagramNodeType>[],
  previousNodes: Node<NodeData | EdgeAnchorNodeData, DiagramNodeType>[],
