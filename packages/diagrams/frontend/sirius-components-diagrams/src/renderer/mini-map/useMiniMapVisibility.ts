...
import { UseMiniMapVisibilityValue } from './useMiniMapVisibility.types';
...
export const useMiniMapVisibility = (): UseMiniMapVisibilityValue => {
  ...
  const [visibility, setVisibility] = useState<boolean>(getInitialMiniMapVisibility);
  ...
  return { isMiniMapVisible: visibility, setMiniMapVisibility: handleMiniMapVisibilityChange };
};
