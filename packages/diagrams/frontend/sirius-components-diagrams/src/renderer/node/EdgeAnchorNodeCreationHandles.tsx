...
import {
  EDGE_ANCHOR_NODE_CREATION_HANDLES_DEFAULT_SIZE,
...
export const EdgeAnchorNodeCreationHandles: NodeComponentsMap['edgeAnchorNodeCreationHandles'] = memo(
  ({ id, data }: NodeProps<Node<EdgeAnchorNodeCreationHandlesData>>) => {
    return (
      <div
        style={{
          width: EDGE_ANCHOR_NODE_CREATION_HANDLES_DEFAULT_SIZE,
          height: EDGE_ANCHOR_NODE_CREATION_HANDLES_DEFAULT_SIZE,
