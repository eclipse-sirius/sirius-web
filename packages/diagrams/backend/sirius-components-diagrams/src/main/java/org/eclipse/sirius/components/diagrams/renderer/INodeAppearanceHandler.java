...
public interface INodeAppearanceHandler {
    ...
    public static final String NODE_APPEARANCE_HANDLERS = "NODE_APPEARANCE_HANDLERS";

    boolean canHandle(INodeStyle nodeStyle);

    INodeStyle handle(INodeStyle providedStyle, List<INodeAppearanceChange> changes, Optional<INodeStyle> previousNodeStyle, Set<String> customizedStyleProperties);
}
