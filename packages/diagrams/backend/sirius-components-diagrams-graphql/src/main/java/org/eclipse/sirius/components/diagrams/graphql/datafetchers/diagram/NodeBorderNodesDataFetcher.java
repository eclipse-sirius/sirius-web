 ...
 * @author sbegaudeau
 */
@QueryDataFetcher(type = "Node", field = "borderNodes")
public class NodeBorderNodesDataFetcher implements IDataFetcherWithFieldCoordinates<DataFetcherResult<List<Node>>> {
    @Override
