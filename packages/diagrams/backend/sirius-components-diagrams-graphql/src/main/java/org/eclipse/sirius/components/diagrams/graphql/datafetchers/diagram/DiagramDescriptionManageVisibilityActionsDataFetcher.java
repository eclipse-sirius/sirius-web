...
public class DiagramDescriptionManageVisibilityActionsDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<List<Action>>> {
    ...
    public CompletableFuture<List<Action>> get(DataFetchingEnvironment environment) throws Exception {
        ...
        if (editingContextId != null && representationId != null) {
            ...
            return this.editingContextDispatcher.dispatchQuery(input.editingContextId(), input)
                    ...
                    .map(GetManageVisibilityActionsSuccessPayload::actions)
                    .toFuture();
        }
