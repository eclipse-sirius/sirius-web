 ...
 * @author arichard
 */
@QueryDataFetcher(type = "NodeDescription", field = "actions")
public class NodeDescriptionActionsDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<List<Action>>> {

    private static final String DIAGRAM_ELEMENT_ID = "diagramElementId";

    private final IEditingContextDispatcher editingContextDispatcher;

    public NodeDescriptionActionsDataFetcher(IEditingContextDispatcher editingContextDispatcher) {
