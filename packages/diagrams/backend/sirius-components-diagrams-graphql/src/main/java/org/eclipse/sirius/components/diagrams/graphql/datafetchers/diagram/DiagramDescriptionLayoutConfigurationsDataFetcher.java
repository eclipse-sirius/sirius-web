...
import org.eclipse.sirius.components.collaborative.diagrams.dto.GetLayoutConfigurationsInput;
...
public class DiagramDescriptionLayoutConfigurationsDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<List<LayoutConfiguration>>> {

    private final IEditingContextDispatcher editingContextDispatcher;

    public DiagramDescriptionLayoutConfigurationsDataFetcher(IEditingContextDispatcher editingContextDispatcher) {
    ...
    public CompletableFuture<List<LayoutConfiguration>> get(DataFetchingEnvironment environment) throws Exception {
        ...
        if (editingContextId != null && representationId != null) {
            GetLayoutConfigurationsInput input = new GetLayoutConfigurationsInput(UUID.randomUUID(), editingContextId, representationId);
