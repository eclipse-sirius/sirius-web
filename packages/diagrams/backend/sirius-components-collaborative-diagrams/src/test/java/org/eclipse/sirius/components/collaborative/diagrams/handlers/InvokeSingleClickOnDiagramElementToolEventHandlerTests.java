...
public class InvokeSingleClickOnDiagramElementToolEventHandlerTests {
    ...
    public void testInvokeToolOnNode() {
        ...
        String nodeDescriptionId = UUID.nameUUIDFromBytes(NODE_DESCRIPTION_ID.getBytes()).toString();
    ...
    public void testInvokeToolOnEdge() {
        ...
        String edgeDescriptionId = UUID.nameUUIDFromBytes(EDGE_DESCRIPTION_ID.getBytes()).toString();
