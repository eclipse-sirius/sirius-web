...
public record SingleClickOnTwoDiagramElementsTool(
        ...
        List<SingleClickOnTwoDiagramElementsCandidate> candidates) implements ITool {
    ...
    public static final class Builder {
        ...
        public SingleClickOnTwoDiagramElementsTool.Builder withImpactAnalysis(boolean withImpactAnalysis) {
            this.withImpactAnalysis = withImpactAnalysis;
            return this;
        }

        public SingleClickOnTwoDiagramElementsTool.Builder keyBindings(List<KeyBinding> keyBindings) {
            this.keyBindings = Objects.requireNonNull(keyBindings);
            return this;
        }

        public SingleClickOnTwoDiagramElementsTool build() {
            return new SingleClickOnTwoDiagramElementsTool(this.id, this.label, this.iconURL, this.dialogDescriptionId, this.withImpactAnalysis, this.keyBindings, this.candidates);
        }
    }
