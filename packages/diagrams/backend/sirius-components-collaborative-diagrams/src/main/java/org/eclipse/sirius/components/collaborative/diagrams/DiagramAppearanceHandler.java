...
public class DiagramAppearanceHandler implements IDiagramAppearanceHandler {
    ...
    public DiagramAppearanceHandler(List<INodeAppearanceHandler> nodeAppearanceHandlers, List<IEdgeAppearanceHandler> edgeAppearanceHandlers) {
    ...
    @Override
    public NodeAppearance getNodeAppearance(VariableManager variableManager, NodeDescription nodeDescription, List<IDiagramEvent> diagramEvents, String nodeId, Optional<Node> optionalPreviousNode) {
