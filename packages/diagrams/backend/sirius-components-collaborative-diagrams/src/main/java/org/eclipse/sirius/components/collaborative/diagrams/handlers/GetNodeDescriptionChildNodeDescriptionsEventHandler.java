...
/**
 * Handle "get child node descriptions" events.
 *
 * @author frouene
 */
@Service
public class GetNodeDescriptionChildNodeDescriptionsEventHandler implements IDiagramEventHandler {
    ...
    public GetNodeDescriptionChildNodeDescriptionsEventHandler(IRepresentationDescriptionSearchService representationDescriptionSearchService, ICollaborativeDiagramMessageService messageService, MeterRegistry meterRegistry) {
    ...
    public boolean canHandle(IDiagramInput diagramInput) {
        return diagramInput instanceof GetNodeDescriptionChildNodeDescriptionsInput;
    }
