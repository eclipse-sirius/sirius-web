...
/**
 * Default implementation of a service used to handle the customization of image node appearance.
 *
 * @author mcharfadi
 */
@Service
public class ImageNodeAppearanceHandler implements INodeAppearanceHandler {
    ...
    public NodeAppearance handle(INodeStyle providedStyle, List<INodeAppearanceChange> changes, Optional<NodeAppearance> previousNodeAppearance) {
        ...
        if (providedStyle instanceof ImageNodeStyle providedImageNodeStyle) {
            ImageNodeStyle.Builder styleBuilder = ImageNodeStyle.newImageNodeStyle(providedImageNodeStyle);
    ...
    private void handleBorderColor(ImageNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
                                   Set<String> customizedStyleProperties) {
        if (!handleResetChange(BORDER_COLOR, changes, customizedStyleProperties)) {
            ...
            } else if (customizedStyleProperties.contains(BORDER_COLOR) && optionalPreviousNodeStyle.isPresent() && optionalPreviousNodeStyle.get() instanceof ImageNodeStyle previousNodeStyle) {
    ...
    private void handleBorderRadius(ImageNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
                                    Set<String> customizedStyleProperties) {
        if (!handleResetChange(BORDER_RADIUS, changes, customizedStyleProperties)) {
            ...
            } else if (customizedStyleProperties.contains(BORDER_RADIUS) && optionalPreviousNodeStyle.isPresent() && optionalPreviousNodeStyle.get() instanceof ImageNodeStyle previousNodeStyle) {
    ...
    private void handleBorderSize(ImageNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
                                  Set<String> customizedStyleProperties) {
        if (!handleResetChange(BORDER_SIZE, changes, customizedStyleProperties)) {
            ...
            } else if (customizedStyleProperties.contains(BORDER_SIZE) && optionalPreviousNodeStyle.isPresent() && optionalPreviousNodeStyle.get() instanceof ImageNodeStyle previousNodeStyle) {
    ...
    private void handleBorderStyle(ImageNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
                                   Set<String> customizedStyleProperties) {
        if (!handleResetChange(BORDER_STYLE, changes, customizedStyleProperties)) {
            ...
            } else if (customizedStyleProperties.contains(BORDER_STYLE) && optionalPreviousNodeStyle.isPresent() && optionalPreviousNodeStyle.get() instanceof ImageNodeStyle previousNodeStyle) {
