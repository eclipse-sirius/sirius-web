...
public class FadeDiagramElementEventHandler implements IDiagramEventHandler {
    ...
    private void handleFadeDiagramElement(One<IPayload> payloadSink, Many<ChangeDescription> changeDescriptionSink, DiagramContext diagramContext, FadeDiagramElementInput diagramInput) {
        ...
        if (resolvedIds.size() > 0) {
            diagramContext.diagramEvents().add(new FadeDiagramElementEvent(resolvedIds, diagramInput.fade()));
        }
