...
import org.eclipse.sirius.components.collaborative.diagrams.api.nodeactions.IManageVisibilityMenuActionsProvider;
...
public class GetManageVisibilityActionsEventHandler implements IDiagramEventHandler {
    ...
    private final List<IManageVisibilityMenuActionsProvider> manageVisibilityMenuActionsProvider;
    ...
    public GetManageVisibilityActionsEventHandler(List<IManageVisibilityMenuActionsProvider> manageVisibilityMenuActionsProvider, IRepresentationDescriptionSearchService representationDescriptionSearchService, IDiagramQueryService diagramQueryService, MeterRegistry meterRegistry) {
