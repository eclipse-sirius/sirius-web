...
public interface IDiagramToolbarFilterSelectionProvider {
    ...
    FilterSelectionMenuItem getDiagramToolbarFilterSelectionMenuItem(IEditingContext editingContext, DiagramContext diagramContext, List<String> diagramElementIds);
