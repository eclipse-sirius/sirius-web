...
public class DiagramInteractionOperations {
    ...
    public static final String SINGLE_CLICK_TOOL = "NodeTool#singleClick";
    ...
    public static final String EDGE_TOOL = "EdgeTool#singleClick";
    public static final Operation EDGE_TOOL_OPERATION = new Operation(EDGE_TOOL, "Used to execute a behavior on two diagram elements");
}
