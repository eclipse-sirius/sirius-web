...
import org.eclipse.sirius.components.collaborative.diagrams.api.nodeactions.IManageVisibilityMenuActionsHandler;
...
public class InvokeManageVisibilityActionEventHandler implements IDiagramEventHandler {
    ...
    private final List<IManageVisibilityMenuActionsHandler> manageVisibilityMenuActionsHandlers;

    private final ICollaborativeDiagramMessageService messageService;

    private final Counter counter;

    public InvokeManageVisibilityActionEventHandler(IDiagramQueryService diagramQueryService, List<IManageVisibilityMenuActionsHandler> manageVisibilityMenuActionsHandlers, ICollaborativeDiagramMessageService messageService, MeterRegistry meterRegistry) {
