...
public class DiagramEventProcessor implements IDiagramEventProcessor {
    ...
    public void refresh(ChangeDescription changeDescription) {
        if (this.shouldRefresh(changeDescription)) {
            ...
            // TODO: The current behavior will not work as expected.
            // TODO: We are able to undone or redone work between to semantic change (for diagram) because any mutation send to the backend are reusing the id of the last refresh event payload.
            if (this.shouldRecordChanges(changeDescription)) {
