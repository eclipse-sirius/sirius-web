...
public class GetConnectorPaletteEventHandler implements IDiagramEventHandler {
    ...
    public GetConnectorPaletteEventHandler(
        ...
        if (diagramInput instanceof GetConnectorPaletteInput toolSectionsInput) {
            ...
            if (optionalDiagramDescription.isPresent()) {
                ...
                var optionalPaletteProvider = this.paletteProviders.stream()
                        .filter(paletteProvider -> paletteProvider.canHandle(diagramDescription))
                        .findFirst();

                var hasSourceData = optionalSourceDiagramElement.isPresent() && optionalSourceDiagramElementDescription.isPresent();
