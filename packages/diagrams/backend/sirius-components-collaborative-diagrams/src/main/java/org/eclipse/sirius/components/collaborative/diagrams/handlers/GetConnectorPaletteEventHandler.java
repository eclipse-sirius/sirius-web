...
public class GetConnectorPaletteEventHandler implements IDiagramEventHandler {
    ...
    public GetConnectorPaletteEventHandler(IRepresentationDescriptionSearchService representationDescriptionSearchService, IDiagramQueryService diagramQueryService, IDiagramDescriptionService diagramDescriptionService, List<IConnectorPaletteProvider> paletteProviders, IObjectSearchService objectSearchService,
