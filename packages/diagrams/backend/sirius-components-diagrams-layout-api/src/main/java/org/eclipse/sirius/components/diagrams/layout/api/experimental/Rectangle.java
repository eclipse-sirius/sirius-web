...
public record Rectangle(double x, double y, double width, double height) {
    ...
    public Rectangle unionWith(Collection<Rectangle> others) {
        List<Rectangle> rectangles = new ArrayList<>();
        rectangles.add(this);
        rectangles.addAll(others);
    ...
    public Rectangle unionWith(Rectangle... others) {
        return this.unionWith(Arrays.asList(others));
    }
