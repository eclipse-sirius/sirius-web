...
public class EditLabelMutationRunner implements IMutationRunner<EditLabelInput> {
    ...
    public EditLabelMutationRunner(IGraphQLRequestor graphQLRequestor) {
        this.graphQLRequestor = Objects.requireNonNull(graphQLRequestor);
    }

    @Override
    public GraphQLResult run(EditLabelInput input) {
        return this.graphQLRequestor.execute(EDIT_LABEL_MUTATION, input);
    }
}
