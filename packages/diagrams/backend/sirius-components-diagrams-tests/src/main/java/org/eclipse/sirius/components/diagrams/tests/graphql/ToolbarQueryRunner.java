...
/**
 * Used to retrieve the toolbar of a diagram.
 *
 * @author tgiraudet
 */
@Service
public class ToolbarQueryRunner implements IQueryRunner {
    ...
    public ToolbarQueryRunner(IGraphQLRequestor graphQLRequestor) {
