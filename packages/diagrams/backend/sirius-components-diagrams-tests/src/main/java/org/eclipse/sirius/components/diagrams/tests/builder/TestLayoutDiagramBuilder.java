...
public final class TestLayoutDiagramBuilder {
    ...
    public static final String NODE_DESCRIPTION_ID = UUID.nameUUIDFromBytes("NODE_DESCRIPTION_ID".getBytes()).toString();

    public static final String CHILD_NODE_DESCRIPTION_ID = UUID.nameUUIDFromBytes("CHILD_NODE_DESCRIPTION_ID".getBytes()).toString();

    public static final String EDGE_DESCRIPTION_ID = UUID.nameUUIDFromBytes("EDGE_DESCRIPTION_ID".getBytes()).toString();
