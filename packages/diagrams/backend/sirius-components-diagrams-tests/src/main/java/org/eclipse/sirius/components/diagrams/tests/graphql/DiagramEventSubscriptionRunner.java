...
public class DiagramEventSubscriptionRunner implements ISubscriptionRunner<DiagramEventInput> {
    ...
    public static final String DIAGRAM_EVENT_SUBSCRIPTION = """
    ...
    @Override
    public GraphQLSubscriptionResult run(DiagramEventInput input) {
        var rawResult = this.graphQLRequestor.subscribe(DIAGRAM_EVENT_SUBSCRIPTION, input);
