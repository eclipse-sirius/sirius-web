 ...
 */
@Service
public class InvokeFilterSelectionActionMutationRunner implements IMutationRunner<InvokeFilterSelectionInput> {
    ...
    public InvokeFilterSelectionActionMutationRunner(IGraphQLRequestor graphQLRequestor) {
