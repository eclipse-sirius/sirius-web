...
public class InsideLabelAssert extends AbstractObjectAssert<InsideLabelAssert, InsideLabel> {
    ...
    public InsideLabelAssert hasType(String type) {
    ...
    public InsideLabelAssert hasPosition(Position position) {
        assertThat(this.actual.getPosition()).isEqualTo(position);
        return this;
    }

    public InsideLabelAssert hasSize(Size size) {
        assertThat(this.actual.getSize()).isEqualTo(size);
        return this;
    }

    public InsideLabelAssert hasAlignment(Position alignment) {
