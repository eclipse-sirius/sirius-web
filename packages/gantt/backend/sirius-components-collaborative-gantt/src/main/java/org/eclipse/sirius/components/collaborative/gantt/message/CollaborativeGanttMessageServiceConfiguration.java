...
public class CollaborativeGanttMessageServiceConfiguration {
    private static final String PATH = "messages/sirius-components-collaborative-gantt";

    @Bean
    public MessageSourceAccessor collaborativeGanttMessageSourceAccessor(@Value("${spring.mvc.locale:en_EN}") Locale locale) {
