...
/**
 * Handle "Delete Task" events.
 *
 * @author lfasani
 */
@Service
public class DeleteTaskEventHandler implements IGanttEventHandler {
    ...
    public DeleteTaskEventHandler(IGanttTaskService ganttTaskService, ICollaborativeGanttMessageService messageService, MeterRegistry meterRegistry) {
    ...
    public boolean canHandle(IEditingContext editingContext, IGanttInput ganttInput) {
        return ganttInput instanceof DeleteGanttTaskInput;
    }
    ...
    public void handle(One<IPayload> payloadSink, Many<ChangeDescription> changeDescriptionSink, IEditingContext editingContext, IGanttContext ganttContext, IGanttInput ganttInput) {
        ...
        String message = this.messageService.invalidInput(ganttInput.getClass().getSimpleName(), DeleteGanttTaskInput.class.getSimpleName());
        ...
        if (ganttInput instanceof DeleteGanttTaskInput input) {
            payload = this.ganttTaskService.deleteTask(input, editingContext, ganttContext.getGantt());
