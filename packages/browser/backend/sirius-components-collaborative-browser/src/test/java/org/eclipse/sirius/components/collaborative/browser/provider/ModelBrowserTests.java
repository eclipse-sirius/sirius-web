 ...
 *******************************************************************************/
package org.eclipse.sirius.components.collaborative.browser.provider;
...
public class ModelBrowserTests {
    ...
    public void testModelBrowserDescriptionProvider() {
        ...
        var containerBrowserDescription = treeDescriptions.stream().filter(treeDescription -> treeDescription.getId().equals(ModelBrowserDescriptionProvider.CONTAINER_DESCRIPTION_ID)).findFirst();
        assertThat(containerBrowserDescription).isPresent();
        var referenceBrowserDescription = treeDescriptions.stream().filter(treeDescription -> treeDescription.getId().equals(ModelBrowserDescriptionProvider.REFERENCE_DESCRIPTION_ID)).findFirst();
        ...
        assertThat(tree.getDescriptionId()).isEqualTo(ModelBrowserDescriptionProvider.REFERENCE_DESCRIPTION_ID);
        ...
        assertThat(tree.getDescriptionId()).isEqualTo(ModelBrowserDescriptionProvider.CONTAINER_DESCRIPTION_ID);
        assertThat(tree.getKind()).isEqualTo(Tree.KIND);
