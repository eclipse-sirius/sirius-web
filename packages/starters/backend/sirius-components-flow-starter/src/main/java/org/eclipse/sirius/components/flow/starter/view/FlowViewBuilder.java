    ...
    public NodeToolSection createHideRevealNodeToolSection() {
        ...
        var revealAllChildrenNodeTool = this.diagramBuilderHelper.newNodeTool()
                ...
                .body(this.viewBuilderHelper.newChangeContext()
                        ...
                        .build())
                .build();
        var resetAllChildrenVisibilityModifiersNodeTool = this.diagramBuilderHelper.newNodeTool()
                .name("Reset content")
                .iconURLsExpression(SHOW_TOOL_ICON_EXPRESSION)
                .preconditionExpression("aql:selectedNode.getChildNodes()->notEmpty() or selectedNode.getBorderNodes()->notEmpty()")
                .body(this.viewBuilderHelper.newChangeContext()
                        .expression("aql:diagramServices.resetViewModifiers(selectedNode.getChildNodes()->union(selectedNode.getBorderNodes()))")
                        .build())
                .build();

        return this.diagramBuilderHelper.newNodeToolSection()
                .name(SHOW_HIDE_TOOL_SECTION_NAME)
                .nodeTools(hideNodeTool, hideAllChildrenNodeTool, revealAllChildrenNodeTool, resetAllChildrenVisibilityModifiersNodeTool)
                .build();
    }
