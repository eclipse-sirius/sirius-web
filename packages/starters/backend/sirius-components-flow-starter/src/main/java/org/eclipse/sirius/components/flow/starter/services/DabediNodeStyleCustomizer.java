...
public class DabediNodeStyleCustomizer implements INodeStyleCustomizer {
    ...
    public DabediNodeStyleCustomizer(@Value("${sirius.web.style.customization.enabled:false}") boolean nodeCustomizationEnabled, IFlowCapablePredicate flowCapablePredicate) {
