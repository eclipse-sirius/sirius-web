 ...
 * {@link org.eclipse.sirius.components.task.Task} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 *
 * @generated
 */
public class TaskItemProvider extends AbstractTaskItemProvider {
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_Task_type")
                : this.getString("_UI_Task_type") + " " + label;
    }
