 ...
 * @author arichard
 */
public class TextfieldCellComponentProps implements IProps {
    ...
    public TextfieldCellComponentProps(VariableManager variableManager, BiFunction<VariableManager, String, Object> cellValueProvider, String featureName, UUID cellId, UUID parentLineId,
            UUID columnId) {
