 ...
 * @author Jerome Gout
 */
public record TextareaCellElementProps(UUID id, String targetObjectId, String targetObjectKind, UUID columnId, String value, String descriptionId) implements IProps {
