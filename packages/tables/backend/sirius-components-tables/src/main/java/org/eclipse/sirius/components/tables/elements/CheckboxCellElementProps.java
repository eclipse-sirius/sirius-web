 ...
 */
@Immutable
public final class CheckboxCellElementProps implements IProps {

    public static final String TYPE = "CheckboxCell"; //$NON-NLS-1$
    ...
    private CheckboxCellElementProps() {
    ...
    public static Builder newCheckboxCellElementProps(UUID id) {
    ...
    public static final class Builder {
        ...
        public CheckboxCellElementProps build() {
            CheckboxCellElementProps cellElementProps = new CheckboxCellElementProps();
