...
public class ColumnComponentProps implements IProps {
    ...
    public ColumnComponentProps(VariableManager variableManager, ColumnDescription columnDescription, Optional<Column> previousColumn, TableRenderingCache cache, String parentElementId) {
