...
public class TableElementFactory implements IElementFactory {
    ...
    private Table instantiateTable(TableElementProps props, List<Object> children) {
        ...
        return Table.newTable(props.getId())
    ...
    private Line instantiateLine(LineElementProps props, List<Object> children) {
        ...
        return Line.newLine(props.getId())
                .targetObjectId(props.getTargetObjectId())
                .descriptionId(props.getDescriptionId())
                .cells(cells)
                .build();
    ...
    private Column instantiateColumn(ColumnElementProps props) {
        return Column.newColumn(props.getId())
                .descriptionId(props.getDescriptionId())
                .label(props.getLabel())
                .featureName(props.getFeatureName())
                .build();
    }

    private TextfieldCell instantiateCell(TextfieldCellElementProps props) {
        return TextfieldCell.newCell(props.getId())
                .parentLineId(props.getParentLineId())
                .columnId(props.getColumnId())
                .cellType(TextfieldCellElementProps.TYPE)
                .value(props.getValue())
                .build();
    }

    private CheckboxCell instantiateCell(CheckboxCellElementProps props) {
        return CheckboxCell.newCell(props.getId())
                .parentLineId(props.getParentLineId())
                .columnId(props.getColumnId())
                .cellType(CheckboxCellElementProps.TYPE)
                .value(props.isValue())
                .build();
    }

    private SelectCell instantiateCell(SelectCellElementProps props) {
        return SelectCell.newCell(props.getId())
                .parentLineId(props.getParentLineId())
                .columnId(props.getColumnId())
                .cellType(SelectCellElementProps.TYPE)
    ...
    private MultiSelectCell instantiateCell(MultiSelectCellElementProps props) {
        return MultiSelectCell.newCell(props.getId())
                .parentLineId(props.getParentLineId())
                .columnId(props.getColumnId())
                .cellType(MultiSelectCellElementProps.TYPE)
                .options(props.getOptions())
