...
public final class TableDescription {
    ...
    private Function<VariableManager, List<ColumnDescription>> columnDescriptionsProvider;
    ...
    public Function<VariableManager, List<ColumnDescription>> getColumnDescriptionsProvider() {
        return this.columnDescriptionsProvider;
    }
    ...
    public static final class Builder {
        ...
        public Builder columnDescriptionsProvider(Function<VariableManager, List<ColumnDescription>> columnDescriptionsProvider) {
            this.columnDescriptionsProvider = Objects.requireNonNull(columnDescriptionsProvider);
            return this;
        }
        ...
        public TableDescription build() {
            ...
            tableDescription.columnDescriptionsProvider = Objects.requireNonNull(this.columnDescriptionsProvider);
