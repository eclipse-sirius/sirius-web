...
public final class Table implements IRepresentation {
    ...
    public static final String KIND = IRepresentation.KIND_PREFIX + "?type=Table"; //$NON-NLS-1$
    ...
    public String toString() {
        String pattern = "{0} '{'id: {1}, targetObjectId: {2}, descriptionId: {3}, label: {4}'}'"; //$NON-NLS-1$
