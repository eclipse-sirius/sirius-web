 ...
 * @author Jerome Gout
 */
public record ResizeTableRowInput(UUID id, String editingContextId, String representationId, String tableId, String rowId, Integer height) implements ITableInput {
}
