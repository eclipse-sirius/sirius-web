...
public class EditTextfieldCellEventHandler implements ITableEventHandler {
    ...
    public EditTextfieldCellEventHandler(IObjectService objectService, ITableQueryService tableQueryService, ITableDescriptionService tableDescriptionService,
            ICollaborativeTableMessageService messageService, IFeedbackMessageService feedbackMessageService, MeterRegistry meterRegistry) {
    ...
    public void handle(One<IPayload> payloadSink, Many<ChangeDescription> changeDescriptionSink, IEditingContext editingContext, Table table, TableDescription tableDescription, ITableInput tableInput) {
        ...
        if (tableInput instanceof EditTextfieldCellInput) {
            EditTextfieldCellInput input = (EditTextfieldCellInput) tableInput;
