 ...
 * @author Jerome Gout
 */
public record InvokeRowContextMenuEntryInput(UUID id, String editingContextId, String representationId, String tableId, UUID rowId, String menuEntryId) implements ITableInput {
}