...
public class EditSelectCellEventHandler implements ITableEventHandler {
    ...
    public void handle(One<IPayload> payloadSink, Many<ChangeDescription> changeDescriptionSink, IEditingContext editingContext, ITableContext tableContext, TableDescription tableDescription, ITableInput tableInput) {
        ...
        if (tableInput instanceof EditSelectCellInput editSelectCellInput) {
            var optCell = this.tableQueryService.findCellById(tableContext.getTable(), UUID.fromString(editSelectCellInput.cellId()));
            ...
            if (optCell.isPresent()) {
                ...
                if (optLine.isPresent() && optCol.isPresent()) {
                    this.invokeEditCell(cell, optLine.get(), optCol.get(), editingContext, tableDescription, editSelectCellInput.newValue());
                    ...
                    payload = this.getPayload(editSelectCellInput.id());
                }
            }
        }
