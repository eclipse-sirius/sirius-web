 ...
 * @author arichard
 */
public record EditSelectCellInput(UUID id, String editingContextId, String representationId, String tableId, String cellId, String newValue) implements ITableInput {
    @Override
