 ...
 */
@Service
public class TableEventHandler implements ITableEventHandler {
    ...
    public TableEventHandler(ICollaborativeTableMessageService messageService, IRepresentationSearchService representationSearchService, MeterRegistry meterRegistry) {
    ...
    public boolean canHandle(ITableInput tableInput) {
        return tableInput instanceof TableInput;
    }
    ...
    public void handle(Sinks.One<IPayload> payloadSink, Sinks.Many<ChangeDescription> changeDescriptionSink, IEditingContext editingContext, ITableContext tableContext, TableDescription tableDescription, ITableInput tableInput) {
        ...
        String message = this.messageService.invalidInput(tableInput.getClass().getSimpleName(), TableInput.class.getSimpleName());
        ...
        Optional<IPayload> payload = this.representationSearchService
                ...
                .map(table -> new TableSuccessPayload(tableInput.id(), table));
