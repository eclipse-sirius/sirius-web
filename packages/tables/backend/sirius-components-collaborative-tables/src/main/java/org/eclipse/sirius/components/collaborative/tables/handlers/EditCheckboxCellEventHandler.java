...
import org.eclipse.sirius.components.collaborative.tables.TableDescriptionService;
...
public class EditCheckboxCellEventHandler implements ITableEventHandler {
    ...
    public EditCheckboxCellEventHandler(IObjectService objectService, ITableQueryService tableQueryService, TableDescriptionService tableDescriptionService,
    ...
    public void handle(One<IPayload> payloadSink, Many<ChangeDescription> changeDescriptionSink, IEditingContext editingContext, Table table, TableDescription tableDescription, ITableInput tableInput) {
        ...
        if (tableInput instanceof EditCheckboxCellInput) {
            EditCheckboxCellInput input = (EditCheckboxCellInput) tableInput;
    ...
    private void invokeEditCell(AbstractCell cell, Line line, Column column, IEditingContext editingContext, TableDescription tableDescription, boolean newValue) {
        ...
        if (optionalLineDescription.isPresent()) {
            ...
            if (optionalSelf.isPresent()) {
                ...
                lineDescription.getNewCellValueHandler().apply(variableManager, Boolean.toString(newValue));
