 ...
 *******************************************************************************/
package org.eclipse.sirius.components.tables.graphql.datafetchers.subscription;
...
/**
 * The data fetcher used to send the refreshed table to a subscription.
 *
 * @author frouene
 */
@SubscriptionDataFetcher(type = "Subscription", field = "tableEvent")
public class SubscriptionTableEventDataFetcher implements IDataFetcherWithFieldCoordinates<Publisher<DataFetcherResult<IPayload>>> {
    ...
    public SubscriptionTableEventDataFetcher(ObjectMapper objectMapper, IExceptionWrapper exceptionWrapper, IEventProcessorSubscriptionProvider eventProcessorSubscriptionProvider) {
    ...
    public Publisher<DataFetcherResult<IPayload>> get(DataFetchingEnvironment environment) throws Exception {
        ...
        var input = this.objectMapper.convertValue(argument, TableEventInput.class);
