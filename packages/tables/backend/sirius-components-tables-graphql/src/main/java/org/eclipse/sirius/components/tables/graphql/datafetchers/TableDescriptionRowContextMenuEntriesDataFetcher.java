...
public class TableDescriptionRowContextMenuEntriesDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<List<RowContextMenuEntry>>> {
    ...
    public TableDescriptionRowContextMenuEntriesDataFetcher(IEditingContextDispatcher editingContextDispatcher) {
