 ...
 * @author pcdavid
 */
@MutationDataFetcher(type = "Mutation", field = "deleteTreeItem")
public class MutationDeleteTreeItemDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationDeleteTreeItemDataFetcher(ObjectMapper objectMapper, IExceptionWrapper exceptionWrapper, IEditingContextDispatcher editingContextDispatcher) {
