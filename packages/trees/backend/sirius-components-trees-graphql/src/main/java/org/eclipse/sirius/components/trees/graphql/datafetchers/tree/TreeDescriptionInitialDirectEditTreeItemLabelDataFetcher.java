...
public class TreeDescriptionInitialDirectEditTreeItemLabelDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<String>> {

    private static final String INPUT_ARGUMENT = "treeItemId";

    private final IEditingContextDispatcher editingContextDispatcher;

    public TreeDescriptionInitialDirectEditTreeItemLabelDataFetcher(IEditingContextDispatcher editingContextDispatcher) {
