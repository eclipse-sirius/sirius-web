...
/**
 * Used to represent a fetch entry tool inside a palette of a tree item.
 *
 * @author mcharfadi
 */
public record FetchTreeItemTool(String id, String label, List<String> iconURL, List<KeyBinding> keyBindings) implements ITool { }
