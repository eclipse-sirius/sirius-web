...
public class CollaborativeTreeMessageServiceConfiguration {
    private static final String PATH = "messages/sirius-components-collaborative-trees";

    @Bean
    public MessageSourceAccessor collaborativeTreeMessageSourceAccessor(@Value("${spring.mvc.locale:en_EN}") Locale locale) {
