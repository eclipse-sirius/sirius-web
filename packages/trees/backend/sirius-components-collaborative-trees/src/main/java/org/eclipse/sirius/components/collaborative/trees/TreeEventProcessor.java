...
public class TreeEventProcessor implements ITreeEventProcessor {
    ...
    public TreeEventProcessor(IEditingContext editingContext, ITreeService treeService, TreeCreationParameters treeCreationParameters, List<ITreeEventHandler> treeEventHandlers,
        ...
        this.logger.atTrace()
                .setMessage("Creating the tree event processor {}")
                .addArgument(treeCreationParameters.getEditingContext().getId())
                .log();
    ...
    public void handle(One<IPayload> payloadSink, Many<ChangeDescription> changeDescriptionSink, IRepresentationInput representationInput) {
        if (representationInput instanceof ITreeInput treeInput) {
    ...
    private Tree refreshTree() {
        ...
        this.logger.atTrace()
                .setMessage("Tree refreshed: {}")
                .addArgument(this.treeCreationParameters.getEditingContext().getId())
                .log();
    ...
    public void dispose() {
        this.logger.atTrace()
                .setMessage("Disposing the tree event processor {}")
                .addArgument(this.treeCreationParameters.getEditingContext().getId())
                .log();
