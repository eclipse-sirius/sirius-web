...
export const useDropTreeItem = (editingContextId: string, treeId: string): UseDropTreeItemValue => {
  ...
  const onDropTreeItem = useCallback((droppedElementIds: string[], targetElementId: string, index: number): void => {
