import { GQLSingleClickOnDiagramElementTool } from '@eclipse-sirius/sirius-components-palette';
 ...
 *******************************************************************************/
export const DEFAULT_TOOL_LIST_ITEMS: GQLSingleClickOnDiagramElementTool[] = [
  {
    id: 'semantic-delete',
    label: 'Delete',
