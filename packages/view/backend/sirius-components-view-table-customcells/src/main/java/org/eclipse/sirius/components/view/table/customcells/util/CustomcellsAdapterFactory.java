 ...
 */
public class CustomcellsAdapterFactory extends AdapterFactoryImpl {
     ...
     * @generated
     */
    protected CustomcellsSwitch<Adapter> modelSwitch = new CustomcellsSwitch<Adapter>() {
        @Override
        public Adapter caseCellCheckboxWidgetDescription(CellCheckboxWidgetDescription object) {
            return CustomcellsAdapterFactory.this.createCellCheckboxWidgetDescriptionAdapter();
        }

        @Override
        public Adapter caseCellWidgetDescription(CellWidgetDescription object) {
            return CustomcellsAdapterFactory.this.createCellWidgetDescriptionAdapter();
        }

        @Override
        public Adapter defaultCase(EObject object) {
            return CustomcellsAdapterFactory.this.createEObjectAdapter();
        }
    };
     ...
     * @generated
     */
    public CustomcellsAdapterFactory() {
