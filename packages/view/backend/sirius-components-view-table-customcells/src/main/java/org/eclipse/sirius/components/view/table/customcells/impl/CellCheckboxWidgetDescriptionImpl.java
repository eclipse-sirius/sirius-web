...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Cell Checkbox Widget Description</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class CellCheckboxWidgetDescriptionImpl extends MinimalEObjectImpl.Container implements CellCheckboxWidgetDescription
{
	...
	public EList<Operation> getBody()
	{
		if (body == null)
		{
			body = new EObjectContainmentEList<Operation>(Operation.class, this, CustomcellsPackage.CELL_CHECKBOX_WIDGET_DESCRIPTION__BODY);
		}
		return body;
	}
