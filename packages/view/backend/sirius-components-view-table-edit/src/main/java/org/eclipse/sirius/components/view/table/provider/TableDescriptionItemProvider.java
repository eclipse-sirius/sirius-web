...
public class TableDescriptionItemProvider extends RepresentationDescriptionItemProvider {
    ...
    /**
	 * This returns TableDescription.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TablePackage.Literals.TABLE_DESCRIPTION__COLUMN_DESCRIPTIONS,
		...
		newChildDescriptors.add
			(createChildParameter
				(TablePackage.Literals.TABLE_DESCRIPTION__CELL_DESCRIPTIONS,
				 TableFactory.eINSTANCE.createCellDescription()));

		newChildDescriptors.add
			(createChildParameter
				(TablePackage.Literals.TABLE_DESCRIPTION__ROW_FILTERS,
