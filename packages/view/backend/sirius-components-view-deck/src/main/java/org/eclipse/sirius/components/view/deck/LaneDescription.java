...
public interface LaneDescription extends DeckElementDescription {
	 ...
	 * The default value is <code>"New Lane Description"</code>.
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.deck.LaneDescription#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.deck.LaneDescription#getDomainType <em>Domain Type</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Returns the value of the '<em><b>Owned Card Descriptions</b></em>' containment reference list.
	 * The list contents are of type {@link org.eclipse.sirius.components.view.deck.CardDescription}.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.deck.LaneDescription#getEditTool <em>Edit Tool</em>}' containment reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.deck.LaneDescription#getCreateTool <em>Create Tool</em>}' containment reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Returns the value of the '<em><b>Card Drop Tool</b></em>' containment reference.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.deck.LaneDescription#getCardDropTool <em>Card Drop Tool</em>}' containment reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @param value the new value of the '<em>Card Drop Tool</em>' containment reference.
	 * @see #getCardDropTool()
	 * @generated
	 */
    ...
    /**
	 * Returns the value of the '<em><b>Is Collapsible Expression</b></em>' attribute.
	 * The default value is <code>"aql:true"</code>.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.deck.LaneDescription#getIsCollapsibleExpression <em>Is Collapsible Expression</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @param value the new value of the '<em>Is Collapsible Expression</em>' attribute.
