...
public class DeckFactoryImpl extends EFactoryImpl implements DeckFactory {
    ...
    public EObject create(EClass eClass) {
		...
		{
			case DeckPackage.DECK_DESCRIPTION: return createDeckDescription();
			case DeckPackage.LANE_DESCRIPTION: return createLaneDescription();
			case DeckPackage.CARD_DESCRIPTION: return createCardDescription();
			case DeckPackage.CREATE_CARD_TOOL: return createCreateCardTool();
			case DeckPackage.EDIT_CARD_TOOL: return createEditCardTool();
			case DeckPackage.DELETE_CARD_TOOL: return createDeleteCardTool();
			case DeckPackage.EDIT_LANE_TOOL: return createEditLaneTool();
			case DeckPackage.CARD_DROP_TOOL: return createCardDropTool();
			case DeckPackage.LANE_DROP_TOOL: return createLaneDropTool();
			case DeckPackage.DECK_DESCRIPTION_STYLE: return createDeckDescriptionStyle();
			case DeckPackage.CONDITIONAL_DECK_DESCRIPTION_STYLE: return createConditionalDeckDescriptionStyle();
			case DeckPackage.DECK_ELEMENT_DESCRIPTION_STYLE: return createDeckElementDescriptionStyle();
			case DeckPackage.CONDITIONAL_DECK_ELEMENT_DESCRIPTION_STYLE: return createConditionalDeckElementDescriptionStyle();
			default:
