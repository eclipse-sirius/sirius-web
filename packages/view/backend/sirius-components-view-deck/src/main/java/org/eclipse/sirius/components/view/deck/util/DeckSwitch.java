...
public class DeckSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID)
		{
			case DeckPackage.DECK_DESCRIPTION:
			{
				...
				T result = caseDeckDescription(deckDescription);
				if (result == null) result = caseRepresentationDescription(deckDescription);
			...
			case DeckPackage.LANE_DESCRIPTION:
			{
				...
				T result = caseLaneDescription(laneDescription);
				if (result == null) result = caseDeckElementDescription(laneDescription);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeckPackage.CARD_DESCRIPTION:
			{
				...
				T result = caseCardDescription(cardDescription);
				if (result == null) result = caseDeckElementDescription(cardDescription);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeckPackage.DECK_TOOL:
			{
				...
				T result = caseDeckTool(deckTool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeckPackage.CREATE_CARD_TOOL:
			{
				...
				T result = caseCreateCardTool(createCardTool);
				if (result == null) result = caseDeckTool(createCardTool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeckPackage.EDIT_CARD_TOOL:
			{
				...
				T result = caseEditCardTool(editCardTool);
				if (result == null) result = caseDeckTool(editCardTool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeckPackage.DELETE_CARD_TOOL:
			{
				...
				T result = caseDeleteCardTool(deleteCardTool);
				if (result == null) result = caseDeckTool(deleteCardTool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeckPackage.EDIT_LANE_TOOL:
			{
				...
				T result = caseEditLaneTool(editLaneTool);
				if (result == null) result = caseDeckTool(editLaneTool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeckPackage.CARD_DROP_TOOL:
			{
				...
				T result = caseCardDropTool(cardDropTool);
				if (result == null) result = caseDeckTool(cardDropTool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeckPackage.LANE_DROP_TOOL:
			{
				...
				T result = caseLaneDropTool(laneDropTool);
				if (result == null) result = caseDeckTool(laneDropTool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeckPackage.DECK_ELEMENT_DESCRIPTION:
			{
				...
				T result = caseDeckElementDescription(deckElementDescription);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeckPackage.DECK_DESCRIPTION_STYLE:
			{
				...
				T result = caseDeckDescriptionStyle(deckDescriptionStyle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeckPackage.CONDITIONAL_DECK_DESCRIPTION_STYLE:
			{
				...
				T result = caseConditionalDeckDescriptionStyle(conditionalDeckDescriptionStyle);
				if (result == null) result = caseConditional(conditionalDeckDescriptionStyle);
				if (result == null) result = caseDeckDescriptionStyle(conditionalDeckDescriptionStyle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeckPackage.DECK_ELEMENT_DESCRIPTION_STYLE:
			{
				...
				T result = caseDeckElementDescriptionStyle(deckElementDescriptionStyle);
				if (result == null) result = caseLabelStyle(deckElementDescriptionStyle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DeckPackage.CONDITIONAL_DECK_ELEMENT_DESCRIPTION_STYLE:
			{
				...
				T result = caseConditionalDeckElementDescriptionStyle(conditionalDeckElementDescriptionStyle);
				if (result == null) result = caseConditional(conditionalDeckElementDescriptionStyle);
				if (result == null) result = caseDeckElementDescriptionStyle(conditionalDeckElementDescriptionStyle);
				if (result == null) result = caseLabelStyle(conditionalDeckElementDescriptionStyle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
    ...
    /**
	 * Returns the result of interpreting the object as an instance of '<em>Conditional Deck Element Description Style</em>'.
	 * <!-- begin-user-doc --> This implementation returns null; returning a non-null result will terminate
     * the switch. <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Conditional Deck Element Description Style</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
