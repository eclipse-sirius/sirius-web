 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.components.view.deck.impl.DeckElementDescriptionImpl#getSemanticCandidatesExpression <em>Semantic Candidates Expression</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.deck.impl.DeckElementDescriptionImpl#getTitleExpression <em>Title Expression</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.deck.impl.DeckElementDescriptionImpl#getLabelExpression <em>Label Expression</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.deck.impl.DeckElementDescriptionImpl#getStyle <em>Style</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.deck.impl.DeckElementDescriptionImpl#getConditionalStyles <em>Conditional Styles</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DeckElementDescriptionImpl extends MinimalEObjectImpl.Container implements DeckElementDescription {
    ...
    public void setSemanticCandidatesExpression(String newSemanticCandidatesExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeckPackage.DECK_ELEMENT_DESCRIPTION__SEMANTIC_CANDIDATES_EXPRESSION, oldSemanticCandidatesExpression, semanticCandidatesExpression));
	}
    ...
    public void setTitleExpression(String newTitleExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeckPackage.DECK_ELEMENT_DESCRIPTION__TITLE_EXPRESSION, oldTitleExpression, titleExpression));
	}
    ...
    public void setLabelExpression(String newLabelExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DeckPackage.DECK_ELEMENT_DESCRIPTION__LABEL_EXPRESSION, oldLabelExpression, labelExpression));
	}
    ...
    public NotificationChain basicSetStyle(DeckElementDescriptionStyle newStyle, NotificationChain msgs) {
		DeckElementDescriptionStyle oldStyle = style;
		style = newStyle;
		if (eNotificationRequired())
		{
    ...
    public void setStyle(DeckElementDescriptionStyle newStyle) {
		if (newStyle != style)
		{
			...
			if (style != null)
				msgs = ((InternalEObject)style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DeckPackage.DECK_ELEMENT_DESCRIPTION__STYLE, null, msgs);
			if (newStyle != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DeckPackage.DECK_ELEMENT_DESCRIPTION__STYLE, newStyle, newStyle));
	}
    ...
    public EList<ConditionalDeckElementDescriptionStyle> getConditionalStyles() {
		...
		{
			conditionalStyles = new EObjectContainmentEList<ConditionalDeckElementDescriptionStyle>(ConditionalDeckElementDescriptionStyle.class, this, DeckPackage.DECK_ELEMENT_DESCRIPTION__CONDITIONAL_STYLES);
		}
    ...
    public void eSet(int featureID, Object newValue) {
		switch (featureID)
		{
			...
			case DeckPackage.DECK_ELEMENT_DESCRIPTION__LABEL_EXPRESSION:
				...
				return;
			case DeckPackage.DECK_ELEMENT_DESCRIPTION__STYLE:
				setStyle((DeckElementDescriptionStyle)newValue);
				return;
			case DeckPackage.DECK_ELEMENT_DESCRIPTION__CONDITIONAL_STYLES:
				getConditionalStyles().clear();
				getConditionalStyles().addAll((Collection<? extends ConditionalDeckElementDescriptionStyle>)newValue);
				return;
		}
    ...
    public void eUnset(int featureID) {
		switch (featureID)
		{
			...
			case DeckPackage.DECK_ELEMENT_DESCRIPTION__LABEL_EXPRESSION:
				...
				return;
			case DeckPackage.DECK_ELEMENT_DESCRIPTION__STYLE:
				setStyle((DeckElementDescriptionStyle)null);
				return;
			case DeckPackage.DECK_ELEMENT_DESCRIPTION__CONDITIONAL_STYLES:
				getConditionalStyles().clear();
				return;
