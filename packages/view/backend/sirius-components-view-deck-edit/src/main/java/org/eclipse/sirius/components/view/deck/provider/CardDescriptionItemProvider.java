...
public class CardDescriptionItemProvider extends DeckElementDescriptionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CardDescription_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CardDescription_name_feature", "_UI_CardDescription_type"),
				 DeckPackage.Literals.CARD_DESCRIPTION__NAME,
				 true,
				 false,
				 false,
    ...
    protected void addDomainTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CardDescription_domainType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CardDescription_domainType_feature", "_UI_CardDescription_type"),
				 DeckPackage.Literals.CARD_DESCRIPTION__DOMAIN_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addDescriptionExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CardDescription_descriptionExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CardDescription_descriptionExpression_feature", "_UI_CardDescription_type"),
				 DeckPackage.Literals.CARD_DESCRIPTION__DESCRIPTION_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(DeckPackage.Literals.CARD_DESCRIPTION__EDIT_TOOL);
			childrenFeatures.add(DeckPackage.Literals.CARD_DESCRIPTION__DELETE_TOOL);
		}
    ...
    /**
	 * This returns CardDescription.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CardDescription"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_CardDescription_type") :
			getString("_UI_CardDescription_type") + " " + label;
	}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DeckPackage.Literals.CARD_DESCRIPTION__EDIT_TOOL,
				 DeckFactory.eINSTANCE.createEditCardTool()));

		newChildDescriptors.add
			(createChildParameter
				(DeckPackage.Literals.CARD_DESCRIPTION__DELETE_TOOL,
				 DeckFactory.eINSTANCE.createDeleteCardTool()));
	}
