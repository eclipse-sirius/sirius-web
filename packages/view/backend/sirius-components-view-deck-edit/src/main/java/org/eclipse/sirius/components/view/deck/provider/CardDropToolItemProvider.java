...
public class CardDropToolItemProvider extends DeckToolItemProvider {
    ...
    /**
	 * This returns CardDropTool.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CardDropTool"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_CardDropTool_type") :
			getString("_UI_CardDropTool_type") + " " + label;
	}
