 ...
 * {@link org.eclipse.sirius.components.view.deck.ConditionalDeckElementDescriptionStyle} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 *
 * @generated
 */
public class ConditionalDeckElementDescriptionStyleItemProvider extends ConditionalItemProvider {
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ConditionalDeckElementDescriptionStyle_type")
                : this.getString("_UI_ConditionalDeckElementDescriptionStyle_type") + " " + label;
    }
