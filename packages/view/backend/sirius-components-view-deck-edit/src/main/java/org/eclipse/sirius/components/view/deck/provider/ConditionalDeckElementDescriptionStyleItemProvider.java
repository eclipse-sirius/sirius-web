...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.deck.ConditionalDeckElementDescriptionStyle} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class ConditionalDeckElementDescriptionStyleItemProvider extends ConditionalItemProvider {
    /**
	 * This constructs an instance from a factory and a notifier.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    public ConditionalDeckElementDescriptionStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addBackgroundColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeckElementDescriptionStyle_backgroundColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeckElementDescriptionStyle_backgroundColor_feature", "_UI_DeckElementDescriptionStyle_type"),
				 DeckPackage.Literals.DECK_ELEMENT_DESCRIPTION_STYLE__BACKGROUND_COLOR,
				 true,
				 false,
				 true,
				 null,
    ...
    protected void addColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DeckElementDescriptionStyle_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DeckElementDescriptionStyle_color_feature", "_UI_DeckElementDescriptionStyle_type"),
				 DeckPackage.Literals.DECK_ELEMENT_DESCRIPTION_STYLE__COLOR,
				 true,
				 false,
				 true,
				 null,
    ...
    /**
	 * This returns ConditionalDeckElementDescriptionStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConditionalDeckElementDescriptionStyle"));
	}
    ...
    public String getText(Object object) {
		String label = ((ConditionalDeckElementDescriptionStyle)object).getCondition();
		return label == null || label.length() == 0 ?
			getString("_UI_ConditionalDeckElementDescriptionStyle_type") :
			getString("_UI_ConditionalDeckElementDescriptionStyle_type") + " " + label;
	}
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConditionalDeckElementDescriptionStyle.class))
		{
