...
public class DeleteCardToolItemProvider extends DeckToolItemProvider {
    ...
    /**
	 * This returns DeleteCardTool.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DeleteCardTool"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_DeleteCardTool_type") :
			getString("_UI_DeleteCardTool_type") + " " + label;
	}
