...
import org.eclipse.sirius.components.widgets.reference.provider.spec.ConditionalReferenceWidgetDescriptionStyleItemProviderSpec;
import org.eclipse.sirius.components.widgets.reference.provider.spec.ReferenceWidgetDescriptionItemProviderSpec;
import org.eclipse.sirius.components.widgets.reference.provider.spec.ReferenceWidgetDescriptionStyleItemProviderSpec;
...
public class ReferenceItemProviderAdapterFactory extends ReferenceAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
     ...
     * {@link ReferenceWidgetDescription} instances. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    /**
     * This keeps track of the one adapter used for all
     * {@link ReferenceWidgetDescriptionStyle} instances. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    public Adapter createReferenceWidgetDescriptionAdapter() {
        if (this.referenceWidgetDescriptionItemProvider == null) {
            this.referenceWidgetDescriptionItemProvider = new ReferenceWidgetDescriptionItemProviderSpec(this);
        }
     ...
     * {@link ReferenceWidgetDescriptionStyle}. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @generated NOT
     */
    ...
    public Adapter createReferenceWidgetDescriptionStyleAdapter() {
        if (this.referenceWidgetDescriptionStyleItemProvider == null) {
            this.referenceWidgetDescriptionStyleItemProvider = new ReferenceWidgetDescriptionStyleItemProviderSpec(this);
        }
    ...
    public Adapter createConditionalReferenceWidgetDescriptionStyleAdapter() {
        if (this.conditionalReferenceWidgetDescriptionStyleItemProvider == null) {
            this.conditionalReferenceWidgetDescriptionStyleItemProvider = new ConditionalReferenceWidgetDescriptionStyleItemProviderSpec(this);
        }
    ...
    public static class FormChildCreationExtender implements IChildCreationExtender {
        ...
        protected static class CreationSwitch extends FormSwitch<Object> {
            ...
            public Object caseGroupDescription(GroupDescription object) {
                this.newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.GROUP_DESCRIPTION__CHILDREN, ReferenceFactory.eINSTANCE.createReferenceWidgetDescription()));
            ...
            public Object caseFlexboxContainerDescription(FlexboxContainerDescription object) {
                this.newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.FLEXBOX_CONTAINER_DESCRIPTION__CHILDREN, ReferenceFactory.eINSTANCE.createReferenceWidgetDescription()));
            ...
            public Object caseFormElementFor(FormElementFor object) {
                this.newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.FORM_ELEMENT_FOR__CHILDREN, ReferenceFactory.eINSTANCE.createReferenceWidgetDescription()));
            ...
            public Object caseFormElementIf(FormElementIf object) {
                this.newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.FORM_ELEMENT_IF__CHILDREN, ReferenceFactory.eINSTANCE.createReferenceWidgetDescription()));
