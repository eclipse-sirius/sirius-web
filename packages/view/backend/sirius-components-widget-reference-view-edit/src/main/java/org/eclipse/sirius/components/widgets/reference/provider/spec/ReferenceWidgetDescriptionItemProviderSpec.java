 ...
 * @author lfasani
 */
public class ReferenceWidgetDescriptionItemProviderSpec extends ReferenceWidgetDescriptionItemProvider {     public ReferenceWidgetDescriptionItemProviderSpec(AdapterFactory adapterFactory) {         super(adapterFactory);     }
    @Override
