...
public class ReferenceWidgetDescriptionItemProvider extends WidgetDescriptionItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (this.itemPropertyDescriptors == null) {
			...
			this.addModelBrowserIdExpressionPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Model Browser Id Expression feature.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @generated
	 */
	protected void addModelBrowserIdExpressionPropertyDescriptor(Object object) {
		this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
				((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
				this.getString("_UI_ReferenceWidgetDescription_modelBrowserIdExpression_feature"),
				this.getString("_UI_PropertyDescriptor_description",
						"_UI_ReferenceWidgetDescription_modelBrowserIdExpression_feature",
						"_UI_ReferenceWidgetDescription_type"),
				ReferencePackage.Literals.REFERENCE_WIDGET_DESCRIPTION__MODEL_BROWSER_ID_EXPRESSION, true, false, false,
