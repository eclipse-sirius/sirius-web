...
public class ReferenceItemProviderAdapterFactory extends ReferenceAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable
{
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.eclipse.sirius.components.view.widget.reference.ReferenceWidgetDescription} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.eclipse.sirius.components.view.widget.reference.ReferenceWidgetDescription}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.eclipse.sirius.components.view.widget.reference.ReferenceWidgetDescriptionStyle} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.eclipse.sirius.components.view.widget.reference.ReferenceWidgetDescriptionStyle}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	{
		if (referenceWidgetDescriptionStyleItemProvider == null)
		{
			referenceWidgetDescriptionStyleItemProvider = new ReferenceWidgetDescriptionStyleItemProvider(this);
		}

		return referenceWidgetDescriptionStyleItemProvider;
	}

	/**
	 * This keeps track of the one adapter used for all {@link org.eclipse.sirius.components.view.widget.reference.ConditionalReferenceWidgetDescriptionStyle} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.eclipse.sirius.components.view.widget.reference.ConditionalReferenceWidgetDescriptionStyle}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	{
		if (conditionalReferenceWidgetDescriptionStyleItemProvider == null)
		{
			conditionalReferenceWidgetDescriptionStyleItemProvider = new ConditionalReferenceWidgetDescriptionStyleItemProvider(this);
		}

		return conditionalReferenceWidgetDescriptionStyleItemProvider;
	}
	...
	public void dispose()
	{
		if (referenceWidgetDescriptionItemProvider != null) referenceWidgetDescriptionItemProvider.dispose();
		if (referenceWidgetDescriptionStyleItemProvider != null) referenceWidgetDescriptionStyleItemProvider.dispose();
		if (conditionalReferenceWidgetDescriptionStyleItemProvider != null) conditionalReferenceWidgetDescriptionStyleItemProvider.dispose();
	}
