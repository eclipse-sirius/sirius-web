...
public class ReferenceItemProviderAdapterFactory extends ReferenceAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
    ...
    /**
     * This keeps track of the one adapter used for all {@link ReferenceWidgetClearButtonDescription} instances. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    /**
     * This creates an adapter for a {@link ReferenceWidgetClearButtonDescription}. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated NOT
     */
    ...
    public Adapter createReferenceWidgetClearButtonDescriptionAdapter() {
        if (this.referenceWidgetClearButtonDescriptionItemProvider == null) {
            this.referenceWidgetClearButtonDescriptionItemProvider = new ReferenceWidgetClearButtonDescriptionItemProviderSpec(this);
        }
