...
import org.eclipse.sirius.components.view.gantt.*;
...
public class GanttAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
    protected GanttSwitch<Adapter> modelSwitch = new GanttSwitch<Adapter>()
		{
			@Override
			public Adapter caseGanttDescription(GanttDescription object)
			{
				return createGanttDescriptionAdapter();
			}
			@Override
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.gantt.TaskDescription <em>Task Description</em>}'.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.gantt.TaskTool <em>Task Tool</em>}'.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.gantt.CreateTaskTool <em>Create Task Tool</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can
     * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
     * end-user-doc -->
	 * @return the new adapter.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.gantt.DeleteTaskTool <em>Delete Task Tool</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can
     * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
     * end-user-doc -->
	 * @return the new adapter.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.gantt.CreateTaskDependencyTool <em>Create Task Dependency Tool</em>}'.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.gantt.DeleteTaskDependencyTool <em>Delete Task Dependency Tool</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful
     * to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
