...
public class GanttFactoryImpl extends EFactoryImpl implements GanttFactory {
    ...
    public EObject create(EClass eClass) {
		...
		{
			case GanttPackage.GANTT_DESCRIPTION: return createGanttDescription();
			case GanttPackage.TASK_DESCRIPTION: return createTaskDescription();
			case GanttPackage.CREATE_TASK_TOOL: return createCreateTaskTool();
			case GanttPackage.EDIT_TASK_TOOL: return createEditTaskTool();
			case GanttPackage.DELETE_TASK_TOOL: return createDeleteTaskTool();
			case GanttPackage.DROP_TASK_TOOL: return createDropTaskTool();
			case GanttPackage.CREATE_TASK_DEPENDENCY_TOOL: return createCreateTaskDependencyTool();
			case GanttPackage.DELETE_TASK_DEPENDENCY_TOOL: return createDeleteTaskDependencyTool();
			default:
	 ...
	 */
    @Override
    public DeleteTaskDependencyTool createDeleteTaskDependencyTool() {
		DeleteTaskDependencyToolImpl deleteTaskDependencyTool = new DeleteTaskDependencyToolImpl();
