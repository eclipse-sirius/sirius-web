...
public interface GanttFactory extends EFactory {
    ...
    /**
	 * Returns a new object of class '<em>Create Task Tool</em>'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Returns a new object of class '<em>Edit Task Tool</em>'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Returns a new object of class '<em>Delete Task Tool</em>'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Returns a new object of class '<em>Drop Task Tool</em>'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
     * Returns a new object of class '<em>Create Task Dependency Tool</em>'. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     * @return a new object of class '<em>Create Task Dependency Tool</em>'.
     * @generated
     */
