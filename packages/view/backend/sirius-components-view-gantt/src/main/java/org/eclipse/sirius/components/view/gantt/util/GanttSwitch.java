...
public class GanttSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID)
		{
			case GanttPackage.GANTT_DESCRIPTION:
			{
				...
				T result = caseGanttDescription(ganttDescription);
				if (result == null) result = caseRepresentationDescription(ganttDescription);
			...
			case GanttPackage.TASK_TOOL:
			{
				...
				T result = caseTaskTool(taskTool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GanttPackage.CREATE_TASK_TOOL:
			{
				...
				T result = caseCreateTaskTool(createTaskTool);
				if (result == null) result = caseTaskTool(createTaskTool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GanttPackage.EDIT_TASK_TOOL:
			{
				...
				T result = caseEditTaskTool(editTaskTool);
				if (result == null) result = caseTaskTool(editTaskTool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GanttPackage.DELETE_TASK_TOOL:
			{
				...
				T result = caseDeleteTaskTool(deleteTaskTool);
				if (result == null) result = caseTaskTool(deleteTaskTool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GanttPackage.DROP_TASK_TOOL:
			{
				...
				T result = caseDropTaskTool(dropTaskTool);
				if (result == null) result = caseTaskTool(dropTaskTool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GanttPackage.CREATE_TASK_DEPENDENCY_TOOL:
			{
				...
				T result = caseCreateTaskDependencyTool(createTaskDependencyTool);
				if (result == null) result = caseTaskTool(createTaskDependencyTool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GanttPackage.DELETE_TASK_DEPENDENCY_TOOL:
			{
				...
				T result = caseDeleteTaskDependencyTool(deleteTaskDependencyTool);
				if (result == null) result = caseTaskTool(deleteTaskDependencyTool);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
    ...
    /**
	 * Returns the result of interpreting the object as an instance of '<em>Task Tool</em>'.
	 * <!-- begin-user-doc -->
     * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * @param object the target of the switch.
