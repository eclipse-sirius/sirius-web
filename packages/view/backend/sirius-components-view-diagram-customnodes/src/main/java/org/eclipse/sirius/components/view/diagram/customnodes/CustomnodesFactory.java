...
public interface CustomnodesFactory extends EFactory
{
	 ...
	 * @generated
	 */
	CustomnodesFactory eINSTANCE = org.eclipse.sirius.components.view.diagram.customnodes.impl.CustomnodesFactoryImpl.init();

	/**
	 * Returns a new object of class '<em>Ellipse Node Style Description</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
