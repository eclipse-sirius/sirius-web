	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION:
			{
				...
				T result = caseEllipseNodeStyleDescription(ellipseNodeStyleDescription);
				if (result == null) result = caseNodeStyleDescription(ellipseNodeStyleDescription);
				if (result == null) result = caseBorderStyle(ellipseNodeStyleDescription);
