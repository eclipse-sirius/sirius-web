 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.diagram.customnodes.impl.EllipseNodeStyleDescriptionImpl#getBorderColor
 * <em>Border Color</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.diagram.customnodes.impl.EllipseNodeStyleDescriptionImpl#getBorderRadius
 * <em>Border Radius</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.diagram.customnodes.impl.EllipseNodeStyleDescriptionImpl#getBorderSize
 ...
 * <li>{@link org.eclipse.sirius.components.view.diagram.customnodes.impl.EllipseNodeStyleDescriptionImpl#getChildrenLayoutStrategy
 * <em>Children Layout Strategy</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.diagram.customnodes.impl.EllipseNodeStyleDescriptionImpl#getDescription
...
public class EllipseNodeStyleDescriptionImpl extends MinimalEObjectImpl.Container implements EllipseNodeStyleDescription {
    ...
    public NotificationChain basicSetChildrenLayoutStrategy(LayoutStrategyDescription newChildrenLayoutStrategy, NotificationChain msgs) {
        ...
        if (this.eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__CHILDREN_LAYOUT_STRATEGY, oldChildrenLayoutStrategy,
    ...
    public void setChildrenLayoutStrategy(LayoutStrategyDescription newChildrenLayoutStrategy) {
        if (newChildrenLayoutStrategy != this.childrenLayoutStrategy) {
            ...
            if (this.childrenLayoutStrategy != null)
                msgs = ((InternalEObject) this.childrenLayoutStrategy).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__CHILDREN_LAYOUT_STRATEGY, null,
                        msgs);
            if (newChildrenLayoutStrategy != null)
                msgs = ((InternalEObject) newChildrenLayoutStrategy).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__CHILDREN_LAYOUT_STRATEGY, null,
                        msgs);
            ...
            this.eNotify(
                    new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__CHILDREN_LAYOUT_STRATEGY, newChildrenLayoutStrategy, newChildrenLayoutStrategy));
    }
    ...
    public void setDescription(String newDescription) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__DESCRIPTION, oldDescription, this.description));
    }
