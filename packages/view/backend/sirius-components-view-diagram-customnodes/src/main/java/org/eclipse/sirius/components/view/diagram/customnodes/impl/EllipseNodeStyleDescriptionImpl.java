 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.customnodes.impl.EllipseNodeStyleDescriptionImpl#getBorderColor <em>Border Color</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.customnodes.impl.EllipseNodeStyleDescriptionImpl#getBorderRadius <em>Border Radius</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.customnodes.impl.EllipseNodeStyleDescriptionImpl#getBorderSize <em>Border Size</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.customnodes.impl.EllipseNodeStyleDescriptionImpl#getBorderLineStyle <em>Border Line Style</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.customnodes.impl.EllipseNodeStyleDescriptionImpl#getChildrenLayoutStrategy <em>Children Layout Strategy</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.customnodes.impl.EllipseNodeStyleDescriptionImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.customnodes.impl.EllipseNodeStyleDescriptionImpl#getBackground <em>Background</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EllipseNodeStyleDescriptionImpl extends MinimalEObjectImpl.Container implements EllipseNodeStyleDescription {
		...
		if (borderColor != null && borderColor.eIsProxy())
		{
			...
			if (borderColor != oldBorderColor)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__BORDER_COLOR, oldBorderColor, borderColor));
			}
		}
		return borderColor;
	}
    ...
    public void setBorderColor(UserColor newBorderColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__BORDER_COLOR, oldBorderColor, borderColor));
	}
    ...
    public void setBorderRadius(int newBorderRadius) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__BORDER_RADIUS, oldBorderRadius, borderRadius));
	}
    ...
    public void setBorderSize(int newBorderSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__BORDER_SIZE, oldBorderSize, borderSize));
	}
    ...
    public void setBorderLineStyle(LineStyle newBorderLineStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__BORDER_LINE_STYLE, oldBorderLineStyle, borderLineStyle));
	}
    ...
    public NotificationChain basicSetChildrenLayoutStrategy(LayoutStrategyDescription newChildrenLayoutStrategy, NotificationChain msgs) {
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__CHILDREN_LAYOUT_STRATEGY, oldChildrenLayoutStrategy, newChildrenLayoutStrategy);
    ...
    public void setChildrenLayoutStrategy(LayoutStrategyDescription newChildrenLayoutStrategy) {
		if (newChildrenLayoutStrategy != childrenLayoutStrategy)
		{
			...
			if (childrenLayoutStrategy != null)
				msgs = ((InternalEObject)childrenLayoutStrategy).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__CHILDREN_LAYOUT_STRATEGY, null, msgs);
			if (newChildrenLayoutStrategy != null)
				msgs = ((InternalEObject)newChildrenLayoutStrategy).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__CHILDREN_LAYOUT_STRATEGY, null, msgs);
			msgs = basicSetChildrenLayoutStrategy(newChildrenLayoutStrategy, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__CHILDREN_LAYOUT_STRATEGY, newChildrenLayoutStrategy, newChildrenLayoutStrategy));
	}
    ...
    public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__DESCRIPTION, oldDescription, description));
	}
    ...
    public UserColor getBackground() {
		if (background != null && background.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__BACKGROUND, oldBackground, background));
			}
		}
		return background;
	}
    ...
    public void setBackground(UserColor newBackground) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__BACKGROUND, oldBackground, background));
	}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID)
		{
			...
			case CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__DESCRIPTION:
