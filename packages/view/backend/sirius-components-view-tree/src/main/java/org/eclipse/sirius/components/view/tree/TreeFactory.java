...
public interface TreeFactory extends EFactory {
    ...
    /**
	 * Returns a new object of class '<em>Item Label Description</em>'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Returns a new object of class '<em>If Tree Item Label Element Description</em>'.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Returns a new object of class '<em>For Tree Item Label Element Description</em>'.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Returns a new object of class '<em>Item Label Fragment Description</em>'.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Returns a new object of class '<em>Single Click Tree Item Context Menu Entry</em>'.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Returns a new object of class '<em>Fetch Tree Item Context Menu Entry</em>'.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Returns a new object of class '<em>Custom Tree Item Context Menu Entry</em>'.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
