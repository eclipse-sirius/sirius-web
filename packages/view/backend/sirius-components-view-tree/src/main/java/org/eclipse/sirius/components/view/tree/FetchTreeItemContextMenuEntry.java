 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.components.view.tree.FetchTreeItemContextMenuEntry#getUrlExression <em>Url Exression</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.tree.FetchTreeItemContextMenuEntry#getKind <em>Kind</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.tree.FetchTreeItemContextMenuEntry#getLabelExpression <em>Label Expression</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.tree.FetchTreeItemContextMenuEntry#getIconURLExpression <em>Icon URL Expression</em>}</li>
 * </ul>
 *
...
public interface FetchTreeItemContextMenuEntry extends TreeItemContextMenuEntry {
    /**
	 * Returns the value of the '<em><b>Url Exression</b></em>' attribute.
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.tree.FetchTreeItemContextMenuEntry#getUrlExression <em>Url Exression</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @param value the new value of the '<em>Url Exression</em>' attribute.
	 * @see #getUrlExression()
	 * @generated
	 */
	 ...
	 * The literals are from the enumeration {@link org.eclipse.sirius.components.view.tree.FetchTreeItemContextMenuEntryKind}.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.tree.FetchTreeItemContextMenuEntry#getKind <em>Kind</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.tree.FetchTreeItemContextMenuEntry#getLabelExpression <em>Label Expression</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.tree.FetchTreeItemContextMenuEntry#getIconURLExpression <em>Icon URL Expression</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
