...
public class TreeFactoryImpl extends EFactoryImpl implements TreeFactory {
    ...
    public EObject create(EClass eClass) {
		...
		{
			case TreePackage.TREE_DESCRIPTION: return createTreeDescription();
			case TreePackage.TREE_ITEM_LABEL_DESCRIPTION: return createTreeItemLabelDescription();
			case TreePackage.IF_TREE_ITEM_LABEL_ELEMENT_DESCRIPTION: return createIfTreeItemLabelElementDescription();
			case TreePackage.FOR_TREE_ITEM_LABEL_ELEMENT_DESCRIPTION: return createForTreeItemLabelElementDescription();
			case TreePackage.TREE_ITEM_LABEL_FRAGMENT_DESCRIPTION: return createTreeItemLabelFragmentDescription();
			case TreePackage.SINGLE_CLICK_TREE_ITEM_CONTEXT_MENU_ENTRY: return createSingleClickTreeItemContextMenuEntry();
			case TreePackage.FETCH_TREE_ITEM_CONTEXT_MENU_ENTRY: return createFetchTreeItemContextMenuEntry();
			case TreePackage.CUSTOM_TREE_ITEM_CONTEXT_MENU_ENTRY: return createCustomTreeItemContextMenuEntry();
			default:
    ...
    public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID())
		{
			case TreePackage.FETCH_TREE_ITEM_CONTEXT_MENU_ENTRY_KIND:
				return createFetchTreeItemContextMenuEntryKindFromString(eDataType, initialValue);
			default:
    ...
    public String convertToString(EDataType eDataType, Object instanceValue) {
		...
		{
			case TreePackage.FETCH_TREE_ITEM_CONTEXT_MENU_ENTRY_KIND:
				return convertFetchTreeItemContextMenuEntryKindToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
