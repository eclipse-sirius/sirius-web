 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.components.view.tree.impl.ForTreeItemLabelElementDescriptionImpl#getIterator <em>Iterator</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.tree.impl.ForTreeItemLabelElementDescriptionImpl#getIterableExpression <em>Iterable Expression</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.tree.impl.ForTreeItemLabelElementDescriptionImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForTreeItemLabelElementDescriptionImpl extends TreeItemLabelElementDescriptionImpl implements ForTreeItemLabelElementDescription {
    ...
    public void setIterator(String newIterator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TreePackage.FOR_TREE_ITEM_LABEL_ELEMENT_DESCRIPTION__ITERATOR, oldIterator, iterator));
	}
    ...
    public void setIterableExpression(String newIterableExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TreePackage.FOR_TREE_ITEM_LABEL_ELEMENT_DESCRIPTION__ITERABLE_EXPRESSION, oldIterableExpression, iterableExpression));
	}
    ...
    public EList<TreeItemLabelElementDescription> getChildren() {
		if (children == null)
		{
			children = new EObjectContainmentEList<TreeItemLabelElementDescription>(TreeItemLabelElementDescription.class, this, TreePackage.FOR_TREE_ITEM_LABEL_ELEMENT_DESCRIPTION__CHILDREN);
		}
		return children;
	}
