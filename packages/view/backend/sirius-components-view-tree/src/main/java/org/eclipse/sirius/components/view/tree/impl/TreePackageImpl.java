...
public class TreePackageImpl extends EPackageImpl implements TreePackage {
    ...
    public EAttribute getTreeDescription_TreeItemTooltipExpression() {
		return (EAttribute)treeDescriptionEClass.getEStructuralFeatures().get(13);
	}
    ...
    public EReference getTreeItemContextMenuEntry_KeyBindings() {
		return (EReference)treeItemContextMenuEntryEClass.getEStructuralFeatures().get(2);
	}
    ...
    public void createPackageContents() {
		...
		createEAttribute(treeDescriptionEClass, TREE_DESCRIPTION__TREE_ITEM_TOOLTIP_EXPRESSION);
		...
		createEReference(treeItemContextMenuEntryEClass, TREE_ITEM_CONTEXT_MENU_ENTRY__KEY_BINDINGS);
    ...
    public void initializePackageContents() {
		...
		initEAttribute(getTreeDescription_TreeItemTooltipExpression(), theViewPackage.getInterpretedExpression(), "treeItemTooltipExpression", null, 0, 1, TreeDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTreeItemContextMenuEntry_KeyBindings(), theViewPackage.getKeyBinding(), null, "keyBindings", null, 0, -1, TreeItemContextMenuEntry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
