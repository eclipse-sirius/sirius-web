    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            case TablePackage.TABLE_DESCRIPTION: {
                ...
                T result = this.caseTableDescription(tableDescription);
                if (result == null)
                    result = this.caseRepresentationDescription(tableDescription);
                if (result == null)
            ...
            case TablePackage.CELL_WIDGET_DESCRIPTION: {
                ...
                T result = this.caseCellWidgetDescription(cellWidgetDescription);
                if (result == null)
                    result = this.defaultCase(theEObject);
                return result;
            }
            case TablePackage.CELL_TEXTFIELD_WIDGET_DESCRIPTION: {
                ...
                T result = this.caseCellTextfieldWidgetDescription(cellTextfieldWidgetDescription);
                if (result == null)
                    result = this.caseCellWidgetDescription(cellTextfieldWidgetDescription);
                if (result == null)
                    result = this.defaultCase(theEObject);
                return result;
            }
            case TablePackage.CELL_LABEL_WIDGET_DESCRIPTION: {
                ...
                T result = this.caseCellLabelWidgetDescription(cellLabelWidgetDescription);
                if (result == null)
                    result = this.caseCellWidgetDescription(cellLabelWidgetDescription);
                if (result == null)
                    result = this.defaultCase(theEObject);
                return result;
            }
