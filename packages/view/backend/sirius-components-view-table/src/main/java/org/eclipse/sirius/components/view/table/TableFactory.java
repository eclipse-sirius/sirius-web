...
public interface TableFactory extends EFactory {
    ...
    /**
	 * Returns a new object of class '<em>Row Description</em>'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Returns a new object of class '<em>Cell Description</em>'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Returns a new object of class '<em>Cell Textfield Widget Description</em>'.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Returns a new object of class '<em>Cell Textarea Widget Description</em>'.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Returns a new object of class '<em>Row Filter Description</em>'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Returns a new object of class '<em>Row Context Menu Entry</em>'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
