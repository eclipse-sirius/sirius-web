...
public class CustomcellsItemProviderAdapterFactory extends CustomcellsAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
     ...
     * {@link org.eclipse.sirius.components.view.table.customcells.CellCheckboxWidgetDescription} instances. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    ...
    public void dispose() {
        if (this.cellCheckboxWidgetDescriptionItemProvider != null)
            this.cellCheckboxWidgetDescriptionItemProvider.dispose();
    }

    /**
     * A child creation extender for the {@link TablePackage}. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
        ...
        protected static class CreationSwitch extends TableSwitch<Object> {
            ...
            public Object caseCellDescription(CellDescription object) {
                this.newChildDescriptors.add(
                        this.createChildParameter(TablePackage.Literals.CELL_DESCRIPTION__CELL_WIDGET_DESCRIPTION, CustomcellsFactory.eINSTANCE.createCellCheckboxWidgetDescription()));
