...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.ConditionalContainerBorderStyle} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class ConditionalContainerBorderStyleItemProvider extends ConditionalItemProvider {
    ...
    /**
	 * This returns ConditionalContainerBorderStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConditionalContainerBorderStyle"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ConditionalContainerBorderStyle_type") :
			getString("_UI_ConditionalContainerBorderStyle_type") + " " + label;
	}
