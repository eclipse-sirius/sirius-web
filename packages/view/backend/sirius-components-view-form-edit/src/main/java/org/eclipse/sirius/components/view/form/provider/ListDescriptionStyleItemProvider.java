...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.ListDescriptionStyle} object.
...
public class ListDescriptionStyleItemProvider extends WidgetDescriptionStyleItemProvider {
    ...
    protected void addColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ListDescriptionStyle_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ListDescriptionStyle_color_feature", "_UI_ListDescriptionStyle_type"),
				 FormPackage.Literals.LIST_DESCRIPTION_STYLE__COLOR,
				 true,
				 false,
				 false,
				 null,
    ...
    /**
	 * This returns ListDescriptionStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ListDescriptionStyle"));
	}
    ...
    public String getText(Object object) {
		...
		return getString("_UI_ListDescriptionStyle_type") + " " + listDescriptionStyle.getFontSize();
	}
