...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.PageDescription} object. <!--
...
public class PageDescriptionItemProvider extends ItemProviderAdapter
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PageDescription_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PageDescription_name_feature", "_UI_PageDescription_type"),
				 FormPackage.Literals.PAGE_DESCRIPTION__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormPackage.Literals.PAGE_DESCRIPTION__LABEL_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addDomainTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PageDescription_domainType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PageDescription_domainType_feature", "_UI_PageDescription_type"),
    ...
    protected void addSemanticCandidatesExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PageDescription_semanticCandidatesExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PageDescription_semanticCandidatesExpression_feature", "_UI_PageDescription_type"),
				 FormPackage.Literals.PAGE_DESCRIPTION__SEMANTIC_CANDIDATES_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormPackage.Literals.PAGE_DESCRIPTION__PRECONDITION_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(FormPackage.Literals.PAGE_DESCRIPTION__GROUPS);
			childrenFeatures.add(FormPackage.Literals.PAGE_DESCRIPTION__TOOLBAR_ACTIONS);
		}
