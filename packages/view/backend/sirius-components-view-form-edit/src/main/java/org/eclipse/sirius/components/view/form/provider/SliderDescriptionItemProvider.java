...
public class SliderDescriptionItemProvider extends WidgetDescriptionItemProvider {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null)
		{
			...
			addCurrentValueExpressionPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SliderDescription_minValueExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SliderDescription_minValueExpression_feature", "_UI_SliderDescription_type"),
				 FormPackage.Literals.SLIDER_DESCRIPTION__MIN_VALUE_EXPRESSION,
				 true,
				 false,
				 false,
    ...
    protected void addMaxValueExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SliderDescription_maxValueExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SliderDescription_maxValueExpression_feature", "_UI_SliderDescription_type"),
				 FormPackage.Literals.SLIDER_DESCRIPTION__MAX_VALUE_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addCurrentValueExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SliderDescription_currentValueExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SliderDescription_currentValueExpression_feature", "_UI_SliderDescription_type"),
				 FormPackage.Literals.SLIDER_DESCRIPTION__CURRENT_VALUE_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addIsEnabledExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SliderDescription_isEnabledExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SliderDescription_isEnabledExpression_feature", "_UI_SliderDescription_type"),
				 FormPackage.Literals.SLIDER_DESCRIPTION__IS_ENABLED_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(FormPackage.Literals.SLIDER_DESCRIPTION__BODY);
		}
    ...
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SliderDescription"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_SliderDescription_type") :
			getString("_UI_SliderDescription_type") + " " + label;
	}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.SLIDER_DESCRIPTION__BODY,
