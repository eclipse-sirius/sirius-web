...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.FormElementIf} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class FormElementIfItemProvider extends FormElementDescriptionItemProvider {
    /**
     * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public FormElementIfItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addPredicateExpressionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_FormElementIf_predicateExpression_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_FormElementIf_predicateExpression_feature", "_UI_FormElementIf_type"),
                FormPackage.Literals.FORM_ELEMENT_IF__PREDICATE_EXPRESSION, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(FormPackage.Literals.FORM_ELEMENT_IF__CHILDREN);
        }
    ...
    /**
     * This returns FormElementIf.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/FormElementIf.svg"));
    }
    ...
    public String getText(Object object) {
        String label = ((FormElementIf) object).getName();
        return label == null || label.length() == 0 ? this.getString("_UI_FormElementIf_type") : this.getString("_UI_FormElementIf_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(FormElementIf.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.FORM_ELEMENT_IF__CHILDREN, FormFactory.eINSTANCE.createBarChartDescription()));

        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.FORM_ELEMENT_IF__CHILDREN, FormFactory.eINSTANCE.createButtonDescription()));
        ...
        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.FORM_ELEMENT_IF__CHILDREN, FormFactory.eINSTANCE.createLabelDescription()));

        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.FORM_ELEMENT_IF__CHILDREN, FormFactory.eINSTANCE.createLinkDescription()));

        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.FORM_ELEMENT_IF__CHILDREN, FormFactory.eINSTANCE.createListDescription()));
        ...
        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.FORM_ELEMENT_IF__CHILDREN, FormFactory.eINSTANCE.createRichTextDescription()));
