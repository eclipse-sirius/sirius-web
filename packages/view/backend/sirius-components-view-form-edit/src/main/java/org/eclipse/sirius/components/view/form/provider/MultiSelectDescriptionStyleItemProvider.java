...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.MultiSelectDescriptionStyle} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class MultiSelectDescriptionStyleItemProvider extends WidgetDescriptionStyleItemProvider {
	 ...
	 * @generated
	 */
    public MultiSelectDescriptionStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addBackgroundColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MultiSelectDescriptionStyle_backgroundColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MultiSelectDescriptionStyle_backgroundColor_feature", "_UI_MultiSelectDescriptionStyle_type"),
				 FormPackage.Literals.MULTI_SELECT_DESCRIPTION_STYLE__BACKGROUND_COLOR,
				 true,
				 false,
				 false,
				 null,
    ...
    protected void addForegroundColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MultiSelectDescriptionStyle_foregroundColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MultiSelectDescriptionStyle_foregroundColor_feature", "_UI_MultiSelectDescriptionStyle_type"),
				 FormPackage.Literals.MULTI_SELECT_DESCRIPTION_STYLE__FOREGROUND_COLOR,
				 true,
				 false,
				 false,
				 null,
    ...
    protected void addShowIconPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MultiSelectDescriptionStyle_showIcon_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MultiSelectDescriptionStyle_showIcon_feature", "_UI_MultiSelectDescriptionStyle_type"),
				 FormPackage.Literals.MULTI_SELECT_DESCRIPTION_STYLE__SHOW_ICON,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
    ...
    /**
	 * This returns MultiSelectDescriptionStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MultiSelectDescriptionStyle"));
	}
    ...
    public String getText(Object object) {
		MultiSelectDescriptionStyle multiSelectDescriptionStyle = (MultiSelectDescriptionStyle)object;
		return getString("_UI_MultiSelectDescriptionStyle_type") + " " + multiSelectDescriptionStyle.getFontSize();
	}
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MultiSelectDescriptionStyle.class))
		{
