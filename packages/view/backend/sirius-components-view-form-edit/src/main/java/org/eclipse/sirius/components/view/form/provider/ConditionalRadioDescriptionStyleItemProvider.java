...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.ConditionalRadioDescriptionStyle} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class ConditionalRadioDescriptionStyleItemProvider extends ConditionalItemProvider {
    ...
    /**
	 * This returns ConditionalRadioDescriptionStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConditionalRadioDescriptionStyle"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ConditionalRadioDescriptionStyle_type") :
			getString("_UI_ConditionalRadioDescriptionStyle_type") + " " + label;
	}
