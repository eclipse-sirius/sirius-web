...
public class ListDescriptionItemProvider extends WidgetDescriptionItemProvider {
    ...
    /**
	 * This returns ListDescription.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ListDescription"));
	}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.LIST_DESCRIPTION__BODY,
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.LIST_DESCRIPTION__STYLE,
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.LIST_DESCRIPTION__CONDITIONAL_STYLES,
				 FormFactory.eINSTANCE.createConditionalListDescriptionStyle()));
	}
