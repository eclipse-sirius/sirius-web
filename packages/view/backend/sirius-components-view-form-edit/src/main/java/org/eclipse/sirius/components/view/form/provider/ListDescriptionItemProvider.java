...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.ListDescription} object. <!--
...
public class ListDescriptionItemProvider extends WidgetDescriptionItemProvider {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.LIST_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createChangeContext()));

        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.LIST_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createCreateInstance()));

        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.LIST_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createSetValue()));

        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.LIST_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createUnsetValue()));

        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.LIST_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createDeleteElement()));

        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.LIST_DESCRIPTION__STYLE, FormFactory.eINSTANCE.createListDescriptionStyle()));

        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.LIST_DESCRIPTION__CONDITIONAL_STYLES, FormFactory.eINSTANCE.createConditionalListDescriptionStyle()));
    }
