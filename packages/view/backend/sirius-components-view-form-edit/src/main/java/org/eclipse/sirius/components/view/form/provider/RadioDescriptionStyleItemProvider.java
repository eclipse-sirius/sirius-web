...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.RadioDescriptionStyle} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class RadioDescriptionStyleItemProvider extends WidgetDescriptionStyleItemProvider {
    /**
	 * This constructs an instance from a factory and a notifier.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    public RadioDescriptionStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RadioDescriptionStyle_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RadioDescriptionStyle_color_feature", "_UI_RadioDescriptionStyle_type"),
				 FormPackage.Literals.RADIO_DESCRIPTION_STYLE__COLOR,
				 true,
				 false,
				 false,
				 null,
    ...
    /**
	 * This returns RadioDescriptionStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RadioDescriptionStyle"));
	}
    ...
    public String getText(Object object) {
		RadioDescriptionStyle radioDescriptionStyle = (RadioDescriptionStyle)object;
		return getString("_UI_RadioDescriptionStyle_type") + " " + radioDescriptionStyle.getFontSize();
	}
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RadioDescriptionStyle.class))
		{
