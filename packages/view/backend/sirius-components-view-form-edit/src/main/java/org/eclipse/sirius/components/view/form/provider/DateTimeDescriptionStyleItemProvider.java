...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.DateTimeDescriptionStyle} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class DateTimeDescriptionStyleItemProvider extends WidgetDescriptionStyleItemProvider {
    /**
	 * This constructs an instance from a factory and a notifier.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    public DateTimeDescriptionStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    /**
	 * This returns DateTimeDescriptionStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DateTimeDescriptionStyle"));
	}
    ...
    public String getText(Object object) {
		String label = ((DateTimeDescriptionStyle)object).getGridTemplateColumns();
		return label == null || label.length() == 0 ?
			getString("_UI_DateTimeDescriptionStyle_type") :
			getString("_UI_DateTimeDescriptionStyle_type") + " " + label;
	}
