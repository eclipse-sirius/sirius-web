...
public class CheckboxDescriptionItemProvider extends WidgetDescriptionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FormPackage.Literals.CHECKBOX_DESCRIPTION__VALUE_EXPRESSION,
				 true,
				 false,
				 false,
    ...
    protected void addIsEnabledExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CheckboxDescription_IsEnabledExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CheckboxDescription_IsEnabledExpression_feature", "_UI_CheckboxDescription_type"),
				 FormPackage.Literals.CHECKBOX_DESCRIPTION__IS_ENABLED_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(FormPackage.Literals.CHECKBOX_DESCRIPTION__BODY);
			childrenFeatures.add(FormPackage.Literals.CHECKBOX_DESCRIPTION__STYLE);
			childrenFeatures.add(FormPackage.Literals.CHECKBOX_DESCRIPTION__CONDITIONAL_STYLES);
		}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.CHECKBOX_DESCRIPTION__BODY,
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.CHECKBOX_DESCRIPTION__STYLE,
				 FormFactory.eINSTANCE.createCheckboxDescriptionStyle()));

		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.CHECKBOX_DESCRIPTION__STYLE,
				 FormFactory.eINSTANCE.createConditionalCheckboxDescriptionStyle()));

		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.CHECKBOX_DESCRIPTION__CONDITIONAL_STYLES,
				 FormFactory.eINSTANCE.createConditionalCheckboxDescriptionStyle()));
	}
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == FormPackage.Literals.CHECKBOX_DESCRIPTION__STYLE ||
			childFeature == FormPackage.Literals.CHECKBOX_DESCRIPTION__CONDITIONAL_STYLES;
