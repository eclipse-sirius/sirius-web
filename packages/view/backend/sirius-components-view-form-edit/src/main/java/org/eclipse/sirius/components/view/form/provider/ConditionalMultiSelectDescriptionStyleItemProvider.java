...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.ConditionalMultiSelectDescriptionStyle} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class ConditionalMultiSelectDescriptionStyleItemProvider extends ConditionalItemProvider {
    ...
    /**
	 * This returns ConditionalMultiSelectDescriptionStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConditionalMultiSelectDescriptionStyle"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ConditionalMultiSelectDescriptionStyle_type") :
			getString("_UI_ConditionalMultiSelectDescriptionStyle_type") + " " + label;
	}
