...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.ConditionalLabelDescriptionStyle} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class ConditionalLabelDescriptionStyleItemProvider extends ConditionalItemProvider {
    /**
	 * This constructs an instance from a factory and a notifier.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    public ConditionalLabelDescriptionStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LabelDescriptionStyle_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LabelDescriptionStyle_color_feature", "_UI_LabelDescriptionStyle_type"),
				 FormPackage.Literals.LABEL_DESCRIPTION_STYLE__COLOR,
				 true,
				 false,
				 false,
				 null,
    ...
    /**
	 * This returns ConditionalLabelDescriptionStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConditionalLabelDescriptionStyle"));
	}
    ...
    public String getText(Object object) {
		String label = ((ConditionalLabelDescriptionStyle)object).getCondition();
		return label == null || label.length() == 0 ?
			getString("_UI_ConditionalLabelDescriptionStyle_type") :
			getString("_UI_ConditionalLabelDescriptionStyle_type") + " " + label;
	}
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConditionalLabelDescriptionStyle.class))
		{
