...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.TextareaDescriptionStyle} object.
...
public class TextareaDescriptionStyleItemProvider extends WidgetDescriptionStyleItemProvider {
    ...
    protected void addBackgroundColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TextareaDescriptionStyle_backgroundColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TextareaDescriptionStyle_backgroundColor_feature", "_UI_TextareaDescriptionStyle_type"),
				 FormPackage.Literals.TEXTAREA_DESCRIPTION_STYLE__BACKGROUND_COLOR,
				 true,
				 false,
				 false,
				 null,
    ...
    protected void addForegroundColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TextareaDescriptionStyle_foregroundColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TextareaDescriptionStyle_foregroundColor_feature", "_UI_TextareaDescriptionStyle_type"),
				 FormPackage.Literals.TEXTAREA_DESCRIPTION_STYLE__FOREGROUND_COLOR,
				 true,
				 false,
				 false,
				 null,
    ...
    /**
	 * This returns TextareaDescriptionStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TextareaDescriptionStyle"));
	}
    ...
    public String getText(Object object) {
		...
		return getString("_UI_TextareaDescriptionStyle_type") + " " + textareaDescriptionStyle.getFontSize();
	}
