...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.ConditionalButtonDescriptionStyle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionalButtonDescriptionStyleItemProvider extends ConditionalItemProvider {
    ...
    protected void addBackgroundColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ButtonDescriptionStyle_backgroundColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ButtonDescriptionStyle_backgroundColor_feature", "_UI_ButtonDescriptionStyle_type"),
				 FormPackage.Literals.BUTTON_DESCRIPTION_STYLE__BACKGROUND_COLOR,
				 true,
				 false,
				 false,
				 null,
    ...
    protected void addForegroundColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ButtonDescriptionStyle_foregroundColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ButtonDescriptionStyle_foregroundColor_feature", "_UI_ButtonDescriptionStyle_type"),
				 FormPackage.Literals.BUTTON_DESCRIPTION_STYLE__FOREGROUND_COLOR,
				 true,
				 false,
				 false,
				 null,
    ...
    /**
	 * This returns ConditionalButtonDescriptionStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConditionalButtonDescriptionStyle"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ConditionalButtonDescriptionStyle_type") :
			getString("_UI_ConditionalButtonDescriptionStyle_type") + " " + label;
	}
