 ...
 * {@link org.eclipse.sirius.components.view.form.ConditionalButtonDescriptionStyle} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class ConditionalButtonDescriptionStyleItemProvider extends ConditionalItemProvider {
    /**
     * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public ConditionalButtonDescriptionStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addBackgroundColorPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_ButtonDescriptionStyle_backgroundColor_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_ButtonDescriptionStyle_backgroundColor_feature", "_UI_ButtonDescriptionStyle_type"),
                FormPackage.Literals.BUTTON_DESCRIPTION_STYLE__BACKGROUND_COLOR, true, false, false, null, null, null));
    }
    ...
    protected void addForegroundColorPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_ButtonDescriptionStyle_foregroundColor_feature"),
                this.getString("_UI_PropertyDescriptor_description", "_UI_ButtonDescriptionStyle_foregroundColor_feature", "_UI_ButtonDescriptionStyle_type"),
                FormPackage.Literals.BUTTON_DESCRIPTION_STYLE__FOREGROUND_COLOR, true, false, false, null, null, null));
    }

    /**
     * This returns ConditionalButtonDescriptionStyle.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    ...
    public String getText(Object object) {
        String label = ((ConditionalButtonDescriptionStyle) object).getCondition();
        return label == null || label.length() == 0 ? this.getString("_UI_ConditionalButtonDescriptionStyle_type") : this.getString("_UI_ConditionalButtonDescriptionStyle_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(ConditionalButtonDescriptionStyle.class)) {
