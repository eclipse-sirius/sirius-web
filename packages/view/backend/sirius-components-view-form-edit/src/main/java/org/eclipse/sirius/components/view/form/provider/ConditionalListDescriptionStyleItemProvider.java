...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.ConditionalListDescriptionStyle} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class ConditionalListDescriptionStyleItemProvider extends ConditionalItemProvider {
    ...
    /**
	 * This returns ConditionalListDescriptionStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConditionalListDescriptionStyle"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ConditionalListDescriptionStyle_type") :
			getString("_UI_ConditionalListDescriptionStyle_type") + " " + label;
	}
