    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.DATE_TIME_DESCRIPTION__BODY,
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.DATE_TIME_DESCRIPTION__STYLE,
				 FormFactory.eINSTANCE.createDateTimeDescriptionStyle()));

		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.DATE_TIME_DESCRIPTION__STYLE,
				 FormFactory.eINSTANCE.createConditionalDateTimeDescriptionStyle()));

		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.DATE_TIME_DESCRIPTION__CONDITIONAL_STYLES,
				 FormFactory.eINSTANCE.createConditionalDateTimeDescriptionStyle()));
	}
