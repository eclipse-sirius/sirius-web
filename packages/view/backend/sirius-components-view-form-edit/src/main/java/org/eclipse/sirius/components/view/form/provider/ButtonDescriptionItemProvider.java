...
public class ButtonDescriptionItemProvider extends WidgetDescriptionItemProvider {
    ...
    protected void addButtonLabelExpressionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                ...
                FormPackage.Literals.BUTTON_DESCRIPTION__BUTTON_LABEL_EXPRESSION, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(FormPackage.Literals.BUTTON_DESCRIPTION__BODY);
            this.childrenFeatures.add(FormPackage.Literals.BUTTON_DESCRIPTION__STYLE);
            this.childrenFeatures.add(FormPackage.Literals.BUTTON_DESCRIPTION__CONDITIONAL_STYLES);
        }
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify = childFeature == FormPackage.Literals.BUTTON_DESCRIPTION__STYLE || childFeature == FormPackage.Literals.BUTTON_DESCRIPTION__CONDITIONAL_STYLES;
