...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.ButtonDescription} object.
...
public class ButtonDescriptionItemProvider extends WidgetDescriptionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ButtonDescription_buttonLabelExpression_feature", "_UI_ButtonDescription_type"),
				 FormPackage.Literals.BUTTON_DESCRIPTION__BUTTON_LABEL_EXPRESSION,
				 true,
				 false,
				 false,
    ...
    protected void addImageExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ButtonDescription_imageExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ButtonDescription_imageExpression_feature", "_UI_ButtonDescription_type"),
				 FormPackage.Literals.BUTTON_DESCRIPTION__IMAGE_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addIsEnabledExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ButtonDescription_IsEnabledExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ButtonDescription_IsEnabledExpression_feature", "_UI_ButtonDescription_type"),
				 FormPackage.Literals.BUTTON_DESCRIPTION__IS_ENABLED_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(FormPackage.Literals.BUTTON_DESCRIPTION__BODY);
			childrenFeatures.add(FormPackage.Literals.BUTTON_DESCRIPTION__STYLE);
			childrenFeatures.add(FormPackage.Literals.BUTTON_DESCRIPTION__CONDITIONAL_STYLES);
		}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			...
			getString("_UI_ButtonDescription_type") + " " + label;
	}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.BUTTON_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createChangeContext()));

        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.BUTTON_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createCreateInstance()));

        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.BUTTON_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createSetValue()));

        newChildDescriptors.add(this.createChildParameter(FormPackage.Literals.BUTTON_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createUnsetValue()));
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == FormPackage.Literals.BUTTON_DESCRIPTION__STYLE ||
			childFeature == FormPackage.Literals.BUTTON_DESCRIPTION__CONDITIONAL_STYLES;
