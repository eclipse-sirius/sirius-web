...
public class FormDescriptionItemProvider extends RepresentationDescriptionItemProvider {
    ...
    public String getText(Object object) {
        String label = ((FormDescription) object).getId();
        return label == null || label.length() == 0 ? this.getString("_UI_FormDescription_type") : this.getString("_UI_FormDescription_type") + " " + label;
    }
