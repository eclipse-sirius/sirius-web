...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.FormDescription} object. <!--
...
public class FormDescriptionItemProvider extends RepresentationDescriptionItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(FormPackage.Literals.FORM_DESCRIPTION__PAGES);
			childrenFeatures.add(FormPackage.Literals.FORM_DESCRIPTION__FORM_VARIABLES);
		}
    ...
    /**
	 * This returns FormDescription.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FormDescription"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_FormDescription_type") :
			getString("_UI_FormDescription_type") + " " + label;
	}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.FORM_DESCRIPTION__PAGES,
				 FormFactory.eINSTANCE.createPageDescription()));

		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.FORM_DESCRIPTION__FORM_VARIABLES,
