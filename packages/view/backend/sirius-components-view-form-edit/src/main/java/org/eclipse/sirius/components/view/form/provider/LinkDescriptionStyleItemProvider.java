...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.LinkDescriptionStyle} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * @generated
 */
public class LinkDescriptionStyleItemProvider extends WidgetDescriptionStyleItemProvider {
    /**
	 * This constructs an instance from a factory and a notifier.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    public LinkDescriptionStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LinkDescriptionStyle_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LinkDescriptionStyle_color_feature", "_UI_LinkDescriptionStyle_type"),
				 FormPackage.Literals.LINK_DESCRIPTION_STYLE__COLOR,
				 true,
				 false,
				 false,
				 null,
    ...
    /**
	 * This returns LinkDescriptionStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LinkDescriptionStyle"));
	}
    ...
    public String getText(Object object) {
		LinkDescriptionStyle linkDescriptionStyle = (LinkDescriptionStyle)object;
		return getString("_UI_LinkDescriptionStyle_type") + " " + linkDescriptionStyle.getFontSize();
	}
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LinkDescriptionStyle.class))
		{
