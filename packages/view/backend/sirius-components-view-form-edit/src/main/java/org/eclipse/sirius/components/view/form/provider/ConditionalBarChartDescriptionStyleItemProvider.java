...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.ConditionalBarChartDescriptionStyle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionalBarChartDescriptionStyleItemProvider extends ConditionalItemProvider {
    /**
	 * This constructs an instance from a factory and a notifier.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    public ConditionalBarChartDescriptionStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null)
		{
			...
			addBarsColorPropertyDescriptor(object);
		}
    ...
    /**
	 * This adds a property descriptor for the Bars Color feature.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    protected void addBarsColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BarChartDescriptionStyle_barsColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BarChartDescriptionStyle_barsColor_feature", "_UI_BarChartDescriptionStyle_type"),
				 FormPackage.Literals.BAR_CHART_DESCRIPTION_STYLE__BARS_COLOR,
				 true,
				 false,
				 false,
    ...
    /**
	 * This returns ConditionalBarChartDescriptionStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConditionalBarChartDescriptionStyle"));
	}
    ...
    public String getText(Object object) {
		String label = ((ConditionalBarChartDescriptionStyle)object).getCondition();
		return label == null || label.length() == 0 ?
			getString("_UI_ConditionalBarChartDescriptionStyle_type") :
			getString("_UI_ConditionalBarChartDescriptionStyle_type") + " " + label;
	}
    ...
    public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ConditionalBarChartDescriptionStyle.class))
		{
