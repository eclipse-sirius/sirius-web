    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.GROUP_DESCRIPTION__TOOLBAR_ACTIONS,
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.GROUP_DESCRIPTION__BORDER_STYLE,
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.GROUP_DESCRIPTION__CONDITIONAL_BORDER_STYLES,
				 FormFactory.eINSTANCE.createConditionalContainerBorderStyle()));
	}
