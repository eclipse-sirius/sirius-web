    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.SELECT_DESCRIPTION__BODY,
		...
		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.SELECT_DESCRIPTION__STYLE,
				 FormFactory.eINSTANCE.createSelectDescriptionStyle()));

		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.SELECT_DESCRIPTION__STYLE,
				 FormFactory.eINSTANCE.createConditionalSelectDescriptionStyle()));

		newChildDescriptors.add
			(createChildParameter
				(FormPackage.Literals.SELECT_DESCRIPTION__CONDITIONAL_STYLES,
				 FormFactory.eINSTANCE.createConditionalSelectDescriptionStyle()));
	}
