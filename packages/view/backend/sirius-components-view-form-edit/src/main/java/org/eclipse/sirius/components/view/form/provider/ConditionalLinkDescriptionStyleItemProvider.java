...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.form.ConditionalLinkDescriptionStyle} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class ConditionalLinkDescriptionStyleItemProvider extends ConditionalItemProvider {
    ...
    /**
	 * This returns ConditionalLinkDescriptionStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ConditionalLinkDescriptionStyle"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ConditionalLinkDescriptionStyle_type") :
			getString("_UI_ConditionalLinkDescriptionStyle_type") + " " + label;
	}
