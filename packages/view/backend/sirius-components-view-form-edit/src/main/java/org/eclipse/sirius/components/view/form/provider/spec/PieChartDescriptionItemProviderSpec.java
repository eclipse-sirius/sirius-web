 ...
 * @author lfasani
 */
public class PieChartDescriptionItemProviderSpec extends PieChartDescriptionItemProvider {
    public PieChartDescriptionItemProviderSpec(AdapterFactory adapterFactory) {
