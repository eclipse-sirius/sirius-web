 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.diagram.LayoutStrategyDescription#getOnWestAtCreationBorderNodes <em>On
 * West At Creation Border Nodes</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.diagram.LayoutStrategyDescription#getOnEastAtCreationBorderNodes <em>On
 * East At Creation Border Nodes</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.diagram.LayoutStrategyDescription#getOnSouthAtCreationBorderNodes
 * <em>On South At Creation Border Nodes</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.diagram.LayoutStrategyDescription#getOnNorthAtCreationBorderNodes
...
public interface LayoutStrategyDescription extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>On West At Creation Border Nodes</b></em>' reference list. The list contents are
    ...
    /**
     * Returns the value of the '<em><b>On East At Creation Border Nodes</b></em>' reference list. The list contents are
     * of type {@link org.eclipse.sirius.components.view.diagram.NodeDescription}. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
    ...
    /**
     * Returns the value of the '<em><b>On South At Creation Border Nodes</b></em>' reference list. The list contents
    ...
    /**
     * Returns the value of the '<em><b>On North At Creation Border Nodes</b></em>' reference list. The list contents
     * are of type {@link org.eclipse.sirius.components.view.diagram.NodeDescription}. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
