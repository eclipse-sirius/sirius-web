 ...
 * @see org.eclipse.sirius.components.view.diagram.DiagramPackage#getSynchronizationPolicy()
 * @model
 * @generated
 */
public enum SynchronizationPolicy implements Enumerator {
    ...
    /**
	 * An array of all the '<em><b>Synchronization Policy</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @generated
	 */
    private static final SynchronizationPolicy[] VALUES_ARRAY = new SynchronizationPolicy[]
		{
			SYNCHRONIZED,
			UNSYNCHRONIZED,
		};
    ...
    /**
	 * A public read-only list of all the '<em><b>Synchronization Policy</b></em>' enumerators.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @generated
	 */
    ...
    /**
	 * Returns the '<em><b>Synchronization Policy</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
