...
public class DiagramSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case DiagramPackage.DIAGRAM_VARIABLE: {
                DiagramVariable diagramVariable = (DiagramVariable) theEObject;
                T result = this.caseDiagramVariable(diagramVariable);
                if (result == null)
                    result = this.defaultCase(theEObject);
                return result;
            }
            ...
            case DiagramPackage.INSIDE_LABEL_STYLE: {
                ...
                if (result == null)
                    result = this.caseBorderStyle(insideLabelStyle);
                if (result == null)
                    result = this.defaultCase(theEObject);
                return result;
            }
            case DiagramPackage.OUTSIDE_LABEL_STYLE: {
                ...
                if (result == null)
                    result = this.caseBorderStyle(outsideLabelStyle);
                if (result == null)
                    result = this.defaultCase(theEObject);
                return result;
            }
            case DiagramPackage.NODE_LABEL_STYLE: {
                ...
                if (result == null)
                    result = this.caseBorderStyle(nodeLabelStyle);
                if (result == null)
                    result = this.defaultCase(theEObject);
                return result;
            }
            ...
            case DiagramPackage.CONDITIONAL_EDGE_STYLE: {
                ...
                if (result == null)
                    result = this.caseBorderStyle(conditionalEdgeStyle);
                if (result == null)
                    result = this.defaultCase(theEObject);
                return result;
            }
     ...
     * @generated
     */
    public T caseDiagramVariable(DiagramVariable object) {
        return null;
    }
