...
public enum InsideLabelPosition implements Enumerator {
    ...
    /**
	 * An array of all the '<em><b>Inside Label Position</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @generated
	 */
    private static final InsideLabelPosition[] VALUES_ARRAY = new InsideLabelPosition[]
		{
			TOP_CENTER,
			TOP_LEFT,
			TOP_RIGHT,
    ...
    /**
	 * A public read-only list of all the '<em><b>Inside Label Position</b></em>' enumerators.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @generated
	 */
    ...
    /**
	 * Returns the '<em><b>Inside Label Position</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
    ...
    /**
	 * Returns the '<em><b>Inside Label Position</b></em>' literal with the specified name.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
    ...
    /**
	 * Returns the '<em><b>Inside Label Position</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
