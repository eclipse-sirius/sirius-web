...
public class ConditionalNodeStyleImpl extends ConditionalImpl implements ConditionalNodeStyle {
    ...
    public void setStyle(NodeStyleDescription newStyle) {
        if (newStyle != this.style) {
            ...
            if (this.style != null)
                msgs = ((InternalEObject) this.style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DiagramPackage.CONDITIONAL_NODE_STYLE__STYLE, null, msgs);
            if (newStyle != null)
            ...
            this.eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_NODE_STYLE__STYLE, newStyle, newStyle));
    }
