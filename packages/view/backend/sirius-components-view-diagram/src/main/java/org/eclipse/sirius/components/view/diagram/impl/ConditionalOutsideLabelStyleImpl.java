 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalOutsideLabelStyleImpl#getStyle <em>Style</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionalOutsideLabelStyleImpl extends ConditionalImpl implements ConditionalOutsideLabelStyle {
    ...
    public void setStyle(OutsideLabelStyle newStyle) {
		if (newStyle != style)
		{
			...
			if (style != null)
				msgs = ((InternalEObject)style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DiagramPackage.CONDITIONAL_OUTSIDE_LABEL_STYLE__STYLE, null, msgs);
			if (newStyle != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_OUTSIDE_LABEL_STYLE__STYLE, newStyle, newStyle));
	}
