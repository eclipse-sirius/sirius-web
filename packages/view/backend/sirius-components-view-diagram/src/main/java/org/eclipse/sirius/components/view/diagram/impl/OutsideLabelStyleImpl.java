 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.OutsideLabelStyleImpl#getBorderColor <em>Border Color</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.OutsideLabelStyleImpl#getBorderRadius <em>Border Radius</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.OutsideLabelStyleImpl#getBorderSize <em>Border Size</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.OutsideLabelStyleImpl#getBorderLineStyle <em>Border Line Style</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.OutsideLabelStyleImpl#getLabelColor <em>Label Color</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.OutsideLabelStyleImpl#getBackground <em>Background</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.OutsideLabelStyleImpl#getShowIconExpression <em>Show Icon Expression</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.OutsideLabelStyleImpl#getLabelIcon <em>Label Icon</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.OutsideLabelStyleImpl#getMaxWidthExpression <em>Max Width Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutsideLabelStyleImpl extends LabelStyleImpl implements OutsideLabelStyle {
		...
		if (borderColor != null && borderColor.eIsProxy())
		{
			...
			if (borderColor != oldBorderColor)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiagramPackage.OUTSIDE_LABEL_STYLE__BORDER_COLOR, oldBorderColor, borderColor));
			}
		}
		return borderColor;
	}
    ...
    public void setBorderColor(UserColor newBorderColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.OUTSIDE_LABEL_STYLE__BORDER_COLOR, oldBorderColor, borderColor));
	}
    ...
    public void setBorderRadius(int newBorderRadius) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.OUTSIDE_LABEL_STYLE__BORDER_RADIUS, oldBorderRadius, borderRadius));
	}
    ...
    public void setBorderSize(int newBorderSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.OUTSIDE_LABEL_STYLE__BORDER_SIZE, oldBorderSize, borderSize));
	}
    ...
    public void setBorderLineStyle(LineStyle newBorderLineStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.OUTSIDE_LABEL_STYLE__BORDER_LINE_STYLE, oldBorderLineStyle, borderLineStyle));
	}
    ...
    public UserColor getLabelColor() {
		if (labelColor != null && labelColor.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiagramPackage.OUTSIDE_LABEL_STYLE__LABEL_COLOR, oldLabelColor, labelColor));
			}
		}
		return labelColor;
	}
    ...
    public void setLabelColor(UserColor newLabelColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.OUTSIDE_LABEL_STYLE__LABEL_COLOR, oldLabelColor, labelColor));
	}
    ...
    public UserColor getBackground() {
		if (background != null && background.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiagramPackage.OUTSIDE_LABEL_STYLE__BACKGROUND, oldBackground, background));
			}
		}
		return background;
	}
    ...
    public void setBackground(UserColor newBackground) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.OUTSIDE_LABEL_STYLE__BACKGROUND, oldBackground, background));
	}
    ...
    public void setShowIconExpression(String newShowIconExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.OUTSIDE_LABEL_STYLE__SHOW_ICON_EXPRESSION, oldShowIconExpression, showIconExpression));
	}
    ...
    public void setLabelIcon(String newLabelIcon) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.OUTSIDE_LABEL_STYLE__LABEL_ICON, oldLabelIcon, labelIcon));
	}
    ...
    public void setMaxWidthExpression(String newMaxWidthExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.OUTSIDE_LABEL_STYLE__MAX_WIDTH_EXPRESSION, oldMaxWidthExpression, maxWidthExpression));
	}
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BorderStyle.class)
		{
			...
			{
				case DiagramPackage.OUTSIDE_LABEL_STYLE__BORDER_COLOR: return DiagramPackage.BORDER_STYLE__BORDER_COLOR;
				case DiagramPackage.OUTSIDE_LABEL_STYLE__BORDER_RADIUS: return DiagramPackage.BORDER_STYLE__BORDER_RADIUS;
				case DiagramPackage.OUTSIDE_LABEL_STYLE__BORDER_SIZE: return DiagramPackage.BORDER_STYLE__BORDER_SIZE;
				case DiagramPackage.OUTSIDE_LABEL_STYLE__BORDER_LINE_STYLE: return DiagramPackage.BORDER_STYLE__BORDER_LINE_STYLE;
				default: return -1;
			}
		}
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == BorderStyle.class)
		{
			...
			{
				case DiagramPackage.BORDER_STYLE__BORDER_COLOR: return DiagramPackage.OUTSIDE_LABEL_STYLE__BORDER_COLOR;
				case DiagramPackage.BORDER_STYLE__BORDER_RADIUS: return DiagramPackage.OUTSIDE_LABEL_STYLE__BORDER_RADIUS;
				case DiagramPackage.BORDER_STYLE__BORDER_SIZE: return DiagramPackage.OUTSIDE_LABEL_STYLE__BORDER_SIZE;
				case DiagramPackage.BORDER_STYLE__BORDER_LINE_STYLE: return DiagramPackage.OUTSIDE_LABEL_STYLE__BORDER_LINE_STYLE;
				default: return -1;
			}
		}
