...
public interface EdgeDescription extends DiagramElementDescription {
    ...
    /**
	 * Returns the value of the '<em><b>Begin Label Expression</b></em>' attribute.
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.diagram.EdgeDescription#getBeginLabelExpression <em>Begin Label Expression</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @param value the new value of the '<em>Begin Label Expression</em>' attribute.
    ...
    /**
	 * Returns the value of the '<em><b>Center Label Expression</b></em>' attribute.
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.diagram.EdgeDescription#getCenterLabelExpression <em>Center Label Expression</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @param value the new value of the '<em>Center Label Expression</em>' attribute.
    ...
    /**
	 * Returns the value of the '<em><b>End Label Expression</b></em>' attribute.
	 * The default value is <code>""</code>.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.diagram.EdgeDescription#getEndLabelExpression <em>End Label Expression</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @param value the new value of the '<em>End Label Expression</em>' attribute.
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.diagram.EdgeDescription#isIsDomainBasedEdge <em>Is Domain Based Edge</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.diagram.EdgeDescription#getPalette <em>Palette</em>}' containment reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Returns the value of the '<em><b>Source Descriptions</b></em>' reference list.
	 * The list contents are of type {@link org.eclipse.sirius.components.view.diagram.DiagramElementDescription}.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Returns the value of the '<em><b>Target Descriptions</b></em>' reference list.
	 * The list contents are of type {@link org.eclipse.sirius.components.view.diagram.DiagramElementDescription}.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.diagram.EdgeDescription#getSourceExpression <em>Source Expression</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 ...
	 * The default value is <code>"aql:self.eCrossReferences()"</code>.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.diagram.EdgeDescription#getTargetExpression <em>Target Expression</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.diagram.EdgeDescription#getStyle <em>Style</em>}' containment reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link org.eclipse.sirius.components.view.diagram.ConditionalEdgeStyle}.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
