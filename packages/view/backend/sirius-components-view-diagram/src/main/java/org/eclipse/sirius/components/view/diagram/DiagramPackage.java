...
public interface DiagramPackage extends EPackage {
    ...
    /**
     * The feature id for the '<em><b>Reused Tool Section</b></em>' reference list. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     * @ordered
     */
    int GROUP_PALETTE__REUSED_TOOL_SECTION = 3;
     ...
     * @ordered
     */
    int GROUP_PALETTE_FEATURE_COUNT = 4;
    ...
    /**
     * Returns the meta object for the reference list
     * '{@link org.eclipse.sirius.components.view.diagram.GroupPalette#getReusedToolSection <em>Reused Tool
     * Section</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the meta object for the reference list '<em>Reused Tool Section</em>'.
     * @see org.eclipse.sirius.components.view.diagram.GroupPalette#getReusedToolSection()
     * @see #getGroupPalette()
     * @generated
     */
    EReference getGroupPalette_ReusedToolSection();
    ...
    interface Literals {
        ...
        /**
         * The meta object literal for the '<em><b>Reused Tool Section</b></em>' reference list feature. <!--
         * begin-user-doc --> <!-- end-user-doc -->
         *
         * @generated
         */
        EReference GROUP_PALETTE__REUSED_TOOL_SECTION = eINSTANCE.getGroupPalette_ReusedToolSection();
