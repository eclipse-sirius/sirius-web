...
public interface DiagramPackage extends EPackage {
     ...
     * @ordered
     */
    int NODE_STYLE_DESCRIPTION__BORDER_COLOR = STYLE_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int RECTANGULAR_NODE_STYLE_DESCRIPTION_FEATURE_COUNT = NODE_STYLE_DESCRIPTION_FEATURE_COUNT + 0;
