...
public enum OutsideLabelPosition implements Enumerator {
    ...
    /**
	 * An array of all the '<em><b>Outside Label Position</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @generated
	 */
    private static final OutsideLabelPosition[] VALUES_ARRAY = new OutsideLabelPosition[]
		{
			BOTTOM_CENTER,
		};

    /**
	 * A public read-only list of all the '<em><b>Outside Label Position</b></em>' enumerators.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @generated
	 */
    ...
    /**
	 * Returns the '<em><b>Outside Label Position</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
