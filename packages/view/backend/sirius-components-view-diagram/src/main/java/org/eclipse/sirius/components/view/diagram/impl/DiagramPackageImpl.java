...
public class DiagramPackageImpl extends EPackageImpl implements DiagramPackage {
     ...
     */
    @Override
    public EAttribute getDiagramDescription_Description() {
    ...
    public void createPackageContents() {
        ...
        this.createEAttribute(this.diagramDescriptionEClass, DIAGRAM_DESCRIPTION__DESCRIPTION);
    ...
    public void initializePackageContents() {
        ...
        this.initEAttribute(this.getDiagramDescription_Description(), this.ecorePackage.getEString(), "description", null, 0, 1, DiagramDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
