...
public class DiagramPackageImpl extends EPackageImpl implements DiagramPackage {
    ...
    public EAttribute getDiagramElementDescription_Description() {
		return (EAttribute)diagramElementDescriptionEClass.getEStructuralFeatures().get(5);
	}
    ...
    public EClass getDiagramStyleDescription() {
		return diagramStyleDescriptionEClass;
	}
    ...
    public EReference getDiagramStyleDescription_Background() {
		return (EReference)diagramStyleDescriptionEClass.getEStructuralFeatures().get(0);
	}
    ...
    public EClass getConditionalDiagramStyle() {
		return conditionalDiagramStyleEClass;
	}
    ...
    public EReference getConditionalDiagramStyle_Style() {
		return (EReference)conditionalDiagramStyleEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
    @Override
    public EReference getNodeTool_KeyBindings() {
		return (EReference)nodeToolEClass.getEStructuralFeatures().get(4);
	}
    ...
    public EReference getSelectionDialogDescription_SelectionDialogTreeDescription() {
		return (EReference)selectionDialogDescriptionEClass.getEStructuralFeatures().get(0);
	}
    ...
    public EAttribute getSelectionDialogDescription_Multiple() {
		return (EAttribute)selectionDialogDescriptionEClass.getEStructuralFeatures().get(1);
	}
    ...
    public EAttribute getSelectionDialogDescription_DefaultTitleExpression() {
		return (EAttribute)selectionDialogDescriptionEClass.getEStructuralFeatures().get(3);
	}
    ...
    public EAttribute getSelectionDialogDescription_NoSelectionTitleExpression() {
		return (EAttribute)selectionDialogDescriptionEClass.getEStructuralFeatures().get(4);
	}
    ...
    public EAttribute getSelectionDialogDescription_WithSelectionTitleExpression() {
		return (EAttribute)selectionDialogDescriptionEClass.getEStructuralFeatures().get(5);
	}
    ...
    public EAttribute getSelectionDialogDescription_DescriptionExpression() {
		return (EAttribute)selectionDialogDescriptionEClass.getEStructuralFeatures().get(6);
	}
    ...
    public EAttribute getSelectionDialogDescription_NoSelectionActionLabelExpression() {
		return (EAttribute)selectionDialogDescriptionEClass.getEStructuralFeatures().get(7);
	}
    ...
    public EAttribute getSelectionDialogDescription_NoSelectionActionDescriptionExpression() {
		return (EAttribute)selectionDialogDescriptionEClass.getEStructuralFeatures().get(8);
	}
    ...
    public EAttribute getSelectionDialogDescription_WithSelectionActionLabelExpression() {
		return (EAttribute)selectionDialogDescriptionEClass.getEStructuralFeatures().get(9);
	}
    ...
    public EAttribute getSelectionDialogDescription_WithSelectionActionDescriptionExpression() {
		return (EAttribute)selectionDialogDescriptionEClass.getEStructuralFeatures().get(10);
	}
    ...
    public EAttribute getSelectionDialogDescription_NoSelectionActionStatusMessageExpression() {
		return (EAttribute)selectionDialogDescriptionEClass.getEStructuralFeatures().get(11);
	}
    ...
    public EAttribute getSelectionDialogDescription_SelectionRequiredWithoutSelectionStatusMessageExpression() {
		return (EAttribute)selectionDialogDescriptionEClass.getEStructuralFeatures().get(12);
	}
    ...
    public EAttribute getSelectionDialogDescription_SelectionRequiredWithSelectionStatusMessageExpression() {
		return (EAttribute)selectionDialogDescriptionEClass.getEStructuralFeatures().get(13);
	}
    ...
    public EAttribute getSelectionDialogDescription_NoSelectionConfirmButtonLabelExpression() {
		return (EAttribute)selectionDialogDescriptionEClass.getEStructuralFeatures().get(14);
	}
    ...
    public EAttribute getSelectionDialogDescription_SelectionRequiredWithoutSelectionConfirmButtonLabelExpression() {
		return (EAttribute)selectionDialogDescriptionEClass.getEStructuralFeatures().get(15);
	}
    ...
    public EAttribute getSelectionDialogDescription_SelectionRequiredWithSelectionConfirmButtonLabelExpression() {
		return (EAttribute)selectionDialogDescriptionEClass.getEStructuralFeatures().get(16);
	}
    ...
    public EAttribute getDiagramToolbar_PreconditionExpression() {
		return (EAttribute)diagramToolbarEClass.getEStructuralFeatures().get(0);
	}
    ...
    public EAttribute getDiagramToolbar_ExpandedByDefault() {
		return (EAttribute)diagramToolbarEClass.getEStructuralFeatures().get(1);
	}
    ...
    public EClass getNodeDecoratorDescription() {
		return nodeDecoratorDescriptionEClass;
	}
    ...
    public EReference getNodeDecoratorDescription_NodeDescriptions() {
		return (EReference)nodeDecoratorDescriptionEClass.getEStructuralFeatures().get(0);
	}
    ...
    public EClass getSemanticDecoratorDescription() {
		return semanticDecoratorDescriptionEClass;
	}
    ...
    public EAttribute getSemanticDecoratorDescription_DomainType() {
		return (EAttribute)semanticDecoratorDescriptionEClass.getEStructuralFeatures().get(0);
	}
    ...
    public EClass getDecoratorDescription() {
		return decoratorDescriptionEClass;
	}
    ...
    public EAttribute getDecoratorDescription_LabelExpression() {
		return (EAttribute)decoratorDescriptionEClass.getEStructuralFeatures().get(0);
	}
    ...
    public EAttribute getDecoratorDescription_PreconditionExpression() {
		return (EAttribute)decoratorDescriptionEClass.getEStructuralFeatures().get(1);
	}
    ...
    public EAttribute getDecoratorDescription_IconURLExpression() {
		return (EAttribute)decoratorDescriptionEClass.getEStructuralFeatures().get(2);
	}
    ...
    public EAttribute getDecoratorDescription_Position() {
		return (EAttribute)decoratorDescriptionEClass.getEStructuralFeatures().get(3);
	}
    ...
    public EAttribute getDecoratorDescription_Name() {
		return (EAttribute)decoratorDescriptionEClass.getEStructuralFeatures().get(4);
	}
    ...
    public EEnum getDiagramLayoutOption() {
		return diagramLayoutOptionEEnum;
	}
    ...
    public void createPackageContents() {
		...
		createEAttribute(diagramDescriptionEClass, DIAGRAM_DESCRIPTION__LAYOUT_OPTION);
		createEReference(diagramDescriptionEClass, DIAGRAM_DESCRIPTION__TOOLBAR);
		...
		createEReference(diagramDescriptionEClass, DIAGRAM_DESCRIPTION__STYLE);
		createEReference(diagramDescriptionEClass, DIAGRAM_DESCRIPTION__CONDITIONAL_STYLES);
		createEReference(diagramDescriptionEClass, DIAGRAM_DESCRIPTION__DECORATOR_DESCRIPTIONS);
		createEAttribute(diagramDescriptionEClass, DIAGRAM_DESCRIPTION__MINIMAP_VISIBLE);
		...
		createEAttribute(diagramElementDescriptionEClass, DIAGRAM_ELEMENT_DESCRIPTION__DESCRIPTION);
		...
		createEAttribute(nodeStyleDescriptionEClass, NODE_STYLE_DESCRIPTION__DESCRIPTION);

		diagramStyleDescriptionEClass = createEClass(DIAGRAM_STYLE_DESCRIPTION);
		createEReference(diagramStyleDescriptionEClass, DIAGRAM_STYLE_DESCRIPTION__BACKGROUND);
		...
		conditionalDiagramStyleEClass = createEClass(CONDITIONAL_DIAGRAM_STYLE);
		createEReference(conditionalDiagramStyleEClass, CONDITIONAL_DIAGRAM_STYLE__STYLE);
		...
		createEReference(nodeToolEClass, NODE_TOOL__KEY_BINDINGS);
		...
		createEAttribute(selectionDialogDescriptionEClass, SELECTION_DIALOG_DESCRIPTION__OPTIONAL);
		createEAttribute(selectionDialogDescriptionEClass, SELECTION_DIALOG_DESCRIPTION__DEFAULT_TITLE_EXPRESSION);
		createEAttribute(selectionDialogDescriptionEClass, SELECTION_DIALOG_DESCRIPTION__NO_SELECTION_TITLE_EXPRESSION);
		createEAttribute(selectionDialogDescriptionEClass, SELECTION_DIALOG_DESCRIPTION__WITH_SELECTION_TITLE_EXPRESSION);
		createEAttribute(selectionDialogDescriptionEClass, SELECTION_DIALOG_DESCRIPTION__DESCRIPTION_EXPRESSION);
		createEAttribute(selectionDialogDescriptionEClass, SELECTION_DIALOG_DESCRIPTION__NO_SELECTION_ACTION_LABEL_EXPRESSION);
		createEAttribute(selectionDialogDescriptionEClass, SELECTION_DIALOG_DESCRIPTION__NO_SELECTION_ACTION_DESCRIPTION_EXPRESSION);
		createEAttribute(selectionDialogDescriptionEClass, SELECTION_DIALOG_DESCRIPTION__WITH_SELECTION_ACTION_LABEL_EXPRESSION);
		createEAttribute(selectionDialogDescriptionEClass, SELECTION_DIALOG_DESCRIPTION__WITH_SELECTION_ACTION_DESCRIPTION_EXPRESSION);
		createEAttribute(selectionDialogDescriptionEClass, SELECTION_DIALOG_DESCRIPTION__NO_SELECTION_ACTION_STATUS_MESSAGE_EXPRESSION);
		createEAttribute(selectionDialogDescriptionEClass, SELECTION_DIALOG_DESCRIPTION__SELECTION_REQUIRED_WITHOUT_SELECTION_STATUS_MESSAGE_EXPRESSION);
		createEAttribute(selectionDialogDescriptionEClass, SELECTION_DIALOG_DESCRIPTION__SELECTION_REQUIRED_WITH_SELECTION_STATUS_MESSAGE_EXPRESSION);
		createEAttribute(selectionDialogDescriptionEClass, SELECTION_DIALOG_DESCRIPTION__NO_SELECTION_CONFIRM_BUTTON_LABEL_EXPRESSION);
		createEAttribute(selectionDialogDescriptionEClass, SELECTION_DIALOG_DESCRIPTION__SELECTION_REQUIRED_WITHOUT_SELECTION_CONFIRM_BUTTON_LABEL_EXPRESSION);
		createEAttribute(selectionDialogDescriptionEClass, SELECTION_DIALOG_DESCRIPTION__SELECTION_REQUIRED_WITH_SELECTION_CONFIRM_BUTTON_LABEL_EXPRESSION);
		...
		diagramToolbarEClass = createEClass(DIAGRAM_TOOLBAR);
		createEAttribute(diagramToolbarEClass, DIAGRAM_TOOLBAR__PRECONDITION_EXPRESSION);
		createEAttribute(diagramToolbarEClass, DIAGRAM_TOOLBAR__EXPANDED_BY_DEFAULT);

		decoratorDescriptionEClass = createEClass(DECORATOR_DESCRIPTION);
		createEAttribute(decoratorDescriptionEClass, DECORATOR_DESCRIPTION__LABEL_EXPRESSION);
		createEAttribute(decoratorDescriptionEClass, DECORATOR_DESCRIPTION__PRECONDITION_EXPRESSION);
		createEAttribute(decoratorDescriptionEClass, DECORATOR_DESCRIPTION__ICON_URL_EXPRESSION);
		createEAttribute(decoratorDescriptionEClass, DECORATOR_DESCRIPTION__POSITION);
		createEAttribute(decoratorDescriptionEClass, DECORATOR_DESCRIPTION__NAME);

		nodeDecoratorDescriptionEClass = createEClass(NODE_DECORATOR_DESCRIPTION);
		createEReference(nodeDecoratorDescriptionEClass, NODE_DECORATOR_DESCRIPTION__NODE_DESCRIPTIONS);

		semanticDecoratorDescriptionEClass = createEClass(SEMANTIC_DECORATOR_DESCRIPTION);
		createEAttribute(semanticDecoratorDescriptionEClass, SEMANTIC_DECORATOR_DESCRIPTION__DOMAIN_TYPE);
		...
		decoratorPositionEEnum = createEEnum(DECORATOR_POSITION);
		diagramLayoutOptionEEnum = createEEnum(DIAGRAM_LAYOUT_OPTION);
	}
    ...
    public void initializePackageContents() {
		...
		conditionalDiagramStyleEClass.getESuperTypes().add(theViewPackage.getConditional());
		...
		nodeDecoratorDescriptionEClass.getESuperTypes().add(this.getDecoratorDescription());
		semanticDecoratorDescriptionEClass.getESuperTypes().add(this.getDecoratorDescription());
		...
		initEAttribute(getDiagramDescription_LayoutOption(), this.getDiagramLayoutOption(), "layoutOption", null, 1, 1, DiagramDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDiagramDescription_Toolbar(), this.getDiagramToolbar(), null, "toolbar", null, 0, 1, DiagramDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDiagramDescription_Style(), this.getDiagramStyleDescription(), null, "style", null, 0, 1, DiagramDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDiagramDescription_ConditionalStyles(), this.getConditionalDiagramStyle(), null, "conditionalStyles", null, 0, -1, DiagramDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDiagramDescription_DecoratorDescriptions(), this.getDecoratorDescription(), null, "decoratorDescriptions", null, 0, -1, DiagramDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDiagramDescription_MinimapVisible(), ecorePackage.getEBoolean(), "minimapVisible", "true", 0, 1, DiagramDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getDiagramElementDescription_Description(), ecorePackage.getEString(), "description", null, 0, 1, DiagramElementDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getNodeStyleDescription_Description(), ecorePackage.getEString(), "description", null, 0, 1, NodeStyleDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(diagramStyleDescriptionEClass, DiagramStyleDescription.class, "DiagramStyleDescription", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDiagramStyleDescription_Background(), theViewPackage.getUserColor(), null, "background", null, 0, 1, DiagramStyleDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(conditionalDiagramStyleEClass, ConditionalDiagramStyle.class, "ConditionalDiagramStyle", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getConditionalDiagramStyle_Style(), this.getDiagramStyleDescription(), null, "style", null, 0, 1, ConditionalDiagramStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEdgeStyle_Description(), ecorePackage.getEString(), "description", null, 0, 1, EdgeStyle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getNodeTool_KeyBindings(), theViewPackage.getKeyBinding(), null, "keyBindings", null, 0, -1, NodeTool.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSelectionDialogDescription_Optional(), ecorePackage.getEBoolean(), "optional", null, 0, 1, SelectionDialogDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectionDialogDescription_DefaultTitleExpression(), ecorePackage.getEString(), "defaultTitleExpression", null, 0, 1, SelectionDialogDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectionDialogDescription_NoSelectionTitleExpression(), ecorePackage.getEString(), "noSelectionTitleExpression", null, 0, 1, SelectionDialogDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectionDialogDescription_WithSelectionTitleExpression(), ecorePackage.getEString(), "withSelectionTitleExpression", null, 0, 1, SelectionDialogDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectionDialogDescription_DescriptionExpression(), ecorePackage.getEString(), "descriptionExpression", null, 0, 1, SelectionDialogDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectionDialogDescription_NoSelectionActionLabelExpression(), ecorePackage.getEString(), "noSelectionActionLabelExpression", null, 0, 1, SelectionDialogDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectionDialogDescription_NoSelectionActionDescriptionExpression(), ecorePackage.getEString(), "noSelectionActionDescriptionExpression", null, 0, 1, SelectionDialogDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectionDialogDescription_WithSelectionActionLabelExpression(), ecorePackage.getEString(), "withSelectionActionLabelExpression", null, 0, 1, SelectionDialogDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectionDialogDescription_WithSelectionActionDescriptionExpression(), ecorePackage.getEString(), "withSelectionActionDescriptionExpression", null, 0, 1, SelectionDialogDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectionDialogDescription_NoSelectionActionStatusMessageExpression(), ecorePackage.getEString(), "noSelectionActionStatusMessageExpression", null, 0, 1, SelectionDialogDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectionDialogDescription_SelectionRequiredWithoutSelectionStatusMessageExpression(), ecorePackage.getEString(), "selectionRequiredWithoutSelectionStatusMessageExpression", null, 0, 1, SelectionDialogDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectionDialogDescription_SelectionRequiredWithSelectionStatusMessageExpression(), ecorePackage.getEString(), "selectionRequiredWithSelectionStatusMessageExpression", null, 0, 1, SelectionDialogDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectionDialogDescription_NoSelectionConfirmButtonLabelExpression(), ecorePackage.getEString(), "noSelectionConfirmButtonLabelExpression", null, 0, 1, SelectionDialogDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectionDialogDescription_SelectionRequiredWithoutSelectionConfirmButtonLabelExpression(), ecorePackage.getEString(), "selectionRequiredWithoutSelectionConfirmButtonLabelExpression", null, 0, 1, SelectionDialogDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSelectionDialogDescription_SelectionRequiredWithSelectionConfirmButtonLabelExpression(), ecorePackage.getEString(), "selectionRequiredWithSelectionConfirmButtonLabelExpression", null, 0, 1, SelectionDialogDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(diagramToolbarEClass, DiagramToolbar.class, "DiagramToolbar", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDiagramToolbar_PreconditionExpression(), theViewPackage.getInterpretedExpression(), "preconditionExpression", null, 0, 1, DiagramToolbar.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDiagramToolbar_ExpandedByDefault(), ecorePackage.getEBoolean(), "expandedByDefault", "true", 0, 1, DiagramToolbar.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(decoratorDescriptionEClass, DecoratorDescription.class, "DecoratorDescription", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDecoratorDescription_LabelExpression(), theViewPackage.getInterpretedExpression(), "labelExpression", null, 0, 1, DecoratorDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDecoratorDescription_PreconditionExpression(), theViewPackage.getInterpretedExpression(), "preconditionExpression", null, 0, 1, DecoratorDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDecoratorDescription_IconURLExpression(), theViewPackage.getInterpretedExpression(), "iconURLExpression", null, 0, 1, DecoratorDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDecoratorDescription_Position(), this.getDecoratorPosition(), "position", null, 0, 1, DecoratorDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDecoratorDescription_Name(), theViewPackage.getIdentifier(), "name", null, 0, 1, DecoratorDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(nodeDecoratorDescriptionEClass, NodeDecoratorDescription.class, "NodeDecoratorDescription", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getNodeDecoratorDescription_NodeDescriptions(), this.getNodeDescription(), null, "nodeDescriptions", null, 0, -1, NodeDecoratorDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(semanticDecoratorDescriptionEClass, SemanticDecoratorDescription.class, "SemanticDecoratorDescription", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSemanticDecoratorDescription_DomainType(), theViewPackage.getDomainType(), "domainType", null, 0, 1, SemanticDecoratorDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(decoratorPositionEEnum, DecoratorPosition.class, "DecoratorPosition");
		addEEnumLiteral(decoratorPositionEEnum, DecoratorPosition.NORTH);
		addEEnumLiteral(decoratorPositionEEnum, DecoratorPosition.NORTH_WEST);
		addEEnumLiteral(decoratorPositionEEnum, DecoratorPosition.WEST);
		addEEnumLiteral(decoratorPositionEEnum, DecoratorPosition.SOUTH_WEST);
		addEEnumLiteral(decoratorPositionEEnum, DecoratorPosition.SOUTH);
		addEEnumLiteral(decoratorPositionEEnum, DecoratorPosition.SOUTH_EAST);
		addEEnumLiteral(decoratorPositionEEnum, DecoratorPosition.EAST);
		addEEnumLiteral(decoratorPositionEEnum, DecoratorPosition.NORTH_EAST);
		addEEnumLiteral(decoratorPositionEEnum, DecoratorPosition.CENTER);

		initEEnum(diagramLayoutOptionEEnum, DiagramLayoutOption.class, "DiagramLayoutOption");
		addEEnumLiteral(diagramLayoutOptionEEnum, DiagramLayoutOption.NONE);
		addEEnumLiteral(diagramLayoutOptionEEnum, DiagramLayoutOption.AUTO_LAYOUT);
		addEEnumLiteral(diagramLayoutOptionEEnum, DiagramLayoutOption.AUTO_UNTIL_MANUAL);
