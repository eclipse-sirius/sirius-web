...
public class DiagramPackageImpl extends EPackageImpl implements DiagramPackage {
     ...
     */
    @Override
    public EAttribute getAction_LabelExpression() {
    ...
    public void createPackageContents() {
        ...
        this.createEAttribute(this.actionEClass, ACTION__LABEL_EXPRESSION);
    ...
    public void initializePackageContents() {
        ...
        this.initEAttribute(this.getAction_Name(), theViewPackage.getIdentifier(), "name", "Tool", 1, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
                !IS_DERIVED, IS_ORDERED);
        this.initEAttribute(this.getAction_LabelExpression(), theViewPackage.getInterpretedExpression(), "labelExpression", null, 0, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
                !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
