 ...
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getFontSize <em>Font Size</em>}</li>
 ...
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#isUnderline <em>Underline</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#isStrikeThrough <em>Strike Through</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getBorderColor <em>Border Color</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getBorderRadius <em>Border Radius</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getBorderSize <em>Border Size</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getBorderLineStyle <em>Border Line Style</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getLineStyle <em>Line Style</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getSourceArrowStyle <em>Source Arrow Style</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getTargetArrowStyle <em>Target Arrow Style</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getEdgeWidth <em>Edge Width</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#isShowIcon <em>Show Icon</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getLabelIcon <em>Label Icon</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getBackground <em>Background</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getMaxWidthExpression <em>Max Width Expression</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getEdgeType <em>Edge Type</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getDescription <em>Description</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionalEdgeStyleImpl extends ConditionalImpl implements ConditionalEdgeStyle {
		...
		if (color != null && color.eIsProxy())
		{
			...
			if (color != oldColor)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiagramPackage.CONDITIONAL_EDGE_STYLE__COLOR, oldColor, color));
			}
		}
		return color;
	}
    ...
    public void setColor(UserColor newColor) {
		...
		color = newColor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__COLOR, oldColor, color));
	}
    ...
    public void setFontSize(int newFontSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__FONT_SIZE, oldFontSize, fontSize));
	}
    ...
    public void setItalic(boolean newItalic) {
		...
		italic = newItalic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__ITALIC, oldItalic, italic));
	}
    ...
    public void setBold(boolean newBold) {
		...
		bold = newBold;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__BOLD, oldBold, bold));
	}
    ...
    public void setUnderline(boolean newUnderline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__UNDERLINE, oldUnderline, underline));
	}
    ...
    public void setStrikeThrough(boolean newStrikeThrough) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__STRIKE_THROUGH, oldStrikeThrough, strikeThrough));
	}
    ...
    public UserColor getBorderColor() {
		if (borderColor != null && borderColor.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_COLOR, oldBorderColor, borderColor));
			}
		}
		return borderColor;
	}
    ...
    public void setBorderColor(UserColor newBorderColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_COLOR, oldBorderColor, borderColor));
	}
    ...
    public void setBorderRadius(int newBorderRadius) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_RADIUS, oldBorderRadius, borderRadius));
	}
    ...
    public void setBorderSize(int newBorderSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_SIZE, oldBorderSize, borderSize));
	}
    ...
    public void setBorderLineStyle(LineStyle newBorderLineStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_LINE_STYLE, oldBorderLineStyle, borderLineStyle));
	}
    ...
    public void setLineStyle(LineStyle newLineStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__LINE_STYLE, oldLineStyle, lineStyle));
	}
    ...
    public void setSourceArrowStyle(ArrowStyle newSourceArrowStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__SOURCE_ARROW_STYLE, oldSourceArrowStyle, sourceArrowStyle));
	}
    ...
    public void setTargetArrowStyle(ArrowStyle newTargetArrowStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__TARGET_ARROW_STYLE, oldTargetArrowStyle, targetArrowStyle));
	}
    ...
    public void setEdgeWidth(int newEdgeWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__EDGE_WIDTH, oldEdgeWidth, edgeWidth));
	}
    ...
    public void setShowIcon(boolean newShowIcon) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__SHOW_ICON, oldShowIcon, showIcon));
	}
    ...
    public void setLabelIcon(String newLabelIcon) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__LABEL_ICON, oldLabelIcon, labelIcon));
	}
    ...
    public UserColor getBackground() {
		if (background != null && background.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiagramPackage.CONDITIONAL_EDGE_STYLE__BACKGROUND, oldBackground, background));
			}
		}
		return background;
	}
    ...
    public void setBackground(UserColor newBackground) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__BACKGROUND, oldBackground, background));
	}
    ...
    public void setMaxWidthExpression(String newMaxWidthExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__MAX_WIDTH_EXPRESSION, oldMaxWidthExpression, maxWidthExpression));
	}
    ...
    public void setEdgeType(EdgeType newEdgeType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__EDGE_TYPE, oldEdgeType, edgeType));
	}
    ...
    public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__DESCRIPTION, oldDescription, description));
	}
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Style.class)
		{
			...
			{
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__COLOR: return DiagramPackage.STYLE__COLOR;
				default: return -1;
			}
		}
		if (baseClass == LabelStyle.class)
		{
			switch (derivedFeatureID)
			{
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__FONT_SIZE: return ViewPackage.LABEL_STYLE__FONT_SIZE;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__ITALIC: return ViewPackage.LABEL_STYLE__ITALIC;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__BOLD: return ViewPackage.LABEL_STYLE__BOLD;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__UNDERLINE: return ViewPackage.LABEL_STYLE__UNDERLINE;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__STRIKE_THROUGH: return ViewPackage.LABEL_STYLE__STRIKE_THROUGH;
				default: return -1;
			}
		}
		if (baseClass == BorderStyle.class)
		{
			switch (derivedFeatureID)
			{
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_COLOR: return DiagramPackage.BORDER_STYLE__BORDER_COLOR;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_RADIUS: return DiagramPackage.BORDER_STYLE__BORDER_RADIUS;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_SIZE: return DiagramPackage.BORDER_STYLE__BORDER_SIZE;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_LINE_STYLE: return DiagramPackage.BORDER_STYLE__BORDER_LINE_STYLE;
				default: return -1;
			}
		}
		if (baseClass == EdgeStyle.class)
		{
			switch (derivedFeatureID)
			{
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__LINE_STYLE: return DiagramPackage.EDGE_STYLE__LINE_STYLE;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__SOURCE_ARROW_STYLE: return DiagramPackage.EDGE_STYLE__SOURCE_ARROW_STYLE;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__TARGET_ARROW_STYLE: return DiagramPackage.EDGE_STYLE__TARGET_ARROW_STYLE;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__EDGE_WIDTH: return DiagramPackage.EDGE_STYLE__EDGE_WIDTH;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__SHOW_ICON: return DiagramPackage.EDGE_STYLE__SHOW_ICON;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__LABEL_ICON: return DiagramPackage.EDGE_STYLE__LABEL_ICON;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__BACKGROUND: return DiagramPackage.EDGE_STYLE__BACKGROUND;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__MAX_WIDTH_EXPRESSION: return DiagramPackage.EDGE_STYLE__MAX_WIDTH_EXPRESSION;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__EDGE_TYPE: return DiagramPackage.EDGE_STYLE__EDGE_TYPE;
				case DiagramPackage.CONDITIONAL_EDGE_STYLE__DESCRIPTION: return DiagramPackage.EDGE_STYLE__DESCRIPTION;
				default: return -1;
			}
		}
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Style.class)
		{
			...
			{
				case DiagramPackage.STYLE__COLOR: return DiagramPackage.CONDITIONAL_EDGE_STYLE__COLOR;
				default: return -1;
			}
		}
		if (baseClass == LabelStyle.class)
		{
			switch (baseFeatureID)
			{
				case ViewPackage.LABEL_STYLE__FONT_SIZE: return DiagramPackage.CONDITIONAL_EDGE_STYLE__FONT_SIZE;
				case ViewPackage.LABEL_STYLE__ITALIC: return DiagramPackage.CONDITIONAL_EDGE_STYLE__ITALIC;
				case ViewPackage.LABEL_STYLE__BOLD: return DiagramPackage.CONDITIONAL_EDGE_STYLE__BOLD;
				case ViewPackage.LABEL_STYLE__UNDERLINE: return DiagramPackage.CONDITIONAL_EDGE_STYLE__UNDERLINE;
				case ViewPackage.LABEL_STYLE__STRIKE_THROUGH: return DiagramPackage.CONDITIONAL_EDGE_STYLE__STRIKE_THROUGH;
				default: return -1;
			}
		}
		if (baseClass == BorderStyle.class)
		{
			switch (baseFeatureID)
			{
				case DiagramPackage.BORDER_STYLE__BORDER_COLOR: return DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_COLOR;
				case DiagramPackage.BORDER_STYLE__BORDER_RADIUS: return DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_RADIUS;
				case DiagramPackage.BORDER_STYLE__BORDER_SIZE: return DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_SIZE;
				case DiagramPackage.BORDER_STYLE__BORDER_LINE_STYLE: return DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_LINE_STYLE;
				default: return -1;
			}
		}
		if (baseClass == EdgeStyle.class)
		{
			switch (baseFeatureID)
			{
				case DiagramPackage.EDGE_STYLE__LINE_STYLE: return DiagramPackage.CONDITIONAL_EDGE_STYLE__LINE_STYLE;
				case DiagramPackage.EDGE_STYLE__SOURCE_ARROW_STYLE: return DiagramPackage.CONDITIONAL_EDGE_STYLE__SOURCE_ARROW_STYLE;
				case DiagramPackage.EDGE_STYLE__TARGET_ARROW_STYLE: return DiagramPackage.CONDITIONAL_EDGE_STYLE__TARGET_ARROW_STYLE;
				case DiagramPackage.EDGE_STYLE__EDGE_WIDTH: return DiagramPackage.CONDITIONAL_EDGE_STYLE__EDGE_WIDTH;
				case DiagramPackage.EDGE_STYLE__SHOW_ICON: return DiagramPackage.CONDITIONAL_EDGE_STYLE__SHOW_ICON;
				case DiagramPackage.EDGE_STYLE__LABEL_ICON: return DiagramPackage.CONDITIONAL_EDGE_STYLE__LABEL_ICON;
				case DiagramPackage.EDGE_STYLE__BACKGROUND: return DiagramPackage.CONDITIONAL_EDGE_STYLE__BACKGROUND;
				case DiagramPackage.EDGE_STYLE__MAX_WIDTH_EXPRESSION: return DiagramPackage.CONDITIONAL_EDGE_STYLE__MAX_WIDTH_EXPRESSION;
				case DiagramPackage.EDGE_STYLE__EDGE_TYPE: return DiagramPackage.CONDITIONAL_EDGE_STYLE__EDGE_TYPE;
				case DiagramPackage.EDGE_STYLE__DESCRIPTION: return DiagramPackage.CONDITIONAL_EDGE_STYLE__DESCRIPTION;
				default: return -1;
			}
		}
