 ...
 * Through</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getBorderColor <em>Border
 * Color</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getBorderRadius <em>Border
 * Radius</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getBorderSize <em>Border
 * Size</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalEdgeStyleImpl#getBorderLineStyle <em>Border
 * Line Style</em>}</li>
...
public class ConditionalEdgeStyleImpl extends ConditionalImpl implements ConditionalEdgeStyle {
    ...
    public UserColor getBorderColor() {
        if (this.borderColor != null && this.borderColor.eIsProxy()) {
            ...
            if (this.borderColor != oldBorderColor) {
                if (this.eNotificationRequired())
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_COLOR, oldBorderColor, this.borderColor));
            }
        }
    ...
    public void setBorderColor(UserColor newBorderColor) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_COLOR, oldBorderColor, this.borderColor));
    }
    ...
    public void setBorderRadius(int newBorderRadius) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_RADIUS, oldBorderRadius, this.borderRadius));
    }
    ...
    public void setBorderSize(int newBorderSize) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_SIZE, oldBorderSize, this.borderSize));
    }
    ...
    public void setBorderLineStyle(LineStyle newBorderLineStyle) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_LINE_STYLE, oldBorderLineStyle, this.borderLineStyle));
    }
    ...
    public UserColor getBackground() {
        if (this.background != null && this.background.eIsProxy()) {
            ...
            if (this.background != oldBackground) {
                if (this.eNotificationRequired())
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiagramPackage.CONDITIONAL_EDGE_STYLE__BACKGROUND, oldBackground, this.background));
            }
        }
    ...
    public void setBackground(UserColor newBackground) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_EDGE_STYLE__BACKGROUND, oldBackground, this.background));
    }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == EdgeStyleDescription.class) {
            switch (derivedFeatureID) {
                case DiagramPackage.CONDITIONAL_EDGE_STYLE__LINE_STYLE:
                    return DiagramPackage.EDGE_STYLE_DESCRIPTION__LINE_STYLE;
                case DiagramPackage.CONDITIONAL_EDGE_STYLE__SOURCE_ARROW_STYLE:
                    return DiagramPackage.EDGE_STYLE_DESCRIPTION__SOURCE_ARROW_STYLE;
                case DiagramPackage.CONDITIONAL_EDGE_STYLE__TARGET_ARROW_STYLE:
                    return DiagramPackage.EDGE_STYLE_DESCRIPTION__TARGET_ARROW_STYLE;
                case DiagramPackage.CONDITIONAL_EDGE_STYLE__EDGE_WIDTH:
                    return DiagramPackage.EDGE_STYLE_DESCRIPTION__EDGE_WIDTH;
                case DiagramPackage.CONDITIONAL_EDGE_STYLE__SHOW_ICON:
                    return DiagramPackage.EDGE_STYLE_DESCRIPTION__SHOW_ICON;
                case DiagramPackage.CONDITIONAL_EDGE_STYLE__LABEL_ICON:
                    return DiagramPackage.EDGE_STYLE_DESCRIPTION__LABEL_ICON;
                case DiagramPackage.CONDITIONAL_EDGE_STYLE__BACKGROUND:
                    return DiagramPackage.EDGE_STYLE_DESCRIPTION__BACKGROUND;
                case DiagramPackage.CONDITIONAL_EDGE_STYLE__MAX_WIDTH_EXPRESSION:
                    return DiagramPackage.EDGE_STYLE_DESCRIPTION__MAX_WIDTH_EXPRESSION;
                case DiagramPackage.CONDITIONAL_EDGE_STYLE__EDGE_TYPE:
                    return DiagramPackage.EDGE_STYLE_DESCRIPTION__EDGE_TYPE;
                case DiagramPackage.CONDITIONAL_EDGE_STYLE__DESCRIPTION:
                    return DiagramPackage.EDGE_STYLE_DESCRIPTION__DESCRIPTION;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == BorderStyle.class) {
            switch (baseFeatureID) {
                case DiagramPackage.BORDER_STYLE__BORDER_COLOR:
                    return DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_COLOR;
                case DiagramPackage.BORDER_STYLE__BORDER_RADIUS:
                    return DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_RADIUS;
                case DiagramPackage.BORDER_STYLE__BORDER_SIZE:
                    return DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_SIZE;
                case DiagramPackage.BORDER_STYLE__BORDER_LINE_STYLE:
                    return DiagramPackage.CONDITIONAL_EDGE_STYLE__BORDER_LINE_STYLE;
                default:
                    return -1;
            }
        }
