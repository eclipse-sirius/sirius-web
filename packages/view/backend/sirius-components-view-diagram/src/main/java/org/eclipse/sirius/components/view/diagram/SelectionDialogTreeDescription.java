 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.diagram.SelectionDialogTreeDescription#getElementsExpression
 * <em>Elements Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.diagram.SelectionDialogTreeDescription#getChildrenExpression
 * <em>Children Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.diagram.SelectionDialogTreeDescription#getIsSelectableExpression <em>Is
...
public interface SelectionDialogTreeDescription extends EObject {
    /**
     * Returns the value of the '<em><b>Elements Expression</b></em>' attribute. The default value is <code>""</code>.
    ...
    /**
     * Returns the value of the '<em><b>Is Selectable Expression</b></em>' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     ...
     * <em>Is Selectable Expression</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Is Selectable Expression</em>' attribute.
