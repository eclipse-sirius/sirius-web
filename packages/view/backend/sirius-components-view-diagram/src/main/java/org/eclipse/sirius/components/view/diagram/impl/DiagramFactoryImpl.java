...
public class DiagramFactoryImpl extends EFactoryImpl implements DiagramFactory {
    ...
    public EObject create(EClass eClass) {
		switch (eClass.getClassifierID())
		{
			...
			case DiagramPackage.DIAGRAM_STYLE_DESCRIPTION: return createDiagramStyleDescription();
			case DiagramPackage.CONDITIONAL_NODE_STYLE: return createConditionalNodeStyle();
			case DiagramPackage.CONDITIONAL_DIAGRAM_STYLE: return createConditionalDiagramStyle();
			...
			case DiagramPackage.DIAGRAM_TOOLBAR: return createDiagramToolbar();
			case DiagramPackage.NODE_DECORATOR_DESCRIPTION: return createNodeDecoratorDescription();
			case DiagramPackage.SEMANTIC_DECORATOR_DESCRIPTION: return createSemanticDecoratorDescription();
			default:
    ...
    public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID())
		{
			...
			case DiagramPackage.DECORATOR_POSITION:
				return createDecoratorPositionFromString(eDataType, initialValue);
			case DiagramPackage.DIAGRAM_LAYOUT_OPTION:
				return createDiagramLayoutOptionFromString(eDataType, initialValue);
			default:
    ...
    public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID())
		{
			...
			case DiagramPackage.DECORATOR_POSITION:
				return convertDecoratorPositionToString(eDataType, instanceValue);
			case DiagramPackage.DIAGRAM_LAYOUT_OPTION:
				return convertDiagramLayoutOptionToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
