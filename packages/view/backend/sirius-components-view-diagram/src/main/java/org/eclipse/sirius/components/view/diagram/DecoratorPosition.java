...
public enum DecoratorPosition implements Enumerator {
     ...
     * @generated
     */
    private static final DecoratorPosition[] VALUES_ARRAY = new DecoratorPosition[]
		{
			NORTH,
			NORTH_WEST,
			WEST,
    ...
    /**
	 * A public read-only list of all the '<em><b>Decorator Position</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @generated
	 */
    ...
    /**
	 * Returns the '<em><b>Decorator Position</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
    ...
    /**
	 * Returns the '<em><b>Decorator Position</b></em>' literal with the specified name.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
    ...
    /**
	 * Returns the '<em><b>Decorator Position</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
