 ...
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ImageNodeStyleDescriptionImpl#getDescription <em>Description</em>}</li>
...
public class ImageNodeStyleDescriptionImpl extends MinimalEObjectImpl.Container implements ImageNodeStyleDescription {
    ...
    public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.IMAGE_NODE_STYLE_DESCRIPTION__DESCRIPTION, oldDescription, description));
	}
