...
public enum DiagramLayoutOption implements Enumerator {
    ...
    /**
	 * The '<em><b>AUTO LAYOUT</b></em>' literal object.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * The '<em><b>AUTO UNTIL MANUAL</b></em>' literal object.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * The '<em><b>AUTO LAYOUT</b></em>' literal value.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #AUTO_LAYOUT
	 * @model
	 * @generated
    ...
    /**
	 * The '<em><b>AUTO UNTIL MANUAL</b></em>' literal value.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 ...
	 * @generated
	 */
    private static final DiagramLayoutOption[] VALUES_ARRAY = new DiagramLayoutOption[]
		{
			NONE,
			AUTO_LAYOUT,
			AUTO_UNTIL_MANUAL,
    ...
    public static DiagramLayoutOption get(int value) {
		switch (value)
		{
			...
			case AUTO_LAYOUT_VALUE: return AUTO_LAYOUT;
			case AUTO_UNTIL_MANUAL_VALUE: return AUTO_UNTIL_MANUAL;
		}
		return null;
	}
