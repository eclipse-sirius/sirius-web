...
public enum UserResizableDirection implements Enumerator {
    ...
    /**
	 * An array of all the '<em><b>User Resizable Direction</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @generated
	 */
    private static final UserResizableDirection[] VALUES_ARRAY = new UserResizableDirection[]
		{
			BOTH,
			HORIZONTAL,
			VERTICAL,
    ...
    /**
	 * A public read-only list of all the '<em><b>User Resizable Direction</b></em>' enumerators.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
	 * @generated
	 */
    ...
    /**
	 * Returns the '<em><b>User Resizable Direction</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
