...
public enum ArrangeLayoutDirection implements Enumerator {
    ...
    /**
	 * An array of all the '<em><b>Arrange Layout Direction</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @generated
	 */
    private static final ArrangeLayoutDirection[] VALUES_ARRAY = new ArrangeLayoutDirection[]
		{
			UNDEFINED,
			RIGHT,
			DOWN,
    ...
    /**
	 * A public read-only list of all the '<em><b>Arrange Layout Direction</b></em>' enumerators.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
	 * @generated
	 */
    ...
    /**
	 * Returns the '<em><b>Arrange Layout Direction</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
