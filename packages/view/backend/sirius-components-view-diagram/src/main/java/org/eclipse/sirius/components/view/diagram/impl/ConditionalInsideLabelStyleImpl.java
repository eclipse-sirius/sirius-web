 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.ConditionalInsideLabelStyleImpl#getStyle <em>Style</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionalInsideLabelStyleImpl extends ConditionalImpl implements ConditionalInsideLabelStyle {
    ...
    public void setStyle(InsideLabelStyle newStyle) {
		if (newStyle != style)
		{
			...
			if (style != null)
				msgs = ((InternalEObject)style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DiagramPackage.CONDITIONAL_INSIDE_LABEL_STYLE__STYLE, null, msgs);
			if (newStyle != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.CONDITIONAL_INSIDE_LABEL_STYLE__STYLE, newStyle, newStyle));
	}
