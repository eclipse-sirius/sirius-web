...
public enum LabelTextAlign implements Enumerator {
    ...
    /**
	 * An array of all the '<em><b>Label Text Align</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    private static final LabelTextAlign[] VALUES_ARRAY = new LabelTextAlign[]
		{
			LEFT,
			RIGHT,
			CENTER,
    ...
    /**
	 * A public read-only list of all the '<em><b>Label Text Align</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @generated
	 */
    ...
    /**
	 * Returns the '<em><b>Label Text Align</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
	 * Returns the '<em><b>Label Text Align</b></em>' literal with the specified name.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
    ...
    /**
	 * Returns the '<em><b>Label Text Align</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
