 ...
 *   <li>{@link org.eclipse.sirius.components.view.diagram.impl.IconLabelNodeStyleDescriptionImpl#getDescription <em>Description</em>}</li>
...
public class IconLabelNodeStyleDescriptionImpl extends MinimalEObjectImpl.Container implements IconLabelNodeStyleDescription {
    ...
    public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.ICON_LABEL_NODE_STYLE_DESCRIPTION__DESCRIPTION, oldDescription, description));
	}
