...
public interface InsideLabelStyle extends NodeLabelStyle {
    ...
    /**
	 * Returns the value of the '<em><b>With Header</b></em>' attribute.
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.diagram.InsideLabelStyle#isWithHeader <em>With Header</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @param value the new value of the '<em>With Header</em>' attribute.
	 * @see #isWithHeader()
	 * @generated
	 */
    ...
    /**
	 * Returns the value of the '<em><b>Header Separator Display Mode</b></em>' attribute.
	 * The literals are from the enumeration {@link org.eclipse.sirius.components.view.diagram.HeaderSeparatorDisplayMode}.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.diagram.InsideLabelStyle#getHeaderSeparatorDisplayMode <em>Header Separator Display Mode</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @param value the new value of the '<em>Header Separator Display Mode</em>' attribute.
	 * @see org.eclipse.sirius.components.view.diagram.HeaderSeparatorDisplayMode
