 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.ListLayoutStrategyDescription#getAreChildNodesDraggableExpression <em>Are Child Nodes Draggable Expression</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.ListLayoutStrategyDescription#getTopGapExpression <em>Top Gap Expression</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.ListLayoutStrategyDescription#getBottomGapExpression <em>Bottom Gap Expression</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.diagram.ListLayoutStrategyDescription#getGrowableNodes <em>Growable Nodes</em>}</li>
 * </ul>
 *
...
public interface ListLayoutStrategyDescription extends LayoutStrategyDescription {
    ...
    /**
	 * Returns the value of the '<em><b>Are Child Nodes Draggable Expression</b></em>' attribute.
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.diagram.ListLayoutStrategyDescription#getAreChildNodesDraggableExpression <em>Are Child Nodes Draggable Expression</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @param value the new value of the '<em>Are Child Nodes Draggable Expression</em>' attribute.
    ...
    /**
	 * Returns the value of the '<em><b>Top Gap Expression</b></em>' attribute.
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.diagram.ListLayoutStrategyDescription#getTopGapExpression <em>Top Gap Expression</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @param value the new value of the '<em>Top Gap Expression</em>' attribute.
    ...
    /**
	 * Returns the value of the '<em><b>Bottom Gap Expression</b></em>' attribute.
	 * The default value is <code>""</code>.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * Sets the value of the '{@link org.eclipse.sirius.components.view.diagram.ListLayoutStrategyDescription#getBottomGapExpression <em>Bottom Gap Expression</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @param value the new value of the '<em>Bottom Gap Expression</em>' attribute.
    ...
    /**
	 * Returns the value of the '<em><b>Growable Nodes</b></em>' reference list.
