 ...
 * <li>{@link org.eclipse.sirius.components.view.diagram.impl.RectangularNodeStyleDescriptionImpl#getDescription
...
public class RectangularNodeStyleDescriptionImpl extends MinimalEObjectImpl.Container implements RectangularNodeStyleDescription {
    ...
    public void setDescription(String newDescription) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, DiagramPackage.RECTANGULAR_NODE_STYLE_DESCRIPTION__DESCRIPTION, oldDescription, this.description));
    }
