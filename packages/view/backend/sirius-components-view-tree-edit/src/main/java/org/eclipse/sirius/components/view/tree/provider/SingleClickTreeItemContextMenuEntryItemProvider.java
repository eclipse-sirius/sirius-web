...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.tree.SingleClickTreeItemContextMenuEntry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SingleClickTreeItemContextMenuEntryItemProvider extends TreeItemContextMenuEntryItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SingleClickTreeItemContextMenuEntry_labelExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SingleClickTreeItemContextMenuEntry_labelExpression_feature", "_UI_SingleClickTreeItemContextMenuEntry_type"),
    ...
    protected void addIconURLExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SingleClickTreeItemContextMenuEntry_iconURLExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SingleClickTreeItemContextMenuEntry_iconURLExpression_feature", "_UI_SingleClickTreeItemContextMenuEntry_type"),
				 TreePackage.Literals.SINGLE_CLICK_TREE_ITEM_CONTEXT_MENU_ENTRY__ICON_URL_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addWithImpactAnalysisPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SingleClickTreeItemContextMenuEntry_withImpactAnalysis_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SingleClickTreeItemContextMenuEntry_withImpactAnalysis_feature", "_UI_SingleClickTreeItemContextMenuEntry_type"),
				 TreePackage.Literals.SINGLE_CLICK_TREE_ITEM_CONTEXT_MENU_ENTRY__WITH_IMPACT_ANALYSIS,
				 true,
				 false,
				 false,
    ...
    /**
	 * This returns SingleClickTreeItemContextMenuEntry.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SingleClickTreeItemContextMenuEntry"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_SingleClickTreeItemContextMenuEntry_type") :
			getString("_UI_SingleClickTreeItemContextMenuEntry_type") + " " + label;
	}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TreePackage.Literals.SINGLE_CLICK_TREE_ITEM_CONTEXT_MENU_ENTRY__BODY,
