...
public class TreeDescriptionItemProvider extends RepresentationDescriptionItemProvider {
    ...
    protected void addTreeItemLabelExpressionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(
                ...
                this.getString("_UI_PropertyDescriptor_description", "_UI_TreeDescription_treeItemLabelExpression_feature",
                        "_UI_TreeDescription_type"),
                TreePackage.Literals.TREE_DESCRIPTION__TREE_ITEM_LABEL_EXPRESSION, true, false, false,
                ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
