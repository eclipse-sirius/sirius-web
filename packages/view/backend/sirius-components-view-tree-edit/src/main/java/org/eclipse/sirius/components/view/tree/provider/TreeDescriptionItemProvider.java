...
public class TreeDescriptionItemProvider extends RepresentationDescriptionItemProvider {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null)
		{
			...
			addTreeItemTooltipExpressionPropertyDescriptor(object);
		}
    ...
    /**
	 * This adds a property descriptor for the Tree Item Tooltip Expression feature.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @generated
	 */
    protected void addTreeItemTooltipExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TreeDescription_treeItemTooltipExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TreeDescription_treeItemTooltipExpression_feature", "_UI_TreeDescription_type"),
				 TreePackage.Literals.TREE_DESCRIPTION__TREE_ITEM_TOOLTIP_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
