...
public class TreeDescriptionItemProvider extends RepresentationDescriptionItemProvider {
	...
	protected void addKindExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TreeDescription_kindExpression_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TreeDescription_kindExpression_feature",
	...
	protected void addIconURLExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TreeDescription_iconURLExpression_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TreeDescription_iconURLExpression_feature",
								"_UI_TreeDescription_type"),
	...
	protected void addElementsExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_TreeDescription_elementsExpression_feature",
						"_UI_TreeDescription_type"),
	...
	protected void addHasChildrenExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_TreeDescription_hasChildrenExpression_feature",
						"_UI_TreeDescription_type"),
	...
	protected void addChildrenExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_TreeDescription_childrenExpression_feature",
						"_UI_TreeDescription_type"),
	...
	protected void addParentExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TreeDescription_parentExpression_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TreeDescription_parentExpression_feature",
								"_UI_TreeDescription_type"),
	...
	protected void addEditableExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_TreeDescription_editableExpression_feature",
						"_UI_TreeDescription_type"),
	...
	protected void addSelectableExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_TreeDescription_selectableExpression_feature",
						"_UI_TreeDescription_type"),
	...
	protected void addDeletableExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_TreeDescription_deletableExpression_feature",
						"_UI_TreeDescription_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_TreeDescription_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(TreePackage.Literals.TREE_DESCRIPTION__TREE_ITEM_LABEL_DESCRIPTIONS,
