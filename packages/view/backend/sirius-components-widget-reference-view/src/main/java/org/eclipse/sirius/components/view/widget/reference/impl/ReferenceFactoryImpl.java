...
public class ReferenceFactoryImpl extends EFactoryImpl implements ReferenceFactory {
    ...
    public EObject create(EClass eClass) {
		switch (eClass.getClassifierID())
		{
			...
			case ReferencePackage.REFERENCE_WIDGET_DESCRIPTION_STYLE: return createReferenceWidgetDescriptionStyle();
			case ReferencePackage.CONDITIONAL_REFERENCE_WIDGET_DESCRIPTION_STYLE: return createConditionalReferenceWidgetDescriptionStyle();
			default:
