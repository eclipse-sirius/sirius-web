...
public class ConditionalButtonDescriptionStyleItemProvider extends ConditionalItemProvider {
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ConditionalButtonDescriptionStyle_type") :
                this.getString("_UI_ConditionalButtonDescriptionStyle_type") + " " + label;
    }
