...
public class CreateInstanceItemProvider extends OperationItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CreateInstance_typeName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CreateInstance_typeName_feature", "_UI_CreateInstance_type"),
    ...
    protected void addReferenceNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CreateInstance_referenceName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CreateInstance_referenceName_feature", "_UI_CreateInstance_type"),
				 ViewPackage.Literals.CREATE_INSTANCE__REFERENCE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addVariableNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CreateInstance_variableName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CreateInstance_variableName_feature", "_UI_CreateInstance_type"),
				 ViewPackage.Literals.CREATE_INSTANCE__VARIABLE_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    /**
	 * This returns CreateInstance.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_CreateInstance_type") :
			getString("_UI_CreateInstance_type") + " " + label;
	}
