...
public class ConditionalBarChartDescriptionStyleItemProvider extends ConditionalItemProvider {
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ConditionalBarChartDescriptionStyle_type") : this.getString("_UI_ConditionalBarChartDescriptionStyle_type") + " " + label;
    }
