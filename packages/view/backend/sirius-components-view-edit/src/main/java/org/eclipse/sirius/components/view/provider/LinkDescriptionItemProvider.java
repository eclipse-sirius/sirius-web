...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.LinkDescription} object. <!--
...
public class LinkDescriptionItemProvider extends WidgetDescriptionItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(ViewPackage.Literals.LINK_DESCRIPTION__STYLE);
            this.childrenFeatures.add(ViewPackage.Literals.LINK_DESCRIPTION__CONDITIONAL_STYLES);
        }
    ...
    /**
     * This returns LinkDescription.svg. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.LINK_DESCRIPTION__STYLE, ViewFactory.eINSTANCE.createLinkDescriptionStyle()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.LINK_DESCRIPTION__STYLE, ViewFactory.eINSTANCE.createConditionalLinkDescriptionStyle()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.LINK_DESCRIPTION__CONDITIONAL_STYLES, ViewFactory.eINSTANCE.createConditionalLinkDescriptionStyle()));
    }
