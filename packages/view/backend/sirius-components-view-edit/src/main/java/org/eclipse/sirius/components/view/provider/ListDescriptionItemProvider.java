...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.ListDescription} object. <!--
...
public class ListDescriptionItemProvider extends WidgetDescriptionItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(ViewPackage.Literals.LIST_DESCRIPTION__BODY);
            this.childrenFeatures.add(ViewPackage.Literals.LIST_DESCRIPTION__STYLE);
            this.childrenFeatures.add(ViewPackage.Literals.LIST_DESCRIPTION__CONDITIONAL_STYLES);
        }
    ...
    /**
     * This returns ListDescription.svg. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.LIST_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createChangeContext()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.LIST_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createCreateInstance()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.LIST_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createSetValue()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.LIST_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createUnsetValue()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.LIST_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createDeleteElement()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.LIST_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createCreateView()));
