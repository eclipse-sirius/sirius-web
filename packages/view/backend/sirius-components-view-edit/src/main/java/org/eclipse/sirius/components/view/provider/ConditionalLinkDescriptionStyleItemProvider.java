...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.ConditionalLinkDescriptionStyle}
 * object. <!-- begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class ConditionalLinkDescriptionStyleItemProvider extends ConditionalItemProvider {
    /**
     * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public ConditionalLinkDescriptionStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addColorPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_LinkDescriptionStyle_color_feature"), //$NON-NLS-1$
                this.getString("_UI_PropertyDescriptor_description", "_UI_LinkDescriptionStyle_color_feature", "_UI_LinkDescriptionStyle_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                ViewPackage.Literals.LINK_DESCRIPTION_STYLE__COLOR, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public String getText(Object object) {
        String label = ((ConditionalLinkDescriptionStyle) object).getCondition();
        return label == null || label.length() == 0 ? this.getString("_UI_ConditionalLinkDescriptionStyle_type") : //$NON-NLS-1$
                this.getString("_UI_ConditionalLinkDescriptionStyle_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(ConditionalLinkDescriptionStyle.class)) {
