...
public class SelectDescriptionItemProvider extends WidgetDescriptionItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(ViewPackage.Literals.SELECT_DESCRIPTION__CONDITIONAL_STYLES);
        }
    ...
    public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
        ...
        boolean qualify = childFeature == ViewPackage.Literals.SELECT_DESCRIPTION__STYLE || childFeature == ViewPackage.Literals.SELECT_DESCRIPTION__CONDITIONAL_STYLES;
