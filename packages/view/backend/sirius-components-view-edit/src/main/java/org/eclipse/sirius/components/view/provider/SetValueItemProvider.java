...
public class SetValueItemProvider extends OperationItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SetValue_featureName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SetValue_featureName_feature", "_UI_SetValue_type"),
				 ViewPackage.Literals.SET_VALUE__FEATURE_NAME,
				 true,
				 false,
				 false,
    ...
    protected void addValueExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SetValue_valueExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SetValue_valueExpression_feature", "_UI_SetValue_type"),
				 ViewPackage.Literals.SET_VALUE__VALUE_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_SetValue_type") :
			getString("_UI_SetValue_type") + " " + label;
	}
