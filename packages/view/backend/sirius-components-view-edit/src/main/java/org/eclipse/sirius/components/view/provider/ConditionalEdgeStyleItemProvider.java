...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.ConditionalEdgeStyle} object. <!--
...
public class ConditionalEdgeStyleItemProvider extends ConditionalItemProvider {
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ConditionalEdgeStyle_type") :
                this.getString("_UI_ConditionalEdgeStyle_type") + " " + label;
    }
