...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.LinkDescriptionStyle} object. <!--
...
public class LinkDescriptionStyleItemProvider extends WidgetDescriptionStyleItemProvider {
    ...
    public String getText(Object object) {
        ...
        return this.getString("_UI_LinkDescriptionStyle_type") + " " + linkDescriptionStyle.getFontSize(); //$NON-NLS-1$ //$NON-NLS-2$
    }
