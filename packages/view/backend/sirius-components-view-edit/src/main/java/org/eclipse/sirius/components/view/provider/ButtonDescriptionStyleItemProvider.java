...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.ButtonDescriptionStyle} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class ButtonDescriptionStyleItemProvider extends WidgetDescriptionStyleItemProvider {
    /**
     * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public ButtonDescriptionStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addBackgroundColorPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_ButtonDescriptionStyle_backgroundColor_feature"), //$NON-NLS-1$
                this.getString("_UI_PropertyDescriptor_description", "_UI_ButtonDescriptionStyle_backgroundColor_feature", "_UI_ButtonDescriptionStyle_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                ViewPackage.Literals.BUTTON_DESCRIPTION_STYLE__BACKGROUND_COLOR, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addForegroundColorPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_ButtonDescriptionStyle_foregroundColor_feature"), //$NON-NLS-1$
                this.getString("_UI_PropertyDescriptor_description", "_UI_ButtonDescriptionStyle_foregroundColor_feature", "_UI_ButtonDescriptionStyle_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                ViewPackage.Literals.BUTTON_DESCRIPTION_STYLE__FOREGROUND_COLOR, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }

    /**
     * This returns ButtonDescriptionStyle.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    ...
    public String getText(Object object) {
        ButtonDescriptionStyle buttonDescriptionStyle = (ButtonDescriptionStyle) object;
        return this.getString("_UI_ButtonDescriptionStyle_type") + " " + buttonDescriptionStyle.getFontSize(); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(ButtonDescriptionStyle.class)) {
