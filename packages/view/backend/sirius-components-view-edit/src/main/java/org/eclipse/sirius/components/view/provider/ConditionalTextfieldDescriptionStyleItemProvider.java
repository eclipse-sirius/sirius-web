...
public class ConditionalTextfieldDescriptionStyleItemProvider extends ConditionalItemProvider {
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ConditionalTextfieldDescriptionStyle_type") :
                this.getString("_UI_ConditionalTextfieldDescriptionStyle_type") + " " + label;
    }
