...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.ConditionalLabelDescriptionStyle}
...
public class ConditionalLabelDescriptionStyleItemProvider extends ConditionalItemProvider {
    ...
    protected void addColorPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_LabelDescriptionStyle_color_feature"), //$NON-NLS-1$
                this.getString("_UI_PropertyDescriptor_description", "_UI_LabelDescriptionStyle_color_feature", "_UI_LabelDescriptionStyle_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                ViewPackage.Literals.LABEL_DESCRIPTION_STYLE__COLOR, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }

    /**
     * This returns ConditionalLabelDescriptionStyle.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ConditionalLabelDescriptionStyle_type") : //$NON-NLS-1$
                this.getString("_UI_ConditionalLabelDescriptionStyle_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
