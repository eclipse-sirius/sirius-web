...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.ImageNodeStyleDescription} object.
...
public class ImageNodeStyleDescriptionItemProvider extends StyleItemProvider {
    ...
    protected void addShapePropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_ImageNodeStyleDescription_shape_feature"), //$NON-NLS-1$
                this.getString("_UI_PropertyDescriptor_description", "_UI_ImageNodeStyleDescription_shape_feature", "_UI_ImageNodeStyleDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                ViewPackage.Literals.IMAGE_NODE_STYLE_DESCRIPTION__SHAPE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public Object getImage(Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/ImageNodeStyle.svg")); //$NON-NLS-1$
    }
    ...
    public String getText(Object object) {
        String label = ((ImageNodeStyleDescription) object).getShape();
        return label == null || label.length() == 0 ? this.getString("_UI_ImageNodeStyleDescription_type") : //$NON-NLS-1$
                this.getString("_UI_ImageNodeStyleDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
