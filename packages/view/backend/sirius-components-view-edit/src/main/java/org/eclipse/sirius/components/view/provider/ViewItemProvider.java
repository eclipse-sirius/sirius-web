...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.View} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class ViewItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(ViewPackage.Literals.VIEW__DESCRIPTIONS);
			childrenFeatures.add(ViewPackage.Literals.VIEW__COLOR_PALETTES);
			childrenFeatures.add(ViewPackage.Literals.VIEW__TEXT_STYLE_PALETTES);
		}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ViewPackage.Literals.VIEW__COLOR_PALETTES,
				 ViewFactory.eINSTANCE.createColorPalette()));

		newChildDescriptors.add
			(createChildParameter
				(ViewPackage.Literals.VIEW__TEXT_STYLE_PALETTES,
				 ViewFactory.eINSTANCE.createTextStylePalette()));
	}
