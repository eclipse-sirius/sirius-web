...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.LabelDescriptionStyle} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class LabelDescriptionStyleItemProvider extends WidgetDescriptionStyleItemProvider {
    /**
     * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public LabelDescriptionStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    /**
     * This returns LabelDescriptionStyle.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    ...
    public String getText(Object object) {
        LabelDescriptionStyle labelDescriptionStyle = (LabelDescriptionStyle) object;
        return this.getString("_UI_LabelDescriptionStyle_type") + " " + labelDescriptionStyle.getFontSize(); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(LabelDescriptionStyle.class)) {
