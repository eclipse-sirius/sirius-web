...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.ButtonDescription} object. <!--
...
public class ButtonDescriptionItemProvider extends WidgetDescriptionItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(ViewPackage.Literals.BUTTON_DESCRIPTION__BODY);
            this.childrenFeatures.add(ViewPackage.Literals.BUTTON_DESCRIPTION__STYLE);
            this.childrenFeatures.add(ViewPackage.Literals.BUTTON_DESCRIPTION__CONDITIONAL_STYLES);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.BUTTON_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createChangeContext()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.BUTTON_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createCreateInstance()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.BUTTON_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createSetValue()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.BUTTON_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createUnsetValue()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.BUTTON_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createDeleteElement()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.BUTTON_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createCreateView()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.BUTTON_DESCRIPTION__BODY, ViewFactory.eINSTANCE.createDeleteView()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.BUTTON_DESCRIPTION__STYLE, ViewFactory.eINSTANCE.createButtonDescriptionStyle()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.BUTTON_DESCRIPTION__STYLE, ViewFactory.eINSTANCE.createConditionalButtonDescriptionStyle()));

        newChildDescriptors.add(this.createChildParameter(ViewPackage.Literals.BUTTON_DESCRIPTION__CONDITIONAL_STYLES, ViewFactory.eINSTANCE.createConditionalButtonDescriptionStyle()));
    }
