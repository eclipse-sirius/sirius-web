 ...
 * @author lfasani
 */
public class RepresentationDescriptionItemProviderSpec extends RepresentationDescriptionItemProvider {
    public RepresentationDescriptionItemProviderSpec(AdapterFactory adapterFactory) {
