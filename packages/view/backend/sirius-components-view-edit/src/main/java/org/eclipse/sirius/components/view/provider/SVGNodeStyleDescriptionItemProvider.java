...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.SVGNodeStyleDescription} object.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class SVGNodeStyleDescriptionItemProvider extends StyleItemProvider {
    /**
     * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public SVGNodeStyleDescriptionItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addShapePropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_SVGNodeStyleDescription_shape_feature"), //$NON-NLS-1$
                this.getString("_UI_PropertyDescriptor_description", "_UI_SVGNodeStyleDescription_shape_feature", "_UI_SVGNodeStyleDescription_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                ViewPackage.Literals.SVG_NODE_STYLE_DESCRIPTION__SHAPE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }

    /**
     * This returns SVGNodeStyleDescription.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated NOT
     */
    @Override
    ...
    public String getText(Object object) {
        String label = ((SVGNodeStyleDescription) object).getShape();
        return label == null || label.length() == 0 ? this.getString("_UI_SVGNodeStyleDescription_type") : //$NON-NLS-1$
                this.getString("_UI_SVGNodeStyleDescription_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(SVGNodeStyleDescription.class)) {
