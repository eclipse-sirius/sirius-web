...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.ConditionalListDescriptionStyle}
 * object. <!-- begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class ConditionalListDescriptionStyleItemProvider extends ConditionalItemProvider {
    /**
     * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public ConditionalListDescriptionStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    public String getText(Object object) {
        String label = ((ConditionalListDescriptionStyle) object).getCondition();
        return label == null || label.length() == 0 ? this.getString("_UI_ConditionalListDescriptionStyle_type") : //$NON-NLS-1$
                this.getString("_UI_ConditionalListDescriptionStyle_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(ConditionalListDescriptionStyle.class)) {
