...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.RadioDescriptionStyle} object. <!--
...
public class RadioDescriptionStyleItemProvider extends WidgetDescriptionStyleItemProvider {
    ...
    protected void addColorPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_RadioDescriptionStyle_color_feature"), //$NON-NLS-1$
                this.getString("_UI_PropertyDescriptor_description", "_UI_RadioDescriptionStyle_color_feature", "_UI_RadioDescriptionStyle_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                ViewPackage.Literals.RADIO_DESCRIPTION_STYLE__COLOR, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return this.getString("_UI_RadioDescriptionStyle_type") + " " + radioDescriptionStyle.getFontSize(); //$NON-NLS-1$ //$NON-NLS-2$
    }
