...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.ListDescriptionStyle} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class ListDescriptionStyleItemProvider extends WidgetDescriptionStyleItemProvider {
    /**
     * This constructs an instance from a factory and a notifier. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @generated
     */
    public ListDescriptionStyleItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addColorPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_ListDescriptionStyle_color_feature"), //$NON-NLS-1$
                this.getString("_UI_PropertyDescriptor_description", "_UI_ListDescriptionStyle_color_feature", "_UI_ListDescriptionStyle_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                ViewPackage.Literals.LIST_DESCRIPTION_STYLE__COLOR, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public String getText(Object object) {
        ListDescriptionStyle listDescriptionStyle = (ListDescriptionStyle) object;
        return this.getString("_UI_ListDescriptionStyle_type") + " " + listDescriptionStyle.getFontSize(); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(ListDescriptionStyle.class)) {
