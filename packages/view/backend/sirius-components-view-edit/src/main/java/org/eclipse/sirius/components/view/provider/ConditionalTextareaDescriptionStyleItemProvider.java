...
public class ConditionalTextareaDescriptionStyleItemProvider extends ConditionalItemProvider {
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ConditionalTextareaDescriptionStyle_type") :
                this.getString("_UI_ConditionalTextareaDescriptionStyle_type") + " " + label;
    }
