...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.ConditionalSelectDescriptionStyle}
...
public class ConditionalSelectDescriptionStyleItemProvider extends ConditionalItemProvider {
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ConditionalSelectDescriptionStyle_type") : //$NON-NLS-1$
                this.getString("_UI_ConditionalSelectDescriptionStyle_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
    }
