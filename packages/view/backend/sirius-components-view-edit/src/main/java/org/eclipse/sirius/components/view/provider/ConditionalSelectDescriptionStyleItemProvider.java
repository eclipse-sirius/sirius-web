...
public class ConditionalSelectDescriptionStyleItemProvider extends ConditionalItemProvider {
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_ConditionalSelectDescriptionStyle_type") :
                this.getString("_UI_ConditionalSelectDescriptionStyle_type") + " " + label;
    }
