...
public class UnsetValueItemProvider extends OperationItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UnsetValue_featureName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UnsetValue_featureName_feature", "_UI_UnsetValue_type"),
				 ViewPackage.Literals.UNSET_VALUE__FEATURE_NAME,
				 true,
				 false,
				 false,
    ...
    protected void addElementExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UnsetValue_elementExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UnsetValue_elementExpression_feature", "_UI_UnsetValue_type"),
				 ViewPackage.Literals.UNSET_VALUE__ELEMENT_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    /**
	 * This returns UnsetValue.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UnsetValue"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_UnsetValue_type") :
			getString("_UI_UnsetValue_type") + " " + label;
	}
