...
public interface WidgetGridLayout extends EObject {
    /**
     * Returns the value of the '<em><b>Grid Template Columns</b></em>' attribute. The default value is <code>""</code>.
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.view.form.WidgetGridLayout#getGridTemplateColumns
     * <em>Grid Template Columns</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Grid Template Columns</em>' attribute.
    ...
    /**
     * Returns the value of the '<em><b>Grid Template Rows</b></em>' attribute. The default value is <code>""</code>.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.view.form.WidgetGridLayout#getGridTemplateRows
     * <em>Grid Template Rows</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Grid Template Rows</em>' attribute.
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.view.form.WidgetGridLayout#getLabelGridRow <em>Label
     * Grid Row</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Label Grid Row</em>' attribute.
     * @see #getLabelGridRow()
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Label Grid Column</b></em>' attribute. The default value is <code>""</code>.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.view.form.WidgetGridLayout#getLabelGridColumn
     * <em>Label Grid Column</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Label Grid Column</em>' attribute.
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.view.form.WidgetGridLayout#getWidgetGridRow
     * <em>Widget Grid Row</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Widget Grid Row</em>' attribute.
    ...
    /**
     * Returns the value of the '<em><b>Widget Grid Column</b></em>' attribute. The default value is <code>""</code>.
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.view.form.WidgetGridLayout#getWidgetGridColumn
     * <em>Widget Grid Column</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @param value
     *            the new value of the '<em>Widget Grid Column</em>' attribute.
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.view.form.WidgetGridLayout#getGap <em>Gap</em>}'
