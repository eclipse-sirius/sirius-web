 ...
 * @see org.eclipse.sirius.components.view.form.FormPackage#getGroupDisplayMode()
 * @model
 * @generated
 */
public enum GroupDisplayMode implements Enumerator {
    ...
    /**
	 * The '<em><b>TOGGLEABLE AREAS</b></em>' literal object.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * The '<em><b>TOGGLEABLE AREAS</b></em>' literal value.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
     ...
     * @generated
     */
    private static final GroupDisplayMode[] VALUES_ARRAY = new GroupDisplayMode[]
		{
			LIST,
			TOGGLEABLE_AREAS,
		};
    ...
    /**
	 * A public read-only list of all the '<em><b>Group Display Mode</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @generated
	 */
    ...
    /**
	 * Returns the '<em><b>Group Display Mode</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
    ...
    /**
	 * Returns the '<em><b>Group Display Mode</b></em>' literal with the specified name.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
    ...
    /**
	 * Returns the '<em><b>Group Display Mode</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
    ...
    public static GroupDisplayMode get(int value) {
		switch (value)
		{
			...
			case TOGGLEABLE_AREAS_VALUE: return TOGGLEABLE_AREAS;
		}
		return null;
	}
