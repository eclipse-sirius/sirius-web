 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.MultiSelectDescriptionStyleImpl#getFontSize <em>Font Size</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.MultiSelectDescriptionStyleImpl#isItalic <em>Italic</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.MultiSelectDescriptionStyleImpl#isBold <em>Bold</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.MultiSelectDescriptionStyleImpl#isUnderline <em>Underline</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.MultiSelectDescriptionStyleImpl#isStrikeThrough <em>Strike Through</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.MultiSelectDescriptionStyleImpl#getGridTemplateColumns <em>Grid Template Columns</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.MultiSelectDescriptionStyleImpl#getGridTemplateRows <em>Grid Template Rows</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.MultiSelectDescriptionStyleImpl#getLabelGridRow <em>Label Grid Row</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.MultiSelectDescriptionStyleImpl#getLabelGridColumn <em>Label Grid Column</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.MultiSelectDescriptionStyleImpl#getWidgetGridRow <em>Widget Grid Row</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.MultiSelectDescriptionStyleImpl#getWidgetGridColumn <em>Widget Grid Column</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.MultiSelectDescriptionStyleImpl#getGap <em>Gap</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.MultiSelectDescriptionStyleImpl#getBackgroundColor <em>Background Color</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.MultiSelectDescriptionStyleImpl#getForegroundColor <em>Foreground Color</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.MultiSelectDescriptionStyleImpl#isShowIcon <em>Show Icon</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultiSelectDescriptionStyleImpl extends WidgetDescriptionStyleImpl implements MultiSelectDescriptionStyle {
    ...
    public void setFontSize(int newFontSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__FONT_SIZE, oldFontSize, fontSize));
	}
    ...
    public void setItalic(boolean newItalic) {
		...
		italic = newItalic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__ITALIC, oldItalic, italic));
	}
    ...
    public void setBold(boolean newBold) {
		...
		bold = newBold;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__BOLD, oldBold, bold));
	}
    ...
    public void setUnderline(boolean newUnderline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__UNDERLINE, oldUnderline, underline));
	}
    ...
    public void setStrikeThrough(boolean newStrikeThrough) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__STRIKE_THROUGH, oldStrikeThrough, strikeThrough));
	}
    ...
    public void setGridTemplateColumns(String newGridTemplateColumns) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS, oldGridTemplateColumns, gridTemplateColumns));
	}
    ...
    public void setGridTemplateRows(String newGridTemplateRows) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS, oldGridTemplateRows, gridTemplateRows));
	}
    ...
    public void setLabelGridRow(String newLabelGridRow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__LABEL_GRID_ROW, oldLabelGridRow, labelGridRow));
	}
    ...
    public void setLabelGridColumn(String newLabelGridColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__LABEL_GRID_COLUMN, oldLabelGridColumn, labelGridColumn));
	}
    ...
    public void setWidgetGridRow(String newWidgetGridRow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__WIDGET_GRID_ROW, oldWidgetGridRow, widgetGridRow));
	}
    ...
    public void setWidgetGridColumn(String newWidgetGridColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN, oldWidgetGridColumn, widgetGridColumn));
	}
    ...
    public void setGap(String newGap) {
		...
		gap = newGap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__GAP, oldGap, gap));
	}
    ...
    public UserColor getBackgroundColor() {
		if (backgroundColor != null && backgroundColor.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__BACKGROUND_COLOR, oldBackgroundColor, backgroundColor));
			}
		}
    ...
    public void setBackgroundColor(UserColor newBackgroundColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__BACKGROUND_COLOR, oldBackgroundColor, backgroundColor));
	}
    ...
    public UserColor getForegroundColor() {
		if (foregroundColor != null && foregroundColor.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__FOREGROUND_COLOR, oldForegroundColor, foregroundColor));
			}
		}
    ...
    public void setForegroundColor(UserColor newForegroundColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__FOREGROUND_COLOR, oldForegroundColor, foregroundColor));
	}
    ...
    public void setShowIcon(boolean newShowIcon) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__SHOW_ICON, oldShowIcon, showIcon));
	}
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == LabelStyle.class)
		{
			...
			{
				case FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__FONT_SIZE: return ViewPackage.LABEL_STYLE__FONT_SIZE;
				case FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__ITALIC: return ViewPackage.LABEL_STYLE__ITALIC;
				case FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__BOLD: return ViewPackage.LABEL_STYLE__BOLD;
				case FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__UNDERLINE: return ViewPackage.LABEL_STYLE__UNDERLINE;
				case FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__STRIKE_THROUGH: return ViewPackage.LABEL_STYLE__STRIKE_THROUGH;
				default: return -1;
			}
		}
		if (baseClass == WidgetGridLayout.class)
		{
			switch (derivedFeatureID)
			{
				case FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS: return FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_COLUMNS;
				case FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS: return FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_ROWS;
				case FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__LABEL_GRID_ROW: return FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_ROW;
				case FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__LABEL_GRID_COLUMN: return FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_COLUMN;
				case FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__WIDGET_GRID_ROW: return FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_ROW;
				case FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN: return FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_COLUMN;
				case FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__GAP: return FormPackage.WIDGET_GRID_LAYOUT__GAP;
				default: return -1;
			}
		}
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == LabelStyle.class)
		{
			...
			{
				case ViewPackage.LABEL_STYLE__FONT_SIZE: return FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__FONT_SIZE;
				case ViewPackage.LABEL_STYLE__ITALIC: return FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__ITALIC;
				case ViewPackage.LABEL_STYLE__BOLD: return FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__BOLD;
				case ViewPackage.LABEL_STYLE__UNDERLINE: return FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__UNDERLINE;
				case ViewPackage.LABEL_STYLE__STRIKE_THROUGH: return FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__STRIKE_THROUGH;
				default: return -1;
			}
		}
		if (baseClass == WidgetGridLayout.class)
		{
			switch (baseFeatureID)
			{
				case FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_COLUMNS: return FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS;
				case FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_ROWS: return FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS;
				case FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_ROW: return FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__LABEL_GRID_ROW;
				case FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_COLUMN: return FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__LABEL_GRID_COLUMN;
				case FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_ROW: return FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__WIDGET_GRID_ROW;
				case FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_COLUMN: return FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN;
				case FormPackage.WIDGET_GRID_LAYOUT__GAP: return FormPackage.MULTI_SELECT_DESCRIPTION_STYLE__GAP;
				default: return -1;
			}
		}
