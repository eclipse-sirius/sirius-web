 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.TextfieldDescriptionImpl#getValueExpression <em>Value
 * Expression</em>}</li>
...
public class TextfieldDescriptionImpl extends WidgetDescriptionImpl implements TextfieldDescription {
    ...
    public void setValueExpression(String newValueExpression) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTFIELD_DESCRIPTION__VALUE_EXPRESSION, oldValueExpression, this.valueExpression));
    }
    ...
    public EList<Operation> getBody() {
        if (this.body == null) {
            this.body = new EObjectContainmentEList<>(Operation.class, this, FormPackage.TEXTFIELD_DESCRIPTION__BODY);
        }
        return this.body;
    }
    ...
    public void setStyle(TextfieldDescriptionStyle newStyle) {
        if (newStyle != this.style) {
            ...
            if (this.style != null)
                msgs = ((InternalEObject) this.style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FormPackage.TEXTFIELD_DESCRIPTION__STYLE, null, msgs);
            if (newStyle != null)
            ...
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTFIELD_DESCRIPTION__STYLE, newStyle, newStyle));
    }
