...
public enum ContainerBorderLineStyle implements Enumerator {
    ...
    /**
	 * An array of all the '<em><b>Container Border Line Style</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @generated
	 */
    private static final ContainerBorderLineStyle[] VALUES_ARRAY = new ContainerBorderLineStyle[]
		{
			SOLID,
			DASHED,
			DOTTED,
    ...
    /**
	 * A public read-only list of all the '<em><b>Container Border Line Style</b></em>' enumerators.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
	 * @generated
	 */
    ...
    /**
	 * Returns the '<em><b>Container Border Line Style</b></em>' literal with the specified name.
	 * <!-- begin-user-doc
     * --> <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
