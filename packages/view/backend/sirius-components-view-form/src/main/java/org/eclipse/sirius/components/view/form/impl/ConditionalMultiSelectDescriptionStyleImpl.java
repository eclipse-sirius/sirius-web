 ...
 * <li>{@link org.eclipse.sirius.components.view.form.impl.ConditionalMultiSelectDescriptionStyleImpl#getFlexDirection
 ...
 * <em>Gap</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.ConditionalMultiSelectDescriptionStyleImpl#getLabelFlex
 * <em>Label Flex</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.ConditionalMultiSelectDescriptionStyleImpl#getValueFlex
 * <em>Value Flex</em>}</li>
...
public class ConditionalMultiSelectDescriptionStyleImpl extends ConditionalImpl implements ConditionalMultiSelectDescriptionStyle {
    ...
    public void setFlexDirection(String newFlexDirection) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CONDITIONAL_MULTI_SELECT_DESCRIPTION_STYLE__FLEX_DIRECTION, oldFlexDirection, this.flexDirection));
    }
    ...
    public void setLabelFlex(String newLabelFlex) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CONDITIONAL_MULTI_SELECT_DESCRIPTION_STYLE__LABEL_FLEX, oldLabelFlex, this.labelFlex));
    }
    ...
    public void setValueFlex(String newValueFlex) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CONDITIONAL_MULTI_SELECT_DESCRIPTION_STYLE__VALUE_FLEX, oldValueFlex, this.valueFlex));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case FormPackage.CONDITIONAL_MULTI_SELECT_DESCRIPTION_STYLE__FLEX_DIRECTION:
                return this.getFlexDirection();
            case FormPackage.CONDITIONAL_MULTI_SELECT_DESCRIPTION_STYLE__GAP:
                return this.getGap();
            case FormPackage.CONDITIONAL_MULTI_SELECT_DESCRIPTION_STYLE__LABEL_FLEX:
                return this.getLabelFlex();
            case FormPackage.CONDITIONAL_MULTI_SELECT_DESCRIPTION_STYLE__VALUE_FLEX:
        ...
        if (baseClass == WidgetFlexboxLayout.class) {
            switch (baseFeatureID) {
                case FormPackage.WIDGET_FLEXBOX_LAYOUT__FLEX_DIRECTION:
                    return FormPackage.CONDITIONAL_MULTI_SELECT_DESCRIPTION_STYLE__FLEX_DIRECTION;
                ...
                case FormPackage.WIDGET_FLEXBOX_LAYOUT__LABEL_FLEX:
                    return FormPackage.CONDITIONAL_MULTI_SELECT_DESCRIPTION_STYLE__LABEL_FLEX;
                case FormPackage.WIDGET_FLEXBOX_LAYOUT__VALUE_FLEX:
                    return FormPackage.CONDITIONAL_MULTI_SELECT_DESCRIPTION_STYLE__VALUE_FLEX;
                default:
                    return -1;
            }
        }
