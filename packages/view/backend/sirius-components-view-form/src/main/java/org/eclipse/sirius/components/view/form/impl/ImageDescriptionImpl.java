...
public class ImageDescriptionImpl extends WidgetDescriptionImpl implements ImageDescription {
    ...
    public void setUrlExpression(String newUrlExpression) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_DESCRIPTION__URL_EXPRESSION, oldUrlExpression, this.urlExpression));
    }
    ...
    public void setMaxWidthExpression(String newMaxWidthExpression) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.IMAGE_DESCRIPTION__MAX_WIDTH_EXPRESSION, oldMaxWidthExpression, this.maxWidthExpression));
    }
