...
public class LabelDescriptionImpl extends WidgetDescriptionImpl implements LabelDescription {
    ...
    public void setValueExpression(String newValueExpression) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.LABEL_DESCRIPTION__VALUE_EXPRESSION, oldValueExpression, this.valueExpression));
    }
    ...
    public void setStyle(LabelDescriptionStyle newStyle) {
        if (newStyle != this.style) {
            ...
            if (this.style != null)
                msgs = ((InternalEObject) this.style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FormPackage.LABEL_DESCRIPTION__STYLE, null, msgs);
            if (newStyle != null)
            ...
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.LABEL_DESCRIPTION__STYLE, newStyle, newStyle));
    }
    ...
    public EList<ConditionalLabelDescriptionStyle> getConditionalStyles() {
        if (this.conditionalStyles == null) {
            this.conditionalStyles = new EObjectContainmentEList<>(ConditionalLabelDescriptionStyle.class, this, FormPackage.LABEL_DESCRIPTION__CONDITIONAL_STYLES);
        }
