 ...
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.SplitButtonDescriptionImpl#getIsEnabledExpression <em>Is Enabled Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SplitButtonDescriptionImpl extends WidgetDescriptionImpl implements SplitButtonDescription {
    ...
    public EList<ButtonDescription> getActions() {
		if (actions == null)
		{
			actions = new EObjectContainmentEList<ButtonDescription>(ButtonDescription.class, this, FormPackage.SPLIT_BUTTON_DESCRIPTION__ACTIONS);
		}
		return actions;
	}
    ...
    public void setIsEnabledExpression(String newIsEnabledExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.SPLIT_BUTTON_DESCRIPTION__IS_ENABLED_EXPRESSION, oldIsEnabledExpression, isEnabledExpression));
	}
    ...
    public void eSet(int featureID, Object newValue) {
		switch (featureID)
		{
			case FormPackage.SPLIT_BUTTON_DESCRIPTION__ACTIONS:
				getActions().clear();
				getActions().addAll((Collection<? extends ButtonDescription>)newValue);
				return;
			case FormPackage.SPLIT_BUTTON_DESCRIPTION__IS_ENABLED_EXPRESSION:
