 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.CheckboxDescriptionStyleImpl#getGridTemplateColumns <em>Grid Template Columns</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.CheckboxDescriptionStyleImpl#getGridTemplateRows <em>Grid Template Rows</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.CheckboxDescriptionStyleImpl#getLabelGridRow <em>Label Grid Row</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.CheckboxDescriptionStyleImpl#getLabelGridColumn <em>Label Grid Column</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.CheckboxDescriptionStyleImpl#getWidgetGridRow <em>Widget Grid Row</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.CheckboxDescriptionStyleImpl#getWidgetGridColumn <em>Widget Grid Column</em>}</li>
...
public class CheckboxDescriptionStyleImpl extends WidgetDescriptionStyleImpl implements CheckboxDescriptionStyle {
    ...
    public void setGridTemplateColumns(String newGridTemplateColumns) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CHECKBOX_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS, oldGridTemplateColumns, gridTemplateColumns));
	}
    ...
    public void setGridTemplateRows(String newGridTemplateRows) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CHECKBOX_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS, oldGridTemplateRows, gridTemplateRows));
	}
    ...
    public void setLabelGridRow(String newLabelGridRow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CHECKBOX_DESCRIPTION_STYLE__LABEL_GRID_ROW, oldLabelGridRow, labelGridRow));
	}
    ...
    public void setLabelGridColumn(String newLabelGridColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CHECKBOX_DESCRIPTION_STYLE__LABEL_GRID_COLUMN, oldLabelGridColumn, labelGridColumn));
	}
    ...
    public void setWidgetGridRow(String newWidgetGridRow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CHECKBOX_DESCRIPTION_STYLE__WIDGET_GRID_ROW, oldWidgetGridRow, widgetGridRow));
	}
    ...
    public void setWidgetGridColumn(String newWidgetGridColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CHECKBOX_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN, oldWidgetGridColumn, widgetGridColumn));
	}
    ...
    public void setGap(String newGap) {
		...
		gap = newGap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CHECKBOX_DESCRIPTION_STYLE__GAP, oldGap, gap));
	}
    ...
    public UserColor getColor() {
		if (color != null && color.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.CHECKBOX_DESCRIPTION_STYLE__COLOR, oldColor, color));
			}
		}
		return color;
	}
    ...
    public void setColor(UserColor newColor) {
		...
		color = newColor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.CHECKBOX_DESCRIPTION_STYLE__COLOR, oldColor, color));
	}
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == WidgetGridLayout.class)
		{
			...
			{
				case FormPackage.CHECKBOX_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS: return FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_COLUMNS;
				case FormPackage.CHECKBOX_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS: return FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_ROWS;
				case FormPackage.CHECKBOX_DESCRIPTION_STYLE__LABEL_GRID_ROW: return FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_ROW;
				case FormPackage.CHECKBOX_DESCRIPTION_STYLE__LABEL_GRID_COLUMN: return FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_COLUMN;
				case FormPackage.CHECKBOX_DESCRIPTION_STYLE__WIDGET_GRID_ROW: return FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_ROW;
				case FormPackage.CHECKBOX_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN: return FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_COLUMN;
				case FormPackage.CHECKBOX_DESCRIPTION_STYLE__GAP: return FormPackage.WIDGET_GRID_LAYOUT__GAP;
				default: return -1;
			}
		}
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == WidgetGridLayout.class)
		{
			...
			{
				case FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_COLUMNS: return FormPackage.CHECKBOX_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS;
				case FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_ROWS: return FormPackage.CHECKBOX_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS;
				case FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_ROW: return FormPackage.CHECKBOX_DESCRIPTION_STYLE__LABEL_GRID_ROW;
				case FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_COLUMN: return FormPackage.CHECKBOX_DESCRIPTION_STYLE__LABEL_GRID_COLUMN;
				case FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_ROW: return FormPackage.CHECKBOX_DESCRIPTION_STYLE__WIDGET_GRID_ROW;
				case FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_COLUMN: return FormPackage.CHECKBOX_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN;
				case FormPackage.WIDGET_GRID_LAYOUT__GAP: return FormPackage.CHECKBOX_DESCRIPTION_STYLE__GAP;
				default: return -1;
			}
		}
