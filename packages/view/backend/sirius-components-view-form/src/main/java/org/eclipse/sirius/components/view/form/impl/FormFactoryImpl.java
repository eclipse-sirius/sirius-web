...
public class FormFactoryImpl extends EFactoryImpl implements FormFactory {
    ...
    public EObject create(EClass eClass) {
		...
		{
			case FormPackage.FORM_DESCRIPTION: return createFormDescription();
			case FormPackage.FORM_VARIABLE: return createFormVariable();
			case FormPackage.PAGE_DESCRIPTION: return createPageDescription();
			case FormPackage.GROUP_DESCRIPTION: return createGroupDescription();
			case FormPackage.BAR_CHART_DESCRIPTION: return createBarChartDescription();
			case FormPackage.BUTTON_DESCRIPTION: return createButtonDescription();
			case FormPackage.CHECKBOX_DESCRIPTION: return createCheckboxDescription();
			case FormPackage.DATE_TIME_DESCRIPTION: return createDateTimeDescription();
			case FormPackage.FLEXBOX_CONTAINER_DESCRIPTION: return createFlexboxContainerDescription();
			case FormPackage.IMAGE_DESCRIPTION: return createImageDescription();
			case FormPackage.LABEL_DESCRIPTION: return createLabelDescription();
			case FormPackage.LINK_DESCRIPTION: return createLinkDescription();
			case FormPackage.LIST_DESCRIPTION: return createListDescription();
			case FormPackage.MULTI_SELECT_DESCRIPTION: return createMultiSelectDescription();
			case FormPackage.PIE_CHART_DESCRIPTION: return createPieChartDescription();
			case FormPackage.RADIO_DESCRIPTION: return createRadioDescription();
			case FormPackage.RICH_TEXT_DESCRIPTION: return createRichTextDescription();
			case FormPackage.SELECT_DESCRIPTION: return createSelectDescription();
			case FormPackage.SPLIT_BUTTON_DESCRIPTION: return createSplitButtonDescription();
			case FormPackage.TEXT_AREA_DESCRIPTION: return createTextAreaDescription();
			case FormPackage.TEXTFIELD_DESCRIPTION: return createTextfieldDescription();
			case FormPackage.TREE_DESCRIPTION: return createTreeDescription();
			case FormPackage.SLIDER_DESCRIPTION: return createSliderDescription();
			case FormPackage.BAR_CHART_DESCRIPTION_STYLE: return createBarChartDescriptionStyle();
			case FormPackage.CONDITIONAL_BAR_CHART_DESCRIPTION_STYLE: return createConditionalBarChartDescriptionStyle();
			case FormPackage.BUTTON_DESCRIPTION_STYLE: return createButtonDescriptionStyle();
			case FormPackage.CONDITIONAL_BUTTON_DESCRIPTION_STYLE: return createConditionalButtonDescriptionStyle();
			case FormPackage.CHECKBOX_DESCRIPTION_STYLE: return createCheckboxDescriptionStyle();
			case FormPackage.CONDITIONAL_CHECKBOX_DESCRIPTION_STYLE: return createConditionalCheckboxDescriptionStyle();
			case FormPackage.DATE_TIME_DESCRIPTION_STYLE: return createDateTimeDescriptionStyle();
			case FormPackage.CONDITIONAL_DATE_TIME_DESCRIPTION_STYLE: return createConditionalDateTimeDescriptionStyle();
			case FormPackage.LABEL_DESCRIPTION_STYLE: return createLabelDescriptionStyle();
			case FormPackage.CONDITIONAL_LABEL_DESCRIPTION_STYLE: return createConditionalLabelDescriptionStyle();
			case FormPackage.LINK_DESCRIPTION_STYLE: return createLinkDescriptionStyle();
			case FormPackage.CONDITIONAL_LINK_DESCRIPTION_STYLE: return createConditionalLinkDescriptionStyle();
			case FormPackage.LIST_DESCRIPTION_STYLE: return createListDescriptionStyle();
			case FormPackage.CONDITIONAL_LIST_DESCRIPTION_STYLE: return createConditionalListDescriptionStyle();
			case FormPackage.MULTI_SELECT_DESCRIPTION_STYLE: return createMultiSelectDescriptionStyle();
			case FormPackage.CONDITIONAL_MULTI_SELECT_DESCRIPTION_STYLE: return createConditionalMultiSelectDescriptionStyle();
			case FormPackage.PIE_CHART_DESCRIPTION_STYLE: return createPieChartDescriptionStyle();
			case FormPackage.CONDITIONAL_PIE_CHART_DESCRIPTION_STYLE: return createConditionalPieChartDescriptionStyle();
			case FormPackage.RADIO_DESCRIPTION_STYLE: return createRadioDescriptionStyle();
			case FormPackage.CONDITIONAL_RADIO_DESCRIPTION_STYLE: return createConditionalRadioDescriptionStyle();
			case FormPackage.SELECT_DESCRIPTION_STYLE: return createSelectDescriptionStyle();
			case FormPackage.CONDITIONAL_SELECT_DESCRIPTION_STYLE: return createConditionalSelectDescriptionStyle();
			case FormPackage.TEXTAREA_DESCRIPTION_STYLE: return createTextareaDescriptionStyle();
			case FormPackage.CONDITIONAL_TEXTAREA_DESCRIPTION_STYLE: return createConditionalTextareaDescriptionStyle();
			case FormPackage.TEXTFIELD_DESCRIPTION_STYLE: return createTextfieldDescriptionStyle();
			case FormPackage.CONDITIONAL_TEXTFIELD_DESCRIPTION_STYLE: return createConditionalTextfieldDescriptionStyle();
			case FormPackage.CONTAINER_BORDER_STYLE: return createContainerBorderStyle();
			case FormPackage.CONDITIONAL_CONTAINER_BORDER_STYLE: return createConditionalContainerBorderStyle();
			case FormPackage.FORM_ELEMENT_FOR: return createFormElementFor();
			case FormPackage.FORM_ELEMENT_IF: return createFormElementIf();
			default:
    ...
    public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID())
		{
			case FormPackage.FLEX_DIRECTION:
				return createFlexDirectionFromString(eDataType, initialValue);
			case FormPackage.GROUP_DISPLAY_MODE:
				return createGroupDisplayModeFromString(eDataType, initialValue);
			case FormPackage.CONTAINER_BORDER_LINE_STYLE:
				return createContainerBorderLineStyleFromString(eDataType, initialValue);
    ...
    public String convertToString(EDataType eDataType, Object instanceValue) {
		...
		{
			case FormPackage.FLEX_DIRECTION:
				return convertFlexDirectionToString(eDataType, instanceValue);
			case FormPackage.GROUP_DISPLAY_MODE:
				return convertGroupDisplayModeToString(eDataType, instanceValue);
			case FormPackage.CONTAINER_BORDER_LINE_STYLE:
				return convertContainerBorderLineStyleToString(eDataType, instanceValue);
			case FormPackage.DATE_TIME_TYPE:
