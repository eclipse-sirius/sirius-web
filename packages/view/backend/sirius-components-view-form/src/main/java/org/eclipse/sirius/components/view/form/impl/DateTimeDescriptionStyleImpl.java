 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.DateTimeDescriptionStyleImpl#getGridTemplateColumns <em>Grid
 * Template Columns</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.DateTimeDescriptionStyleImpl#getGridTemplateRows <em>Grid
 * Template Rows</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.DateTimeDescriptionStyleImpl#getLabelGridRow <em>Label Grid
 * Row</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.DateTimeDescriptionStyleImpl#getLabelGridColumn <em>Label
 * Grid Column</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.DateTimeDescriptionStyleImpl#getWidgetGridRow <em>Widget Grid
 * Row</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.DateTimeDescriptionStyleImpl#getWidgetGridColumn <em>Widget
 * Grid Column</em>}</li>
...
public class DateTimeDescriptionStyleImpl extends WidgetDescriptionStyleImpl implements DateTimeDescriptionStyle {
    ...
    public void setGridTemplateColumns(String newGridTemplateColumns) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS, oldGridTemplateColumns, this.gridTemplateColumns));
    }
    ...
    public void setGridTemplateRows(String newGridTemplateRows) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS, oldGridTemplateRows, this.gridTemplateRows));
    }
    ...
    public void setLabelGridRow(String newLabelGridRow) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__LABEL_GRID_ROW, oldLabelGridRow, this.labelGridRow));
    }
    ...
    public void setLabelGridColumn(String newLabelGridColumn) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__LABEL_GRID_COLUMN, oldLabelGridColumn, this.labelGridColumn));
    }
    ...
    public void setWidgetGridRow(String newWidgetGridRow) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__WIDGET_GRID_ROW, oldWidgetGridRow, this.widgetGridRow));
    }
    ...
    public void setWidgetGridColumn(String newWidgetGridColumn) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN, oldWidgetGridColumn, this.widgetGridColumn));
    }
        ...
        if (baseClass == WidgetGridLayout.class) {
            switch (baseFeatureID) {
                case FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_COLUMNS:
                    return FormPackage.DATE_TIME_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS;
                case FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_ROWS:
                    return FormPackage.DATE_TIME_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS;
                case FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_ROW:
                    return FormPackage.DATE_TIME_DESCRIPTION_STYLE__LABEL_GRID_ROW;
                case FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_COLUMN:
                    return FormPackage.DATE_TIME_DESCRIPTION_STYLE__LABEL_GRID_COLUMN;
                case FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_ROW:
                    return FormPackage.DATE_TIME_DESCRIPTION_STYLE__WIDGET_GRID_ROW;
                case FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_COLUMN:
                    return FormPackage.DATE_TIME_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN;
