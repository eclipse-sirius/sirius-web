 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.DateTimeDescriptionStyleImpl#getGridTemplateColumns <em>Grid Template Columns</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.DateTimeDescriptionStyleImpl#getGridTemplateRows <em>Grid Template Rows</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.DateTimeDescriptionStyleImpl#getLabelGridRow <em>Label Grid Row</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.DateTimeDescriptionStyleImpl#getLabelGridColumn <em>Label Grid Column</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.DateTimeDescriptionStyleImpl#getWidgetGridRow <em>Widget Grid Row</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.DateTimeDescriptionStyleImpl#getWidgetGridColumn <em>Widget Grid Column</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.DateTimeDescriptionStyleImpl#getGap <em>Gap</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.DateTimeDescriptionStyleImpl#getBackgroundColor <em>Background Color</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.DateTimeDescriptionStyleImpl#getForegroundColor <em>Foreground Color</em>}</li>
...
public class DateTimeDescriptionStyleImpl extends WidgetDescriptionStyleImpl implements DateTimeDescriptionStyle {
    ...
    public void setGridTemplateColumns(String newGridTemplateColumns) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS, oldGridTemplateColumns, gridTemplateColumns));
	}
    ...
    public void setGridTemplateRows(String newGridTemplateRows) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS, oldGridTemplateRows, gridTemplateRows));
	}
    ...
    public void setLabelGridRow(String newLabelGridRow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__LABEL_GRID_ROW, oldLabelGridRow, labelGridRow));
	}
    ...
    public void setLabelGridColumn(String newLabelGridColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__LABEL_GRID_COLUMN, oldLabelGridColumn, labelGridColumn));
	}
    ...
    public void setWidgetGridRow(String newWidgetGridRow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__WIDGET_GRID_ROW, oldWidgetGridRow, widgetGridRow));
	}
    ...
    public void setWidgetGridColumn(String newWidgetGridColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN, oldWidgetGridColumn, widgetGridColumn));
	}
    ...
    public void setGap(String newGap) {
		...
		gap = newGap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__GAP, oldGap, gap));
	}
    ...
    public UserColor getBackgroundColor() {
		if (backgroundColor != null && backgroundColor.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.DATE_TIME_DESCRIPTION_STYLE__BACKGROUND_COLOR, oldBackgroundColor, backgroundColor));
			}
		}
    ...
    public void setBackgroundColor(UserColor newBackgroundColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__BACKGROUND_COLOR, oldBackgroundColor, backgroundColor));
	}
    ...
    public UserColor getForegroundColor() {
		if (foregroundColor != null && foregroundColor.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.DATE_TIME_DESCRIPTION_STYLE__FOREGROUND_COLOR, oldForegroundColor, foregroundColor));
			}
		}
    ...
    public void setForegroundColor(UserColor newForegroundColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__FOREGROUND_COLOR, oldForegroundColor, foregroundColor));
	}
    ...
    public void setItalic(boolean newItalic) {
		...
		italic = newItalic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__ITALIC, oldItalic, italic));
	}
    ...
    public void setBold(boolean newBold) {
		...
		bold = newBold;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TIME_DESCRIPTION_STYLE__BOLD, oldBold, bold));
	}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID)
		{
			case FormPackage.DATE_TIME_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS:
				return getGridTemplateColumns();
			case FormPackage.DATE_TIME_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS:
				return getGridTemplateRows();
			case FormPackage.DATE_TIME_DESCRIPTION_STYLE__LABEL_GRID_ROW:
				return getLabelGridRow();
			case FormPackage.DATE_TIME_DESCRIPTION_STYLE__LABEL_GRID_COLUMN:
				return getLabelGridColumn();
			case FormPackage.DATE_TIME_DESCRIPTION_STYLE__WIDGET_GRID_ROW:
				return getWidgetGridRow();
			case FormPackage.DATE_TIME_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN:
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == WidgetGridLayout.class)
		{
			...
			{
				case FormPackage.DATE_TIME_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS: return FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_COLUMNS;
				case FormPackage.DATE_TIME_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS: return FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_ROWS;
				case FormPackage.DATE_TIME_DESCRIPTION_STYLE__LABEL_GRID_ROW: return FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_ROW;
				case FormPackage.DATE_TIME_DESCRIPTION_STYLE__LABEL_GRID_COLUMN: return FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_COLUMN;
				case FormPackage.DATE_TIME_DESCRIPTION_STYLE__WIDGET_GRID_ROW: return FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_ROW;
				case FormPackage.DATE_TIME_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN: return FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_COLUMN;
				case FormPackage.DATE_TIME_DESCRIPTION_STYLE__GAP: return FormPackage.WIDGET_GRID_LAYOUT__GAP;
				default: return -1;
			}
		}
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == WidgetGridLayout.class)
		{
			...
			{
				case FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_COLUMNS: return FormPackage.DATE_TIME_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS;
				case FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_ROWS: return FormPackage.DATE_TIME_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS;
				case FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_ROW: return FormPackage.DATE_TIME_DESCRIPTION_STYLE__LABEL_GRID_ROW;
				case FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_COLUMN: return FormPackage.DATE_TIME_DESCRIPTION_STYLE__LABEL_GRID_COLUMN;
				case FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_ROW: return FormPackage.DATE_TIME_DESCRIPTION_STYLE__WIDGET_GRID_ROW;
				case FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_COLUMN: return FormPackage.DATE_TIME_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN;
				case FormPackage.WIDGET_GRID_LAYOUT__GAP: return FormPackage.DATE_TIME_DESCRIPTION_STYLE__GAP;
				default: return -1;
			}
		}
