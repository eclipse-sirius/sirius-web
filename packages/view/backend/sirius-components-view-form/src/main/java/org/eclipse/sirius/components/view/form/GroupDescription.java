 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.form.GroupDescription#getName <em>Name</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.GroupDescription#getLabelExpression <em>Label
 * Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.GroupDescription#getDisplayMode <em>Display Mode</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.GroupDescription#getSemanticCandidatesExpression <em>Semantic
 * Candidates Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.GroupDescription#getToolbarActions <em>Toolbar Actions</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.GroupDescription#getWidgets <em>Widgets</em>}</li>
 * </ul>
 *
 * @see org.eclipse.sirius.components.view.form.FormPackage#getGroupDescription()
 * @model
 * @generated
 */
public interface GroupDescription extends EObject {
     ...
     * @see org.eclipse.sirius.components.view.form.FormPackage#getGroupDescription_LabelExpression()
     ...
     * literals are from the enumeration {@link org.eclipse.sirius.components.view.form.GroupDisplayMode}. <!--
     ...
     * @see org.eclipse.sirius.components.view.form.FormPackage#getGroupDescription_DisplayMode()
     ...
     * @see org.eclipse.sirius.components.view.form.FormPackage#getGroupDescription_ToolbarActions()
