 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getFontSize <em>Font
 * Size</em>}</li>
 ...
 * <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#isUnderline
 * <em>Underline</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#isStrikeThrough <em>Strike
 * Through</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getGridTemplateColumns <em>Grid
 * Template Columns</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getGridTemplateRows <em>Grid
 * Template Rows</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getLabelGridRow <em>Label Grid
 * Row</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getLabelGridColumn <em>Label
 * Grid Column</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getWidgetGridRow <em>Widget Grid
 * Row</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getWidgetGridColumn <em>Widget
 * Grid Column</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getGap <em>Gap</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getBackgroundColor
 * <em>Background Color</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getForegroundColor
...
public class TextareaDescriptionStyleImpl extends WidgetDescriptionStyleImpl implements TextareaDescriptionStyle {
    ...
    public void setFontSize(int newFontSize) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__FONT_SIZE, oldFontSize, this.fontSize));
    }
    ...
    public void setItalic(boolean newItalic) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__ITALIC, oldItalic, this.italic));
    }
    ...
    public void setBold(boolean newBold) {
        ...
        this.bold = newBold;
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__BOLD, oldBold, this.bold));
    }
    ...
    public void setUnderline(boolean newUnderline) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__UNDERLINE, oldUnderline, this.underline));
    }
    ...
    public void setStrikeThrough(boolean newStrikeThrough) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__STRIKE_THROUGH, oldStrikeThrough, this.strikeThrough));
    }
    ...
    public void setGridTemplateColumns(String newGridTemplateColumns) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS, oldGridTemplateColumns, this.gridTemplateColumns));
    }
    ...
    public void setGridTemplateRows(String newGridTemplateRows) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS, oldGridTemplateRows, this.gridTemplateRows));
    }
    ...
    public void setLabelGridRow(String newLabelGridRow) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__LABEL_GRID_ROW, oldLabelGridRow, this.labelGridRow));
    }
    ...
    public void setLabelGridColumn(String newLabelGridColumn) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__LABEL_GRID_COLUMN, oldLabelGridColumn, this.labelGridColumn));
    }
    ...
    public void setWidgetGridRow(String newWidgetGridRow) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__WIDGET_GRID_ROW, oldWidgetGridRow, this.widgetGridRow));
    }
    ...
    public void setWidgetGridColumn(String newWidgetGridColumn) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN, oldWidgetGridColumn, this.widgetGridColumn));
    }
    ...
    public void setGap(String newGap) {
        ...
        this.gap = newGap;
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__GAP, oldGap, this.gap));
    }
    ...
    public UserColor getBackgroundColor() {
        if (this.backgroundColor != null && this.backgroundColor.eIsProxy()) {
            ...
            if (this.backgroundColor != oldBackgroundColor) {
                if (this.eNotificationRequired())
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.TEXTAREA_DESCRIPTION_STYLE__BACKGROUND_COLOR, oldBackgroundColor, this.backgroundColor));
            }
        }
    ...
    public void setBackgroundColor(UserColor newBackgroundColor) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__BACKGROUND_COLOR, oldBackgroundColor, this.backgroundColor));
    }
    ...
    public UserColor getForegroundColor() {
        if (this.foregroundColor != null && this.foregroundColor.eIsProxy()) {
            ...
            if (this.foregroundColor != oldForegroundColor) {
                if (this.eNotificationRequired())
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.TEXTAREA_DESCRIPTION_STYLE__FOREGROUND_COLOR, oldForegroundColor, this.foregroundColor));
            }
        }
    ...
    public void setForegroundColor(UserColor newForegroundColor) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__FOREGROUND_COLOR, oldForegroundColor, this.foregroundColor));
    }
        ...
        if (baseClass == LabelStyle.class) {
            switch (baseFeatureID) {
                case ViewPackage.LABEL_STYLE__FONT_SIZE:
                    return FormPackage.TEXTAREA_DESCRIPTION_STYLE__FONT_SIZE;
                case ViewPackage.LABEL_STYLE__ITALIC:
                    return FormPackage.TEXTAREA_DESCRIPTION_STYLE__ITALIC;
                case ViewPackage.LABEL_STYLE__BOLD:
                    return FormPackage.TEXTAREA_DESCRIPTION_STYLE__BOLD;
                case ViewPackage.LABEL_STYLE__UNDERLINE:
                    return FormPackage.TEXTAREA_DESCRIPTION_STYLE__UNDERLINE;
                case ViewPackage.LABEL_STYLE__STRIKE_THROUGH:
                    return FormPackage.TEXTAREA_DESCRIPTION_STYLE__STRIKE_THROUGH;
                default:
                    return -1;
            }
        }
        if (baseClass == WidgetGridLayout.class) {
            switch (baseFeatureID) {
                case FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_COLUMNS:
                    return FormPackage.TEXTAREA_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS;
                case FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_ROWS:
                    return FormPackage.TEXTAREA_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS;
                case FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_ROW:
                    return FormPackage.TEXTAREA_DESCRIPTION_STYLE__LABEL_GRID_ROW;
                case FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_COLUMN:
                    return FormPackage.TEXTAREA_DESCRIPTION_STYLE__LABEL_GRID_COLUMN;
                case FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_ROW:
                    return FormPackage.TEXTAREA_DESCRIPTION_STYLE__WIDGET_GRID_ROW;
                case FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_COLUMN:
                    return FormPackage.TEXTAREA_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN;
                case FormPackage.WIDGET_GRID_LAYOUT__GAP:
                    return FormPackage.TEXTAREA_DESCRIPTION_STYLE__GAP;
                default:
                    return -1;
            }
        }
