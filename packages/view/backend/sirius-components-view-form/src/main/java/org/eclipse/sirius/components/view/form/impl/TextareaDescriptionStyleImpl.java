 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getFontSize <em>Font Size</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#isItalic <em>Italic</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#isBold <em>Bold</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#isUnderline <em>Underline</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#isStrikeThrough <em>Strike Through</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getGridTemplateColumns <em>Grid Template Columns</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getGridTemplateRows <em>Grid Template Rows</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getLabelGridRow <em>Label Grid Row</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getLabelGridColumn <em>Label Grid Column</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getWidgetGridRow <em>Widget Grid Row</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getWidgetGridColumn <em>Widget Grid Column</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getGap <em>Gap</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getBackgroundColor <em>Background Color</em>}</li>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.TextareaDescriptionStyleImpl#getForegroundColor <em>Foreground Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TextareaDescriptionStyleImpl extends WidgetDescriptionStyleImpl implements TextareaDescriptionStyle {
    ...
    protected EClass eStaticClass() {
		return FormPackage.Literals.TEXTAREA_DESCRIPTION_STYLE;
	}
    ...
    public void setFontSize(int newFontSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__FONT_SIZE, oldFontSize, fontSize));
	}
    ...
    public void setItalic(boolean newItalic) {
		...
		italic = newItalic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__ITALIC, oldItalic, italic));
	}
    ...
    public void setBold(boolean newBold) {
		...
		bold = newBold;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__BOLD, oldBold, bold));
	}
    ...
    public void setUnderline(boolean newUnderline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__UNDERLINE, oldUnderline, underline));
	}
    ...
    public void setStrikeThrough(boolean newStrikeThrough) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__STRIKE_THROUGH, oldStrikeThrough, strikeThrough));
	}
    ...
    public void setGridTemplateColumns(String newGridTemplateColumns) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS, oldGridTemplateColumns, gridTemplateColumns));
	}
    ...
    public void setGridTemplateRows(String newGridTemplateRows) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS, oldGridTemplateRows, gridTemplateRows));
	}
    ...
    public void setLabelGridRow(String newLabelGridRow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__LABEL_GRID_ROW, oldLabelGridRow, labelGridRow));
	}
    ...
    public void setLabelGridColumn(String newLabelGridColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__LABEL_GRID_COLUMN, oldLabelGridColumn, labelGridColumn));
	}
    ...
    public void setWidgetGridRow(String newWidgetGridRow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__WIDGET_GRID_ROW, oldWidgetGridRow, widgetGridRow));
	}
    ...
    public void setWidgetGridColumn(String newWidgetGridColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN, oldWidgetGridColumn, widgetGridColumn));
	}
    ...
    public void setGap(String newGap) {
		...
		gap = newGap;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__GAP, oldGap, gap));
	}
    ...
    public UserColor getBackgroundColor() {
		if (backgroundColor != null && backgroundColor.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.TEXTAREA_DESCRIPTION_STYLE__BACKGROUND_COLOR, oldBackgroundColor, backgroundColor));
			}
		}
    ...
    public void setBackgroundColor(UserColor newBackgroundColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__BACKGROUND_COLOR, oldBackgroundColor, backgroundColor));
	}
    ...
    public UserColor getForegroundColor() {
		if (foregroundColor != null && foregroundColor.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FormPackage.TEXTAREA_DESCRIPTION_STYLE__FOREGROUND_COLOR, oldForegroundColor, foregroundColor));
			}
		}
    ...
    public void setForegroundColor(UserColor newForegroundColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.TEXTAREA_DESCRIPTION_STYLE__FOREGROUND_COLOR, oldForegroundColor, foregroundColor));
	}
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID)
		{
			case FormPackage.TEXTAREA_DESCRIPTION_STYLE__FONT_SIZE:
				return getFontSize();
			case FormPackage.TEXTAREA_DESCRIPTION_STYLE__ITALIC:
				return isItalic();
			case FormPackage.TEXTAREA_DESCRIPTION_STYLE__BOLD:
				return isBold();
			case FormPackage.TEXTAREA_DESCRIPTION_STYLE__UNDERLINE:
				return isUnderline();
			case FormPackage.TEXTAREA_DESCRIPTION_STYLE__STRIKE_THROUGH:
				return isStrikeThrough();
			case FormPackage.TEXTAREA_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS:
				return getGridTemplateColumns();
			case FormPackage.TEXTAREA_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS:
				return getGridTemplateRows();
			case FormPackage.TEXTAREA_DESCRIPTION_STYLE__LABEL_GRID_ROW:
				return getLabelGridRow();
			case FormPackage.TEXTAREA_DESCRIPTION_STYLE__LABEL_GRID_COLUMN:
				return getLabelGridColumn();
			case FormPackage.TEXTAREA_DESCRIPTION_STYLE__WIDGET_GRID_ROW:
				return getWidgetGridRow();
			case FormPackage.TEXTAREA_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN:
				return getWidgetGridColumn();
			case FormPackage.TEXTAREA_DESCRIPTION_STYLE__GAP:
				return getGap();
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == LabelStyle.class)
		{
			...
			{
				case FormPackage.TEXTAREA_DESCRIPTION_STYLE__FONT_SIZE: return ViewPackage.LABEL_STYLE__FONT_SIZE;
				case FormPackage.TEXTAREA_DESCRIPTION_STYLE__ITALIC: return ViewPackage.LABEL_STYLE__ITALIC;
				case FormPackage.TEXTAREA_DESCRIPTION_STYLE__BOLD: return ViewPackage.LABEL_STYLE__BOLD;
				case FormPackage.TEXTAREA_DESCRIPTION_STYLE__UNDERLINE: return ViewPackage.LABEL_STYLE__UNDERLINE;
				case FormPackage.TEXTAREA_DESCRIPTION_STYLE__STRIKE_THROUGH: return ViewPackage.LABEL_STYLE__STRIKE_THROUGH;
				default: return -1;
			}
		}
		if (baseClass == WidgetGridLayout.class)
		{
			switch (derivedFeatureID)
			{
				case FormPackage.TEXTAREA_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS: return FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_COLUMNS;
				case FormPackage.TEXTAREA_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS: return FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_ROWS;
				case FormPackage.TEXTAREA_DESCRIPTION_STYLE__LABEL_GRID_ROW: return FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_ROW;
				case FormPackage.TEXTAREA_DESCRIPTION_STYLE__LABEL_GRID_COLUMN: return FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_COLUMN;
				case FormPackage.TEXTAREA_DESCRIPTION_STYLE__WIDGET_GRID_ROW: return FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_ROW;
				case FormPackage.TEXTAREA_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN: return FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_COLUMN;
				case FormPackage.TEXTAREA_DESCRIPTION_STYLE__GAP: return FormPackage.WIDGET_GRID_LAYOUT__GAP;
				default: return -1;
			}
		}
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == LabelStyle.class)
		{
			...
			{
				case ViewPackage.LABEL_STYLE__FONT_SIZE: return FormPackage.TEXTAREA_DESCRIPTION_STYLE__FONT_SIZE;
				case ViewPackage.LABEL_STYLE__ITALIC: return FormPackage.TEXTAREA_DESCRIPTION_STYLE__ITALIC;
				case ViewPackage.LABEL_STYLE__BOLD: return FormPackage.TEXTAREA_DESCRIPTION_STYLE__BOLD;
				case ViewPackage.LABEL_STYLE__UNDERLINE: return FormPackage.TEXTAREA_DESCRIPTION_STYLE__UNDERLINE;
				case ViewPackage.LABEL_STYLE__STRIKE_THROUGH: return FormPackage.TEXTAREA_DESCRIPTION_STYLE__STRIKE_THROUGH;
				default: return -1;
			}
		}
		if (baseClass == WidgetGridLayout.class)
		{
			switch (baseFeatureID)
			{
				case FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_COLUMNS: return FormPackage.TEXTAREA_DESCRIPTION_STYLE__GRID_TEMPLATE_COLUMNS;
				case FormPackage.WIDGET_GRID_LAYOUT__GRID_TEMPLATE_ROWS: return FormPackage.TEXTAREA_DESCRIPTION_STYLE__GRID_TEMPLATE_ROWS;
				case FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_ROW: return FormPackage.TEXTAREA_DESCRIPTION_STYLE__LABEL_GRID_ROW;
				case FormPackage.WIDGET_GRID_LAYOUT__LABEL_GRID_COLUMN: return FormPackage.TEXTAREA_DESCRIPTION_STYLE__LABEL_GRID_COLUMN;
				case FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_ROW: return FormPackage.TEXTAREA_DESCRIPTION_STYLE__WIDGET_GRID_ROW;
				case FormPackage.WIDGET_GRID_LAYOUT__WIDGET_GRID_COLUMN: return FormPackage.TEXTAREA_DESCRIPTION_STYLE__WIDGET_GRID_COLUMN;
				case FormPackage.WIDGET_GRID_LAYOUT__GAP: return FormPackage.TEXTAREA_DESCRIPTION_STYLE__GAP;
				default: return -1;
			}
		}
