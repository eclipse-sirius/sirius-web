...
public enum FlexDirection implements Enumerator {
    ...
    /**
	 * The '<em><b>Row Reverse</b></em>' literal object.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * The '<em><b>Column Reverse</b></em>' literal object.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
    ...
    /**
	 * The '<em><b>Row Reverse</b></em>' literal value.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #ROW_REVERSE
    ...
    /**
	 * The '<em><b>Column Reverse</b></em>' literal value.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #COLUMN_REVERSE
    ...
    /**
	 * An array of all the '<em><b>Flex Direction</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    private static final FlexDirection[] VALUES_ARRAY = new FlexDirection[]
		{
			ROW,
			ROW_REVERSE,
			COLUMN,
    ...
    /**
	 * A public read-only list of all the '<em><b>Flex Direction</b></em>' enumerators.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @generated
	 */
    ...
    /**
	 * Returns the '<em><b>Flex Direction</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    /**
	 * Returns the '<em><b>Flex Direction</b></em>' literal with the specified name.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
    ...
    /**
	 * Returns the '<em><b>Flex Direction</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
    ...
    public static FlexDirection get(int value) {
		switch (value)
		{
			...
			case ROW_REVERSE_VALUE: return ROW_REVERSE;
			case COLUMN_VALUE: return COLUMN;
			case COLUMN_REVERSE_VALUE: return COLUMN_REVERSE;
		}
		return null;
	}
