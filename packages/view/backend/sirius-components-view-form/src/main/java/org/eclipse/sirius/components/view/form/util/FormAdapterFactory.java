...
public class FormAdapterFactory extends AdapterFactoryImpl {
    ...
    protected FormSwitch<Adapter> modelSwitch = new FormSwitch<>() {
        ...
        @Override
        public Adapter caseWidgetFlexboxLayout(WidgetFlexboxLayout object) {
            return FormAdapterFactory.this.createWidgetFlexboxLayoutAdapter();
        }
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.form.WidgetFlexboxLayout
     * <em>Widget Flexbox Layout</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
     * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
     * end-user-doc -->
     *
     * @return the new adapter.
     ...
     * @generated
     */
    public Adapter createWidgetFlexboxLayoutAdapter() {
        return null;
    }
