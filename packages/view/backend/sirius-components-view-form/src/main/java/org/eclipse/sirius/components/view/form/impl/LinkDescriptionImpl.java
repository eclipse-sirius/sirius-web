...
public class LinkDescriptionImpl extends WidgetDescriptionImpl implements LinkDescription {
    ...
    public void setValueExpression(String newValueExpression) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.LINK_DESCRIPTION__VALUE_EXPRESSION, oldValueExpression, this.valueExpression));
    }
    ...
    public void setStyle(LinkDescriptionStyle newStyle) {
        if (newStyle != this.style) {
            ...
            if (this.style != null)
                msgs = ((InternalEObject) this.style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FormPackage.LINK_DESCRIPTION__STYLE, null, msgs);
            if (newStyle != null)
            ...
            this.eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.LINK_DESCRIPTION__STYLE, newStyle, newStyle));
    }
    ...
    public EList<ConditionalLinkDescriptionStyle> getConditionalStyles() {
        if (this.conditionalStyles == null) {
            this.conditionalStyles = new EObjectContainmentEList<>(ConditionalLinkDescriptionStyle.class, this, FormPackage.LINK_DESCRIPTION__CONDITIONAL_STYLES);
        }
