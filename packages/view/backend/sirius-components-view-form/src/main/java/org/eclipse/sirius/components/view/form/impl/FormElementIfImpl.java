 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.components.view.form.impl.FormElementIfImpl#getPredicateExpression <em>Predicate Expression</em>}</li>
...
public class FormElementIfImpl extends FormElementDescriptionImpl implements FormElementIf {
    ...
    public void setPredicateExpression(String newPredicateExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORM_ELEMENT_IF__PREDICATE_EXPRESSION, oldPredicateExpression, predicateExpression));
	}
    ...
    public EList<FormElementDescription> getChildren() {
		if (children == null)
		{
			children = new EObjectContainmentEList<FormElementDescription>(FormElementDescription.class, this, FormPackage.FORM_ELEMENT_IF__CHILDREN);
		}
		return children;
	}
