...
public class RadioDescriptionImpl extends WidgetDescriptionImpl implements RadioDescription {
    ...
    public void setValueExpression(String newValueExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.RADIO_DESCRIPTION__VALUE_EXPRESSION, oldValueExpression, valueExpression));
	}
    ...
    public void setCandidatesExpression(String newCandidatesExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.RADIO_DESCRIPTION__CANDIDATES_EXPRESSION, oldCandidatesExpression, candidatesExpression));
	}
    ...
    public void setCandidateLabelExpression(String newCandidateLabelExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.RADIO_DESCRIPTION__CANDIDATE_LABEL_EXPRESSION, oldCandidateLabelExpression, candidateLabelExpression));
	}
    ...
    public EList<Operation> getBody() {
		if (body == null)
		{
			body = new EObjectContainmentEList<Operation>(Operation.class, this, FormPackage.RADIO_DESCRIPTION__BODY);
		}
		return body;
	}
    ...
    public NotificationChain basicSetStyle(RadioDescriptionStyle newStyle, NotificationChain msgs) {
		RadioDescriptionStyle oldStyle = style;
		style = newStyle;
		if (eNotificationRequired())
		{
    ...
    public void setStyle(RadioDescriptionStyle newStyle) {
		if (newStyle != style)
		{
			...
			if (style != null)
				msgs = ((InternalEObject)style).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FormPackage.RADIO_DESCRIPTION__STYLE, null, msgs);
			if (newStyle != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.RADIO_DESCRIPTION__STYLE, newStyle, newStyle));
	}
    ...
    public EList<ConditionalRadioDescriptionStyle> getConditionalStyles() {
		...
		{
			conditionalStyles = new EObjectContainmentEList<ConditionalRadioDescriptionStyle>(ConditionalRadioDescriptionStyle.class, this, FormPackage.RADIO_DESCRIPTION__CONDITIONAL_STYLES);
		}
    ...
    public void setIsEnabledExpression(String newIsEnabledExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.RADIO_DESCRIPTION__IS_ENABLED_EXPRESSION, oldIsEnabledExpression, isEnabledExpression));
	}
    ...
    public void eSet(int featureID, Object newValue) {
		switch (featureID)
		{
			...
			case FormPackage.RADIO_DESCRIPTION__BODY:
				...
				return;
			case FormPackage.RADIO_DESCRIPTION__STYLE:
				setStyle((RadioDescriptionStyle)newValue);
				return;
			case FormPackage.RADIO_DESCRIPTION__CONDITIONAL_STYLES:
				getConditionalStyles().clear();
				getConditionalStyles().addAll((Collection<? extends ConditionalRadioDescriptionStyle>)newValue);
				return;
			case FormPackage.RADIO_DESCRIPTION__IS_ENABLED_EXPRESSION:
    ...
    public void eUnset(int featureID) {
		switch (featureID)
		{
			...
			case FormPackage.RADIO_DESCRIPTION__BODY:
				...
				return;
			case FormPackage.RADIO_DESCRIPTION__STYLE:
				setStyle((RadioDescriptionStyle)null);
				return;
			case FormPackage.RADIO_DESCRIPTION__CONDITIONAL_STYLES:
				getConditionalStyles().clear();
				return;
