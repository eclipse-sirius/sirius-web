...
/**
 * Service to handle collapse element tool execution.
 *
 * @author mcharfadi
 */
@Service
public class CollapseElementToolHandler implements ISingleClickOnOneDiagramElementHandler {

    public static final String COLLASPSE_ELEMENT_TOOL_ID = "collapse";
    ...
    public boolean canHandle(IEditingContext editingContext, DiagramContext diagramContext, String toolId, String diagramElementId) {
        return CollapseElementToolHandler.COLLASPSE_ELEMENT_TOOL_ID.equals(toolId);
    }
    ...
    public IStatus execute(IEditingContext editingContext, DiagramContext diagramContext, String toolId, String diagramElementId, List<ToolVariable> variables) {
        diagramContext.diagramEvents().add(new UpdateCollapsingStateEvent(diagramElementId, CollapsingState.COLLAPSED));
        return new Success();
    }
}
