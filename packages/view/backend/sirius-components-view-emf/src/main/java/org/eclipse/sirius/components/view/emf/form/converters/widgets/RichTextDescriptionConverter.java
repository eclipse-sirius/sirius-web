...
public class RichTextDescriptionConverter implements IWidgetDescriptionConverter {
    ...
    public RichTextDescriptionConverter(IObjectService objectService, IOperationExecutor operationExecutor, IFeedbackMessageService feedbackMessageService, IFormIdProvider widgetIdProvider) {
