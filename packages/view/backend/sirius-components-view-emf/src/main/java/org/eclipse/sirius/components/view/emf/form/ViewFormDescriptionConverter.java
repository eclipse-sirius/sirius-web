...
public class ViewFormDescriptionConverter implements IRepresentationDescriptionConverter {
    ...
    public ViewFormDescriptionConverter(IObjectService objectService, ILabelService labelService, IEditService editService, IFormIdProvider formIdProvider, List<IWidgetConverterProvider> customWidgetConverterProviders, IFeedbackMessageService feedbackMessageService) {
    ...
    public IRepresentationDescription convert(RepresentationDescription representationDescription, List<RepresentationDescription> allRepresentationDescriptions, AQLInterpreter interpreter) {
        ...
        Switch<Optional<AbstractControlDescription>> dispatcher = new ViewFormDescriptionConverterSwitch(interpreter, this.editService, this.objectService, this.labelService, new ComposedSwitch<>(widgetConverters),
