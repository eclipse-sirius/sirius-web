...
public class CheckboxDescriptionConverter {
    ...
    public CheckboxDescriptionConverter(AQLInterpreter interpreter, IObjectService objectService, IEditService editService, IFeedbackMessageService feedbackMessageService, IFormIdProvider widgetIdProvider) {
    ...
    public CheckboxDescription convert(org.eclipse.sirius.components.view.form.CheckboxDescription viewCheckboxDescription) {
        ...
        return CheckboxDescription.newCheckboxDescription(descriptionId)
                ...
                .newValueHandler(new NewValueHandler<>(this.interpreter, this.editService, this.feedbackMessageService, viewCheckboxDescription.getBody()))
