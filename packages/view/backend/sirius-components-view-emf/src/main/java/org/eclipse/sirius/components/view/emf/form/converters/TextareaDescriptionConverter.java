...
public class TextareaDescriptionConverter {
    ...
    public TextareaDescriptionConverter(AQLInterpreter interpreter, IObjectService objectService, IEditService editService, IFeedbackMessageService feedbackMessageService, IFormIdProvider widgetIdProvider) {
    ...
    public TextareaDescription convert(TextAreaDescription viewTextAreaDescription) {
        ...
        return TextareaDescription.newTextareaDescription(descriptionId)
                ...
                .newValueHandler(new NewValueHandler<>(this.interpreter, this.editService, this.feedbackMessageService, viewTextAreaDescription.getBody()))
