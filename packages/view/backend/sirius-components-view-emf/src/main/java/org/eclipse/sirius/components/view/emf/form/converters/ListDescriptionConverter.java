 ...
 * @author sbegaudeau
 */
public class ListDescriptionConverter {
    ...
    public ListDescription convert(org.eclipse.sirius.components.view.form.ListDescription viewListDescription) {
        ...
        return ListDescription.newListDescription(descriptionId)
                .idProvider(new WidgetIdProvider())
                .targetObjectIdProvider(new TargetObjectIdProvider(this.objectService))
                .labelProvider(new StringValueProvider(this.interpreter, viewListDescription.getLabelExpression()))
                .isReadOnlyProvider(new ReadOnlyValueProvider(this.interpreter, viewListDescription.getIsEnabledExpression()))
                .itemsProvider(new MultiValueProvider(this.interpreter, viewListDescription.getValueExpression(), Object.class))
                ...
                .itemLabelProvider(new StringValueProvider(this.interpreter, viewListDescription.getDisplayExpression()))
                .itemDeletableProvider(new BooleanValueProvider(this.interpreter, viewListDescription.getIsDeletableExpression()))
