...
public class CheckboxDescriptionConverter implements IWidgetDescriptionConverter {
    ...
    public CheckboxDescriptionConverter(IIdentityService identityService, IOperationExecutor operationExecutor, IFeedbackMessageService feedbackMessageService, IFormIdProvider widgetIdProvider) {
