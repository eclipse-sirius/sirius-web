...
public class SingleClickOnOneDiagramElementVariableManagerProvider implements ISingleClickOnOneDiagramElementVariableManagerProvider {
    ...
    public SingleClickOnOneDiagramElementVariableManagerProvider(IObjectSearchService objectSearchService, IDiagramQueryService diagramQueryService, IToolVariableHandler toolVariableHandler, IOperationValidator operationValidator) {
