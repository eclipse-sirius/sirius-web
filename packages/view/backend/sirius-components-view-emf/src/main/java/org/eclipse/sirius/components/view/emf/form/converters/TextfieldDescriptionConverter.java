...
public class TextfieldDescriptionConverter {
    ...
    public TextfieldDescriptionConverter(AQLInterpreter interpreter, IObjectService objectService, IOperationExecutor operationExecutor, IFeedbackMessageService feedbackMessageService, IFormIdProvider widgetIdProvider) {
    ...
    public TextfieldDescription convert(org.eclipse.sirius.components.view.form.TextfieldDescription viewTextfieldDescription) {
        ...
        return TextfieldDescription.newTextfieldDescription(descriptionId)
                ...
                .newValueHandler(new NewValueHandler<>(this.interpreter, this.operationExecutor, this.feedbackMessageService, viewTextfieldDescription.getBody()))
