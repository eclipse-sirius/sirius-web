...
/**
 * Service to handle fade element tool execution.
 *
 * @author mcharfadi
 */
@Service
public class FadeElementToolHandler implements ISingleClickOnOneDiagramElementHandler, ISingleClickOnMultipleDiagramElementHandler {

    public static final String FADE_ELEMENT_TOOL_ID = "fade";
    ...
    public boolean canHandle(IEditingContext editingContext, DiagramContext diagramContext, String toolId, String diagramElementId) {
        return FadeElementToolHandler.FADE_ELEMENT_TOOL_ID.equals(toolId);
    }
    ...
    public IStatus execute(IEditingContext editingContext, DiagramContext diagramContext, String toolId, String diagramElementId, List<ToolVariable> variables) {
        diagramContext.diagramEvents().add(new FadeDiagramElementEvent(Set.of(diagramElementId), true));
        return new Success();
    }
    ...
    public IStatus execute(IEditingContext editingContext, DiagramContext diagramContext, String toolId, List<String> diagramElementIds, List<ToolVariable> variables) {
        ...
        diagramContext.diagramEvents().add(new FadeDiagramElementEvent(targetSet, true));
        return new Success();
    }
}
