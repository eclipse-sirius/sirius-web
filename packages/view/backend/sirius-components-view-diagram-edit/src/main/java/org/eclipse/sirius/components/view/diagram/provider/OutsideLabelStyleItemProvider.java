...
public class OutsideLabelStyleItemProvider extends LabelStyleItemProvider {
    ...
    /**
	 * This returns OutsideLabelStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OutsideLabelStyle"));
	}
    ...
    public String getText(Object object) {
		...
		return getString("_UI_OutsideLabelStyle_type") + " " + outsideLabelStyle.getFontSize();
	}
