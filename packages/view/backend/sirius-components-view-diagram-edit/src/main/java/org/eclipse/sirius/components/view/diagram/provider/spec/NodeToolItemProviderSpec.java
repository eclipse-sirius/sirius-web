 ...
 * @author lfasani
 */
public class NodeToolItemProviderSpec extends NodeToolItemProvider {
    public NodeToolItemProviderSpec(AdapterFactory adapterFactory) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        new ToolItemProviderSpec(this.adapterFactory).collectNewChildDescriptors(newChildDescriptors, object);
