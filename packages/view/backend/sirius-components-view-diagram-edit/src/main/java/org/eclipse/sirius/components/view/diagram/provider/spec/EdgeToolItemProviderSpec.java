...
import org.eclipse.sirius.components.view.diagram.provider.EdgeToolItemProvider;
 ...
 * @author lfasani
 */
public class EdgeToolItemProviderSpec extends EdgeToolItemProvider {
    public EdgeToolItemProviderSpec(AdapterFactory adapterFactory) {
