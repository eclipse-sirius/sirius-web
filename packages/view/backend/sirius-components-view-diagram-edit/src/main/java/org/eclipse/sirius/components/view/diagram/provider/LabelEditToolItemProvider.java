...
public class LabelEditToolItemProvider extends ToolItemProvider {
    ...
    protected void addInitialDirectEditLabelExpressionPropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                ...
                DiagramPackage.Literals.LABEL_EDIT_TOOL__INITIAL_DIRECT_EDIT_LABEL_EXPRESSION, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_LabelEditTool_type") : this.getString("_UI_LabelEditTool_type") + " " + label;
    }
