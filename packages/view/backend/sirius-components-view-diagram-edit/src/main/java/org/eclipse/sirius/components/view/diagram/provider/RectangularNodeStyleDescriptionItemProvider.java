...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.diagram.RectangularNodeStyleDescription} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RectangularNodeStyleDescriptionItemProvider extends ItemProviderAdapter
    ...
    protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NodeStyleDescription_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NodeStyleDescription_description_feature", "_UI_NodeStyleDescription_type"),
    ...
    protected void addBackgroundPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RectangularNodeStyleDescription_background_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RectangularNodeStyleDescription_background_feature", "_UI_RectangularNodeStyleDescription_type"),
    ...
    /**
	 * This returns RectangularNodeStyleDescription.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RectangularNodeStyleDescription"));
	}
    ...
    public String getText(Object object) {
		RectangularNodeStyleDescription rectangularNodeStyleDescription = (RectangularNodeStyleDescription)object;
		return getString("_UI_RectangularNodeStyleDescription_type") + " " + rectangularNodeStyleDescription.getBorderRadius();
	}
