...
public class NodeToolItemProvider extends ToolItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NodeTool_iconURLsExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NodeTool_iconURLsExpression_feature", "_UI_NodeTool_type"),
				 DiagramPackage.Literals.NODE_TOOL__ICON_UR_LS_EXPRESSION,
				 true,
				 false,
				 false,
    ...
    protected void addElementsToSelectExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NodeTool_elementsToSelectExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NodeTool_elementsToSelectExpression_feature", "_UI_NodeTool_type"),
				 DiagramPackage.Literals.NODE_TOOL__ELEMENTS_TO_SELECT_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addWithImpactAnalysisPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NodeTool_withImpactAnalysis_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NodeTool_withImpactAnalysis_feature", "_UI_NodeTool_type"),
				 DiagramPackage.Literals.NODE_TOOL__WITH_IMPACT_ANALYSIS,
				 true,
				 false,
				 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null)
		{
			...
			childrenFeatures.add(DiagramPackage.Literals.NODE_TOOL__DIALOG_DESCRIPTION);
			childrenFeatures.add(DiagramPackage.Literals.NODE_TOOL__KEY_BINDINGS);
		}
    ...
    /**
	 * This returns NodeTool.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/NodeTool"));
	}
    ...
    public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_NodeTool_type") :
			getString("_UI_NodeTool_type") + " " + label;
	}
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramPackage.Literals.NODE_TOOL__DIALOG_DESCRIPTION,
				 DiagramFactory.eINSTANCE.createSelectionDialogDescription()));

		newChildDescriptors.add
			(createChildParameter
				(DiagramPackage.Literals.NODE_TOOL__KEY_BINDINGS,
