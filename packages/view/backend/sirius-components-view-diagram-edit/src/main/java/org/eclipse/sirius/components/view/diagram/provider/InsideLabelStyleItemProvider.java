...
public class InsideLabelStyleItemProvider extends LabelStyleItemProvider {
    ...
    public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null)
		{
			...
			addShowIconExpressionPropertyDescriptor(object);
			addLabelIconPropertyDescriptor(object);
			addMaxWidthExpressionPropertyDescriptor(object);
			addWithHeaderPropertyDescriptor(object);
			addHeaderSeparatorDisplayModePropertyDescriptor(object);
		}
    ...
    protected void addLabelColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NodeLabelStyle_labelColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NodeLabelStyle_labelColor_feature", "_UI_NodeLabelStyle_type"),
				 DiagramPackage.Literals.NODE_LABEL_STYLE__LABEL_COLOR,
				 true,
				 false,
				 true,
				 null,
    ...
    protected void addLabelIconPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NodeLabelStyle_labelIcon_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NodeLabelStyle_labelIcon_feature", "_UI_NodeLabelStyle_type"),
				 DiagramPackage.Literals.NODE_LABEL_STYLE__LABEL_ICON,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addMaxWidthExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NodeLabelStyle_maxWidthExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NodeLabelStyle_maxWidthExpression_feature", "_UI_NodeLabelStyle_type"),
				 DiagramPackage.Literals.NODE_LABEL_STYLE__MAX_WIDTH_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addBackgroundPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NodeLabelStyle_background_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NodeLabelStyle_background_feature", "_UI_NodeLabelStyle_type"),
				 DiagramPackage.Literals.NODE_LABEL_STYLE__BACKGROUND,
				 true,
				 false,
				 true,
				 null,
    ...
    protected void addShowIconExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NodeLabelStyle_showIconExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NodeLabelStyle_showIconExpression_feature", "_UI_NodeLabelStyle_type"),
				 DiagramPackage.Literals.NODE_LABEL_STYLE__SHOW_ICON_EXPRESSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    protected void addWithHeaderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InsideLabelStyle_withHeader_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InsideLabelStyle_withHeader_feature", "_UI_InsideLabelStyle_type"),
				 DiagramPackage.Literals.INSIDE_LABEL_STYLE__WITH_HEADER,
				 true,
				 false,
				 false,
    ...
    /**
	 * This adds a property descriptor for the Header Separator Display Mode feature.
	 * <!-- begin-user-doc --> <!--
     * end-user-doc -->
	 * @generated
	 */
    protected void addHeaderSeparatorDisplayModePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InsideLabelStyle_headerSeparatorDisplayMode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InsideLabelStyle_headerSeparatorDisplayMode_feature", "_UI_InsideLabelStyle_type"),
				 DiagramPackage.Literals.INSIDE_LABEL_STYLE__HEADER_SEPARATOR_DISPLAY_MODE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
    ...
    /**
	 * This returns InsideLabelStyle.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
    @Override
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InsideLabelStyle"));
	}
    ...
    public String getText(Object object) {
		...
		return getString("_UI_InsideLabelStyle_type") + " " + insideLabelStyle.getFontSize();
	}
