...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.diagram.IconLabelNodeStyleDescription} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class IconLabelNodeStyleDescriptionItemProvider extends ItemProviderAdapter
    ...
    protected void addBackgroundPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IconLabelNodeStyleDescription_background_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IconLabelNodeStyleDescription_background_feature", "_UI_IconLabelNodeStyleDescription_type"),
    ...
    public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IconLabelNodeStyleDescription"));
	}
    ...
    public String getText(Object object) {
		...
		return getString("_UI_IconLabelNodeStyleDescription_type") + " " + iconLabelNodeStyleDescription.getBorderRadius();
	}
