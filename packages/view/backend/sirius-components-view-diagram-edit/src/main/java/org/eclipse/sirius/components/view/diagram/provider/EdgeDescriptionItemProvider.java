    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DiagramPackage.Literals.EDGE_DESCRIPTION__PALETTE,
				 DiagramFactory.eINSTANCE.createEdgePalette()));

		newChildDescriptors.add
			(createChildParameter
				(DiagramPackage.Literals.EDGE_DESCRIPTION__STYLE,
				 DiagramFactory.eINSTANCE.createEdgeStyle()));

		newChildDescriptors.add
			(createChildParameter
				(DiagramPackage.Literals.EDGE_DESCRIPTION__STYLE,
				 DiagramFactory.eINSTANCE.createConditionalEdgeStyle()));

		newChildDescriptors.add
			(createChildParameter
				(DiagramPackage.Literals.EDGE_DESCRIPTION__CONDITIONAL_STYLES,
				 DiagramFactory.eINSTANCE.createConditionalEdgeStyle()));
	}
