...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.components.view.diagram.Tool} object. <!--
...
public class ToolItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
    ...
    protected void addNamePropertyDescriptor(Object object) {
        this.itemPropertyDescriptors.add(this.createItemPropertyDescriptor(((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(), this.getResourceLocator(),
                this.getString("_UI_Tool_name_feature"), this.getString("_UI_PropertyDescriptor_description", "_UI_Tool_name_feature", "_UI_Tool_type"), DiagramPackage.Literals.TOOL__NAME, true,
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? this.getString("_UI_Tool_type") : this.getString("_UI_Tool_type") + " " + label;
    }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(DiagramPackage.Literals.TOOL__BODY, DiagramFactory.eINSTANCE.createCreateView()));

        newChildDescriptors.add(this.createChildParameter(DiagramPackage.Literals.TOOL__BODY, DiagramFactory.eINSTANCE.createDeleteView()));

        newChildDescriptors.add(this.createChildParameter(DiagramPackage.Literals.TOOL__BODY, ViewFactory.eINSTANCE.createChangeContext()));

        newChildDescriptors.add(this.createChildParameter(DiagramPackage.Literals.TOOL__BODY, ViewFactory.eINSTANCE.createCreateInstance()));

        newChildDescriptors.add(this.createChildParameter(DiagramPackage.Literals.TOOL__BODY, ViewFactory.eINSTANCE.createSetValue()));
