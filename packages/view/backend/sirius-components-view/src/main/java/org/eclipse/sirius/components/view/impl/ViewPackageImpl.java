...
public class ViewPackageImpl extends EPackageImpl implements ViewPackage {
    ...
    public EAttribute getRepresentationDescription_Description() {
		return (EAttribute)representationDescriptionEClass.getEStructuralFeatures().get(5);
	}
    ...
    public EAttribute getRepresentationDescription_EndUserDocumentation() {
		return (EAttribute)representationDescriptionEClass.getEStructuralFeatures().get(6);
	}
    ...
    public EAttribute getKeyBinding_Meta() {
		return (EAttribute)keyBindingEClass.getEStructuralFeatures().get(2);
	}
    ...
    public EAttribute getKeyBinding_Key() {
		return (EAttribute)keyBindingEClass.getEStructuralFeatures().get(3);
	}
    ...
    public void createPackageContents() {
		...
		createEAttribute(representationDescriptionEClass, REPRESENTATION_DESCRIPTION__DESCRIPTION);
		createEAttribute(representationDescriptionEClass, REPRESENTATION_DESCRIPTION__END_USER_DOCUMENTATION);
		...
		createEAttribute(keyBindingEClass, KEY_BINDING__CTRL);
		createEAttribute(keyBindingEClass, KEY_BINDING__ALT);
		createEAttribute(keyBindingEClass, KEY_BINDING__META);
		createEAttribute(keyBindingEClass, KEY_BINDING__KEY);
    ...
    public void initializePackageContents() {
		...
		initEAttribute(getRepresentationDescription_Description(), ecorePackage.getEString(), "description", null, 0, 1, RepresentationDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRepresentationDescription_EndUserDocumentation(), ecorePackage.getEString(), "endUserDocumentation", null, 0, 1, RepresentationDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(keyBindingEClass, KeyBinding.class, "KeyBinding", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getKeyBinding_Ctrl(), ecorePackage.getEBoolean(), "ctrl", null, 0, 1, KeyBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getKeyBinding_Alt(), ecorePackage.getEBoolean(), "alt", null, 0, 1, KeyBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getKeyBinding_Meta(), ecorePackage.getEBoolean(), "meta", null, 0, 1, KeyBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getKeyBinding_Key(), ecorePackage.getEString(), "key", null, 0, 1, KeyBinding.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
