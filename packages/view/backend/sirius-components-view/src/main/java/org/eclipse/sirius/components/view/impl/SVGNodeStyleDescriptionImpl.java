...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>SVG Node Style Description</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.impl.SVGNodeStyleDescriptionImpl#getFontSize <em>Font Size</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.SVGNodeStyleDescriptionImpl#isItalic <em>Italic</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.SVGNodeStyleDescriptionImpl#isBold <em>Bold</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.SVGNodeStyleDescriptionImpl#isUnderline <em>Underline</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.SVGNodeStyleDescriptionImpl#isStrikeThrough <em>Strike
 * Through</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.SVGNodeStyleDescriptionImpl#getBorderColor <em>Border
 * Color</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.SVGNodeStyleDescriptionImpl#getBorderRadius <em>Border
 * Radius</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.SVGNodeStyleDescriptionImpl#getBorderSize <em>Border
 * Size</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.SVGNodeStyleDescriptionImpl#getBorderLineStyle <em>Border Line
 * Style</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.SVGNodeStyleDescriptionImpl#getLabelColor <em>Label
 * Color</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.SVGNodeStyleDescriptionImpl#getSizeComputationExpression <em>Size
 * Computation Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.SVGNodeStyleDescriptionImpl#getShape <em>Shape</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SVGNodeStyleDescriptionImpl extends StyleImpl implements SVGNodeStyleDescription {
    /**
     ...
     * @generated
     */
    protected SVGNodeStyleDescriptionImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return ViewPackage.Literals.SVG_NODE_STYLE_DESCRIPTION;
    }
    ...
    public void setFontSize(int newFontSize) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.SVG_NODE_STYLE_DESCRIPTION__FONT_SIZE, oldFontSize, this.fontSize));
    }
    ...
    public void setItalic(boolean newItalic) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.SVG_NODE_STYLE_DESCRIPTION__ITALIC, oldItalic, this.italic));
    }
    ...
    public void setBold(boolean newBold) {
        ...
        this.bold = newBold;
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.SVG_NODE_STYLE_DESCRIPTION__BOLD, oldBold, this.bold));
    }
    ...
    public void setUnderline(boolean newUnderline) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.SVG_NODE_STYLE_DESCRIPTION__UNDERLINE, oldUnderline, this.underline));
    }
    ...
    public void setStrikeThrough(boolean newStrikeThrough) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.SVG_NODE_STYLE_DESCRIPTION__STRIKE_THROUGH, oldStrikeThrough, this.strikeThrough));
    }
    ...
    public void setBorderColor(String newBorderColor) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.SVG_NODE_STYLE_DESCRIPTION__BORDER_COLOR, oldBorderColor, this.borderColor));
    }
    ...
    public void setBorderRadius(int newBorderRadius) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.SVG_NODE_STYLE_DESCRIPTION__BORDER_RADIUS, oldBorderRadius, this.borderRadius));
    }
    ...
    public void setBorderSize(int newBorderSize) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.SVG_NODE_STYLE_DESCRIPTION__BORDER_SIZE, oldBorderSize, this.borderSize));
    }
    ...
    public void setBorderLineStyle(LineStyle newBorderLineStyle) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.SVG_NODE_STYLE_DESCRIPTION__BORDER_LINE_STYLE, oldBorderLineStyle, this.borderLineStyle));
    }
    ...
    public void setLabelColor(String newLabelColor) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.SVG_NODE_STYLE_DESCRIPTION__LABEL_COLOR, oldLabelColor, this.labelColor));
    }
    ...
    public void setSizeComputationExpression(String newSizeComputationExpression) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(
                    new ENotificationImpl(this, Notification.SET, ViewPackage.SVG_NODE_STYLE_DESCRIPTION__SIZE_COMPUTATION_EXPRESSION, oldSizeComputationExpression, this.sizeComputationExpression));
    }
    ...
    public void setShape(String newShape) {
        ...
        this.shape = newShape;
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.SVG_NODE_STYLE_DESCRIPTION__SHAPE, oldShape, this.shape));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ViewPackage.SVG_NODE_STYLE_DESCRIPTION__FONT_SIZE:
            return this.getFontSize();
        case ViewPackage.SVG_NODE_STYLE_DESCRIPTION__ITALIC:
            return this.isItalic();
        case ViewPackage.SVG_NODE_STYLE_DESCRIPTION__BOLD:
            return this.isBold();
        case ViewPackage.SVG_NODE_STYLE_DESCRIPTION__UNDERLINE:
            return this.isUnderline();
        case ViewPackage.SVG_NODE_STYLE_DESCRIPTION__STRIKE_THROUGH:
            return this.isStrikeThrough();
        case ViewPackage.SVG_NODE_STYLE_DESCRIPTION__BORDER_COLOR:
            return this.getBorderColor();
        case ViewPackage.SVG_NODE_STYLE_DESCRIPTION__BORDER_RADIUS:
            return this.getBorderRadius();
        case ViewPackage.SVG_NODE_STYLE_DESCRIPTION__BORDER_SIZE:
            return this.getBorderSize();
        case ViewPackage.SVG_NODE_STYLE_DESCRIPTION__BORDER_LINE_STYLE:
            return this.getBorderLineStyle();
        case ViewPackage.SVG_NODE_STYLE_DESCRIPTION__LABEL_COLOR:
            return this.getLabelColor();
        case ViewPackage.SVG_NODE_STYLE_DESCRIPTION__SIZE_COMPUTATION_EXPRESSION:
            return this.getSizeComputationExpression();
        case ViewPackage.SVG_NODE_STYLE_DESCRIPTION__SHAPE:
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == LabelStyle.class) {
            ...
            case ViewPackage.LABEL_STYLE__FONT_SIZE:
                return ViewPackage.SVG_NODE_STYLE_DESCRIPTION__FONT_SIZE;
            case ViewPackage.LABEL_STYLE__ITALIC:
                return ViewPackage.SVG_NODE_STYLE_DESCRIPTION__ITALIC;
            case ViewPackage.LABEL_STYLE__BOLD:
                return ViewPackage.SVG_NODE_STYLE_DESCRIPTION__BOLD;
            case ViewPackage.LABEL_STYLE__UNDERLINE:
                return ViewPackage.SVG_NODE_STYLE_DESCRIPTION__UNDERLINE;
            case ViewPackage.LABEL_STYLE__STRIKE_THROUGH:
                return ViewPackage.SVG_NODE_STYLE_DESCRIPTION__STRIKE_THROUGH;
            default:
                return -1;
            }
        }
        if (baseClass == BorderStyle.class) {
            ...
            case ViewPackage.BORDER_STYLE__BORDER_COLOR:
                return ViewPackage.SVG_NODE_STYLE_DESCRIPTION__BORDER_COLOR;
            case ViewPackage.BORDER_STYLE__BORDER_RADIUS:
                return ViewPackage.SVG_NODE_STYLE_DESCRIPTION__BORDER_RADIUS;
            case ViewPackage.BORDER_STYLE__BORDER_SIZE:
                return ViewPackage.SVG_NODE_STYLE_DESCRIPTION__BORDER_SIZE;
            case ViewPackage.BORDER_STYLE__BORDER_LINE_STYLE:
                return ViewPackage.SVG_NODE_STYLE_DESCRIPTION__BORDER_LINE_STYLE;
            default:
                return -1;
            }
        }
