 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.impl.EdgeToolImpl#getTargetElementDescriptions <em>Target Element
 * Descriptions</em>}</li>
 * </ul>
 *
 * @generated
...
public class EdgeToolImpl extends ToolImpl implements EdgeTool {
    ...
    protected EClass eStaticClass() {
        return ViewPackage.Literals.EDGE_TOOL;
    }
    ...
    public EList<DiagramElementDescription> getTargetElementDescriptions() {
        if (this.targetElementDescriptions == null) {
            this.targetElementDescriptions = new EObjectResolvingEList<>(DiagramElementDescription.class, this, ViewPackage.EDGE_TOOL__TARGET_ELEMENT_DESCRIPTIONS);
        }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ViewPackage.EDGE_TOOL__TARGET_ELEMENT_DESCRIPTIONS:
