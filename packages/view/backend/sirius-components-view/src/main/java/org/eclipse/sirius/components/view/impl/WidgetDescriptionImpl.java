 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.impl.WidgetDescriptionImpl#getName <em>Name</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.WidgetDescriptionImpl#getLabelExpression <em>Label
 * Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.WidgetDescriptionImpl#getValueExpression <em>Value
 * Expression</em>}</li>
 * </ul>
 *
 * @generated
...
public abstract class WidgetDescriptionImpl extends MinimalEObjectImpl.Container implements WidgetDescription {
    ...
    protected EClass eStaticClass() {
        return ViewPackage.Literals.WIDGET_DESCRIPTION;
    }
    ...
    public void setName(String newName) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.WIDGET_DESCRIPTION__NAME, oldName, this.name));
    }
    ...
    public void setLabelExpression(String newLabelExpression) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.WIDGET_DESCRIPTION__LABEL_EXPRESSION, oldLabelExpression, this.labelExpression));
    }
