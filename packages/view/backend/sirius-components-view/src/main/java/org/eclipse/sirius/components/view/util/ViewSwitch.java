...
public class ViewSwitch<T> extends Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case ViewPackage.SVG_NODE_STYLE_DESCRIPTION: {
            SVGNodeStyleDescription svgNodeStyleDescription = (SVGNodeStyleDescription) theEObject;
            T result = this.caseSVGNodeStyleDescription(svgNodeStyleDescription);
            if (result == null)
                result = this.caseNodeStyleDescription(svgNodeStyleDescription);
            if (result == null)
                result = this.caseStyle(svgNodeStyleDescription);
            if (result == null)
                result = this.caseLabelStyle(svgNodeStyleDescription);
            if (result == null)
                result = this.caseBorderStyle(svgNodeStyleDescription);
            if (result == null)
                result = this.defaultCase(theEObject);
            return result;
        }
        ...
        case ViewPackage.CONDITIONAL_NODE_STYLE: {
            ...
            if (result == null)
                result = this.caseNodeStyleDescription(conditionalNodeStyle);
            if (result == null)
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>SVG Node Style Description</em>'. <!--
     * begin-user-doc --> This implementation returns null; returning a non-null result will terminate the switch. <!--
     * end-user-doc -->
     *
     * @param object
     *            the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>SVG Node Style Description</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
    public T caseSVGNodeStyleDescription(SVGNodeStyleDescription object) {
        return null;
    }
