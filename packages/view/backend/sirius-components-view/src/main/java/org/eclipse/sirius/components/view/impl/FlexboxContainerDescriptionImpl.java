 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.impl.FlexboxContainerDescriptionImpl#getChildren
 * <em>Children</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.FlexboxContainerDescriptionImpl#getFlexDirection <em>Flex
 * Direction</em>}</li>
 * </ul>
 *
 * @generated
...
public class FlexboxContainerDescriptionImpl extends WidgetDescriptionImpl implements FlexboxContainerDescription {
    ...
    protected EClass eStaticClass() {
        return ViewPackage.Literals.FLEXBOX_CONTAINER_DESCRIPTION;
    }
    ...
    public EList<WidgetDescription> getChildren() {
        if (this.children == null) {
            this.children = new EObjectContainmentEList<>(WidgetDescription.class, this, ViewPackage.FLEXBOX_CONTAINER_DESCRIPTION__CHILDREN);
        }
    ...
    public void setFlexDirection(FlexDirection newFlexDirection) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.FLEXBOX_CONTAINER_DESCRIPTION__FLEX_DIRECTION, oldFlexDirection, this.flexDirection));
    }
