...
public class ViewFactoryImpl extends EFactoryImpl implements ViewFactory {
    ...
    public EObject create(EClass eClass) {
		switch (eClass.getClassifierID())
		{
			...
			case ViewPackage.COLOR_PALETTE: return createColorPalette();
			case ViewPackage.FIXED_COLOR: return createFixedColor();
			case ViewPackage.CHANGE_CONTEXT: return createChangeContext();
			case ViewPackage.CREATE_INSTANCE: return createCreateInstance();
			case ViewPackage.SET_VALUE: return createSetValue();
			case ViewPackage.UNSET_VALUE: return createUnsetValue();
			case ViewPackage.DELETE_ELEMENT: return createDeleteElement();
			case ViewPackage.LET: return createLet();
			case ViewPackage.IF: return createIf();
			case ViewPackage.FOR: return createFor();
			case ViewPackage.TEXT_STYLE_PALETTE: return createTextStylePalette();
			case ViewPackage.TEXT_STYLE_DESCRIPTION: return createTextStyleDescription();
			case ViewPackage.KEY_BINDING: return createKeyBinding();
			default:
