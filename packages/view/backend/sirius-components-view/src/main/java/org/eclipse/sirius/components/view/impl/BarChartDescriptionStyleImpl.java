 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.impl.BarChartDescriptionStyleImpl#getFontSize <em>Font Size</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.BarChartDescriptionStyleImpl#isItalic <em>Italic</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.BarChartDescriptionStyleImpl#isBold <em>Bold</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.BarChartDescriptionStyleImpl#isUnderline <em>Underline</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.BarChartDescriptionStyleImpl#isStrikeThrough <em>Strike
 * Through</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.BarChartDescriptionStyleImpl#getBarsColor <em>Bars
 * Color</em>}</li>
 * </ul>
 *
 * @generated
...
public class BarChartDescriptionStyleImpl extends WidgetDescriptionStyleImpl implements BarChartDescriptionStyle {
    ...
    /**
     * The default value of the '{@link #getBarsColor() <em>Bars Color</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @see #getBarsColor()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getBarsColor() <em>Bars Color</em>}' attribute. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @see #getBarsColor()
     * @generated
    ...
    protected EClass eStaticClass() {
        return ViewPackage.Literals.BAR_CHART_DESCRIPTION_STYLE;
    }
    ...
    public void setFontSize(int newFontSize) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.BAR_CHART_DESCRIPTION_STYLE__FONT_SIZE, oldFontSize, this.fontSize));
    }
    ...
    public void setItalic(boolean newItalic) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.BAR_CHART_DESCRIPTION_STYLE__ITALIC, oldItalic, this.italic));
    }
    ...
    public void setBold(boolean newBold) {
        ...
        this.bold = newBold;
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.BAR_CHART_DESCRIPTION_STYLE__BOLD, oldBold, this.bold));
    }
    ...
    public void setUnderline(boolean newUnderline) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.BAR_CHART_DESCRIPTION_STYLE__UNDERLINE, oldUnderline, this.underline));
    }
    ...
    public void setStrikeThrough(boolean newStrikeThrough) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.BAR_CHART_DESCRIPTION_STYLE__STRIKE_THROUGH, oldStrikeThrough, this.strikeThrough));
    }
    ...
    public void setBarsColor(String newBarsColor) {
        String oldBarsColor = this.barsColor;
        this.barsColor = newBarsColor;
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.BAR_CHART_DESCRIPTION_STYLE__BARS_COLOR, oldBarsColor, this.barsColor));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
        case ViewPackage.BAR_CHART_DESCRIPTION_STYLE__FONT_SIZE:
            return this.getFontSize();
        case ViewPackage.BAR_CHART_DESCRIPTION_STYLE__ITALIC:
            return this.isItalic();
        case ViewPackage.BAR_CHART_DESCRIPTION_STYLE__BOLD:
            return this.isBold();
        case ViewPackage.BAR_CHART_DESCRIPTION_STYLE__UNDERLINE:
            return this.isUnderline();
        case ViewPackage.BAR_CHART_DESCRIPTION_STYLE__STRIKE_THROUGH:
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == LabelStyle.class) {
            ...
            case ViewPackage.LABEL_STYLE__FONT_SIZE:
                return ViewPackage.BAR_CHART_DESCRIPTION_STYLE__FONT_SIZE;
            case ViewPackage.LABEL_STYLE__ITALIC:
                return ViewPackage.BAR_CHART_DESCRIPTION_STYLE__ITALIC;
            case ViewPackage.LABEL_STYLE__BOLD:
                return ViewPackage.BAR_CHART_DESCRIPTION_STYLE__BOLD;
            case ViewPackage.LABEL_STYLE__UNDERLINE:
                return ViewPackage.BAR_CHART_DESCRIPTION_STYLE__UNDERLINE;
            case ViewPackage.LABEL_STYLE__STRIKE_THROUGH:
                return ViewPackage.BAR_CHART_DESCRIPTION_STYLE__STRIKE_THROUGH;
            default:
                return -1;
            }
        }
