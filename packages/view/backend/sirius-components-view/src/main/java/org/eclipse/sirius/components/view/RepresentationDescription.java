 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.RepresentationDescription#getId <em>Id</em>}</li>
...
public interface RepresentationDescription extends EObject {
     ...
     * @see #setId(String)
     * @see org.eclipse.sirius.components.view.ViewPackage#getRepresentationDescription_Id()
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.view.RepresentationDescription#getId <em>Id</em>}'
