...
public abstract class LabelStyleImpl extends MinimalEObjectImpl.Container implements LabelStyle {
    ...
    public void setFontSize(int newFontSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.LABEL_STYLE__FONT_SIZE, oldFontSize, fontSize));
	}
    ...
    public void setItalic(boolean newItalic) {
		...
		italic = newItalic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.LABEL_STYLE__ITALIC, oldItalic, italic));
	}
    ...
    public void setBold(boolean newBold) {
		...
		bold = newBold;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.LABEL_STYLE__BOLD, oldBold, bold));
	}
    ...
    public void setUnderline(boolean newUnderline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.LABEL_STYLE__UNDERLINE, oldUnderline, underline));
	}
    ...
    public void setStrikeThrough(boolean newStrikeThrough) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.LABEL_STYLE__STRIKE_THROUGH, oldStrikeThrough, strikeThrough));
	}
