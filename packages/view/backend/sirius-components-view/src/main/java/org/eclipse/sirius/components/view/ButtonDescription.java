 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.ButtonDescription#getButtonLabelExpression <em>Button Label
 * Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.ButtonDescription#getPushExpression <em>Push Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.ButtonDescription#getImageExpression <em>Image Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.ButtonDescription#getStyle <em>Style</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.ButtonDescription#getConditionalStyles <em>Conditional
 * Styles</em>}</li>
 * </ul>
 *
 * @see org.eclipse.sirius.components.view.ViewPackage#getButtonDescription()
 * @model
 * @generated
 */
public interface ButtonDescription extends WidgetDescription {
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.view.ButtonDescription#getButtonLabelExpression
     ...
     * @see org.eclipse.sirius.components.view.ViewPackage#getButtonDescription_Body()
     ...
     * @see org.eclipse.sirius.components.view.ViewPackage#getButtonDescription_ImageExpression()
     * @model
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.view.ButtonDescription#getImageExpression <em>Image
     ...
     * @see org.eclipse.sirius.components.view.ViewPackage#getButtonDescription_Style()
     * @model containment="true"
     * @generated
     */
    ...
    /**
     * Sets the value of the '{@link org.eclipse.sirius.components.view.ButtonDescription#getStyle <em>Style</em>}'
     ...
     * of type {@link org.eclipse.sirius.components.view.ConditionalButtonDescriptionStyle}. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     *
     * @return the value of the '<em>Conditional Styles</em>' containment reference list.
     * @see org.eclipse.sirius.components.view.ViewPackage#getButtonDescription_ConditionalStyles()
     * @model containment="true"
     * @generated
     */
