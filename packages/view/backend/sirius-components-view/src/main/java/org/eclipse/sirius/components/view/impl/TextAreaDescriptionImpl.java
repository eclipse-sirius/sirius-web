...
public class TextAreaDescriptionImpl extends WidgetDescriptionImpl implements TextAreaDescription {
    ...
    protected EClass eStaticClass() {
        return ViewPackage.Literals.TEXT_AREA_DESCRIPTION;
    }
    ...
    public void setValueExpression(String newValueExpression) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.TEXT_AREA_DESCRIPTION__VALUE_EXPRESSION, oldValueExpression, this.valueExpression));
    }
    ...
    public EList<Operation> getBody() {
        if (this.body == null) {
            this.body = new EObjectContainmentEList<>(Operation.class, this, ViewPackage.TEXT_AREA_DESCRIPTION__BODY);
        }
        return this.body;
    }
