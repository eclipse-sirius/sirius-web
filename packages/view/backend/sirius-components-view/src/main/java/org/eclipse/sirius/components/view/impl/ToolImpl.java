 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.impl.ToolImpl#getName <em>Name</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.ToolImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ToolImpl extends MinimalEObjectImpl.Container implements Tool {
    ...
    protected EClass eStaticClass() {
        return ViewPackage.Literals.TOOL;
    }
    ...
    public void setName(String newName) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.TOOL__NAME, oldName, this.name));
    }
    ...
    public EList<Operation> getBody() {
        if (this.body == null) {
            this.body = new EObjectContainmentEList<>(Operation.class, this, ViewPackage.TOOL__BODY);
        }
        return this.body;
    }
