 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.components.view.impl.RichTextDescriptionImpl#getValueExpression <em>Value
 * Expression</em>}</li>
 * <li>{@link org.eclipse.sirius.components.view.impl.RichTextDescriptionImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RichTextDescriptionImpl extends WidgetDescriptionImpl implements RichTextDescription {
    ...
    protected EClass eStaticClass() {
        return ViewPackage.Literals.RICH_TEXT_DESCRIPTION;
    }
    ...
    public void setValueExpression(String newValueExpression) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.RICH_TEXT_DESCRIPTION__VALUE_EXPRESSION, oldValueExpression, this.valueExpression));
    }
    ...
    public EList<Operation> getBody() {
        if (this.body == null) {
            this.body = new EObjectContainmentEList<>(Operation.class, this, ViewPackage.RICH_TEXT_DESCRIPTION__BODY);
        }
        return this.body;
    }
