...
public interface FormDescription extends RepresentationDescription {
    /**
     * Returns the value of the '<em><b>Toolbar Buttons</b></em>' containment reference list. The list contents are of
     * type {@link org.eclipse.sirius.components.view.ButtonDescription}. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the value of the '<em>Toolbar Buttons</em>' containment reference list.
     * @see org.eclipse.sirius.components.view.ViewPackage#getFormDescription_ToolbarButtons()
     * @model containment="true"
     * @generated
     */
    EList<ButtonDescription> getToolbarButtons();
