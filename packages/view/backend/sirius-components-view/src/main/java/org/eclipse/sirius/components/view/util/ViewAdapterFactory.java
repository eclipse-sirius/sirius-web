...
public class ViewAdapterFactory extends AdapterFactoryImpl {
    ...
    protected ViewSwitch<Adapter> modelSwitch = new ViewSwitch<Adapter>()
		{
			...
			{
				return createTextStylePaletteAdapter();
			}
			@Override
			public Adapter caseTextStyleDescription(TextStyleDescription object)
			{
				return createTextStyleDescriptionAdapter();
			}
			@Override
			public Adapter caseKeyBinding(KeyBinding object)
			{
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.ColorPalette <em>Color Palette</em>}'.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.FixedColor <em>Fixed Color</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.UserColor <em>User Color</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.ChangeContext <em>Change Context</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.CreateInstance <em>Create Instance</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.UnsetValue <em>Unset Value</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.DeleteElement <em>Delete Element</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.TextStyleDescription <em>Text Style Description</em>}'.
    ...
    /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.sirius.components.view.KeyBinding <em>Key Binding</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
     * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
