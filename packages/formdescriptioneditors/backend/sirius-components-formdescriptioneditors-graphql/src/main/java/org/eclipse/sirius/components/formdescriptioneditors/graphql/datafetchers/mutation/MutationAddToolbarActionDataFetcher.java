...
/**
 * The data fetcher used to add a toolbar action from a Form Description Editor.
 *
 * @author arichard
 */
@MutationDataFetcher(type = "Mutation", field = "addToolbarAction")
public class MutationAddToolbarActionDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationAddToolbarActionDataFetcher(ObjectMapper objectMapper, IExceptionWrapper exceptionWrapper, IEditingContextDispatcher editingContextDispatcher) {
    ...
    public CompletableFuture<IPayload> get(DataFetchingEnvironment environment) throws Exception {
        ...
        var input = this.objectMapper.convertValue(argument, AddToolbarActionInput.class);
