...
/**
 * The data fetcher used to move a toolbar action from a Form Description Editor.
 *
 * @author arichard
 */
@MutationDataFetcher(type = "Mutation", field = "moveToolbarAction")
public class MutationMoveToolbarActionDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationMoveToolbarActionDataFetcher(ObjectMapper objectMapper, IExceptionWrapper exceptionWrapper, IEditingContextDispatcher editingContextDispatcher) {
    ...
    public CompletableFuture<IPayload> get(DataFetchingEnvironment environment) throws Exception {
        ...
        var input = this.objectMapper.convertValue(argument, MoveToolbarActionInput.class);
