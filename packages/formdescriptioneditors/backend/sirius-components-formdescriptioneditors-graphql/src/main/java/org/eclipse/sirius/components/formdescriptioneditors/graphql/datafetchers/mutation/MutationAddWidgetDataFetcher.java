...
/**
 * The data fetcher used to add a widget from a Form Description Editor.
 *
 * @author wpiers
 */
...
public class MutationAddWidgetDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationAddWidgetDataFetcher(ObjectMapper objectMapper, IExceptionWrapper exceptionWrapper, IEditingContextDispatcher editingContextDispatcher) {
