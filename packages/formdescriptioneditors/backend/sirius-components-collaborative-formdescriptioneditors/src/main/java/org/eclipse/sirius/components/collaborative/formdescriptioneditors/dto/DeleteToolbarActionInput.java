 ...
 * @author arichard
 */
public record DeleteToolbarActionInput(UUID id, String editingContextId, String representationId, String toolbarActionId) implements IFormDescriptionEditorInput {
}
