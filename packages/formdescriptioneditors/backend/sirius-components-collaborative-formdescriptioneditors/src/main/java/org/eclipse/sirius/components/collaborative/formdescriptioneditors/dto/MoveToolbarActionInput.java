 ...
 * @author arichard
 */
public record MoveToolbarActionInput(UUID id, String editingContextId, String representationId, String containerId, String toolbarActionId, int index) implements IFormDescriptionEditorInput {
}
