...
public final class FormDescriptionEditorForElementProps implements IProps {
    ...
    public static Builder newFormDescriptionEditorForElementProps(String id) {
    ...
    /**
     * The builder of the FormDescriptionEditorFor element props.
     *
     * @author pcdavid
     */
    ...
    public static final class Builder {
        ...
        public FormDescriptionEditorForElementProps build() {
            ...
            formDescriptionEditorForElementProps.id = Objects.requireNonNull(this.id);
            formDescriptionEditorForElementProps.label = Objects.requireNonNull(this.label);
            formDescriptionEditorForElementProps.iconURL = this.iconURL;
            formDescriptionEditorForElementProps.children = Objects.requireNonNull(this.children);
