...
/**
 * The description of the FDE If widget.
 *
 * @author pcdavid
 */
@Immutable
public final class FormDescriptionEditorIfDescription extends AbstractWidgetDescription {
    ...
    public static Builder newFormDescriptionEditorIfDescription(String id) {
    ...
    /**
     * Builder used to create the FDE If description.
     *
     * @author pcdavid
     */
    ...
    public static final class Builder {
        ...
        public FormDescriptionEditorIfDescription build() {
            ...
            formDescriptionEditorIfDescription.id = Objects.requireNonNull(this.id);
            formDescriptionEditorIfDescription.targetObjectIdProvider = Objects.requireNonNull(this.targetObjectIdProvider);
            formDescriptionEditorIfDescription.idProvider = Objects.requireNonNull(this.idProvider);
            formDescriptionEditorIfDescription.labelProvider = Objects.requireNonNull(this.labelProvider);
            formDescriptionEditorIfDescription.isReadOnlyProvider = Objects.requireNonNull(this.isReadOnlyProvider);
            formDescriptionEditorIfDescription.diagnosticsProvider = Objects.requireNonNull(this.diagnosticsProvider);
            formDescriptionEditorIfDescription.kindProvider = Objects.requireNonNull(this.kindProvider);
            formDescriptionEditorIfDescription.messageProvider = Objects.requireNonNull(this.messageProvider);
            formDescriptionEditorIfDescription.helpTextProvider = this.helpTextProvider; // Optional on purpose
            formDescriptionEditorIfDescription.children = Objects.requireNonNull(this.children);
