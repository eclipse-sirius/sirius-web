        ...
        List<Element> children = candidates.stream()
                .map(candidate -> {
                    ...
                    return pageDescriptions.stream()
                            ...
                            .map(pageDescription -> new Element(PageComponent.class,
                                    new PageComponentProps(childVariableManager, pageDescription, this.props.getWidgetDescriptors(), this.props.getCustomCellDescriptors())));
                })
                .toList();
