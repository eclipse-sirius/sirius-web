...
/**
 * The style of a Label Widget.
 *
 * @author fbarbin
 */
@Immutable
public final class LabelWidgetStyle extends AbstractFontStyle {

    private String color;

    private LabelWidgetStyle() {
    ...
    public static Builder newLabelWidgetStyle() {
        return new Builder();
    }
    ...
    /**
     * Builder used to create the Label style.
     *
     * @author fbarbin
     */
    ...
    public static final class Builder {
        ...
        public LabelWidgetStyle build() {
            LabelWidgetStyle labelStyle = new LabelWidgetStyle();
            labelStyle.color = this.color;
