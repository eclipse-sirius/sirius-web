...
public class GroupComponent implements IComponent {
    ...
    public Element render() {
        ...
        for (Object semanticElement : semanticElements) {
            ...
            List<Element> groupButtons = new ArrayList<>();
            for (ButtonDescription buttonDescription : groupDescription.getButtonDescriptions()) {
                groupButtons.add(new Element(ButtonComponent.class, new ButtonComponentProps(groupVariableManager, buttonDescription)));
            }
            ...
            List<Element> groupChildren = List.of(
                    new Element(GroupToolbarComponent.class, new FragmentProps(groupButtons)),
