...
/**
 * Unit tests of the widget reference set value event handler.
 *
 * @author Jerome Gout
 */
public class SetReferenceValueEventHandlerTests {
    ...
    @Test
    public void testSetReferenceValue() {
        String referenceValueId = "ReferenceValue Id";
        String changeKind = ChangeKind.SEMANTIC_CHANGE;

        var input = new SetReferenceValueInput(UUID.randomUUID(), FORM_ID.toString(), UUID.randomUUID().toString(), REF_WIDGET_ID, referenceValueId);
        AtomicBoolean hasBeenExecuted = new AtomicBoolean();
        Function<Object, IStatus> setHandler = (newValue) -> {
    ...
    @Test
    public void testSetReferenceValueReadOnly() {
        String referenceValueId = "ReferenceValue Id";
        String changeKind = ChangeKind.SEMANTIC_CHANGE;
