...
/**
 * Handles the default clear operations on reference widgets.
 *
 * @author tgiraudet
 * @since 2026.11.0
 */
public interface IDefaultReferenceWidgetClearHandler {
     ...
     * @author tgiraudet
     */
    class NoOp implements IDefaultReferenceWidgetClearHandler {
