...
public class SelectOptionIconURLDataFetcher implements IDataFetcherWithFieldCoordinates<List<String>> {
    ...
    public SelectOptionIconURLDataFetcher(IImageURLSanitizer imageURLSanitizer) {
    ...
    public List<String> get(DataFetchingEnvironment environment) throws Exception {
        ...
        return option.getIconURL().stream().map(url -> this.imageURLSanitizer.sanitize(URLConstants.IMAGE_BASE_PATH, url)).toList();
    }
}
