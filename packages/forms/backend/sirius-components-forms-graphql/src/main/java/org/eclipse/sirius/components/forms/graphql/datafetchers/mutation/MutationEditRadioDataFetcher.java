 ...
 * @author sbegaudeau
 */
@MutationDataFetcher(type = "Mutation", field = "editRadio")
public class MutationEditRadioDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationEditRadioDataFetcher(ObjectMapper objectMapper, IExceptionWrapper exceptionWrapper, IEditingContextDispatcher editingContextDispatcher) {
