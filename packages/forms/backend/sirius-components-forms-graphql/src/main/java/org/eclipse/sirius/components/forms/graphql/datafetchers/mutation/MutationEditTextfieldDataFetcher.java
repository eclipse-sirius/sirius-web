 ...
 * @author pcdavid
 */
@MutationDataFetcher(type = "Mutation", field = "editTextfield")
public class MutationEditTextfieldDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationEditTextfieldDataFetcher(ObjectMapper objectMapper, IExceptionWrapper exceptionWrapper, IEditingContextDispatcher editingContextDispatcher) {
