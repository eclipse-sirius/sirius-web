 ...
 * @author gcoutable
 */
@MutationDataFetcher(type = "Mutation", field = "deleteListItem")
public class MutationDeleteItemDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationDeleteItemDataFetcher(ObjectMapper objectMapper, IExceptionWrapper exceptionWrapper, IEditingContextDispatcher editingContextDispatcher) {
