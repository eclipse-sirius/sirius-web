 ...
 * @author arichard
 */
@MutationDataFetcher(type = "Mutation", field = "editMultiSelect")
public class MutationEditMultiSelectDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationEditMultiSelectDataFetcher(ObjectMapper objectMapper, IExceptionWrapper exceptionWrapper, IEditingContextDispatcher editingContextDispatcher) {
