...
public class FormEventProcessor implements IFormEventProcessor {
    ...
    public Flux<IPayload> getOutputEvents(IInput input) {
        ...
        var initialCapabilitiesRefresh = Mono.fromCallable(() -> new FormCapabilitiesRefreshedEventPayload(input.id(), this.currentForm.get().getId(), this.formCapabilitiesService.getFormCapabilities(formId,
                this.editingContext)));
