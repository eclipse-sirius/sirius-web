...
public final class EditSelectInput implements IFormInput {
    ...
    public EditSelectInput() {
        // Used by Jackson
    }

    public EditSelectInput(UUID id, String editingContextId, String representationId, String selectId, String newValue) {
    ...
    public String toString() {
        String pattern = "{0} '{'id: {1}, editingContextId: {2}, representationId: {3}, selectId: {4}, newValue: {5}'}'";
