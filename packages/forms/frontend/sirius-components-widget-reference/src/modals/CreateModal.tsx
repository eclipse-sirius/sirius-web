  ...
  useEffect(() => {
    if (!childCreationDescriptionsLoading) {
      ...
      if (childCreationDescriptionsData) {
        ...
        setState((prevState) => ({
          ...prevState,
          referenceWidgetChildCreationDescriptions: referenceWidgetChildCreationDescriptions,
          selectedChildCreationDescriptionId: selectedChildCreationDescriptionId,
        }));
      }
    }
    ...
    <Dialog
      ...
      <DialogActions>
        <Button
          ...
          disabled={!state.selectedChildCreationDescriptionId || !state.selectedDomainId}>
          Create
        </Button>
      </DialogActions>
    </Dialog>
