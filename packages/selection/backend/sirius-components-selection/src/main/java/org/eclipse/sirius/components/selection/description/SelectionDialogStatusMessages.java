 ...
 * This third status message is handled by the SelectionDialogSelectionRequiredWithSelectionStatusMessageDataFetcher.
 * </p>
 *
 * @author gcoutable
 */
public record SelectionDialogStatusMessages(String noSelectionActionStatusMessage, String selectionRequiredWithoutSelectionStatusMessage) {
    public SelectionDialogStatusMessages {
