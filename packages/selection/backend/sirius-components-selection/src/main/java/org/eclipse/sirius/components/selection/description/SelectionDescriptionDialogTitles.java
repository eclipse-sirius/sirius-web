 ...
 * @author gcoutable
 */
public record SelectionDescriptionDialogTitles(String defaultTitle, String noSelectionTitle, String withSelectionTitle) {
    public SelectionDescriptionDialogTitles {
