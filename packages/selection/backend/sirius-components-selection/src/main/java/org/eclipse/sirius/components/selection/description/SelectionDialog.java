 ...
 * @author gcoutable
 */
public record SelectionDialog(
        SelectionDialogTitles titles,
        String description,
        SelectionDialogAction noSelectionAction,
        SelectionDialogAction withSelectionAction,
        SelectionDialogStatusMessages statusMessages,
        SelectionDialogConfirmButtonLabels confirmButtonLabels
) {
