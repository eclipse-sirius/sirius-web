 ...
 * @author gcoutable
 */
public record GetSelectionDescriptionDialogSelectionRequiredWithSelectionStatusMessagePayload(UUID id, String statusMessage) implements IPayload {
    public GetSelectionDescriptionDialogSelectionRequiredWithSelectionStatusMessagePayload {
