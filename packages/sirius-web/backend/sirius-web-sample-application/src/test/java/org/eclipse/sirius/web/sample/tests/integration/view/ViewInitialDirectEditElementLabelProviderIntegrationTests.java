...
/**
 * Integration tests of a the initial direct edit element label on a diagram element based on the view DSL.
 *
 * @author arichard
 */
...
public class ViewInitialDirectEditElementLabelProviderIntegrationTests extends AbstractIntegrationTests {
    ...
    private DiagramRefreshedEventPayload initializedDiagramPayload;
    ...
    @Test
    @DisplayName("Try to edit the label of a diagram element")
    public void initialDirectEditElementLabel() {
        ...
        StepVerifier.create(payloadFlux)
                ...
                .then(() -> this.editDiagramElementLabel(this.initializedDiagramPayload))
                .thenCancel()
