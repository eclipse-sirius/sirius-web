...
public class DefaultModelBrowsersMetadataProvider implements IRepresentationMetadataProvider {
    ...
    public Optional<RepresentationMetadata> getMetadata(String representationId) {
        ...
        if (representationId.startsWith(DefaultModelBrowsersTreeDescriptionProvider.MODEL_BROWSER_PREFIX + "?treeDescriptionId=" + DefaultModelBrowsersTreeDescriptionProvider.CONTAINER_DESCRIPTION_ID)) {
            representationMetadata = RepresentationMetadata.newRepresentationMetadata(representationId)
                    ...
                    .iconURLs(List.of())
                    .build();
        } else if (representationId.startsWith(DefaultModelBrowsersTreeDescriptionProvider.MODEL_BROWSER_PREFIX + "?treeDescriptionId=" + DefaultModelBrowsersTreeDescriptionProvider.REFERENCE_DESCRIPTION_ID)) {
            representationMetadata = RepresentationMetadata.newRepresentationMetadata(representationId)
                    .kind(Tree.KIND)
                    .label(DefaultModelBrowsersTreeDescriptionProvider.REPRESENTATION_NAME)
