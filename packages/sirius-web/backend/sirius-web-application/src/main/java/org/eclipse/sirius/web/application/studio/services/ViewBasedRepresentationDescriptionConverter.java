        ...
        if (editingContext instanceof EditingContext siriusWebEditingContext) {
            this.viewConverter.convert(siriusWebEditingContext, siriusWebEditingContext.getViews())
                ...
                .forEach(viewConverterResult -> {
                    ...
                    viewConverterResult.viewConversionData().ifPresent(viewConversionData ->
                        siriusWebEditingContext.getRepresentationDescriptionIdToConverterResult().put(viewConverterResult.representationDescription().getId(), viewConversionData)
                    );
                });
        }
    }
