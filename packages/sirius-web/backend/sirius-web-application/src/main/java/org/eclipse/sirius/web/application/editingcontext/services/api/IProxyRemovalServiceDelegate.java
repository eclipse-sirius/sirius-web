...
/**
 * Delegates that removes EMF proxies in specific contexts.
 *
 * @author gdaniel
 */
public interface IProxyRemovalServiceDelegate {
     ...
     * @author gdaniel
     */
    class NoOp implements IProxyRemovalServiceDelegate {
