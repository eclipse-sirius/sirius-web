...
/**
 * Provides the description of the show button for the diagram filter's split button.
 *
 * @author gdaniel
 */
@Service
public class ShowButtonDescriptionProvider implements IDiagramFilterActionContributionProvider {
    ...
    public ShowButtonDescriptionProvider(IIdentityService identityService, IDiagramFilterHelper diagramFilterHelper, IMessageService messageService) {
    ...
    public ButtonDescription getButtonDescription() {
        return ButtonDescription.newButtonDescription("diagram-filter/split-button/show")
                ...
                .labelProvider(variableManager -> this.messageService.diagramFilterShowElements())
                .iconURLProvider(variableManager -> List.of())
                .isReadOnlyProvider(variableManager -> false)
                .buttonLabelProvider(variableManager -> this.messageService.diagramFilterShowElements())
                .imageURLProvider(variableManager -> "/icons/full/obj16/ShowTool.svg")
                .pushButtonHandler(variableManager -> {
                    ...
                    return this.diagramFilterHelper.sendDiagramEvent(variableManager, new HideDiagramElementInput(UUID.randomUUID(), editingContext.getId(), diagram.getId(), nodeIds, false));
                })
                ...
                .helpTextProvider(variableManager -> this.messageService.showSelectedElements())
                .build();
    }
