...
public class UpdateLibraryImpactAnalysisReportDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<ImpactAnalysisReport>> {

    private static final String LIBRARY_ID = "libraryId";

    private final IEditingContextDispatcher editingContextDispatcher;

    public UpdateLibraryImpactAnalysisReportDataFetcher(IEditingContextDispatcher editingContextDispatcher) {
