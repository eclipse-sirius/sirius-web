...
/**
 * Default implementation of a service used to handle the customization of a elipse node's appearance.
 *
 * @author mcharfadi
 */
@Service
public class ElipseNodeAppearanceHandler implements INodeAppearanceHandler {
    ...
    private void handleBorderRadius(EllipseNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
                                    Set<String> customizedStyleProperties) {
