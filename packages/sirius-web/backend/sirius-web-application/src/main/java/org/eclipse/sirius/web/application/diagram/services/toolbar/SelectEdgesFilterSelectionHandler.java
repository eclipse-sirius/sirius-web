...
/**
 * Handler to select all edges for FilterSelectionMenu in the diagram toolbar.
 *
 * @author mcharfadi
 */
@Service
public class SelectEdgesFilterSelectionHandler implements IDiagramToolbarFilterSelectionHandler {
    ...
    public boolean canHandle(IEditingContext editingContext, DiagramContext diagramContext, String toolbarFilterSelectionMenuItemId, List<String> diagramElementIds) {
        return toolbarFilterSelectionMenuItemId.equals(SelectEdgesFilterSelectionProvider.ID);
    }
    ...
    public List<String> getNewSelection(IEditingContext editingContext, DiagramContext diagramContext, String toolbarFilterSelectionMenuItemId, List<String> diagramElementIds) {
        return diagramContext.diagram().getEdges().stream().map(Edge::getId).toList();
    }
}
