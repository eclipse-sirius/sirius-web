...
/**
 * Data fetcher for the field Mutation#createProjectFromTemplate.
 *
 * @author pcdavid
 */
...
public class MutationCreateProjectFromTemplateDataFetcher implements IDataFetcherWithFieldCoordinates<IPayload> {
    ...
    public MutationCreateProjectFromTemplateDataFetcher(ObjectMapper objectMapper, IProjectTemplateApplicationService projectTemplateApplicationService) {
