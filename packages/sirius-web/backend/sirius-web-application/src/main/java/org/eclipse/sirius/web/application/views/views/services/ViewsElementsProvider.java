...
import org.eclipse.sirius.web.application.views.views.services.api.IViewsElementsProvider;
...
/**
 * Service in charge of providing the list of representations available in the "views" view, directly organized into a synthetic semantic tree.
 *
 * @author theogiraudet
 */
@Service
public class ViewsElementsProvider implements IViewsElementsProvider {
    ...
    public ViewsElementsProvider(IRepresentationMetadataSearchService representationMetadataSearchService, IRepresentationDescriptionSearchService representationDescriptionSearchService,
