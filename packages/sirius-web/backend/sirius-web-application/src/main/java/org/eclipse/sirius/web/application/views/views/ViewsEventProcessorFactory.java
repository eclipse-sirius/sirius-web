 ...
 *******************************************************************************/
package org.eclipse.sirius.web.application.views.views;
...
/**
 * Used to create the views event processors.
 *
 * @author tgiraudet
 */
@Service
public class ViewsEventProcessorFactory implements IRepresentationEventProcessorFactory {
    ...
    public ViewsEventProcessorFactory(IRepresentationDescriptionSearchService representationDescriptionSearchService, ITreeService treeService, List<ITreeEventHandler> treeEventHandlers,
    ...
    public boolean canHandle(IEditingContext editingContext, String representationId) {
        return representationId.startsWith(ViewsTreeDescriptionProvider.PREFIX);
    }
