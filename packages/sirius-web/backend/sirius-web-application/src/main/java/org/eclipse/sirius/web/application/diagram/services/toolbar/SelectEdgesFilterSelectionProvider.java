...
/**
 * Handler used to get the select edges menu item of the FilterSelectionMenu in the diagram toolbar.
 *
 * @author mcharfadi
 */
@Service
public class SelectEdgesFilterSelectionProvider implements IDiagramToolbarFilterSelectionProvider {

    public static final String ID = "select_edges";
