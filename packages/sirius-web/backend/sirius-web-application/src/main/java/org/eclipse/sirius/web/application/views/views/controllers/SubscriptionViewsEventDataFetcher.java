 ...
 *******************************************************************************/
package org.eclipse.sirius.web.application.views.views.controllers;
...
/**
 * The data fetcher used to send the representations view subscription.
 *
 * @author tgiraudet
 */
@SubscriptionDataFetcher(type = "Subscription", field = "viewsEvent")
public class SubscriptionViewsEventDataFetcher implements IDataFetcherWithFieldCoordinates<Publisher<DataFetcherResult<IPayload>>> {
    ...
    public SubscriptionViewsEventDataFetcher(ObjectMapper objectMapper, IExceptionWrapper exceptionWrapper, IEventProcessorSubscriptionProvider eventProcessorSubscriptionProvider) {
    ...
    public Publisher<DataFetcherResult<IPayload>> get(DataFetchingEnvironment environment) throws Exception {
        ...
        var input = this.objectMapper.convertValue(argument, ViewsEventInput.class);
