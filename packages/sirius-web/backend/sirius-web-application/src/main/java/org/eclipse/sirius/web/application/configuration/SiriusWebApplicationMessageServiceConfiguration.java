 ...
 */
@Configuration
public class SiriusWebApplicationMessageServiceConfiguration {

    private static final String PATH = "messages/sirius-web-application";

    @Bean
    public MessageSourceAccessor siriusWebApplicationMessageSourceAccessor(@Value("${spring.mvc.locale:en_EN}") Locale locale) {
