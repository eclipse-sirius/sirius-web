 ...
 * @author gcoutable
 */
@QueryDataFetcher(type = "ProjectsCapabilities", field = "canCreate")
public class ProjectsCapabilitiesCanCreateDataFetcher implements IDataFetcherWithFieldCoordinates<Boolean> {
    ...
    public ProjectsCapabilitiesCanCreateDataFetcher(ICapabilityEvaluator capabilityEvaluator) {
        this.capabilityEvaluator = Objects.requireNonNull(capabilityEvaluator);
    }

    @Override
    public Boolean get(DataFetchingEnvironment environment) throws Exception {
        return this.capabilityEvaluator.hasCapability(SiriusWebCapabilities.PROJECT, null, SiriusWebCapabilities.Project.CREATE);
    }
}
