 ...
 */
@Service
public class SelectAllNodesFilterSelectionHandler implements IFilterSelectionHandler {
    ...
    public boolean canHandle(IEditingContext editingContext, DiagramContext diagramContext, String toolbarFilterSelectionMenuItemId, List<String> diagramElementIds) {
        return SelectAllNodesFilterSelectionProvider.ID.equals(toolbarFilterSelectionMenuItemId);
    }
    ...
    public List<String> getNewSelection(IEditingContext editingContext, DiagramContext diagramContext, String toolbarFilterSelectionMenuItemId, List<String> diagramElementIds) {
        return this.getAllNodes(diagramContext.diagram().getNodes()).stream().map(Node::getId).toList();
    }
    ...
    public List<Node> getAllNodes(List<Node> nodes) {
        ...
        for (Node node : nodes) {
            allNodes.add(node);
            var children = new LinkedList<Node>(node.getChildNodes());
