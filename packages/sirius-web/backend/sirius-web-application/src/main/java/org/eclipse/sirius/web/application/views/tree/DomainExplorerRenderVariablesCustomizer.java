...
/**
 * Provides additional render variables to be used by {@link DomainExplorerRepresentationDescriptionProvider} to reduce the amount of duplicate work (notably database access):
 *
 * <dl>
 ...
 */
@Service
public class DomainExplorerRenderVariablesCustomizer implements IRepresentationRenderVariableCustomizer {

    private final IRepresentationMetadataSearchService representationMetadataSearchService;

    public DomainExplorerRenderVariablesCustomizer(IRepresentationMetadataSearchService representationMetadataSearchService) {
    ...
    public VariableManager customize(IRepresentationDescription representationDescription, VariableManager variableManager) {
        if (DomainViewTreeDescriptionProvider.DOMAIN_EXPLORER_DESCRIPTION_NAME.equals(representationDescription.getLabel())) {
