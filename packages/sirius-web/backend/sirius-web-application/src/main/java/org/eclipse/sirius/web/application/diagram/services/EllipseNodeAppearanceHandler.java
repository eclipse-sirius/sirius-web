 ...
 */
@Service
public class EllipseNodeAppearanceHandler implements INodeAppearanceHandler {
    ...
    public NodeAppearance handle(INodeStyle providedStyle, List<INodeAppearanceChange> changes, Optional<NodeAppearance> previousNodeAppearance) {
        ...
        if (providedStyle instanceof EllipseNodeStyle providedEllipseNodeStyle) {
            EllipseNodeStyle.Builder styleBuilder = EllipseNodeStyle.newEllipseNodeStyle(providedEllipseNodeStyle);
    ...
    private void handleBackground(EllipseNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle, Set<String> customizedStyleProperties) {
        if (!handleResetChange(BACKGROUND, changes, customizedStyleProperties)) {
            ...
            } else if (customizedStyleProperties.contains(BACKGROUND) && optionalPreviousNodeStyle.isPresent() && optionalPreviousNodeStyle.get() instanceof EllipseNodeStyle previousNodeStyle) {
    ...
    private void handleBorderColor(EllipseNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
        ...
        if (!handleResetChange(BORDER_COLOR, changes, customizedStyleProperties)) {
            ...
            } else if (customizedStyleProperties.contains(BORDER_COLOR) && optionalPreviousNodeStyle.isPresent() && optionalPreviousNodeStyle.get() instanceof EllipseNodeStyle previousNodeStyle) {
    ...
    private void handleBorderSize(EllipseNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
                                  Set<String> customizedStyleProperties) {
        if (!handleResetChange(BORDER_SIZE, changes, customizedStyleProperties)) {
            ...
            } else if (customizedStyleProperties.contains(BORDER_SIZE) && optionalPreviousNodeStyle.isPresent() && optionalPreviousNodeStyle.get() instanceof EllipseNodeStyle previousNodeStyle) {
    ...
    private void handleBorderStyle(EllipseNodeStyle.Builder styleBuilder, List<INodeAppearanceChange> changes, Optional<INodeStyle> optionalPreviousNodeStyle,
                                   Set<String> customizedStyleProperties) {
        if (!handleResetChange(BORDER_STYLE, changes, customizedStyleProperties)) {
            ...
            } else if (customizedStyleProperties.contains(BORDER_STYLE) && optionalPreviousNodeStyle.isPresent() && optionalPreviousNodeStyle.get() instanceof EllipseNodeStyle previousNodeStyle) {
