            ...
            if (editingContext instanceof EditingContext siriusWebEditingContext) {
                ...
                for (Library library : libraries) {
                    ...
                    if (optionalSemanticData.isPresent()) {
                        if (optionalSemanticData.get().getDependencies().stream().anyMatch(dependency -> dependency.libraryId().equals(library.getId()))) {
                            ...
                            this.semanticDataUpdateService.addDependency(input, optionalSemanticData.get().getId(), library.getId());
                        }
                    }
                }
                this.editingContextLibraryLoader.loadLibraries(siriusWebEditingContext);
