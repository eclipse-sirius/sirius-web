...
public class DependencyGraph<T> {
    ...
    private Set<T> nodes = new LinkedHashSet<>();
    ...
    public void removeNode(T node) {
        ...
        if (this.nodes.remove(node)) {
            this.edges.removeIf(e -> Objects.equals(e.source(), node) || Objects.equals(e.target(), node));
        }
    }
     ...
     * @author gdaniel
     */
    private record Edge<T>(T source, T target) {
