...
public class GetRelationshipsByRelatedElementRestEventHandler implements IEditingContextEventHandler {
    ...
    public GetRelationshipsByRelatedElementRestEventHandler(IMessageService messageService, MeterRegistry meterRegistry, IObjectRestService objectRestService) {
