...
/**
 * Data fetcher for the field ProjectCapabilities#canDelete.
 *
 * @author gcoutable
 */
@QueryDataFetcher(type = "ProjectCapabilities", field = "canDelete")
public class ProjectCapabilitiesCanDeleteDataFetcher implements IDataFetcherWithFieldCoordinates<Boolean> {

    private final List<ICapabilityVoter> capabilityVoters;

    public ProjectCapabilitiesCanDeleteDataFetcher(List<ICapabilityVoter> capabilityVoters) {
    ...
    public Boolean get(DataFetchingEnvironment environment) throws Exception {
        ...
        return this.capabilityVoters.stream().allMatch(voter -> voter.vote(SiriusWebCapabilities.PROJECT, projectId, SiriusWebCapabilities.Project.DELETE) == CapabilityVote.GRANTED);
    }
}
