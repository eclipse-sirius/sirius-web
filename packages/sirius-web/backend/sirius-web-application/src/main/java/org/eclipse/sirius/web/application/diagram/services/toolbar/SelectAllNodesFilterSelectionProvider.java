...
/**
 * Handler used to get the select nodes menu item of the FilterSelectionMenu in the diagram toolbar.
 *
 * @author mcharfadi
 */
@Service
public class SelectAllNodesFilterSelectionProvider implements IDiagramToolbarFilterSelectionProvider {
    ...
    public FilterSelectionMenuItem getDiagramToolbarFilterSelectionMenuItem(IEditingContext editingContext, DiagramContext diagramContext,  List<String> diagramElementIds) {
        return new FilterSelectionMenuItem(ID, "Select all nodes");
    }
