...
public class RenameRepresentationTreeItemHandler implements IRenameTreeItemHandler {
    ...
    public RenameRepresentationTreeItemHandler(IRepresentationMetadataUpdateService representationMetadataUpdateService, ICollaborativeMessageService messageService, MeterRegistry meterRegistry) {
    ...
    public IStatus handle(IEditingContext editingContext, TreeItem treeItem, String newLabel, Tree tree) {
        ...
        var input = new RenameRepresentationInput(UUID.randomUUID(), editingContext.getId(), treeItem.getId(), newLabel);
