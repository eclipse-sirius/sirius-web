...
public class ProjectCapabilitiesCanEditDataFetcher implements IDataFetcherWithFieldCoordinates<Boolean> {
    ...
    public ProjectCapabilitiesCanEditDataFetcher(ICapabilityEvaluator capabilityEvaluator) {
    ...
    public Boolean get(DataFetchingEnvironment environment) throws Exception {
        ...
        return this.capabilityEvaluator.hasCapability(SiriusWebCapabilities.PROJECT, projectId, SiriusWebCapabilities.Project.EDIT);
    }
}
