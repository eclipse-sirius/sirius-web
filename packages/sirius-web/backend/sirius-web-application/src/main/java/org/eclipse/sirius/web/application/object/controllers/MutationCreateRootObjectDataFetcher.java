...
/**
 * Data fetcher for the field Mutation#createRootObject.
 *
 * @author sbegaudeau
 */
@MutationDataFetcher(type = "Mutation", field = "createRootObject")
public class MutationCreateRootObjectDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationCreateRootObjectDataFetcher(ObjectMapper objectMapper, IEditingContextDispatcher editingContextDispatcher) {
