...
public class UndoEventHandler implements IEditingContextEventHandler {
    ...
    public UndoEventHandler(ICollaborativeDiagramMessageService messageService, List<IRepresentationChangeHandler> representationEventProcessorChangeHandlers) {
    ...
    public void handle(One<IPayload> payloadSink, Many<ChangeDescription> changeDescriptionSink, IEditingContext editingContext, IInput input) {
        ...
        if (editingContext instanceof EditingContext siriusEditingContext && input instanceof UndoInput undoInput) {
            ...
            changeDescription = new ChangeDescription(ChangeKind.UNDO_REDO_CHANGE, editingContext.getId(), input);
