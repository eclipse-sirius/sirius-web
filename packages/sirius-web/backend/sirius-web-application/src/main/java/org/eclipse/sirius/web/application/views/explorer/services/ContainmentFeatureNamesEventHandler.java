...
public class ContainmentFeatureNamesEventHandler implements IEditingContextEventHandler {
    ...
    public void handle(One<IPayload> payloadSink, Many<ChangeDescription> changeDescriptionSink, IEditingContext editingContext, IInput input) {
        ...
        if (input instanceof EditingContextContainmentFeatureNamesInput editingContextContainmentFeatureNamesInput) {
            ...
            if (containerOpt.isPresent() && containedObjectOpt.isPresent()) {
                List<String> containmentFeatureNames = this.getContainmentFeatureNames(containerOpt.get(), containedObjectOpt.get());

                payload = new EditingContextContainmentFeatureNamesSuccessPayload(input.id(), containmentFeatureNames);
