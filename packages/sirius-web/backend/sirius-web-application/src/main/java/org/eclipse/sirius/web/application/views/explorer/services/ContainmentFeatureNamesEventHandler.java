    ...
    public void handle(One<IPayload> payloadSink, Many<ChangeDescription> changeDescriptionSink, IEditingContext editingContext, IInput input) {
        ...
        if (input instanceof EditingContextContainmentFeatureNamesInput editingContextContainmentFeatureNamesInput) {
            ...
            if (optChild.isPresent()) {
                ...
                List<ContainmentFeature> containmentFeatureNames = optContainer.map(container -> containmentFeatureNameProvider.getContainmentFeatureNames(optChild.get(), container))
                        .orElse(List.of());
