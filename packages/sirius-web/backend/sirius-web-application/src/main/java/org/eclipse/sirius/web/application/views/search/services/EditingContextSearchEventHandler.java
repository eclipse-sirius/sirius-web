...
public class EditingContextSearchEventHandler implements IEditingContextEventHandler {
    ...
    public EditingContextSearchEventHandler(ILabelService labelService, IMessageService messageService, MeterRegistry meterRegistry) {
    ...
    public boolean canHandle(IEditingContext editingContext, IInput input) {
        return input instanceof SearchInput && editingContext instanceof IEMFEditingContext;
    }
    ...
    public void handle(One<IPayload> payloadSink, Many<ChangeDescription> changeDescriptionSink, IEditingContext editingContext, IInput input) {
        ...
        if (input instanceof SearchInput searchInput && editingContext instanceof IEMFEditingContext emfEditingContext) {
