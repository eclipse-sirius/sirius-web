...
public class MutationDeleteRepresentationMetadataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationDeleteRepresentationMetadataFetcher(ObjectMapper objectMapper, IEditingContextEventProcessorRegistry editingContextEventProcessorRegistry, IRepresentationApplicationService representationApplicationService, IMessageService messageService) {
