...
/**
 * Handler to unselect all child nodes for a given selection in the diagram toolbar.
 *
 * @author mcharfadi
 */
@Service
public class UnselectChildNodesFilterSelectionHandler implements IDiagramToolbarFilterSelectionHandler {

    private final IDiagramQueryService diagramQueryService;

    public UnselectChildNodesFilterSelectionHandler(IDiagramQueryService diagramQueryService) {
    ...
    public boolean canHandle(IEditingContext editingContext, DiagramContext diagramContext, String toolbarFilterSelectionMenuItemId, List<String> diagramElementIds) {
        return toolbarFilterSelectionMenuItemId.equals(UnselectChildNodesFilterSelectionProvider.ID);
    }
