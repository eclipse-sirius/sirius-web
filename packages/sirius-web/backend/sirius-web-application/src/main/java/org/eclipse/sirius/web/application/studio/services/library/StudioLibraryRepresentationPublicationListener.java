...
/**
 * Used to create the representations of a studio library once its semantic data are published.
 *
 * @author gdaniel
 */
@Service
public class StudioLibraryRepresentationPublicationListener {
    ...
    private final Logger logger = LoggerFactory.getLogger(StudioLibraryRepresentationPublicationListener.class);

    public StudioLibraryRepresentationPublicationListener(IRepresentationMetadataSearchService representationMetadataSearchService,
    ...
    public void onSemanticDataCreatedEvent(SemanticDataCreatedEvent semanticDataCreatedEvent) {
        if (semanticDataCreatedEvent.causedBy() instanceof StudioLibrarySemanticDataCreationRequested request
