...
public class ProjectTemplateApplicationService implements IProjectTemplateApplicationService {
    ...
    public List<ProjectTemplateDTO> findAll() {
        return this.getProjectTemplatesSortedByName().stream().map(this::toDTO).toList();
    }
    ...
    private Page<ProjectTemplateDTO> handleProjectBrowser(Pageable pageable) {
        ...
        siriusWebProjectTemplate.add(new ProjectTemplate("create-project", "Blank Project", "/project-templates/blank-project.png", List.of()));
    ...
    private ProjectTemplateDTO toDTO(ProjectTemplate projectTemplate) {
        return new ProjectTemplateDTO(projectTemplate.id(), projectTemplate.label(), projectTemplate.imageURL(), projectTemplate.natures().stream().map(ProjectTemplateNature::id).toList());
    }
