...
/**
 * Used to compute the initial label to display when the direct edit of a tree item of the views explorer is triggered on the frontend.
 *
 * @author tgiraudet
 */
@Service
public class ViewsExplorerInitialDirectEditTreeItemLabelProvider implements IInitialDirectEditTreeItemLabelProvider {

    @Override
    public boolean canHandle(Tree tree) {
        return tree.getId().startsWith(ViewsExplorerTreeDescriptionProvider.PREFIX);
    }
