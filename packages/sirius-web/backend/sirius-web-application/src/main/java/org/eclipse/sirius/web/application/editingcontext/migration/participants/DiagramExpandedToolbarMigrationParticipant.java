...
/**
 * Expand the toolbar of imported diagrams.
 *
 * @author tgiraudet
 */
@Service
public class DiagramExpandedToolbarMigrationParticipant implements IMigrationParticipant {

    private static final String PARTICIPANT_VERSION = "2026.3.0-2026020061429";
    ...
    public void postObjectLoading(JsonResource resource, EObject eObject, JsonObject jsonObject) {
        if (eObject instanceof DiagramToolbar toolbar) {
