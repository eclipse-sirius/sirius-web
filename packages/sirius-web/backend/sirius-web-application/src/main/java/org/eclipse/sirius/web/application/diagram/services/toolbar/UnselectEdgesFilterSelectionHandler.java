...
/**
 * Handler to filter out the edges from a selection for FilterSelectionMenu in the diagram toolbar.
 *
 * @author mcharfadi
 */
@Service
public class UnselectEdgesFilterSelectionHandler implements IFilterSelectionHandler {
    ...
    public boolean canHandle(IEditingContext editingContext, DiagramContext diagramContext, String toolbarFilterSelectionMenuItemId, List<String> diagramElementIds) {
        return UnselectEdgesFilterSelectionProvider.ID.equals(toolbarFilterSelectionMenuItemId);
    }
    ...
    public List<String> getNewSelection(IEditingContext editingContext, DiagramContext diagramContext, String toolbarFilterSelectionMenuItemId, List<String> diagramElementIds) {
        var result = diagramElementIds.stream()
