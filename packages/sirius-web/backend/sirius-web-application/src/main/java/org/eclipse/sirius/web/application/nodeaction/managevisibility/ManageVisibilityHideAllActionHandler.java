 ...
 */
@Service
public class ManageVisibilityHideAllActionHandler implements IManageVisibilityMenuActionHandler {
    ...
    public IStatus handle(IEditingContext editingContext, DiagramContext diagramContext, IDiagramElement diagramElement, String actionId) {
        ...
        if (optionalNode.isPresent()) {
            ...
            diagramContext.diagramEvents().add(new HideDiagramElementEvent(childrenIds, true));
        }
        return new Success();
    }
}
