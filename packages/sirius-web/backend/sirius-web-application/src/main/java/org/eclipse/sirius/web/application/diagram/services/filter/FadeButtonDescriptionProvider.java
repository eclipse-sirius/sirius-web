...
public class FadeButtonDescriptionProvider implements IDiagramFilterActionContributionProvider {
    ...
    public FadeButtonDescriptionProvider(IIdentityService identityService, IDiagramFilterHelper diagramFilterHelper, IMessageService messageService) {
    ...
    public ButtonDescription getButtonDescription() {
        return ButtonDescription.newButtonDescription("diagram-filter/split-button/fade")
                ...
                .labelProvider(variableManager -> this.messageService.diagramFilterFadeElements())
                .iconURLProvider(variableManager -> List.of())
                .isReadOnlyProvider(variableManager -> false)
                .buttonLabelProvider(variableManager -> this.messageService.diagramFilterFadeElements())
