...
/**
 * Data fetcher for the field Mutation#createChild.
 *
 * @author sbegaudeau
 */
@MutationDataFetcher(type = "Mutation", field = "createChild")
public class MutationCreateChildDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<IPayload>> {
    ...
    public MutationCreateChildDataFetcher(ObjectMapper objectMapper, IEditingContextDispatcher editingContextDispatcher) {
