...
public class DomainDropTreeItemHandler implements IDropTreeItemHandler {
    ...
    public DomainDropTreeItemHandler(ExplorerDropTreeItemHandler explorerDropTreeItemHandler, IViewRepresentationDescriptionSearchService viewRepresentationDescriptionSearchService) {
        this.explorerDropTreeItemHandler = Objects.requireNonNull(explorerDropTreeItemHandler);
    ...
    public IStatus handle(IEditingContext editingContext, Tree tree, DropTreeItemInput input) {
        return this.explorerDropTreeItemHandler.handle(editingContext, tree, input);
    }
