...
public class ProjectSubscriptions implements IProjectSubscriptions {
    ...
    private final Map<String, Sinks.Many<IPayload>> projectIdsToSink = new HashMap<>();
    ...
    public Optional<Flux<IPayload>> findProjectSubscriptionById(String projectId) {
    ...
    @Override
    public void emit(String projectId, IPayload payload) {
