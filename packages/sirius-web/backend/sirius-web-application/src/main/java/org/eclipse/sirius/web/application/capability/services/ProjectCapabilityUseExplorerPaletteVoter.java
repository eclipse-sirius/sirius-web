...
/**
 * Used to configure the server to grant the ProjectCapabilityUseExplorerPaletteVoter if the env variable USE_EXPLORER_PALETTE is set to true.
 *
 * @author mcharfadi
 */
@Service
public class ProjectCapabilityUseExplorerPaletteVoter implements ICapabilityVoter {
    ...
    public CapabilityVote vote(String type, String identifier, String capability) {
        ...
        if (SiriusWebCapabilities.PROJECT.equals(type) && SiriusWebCapabilities.Project.USE_EXPLORER_PALETTE.equals(capability) && !useExplorerPalette) {
