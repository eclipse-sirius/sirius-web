...
/**
 * Used to provide the hide all action for the manage visibility node action.
 *
 * @author mcharfadi
 */
@Service
public class ManageVisibilityHideAllAction implements IManageVisibilityMenuActionsProvider {

    public static final String ACTION_ID = "manage_visibility_menu_hide_all_action";
    ...
    public List<ManageVisibilityAction> handle(IEditingContext editingContext, DiagramDescription diagramDescription, IDiagramElement diagramElement) {
        return List.of(new ManageVisibilityAction(ACTION_ID, "Hide all"));
    }
}
