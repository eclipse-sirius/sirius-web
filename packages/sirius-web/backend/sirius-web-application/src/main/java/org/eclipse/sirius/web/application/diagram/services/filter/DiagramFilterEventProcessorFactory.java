    ...
    public Optional<IRepresentationEventProcessor> createRepresentationEventProcessor(IEditingContext editingContext, String representationId) {
        if (this.diagramFilterDescriptionProvider != null) {
            ...
            if (!objects.isEmpty()) {
                ...
                var formEventProcessorConfiguration = new FormEventProcessorConfiguration(editingContext, this.objectSearchService, formCreationParameters, this.widgetDescriptors, this.formEventHandlers,
