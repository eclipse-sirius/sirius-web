        ...
        if (optionalEditingDomain.isPresent()) {
            ...
            if (eReferenceOpt.isPresent()) {
                if (this.canFeatureBeSet(containerEObject, eReferenceOpt.get())) {
                    duplicatedObjectOptional = this.duplicateObject(objectToDuplicate, settings)
            ...
            if (settings.updateIncomingReferences() && duplicatedObjectOptional.isPresent() && duplicatedObjectOptional.get() instanceof EObject duplicatedEObject) {
