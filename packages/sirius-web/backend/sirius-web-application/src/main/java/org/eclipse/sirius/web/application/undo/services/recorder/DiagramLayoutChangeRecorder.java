...
/**
 * Use to record data needed to perform the undo for layout changes.
 *
 * @author mcharfadi
 */
@Service
                    ...
                    .forEach(updatedNodeLayoutInput -> {
                        ...
                        if (previousNodeLayoutData != null) {
                            if (!isSameNodeLayoutData(previousNodeLayoutData, updatedNodeLayoutInput)) {
                                var updatedNodeLayout = new NodeLayoutData(updatedNodeLayoutInput.id(), updatedNodeLayoutInput.position(), updatedNodeLayoutInput.size(), updatedNodeLayoutInput.resizedByUser(), updatedNodeLayoutInput.handleLayoutData());
            ...
            layoutDiagramInput.diagramLayoutData().labelLayoutData()
                    .forEach(updatedLabelLayoutInput -> {
                        ...
                        if (previousLabelLayoutData != null) {
                            if (!isSameLabelLayoutData(previousLabelLayoutData, updatedLabelLayoutInput)) {
                                var updatedLabelLayout = new LabelLayoutData(updatedLabelLayoutInput.id(), updatedLabelLayoutInput.position());
