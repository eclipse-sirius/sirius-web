...
public class HideButtonDescriptionProvider implements IDiagramFilterActionContributionProvider {
    ...
    public HideButtonDescriptionProvider(IIdentityService identityService, IDiagramFilterHelper diagramFilterHelper, IMessageService messageService) {
    ...
    public ButtonDescription getButtonDescription() {
        return ButtonDescription.newButtonDescription("diagram-filter/split-button/hide")
                ...
                .labelProvider(variableManager -> this.messageService.diagramFilterHideElements())
                .iconURLProvider(variableManager -> List.of())
                .isReadOnlyProvider(variableManager -> false)
                .buttonLabelProvider(variableManager -> this.messageService.diagramFilterHideElements())
