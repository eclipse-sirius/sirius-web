 ...
 * @author tgiraudet
 */
public interface IViewsExplorerLabelService {

    boolean isEditable(IEditingContext editingContext, Object self);

    StyledString getLabel(IEditingContext editingContext, Object self);
