...
public class EditingContext implements IEMFEditingContext {
    ...
    private final Map<String, IViewConversionData> representationDescriptionIdToConverterResult = new HashMap<>();
    ...
    public Map<String, IViewConversionData> getRepresentationDescriptionIdToConverterResult() {
        return this.representationDescriptionIdToConverterResult;
    }
