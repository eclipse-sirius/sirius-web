 ...
 * @author gdaniel
 */
public record SemanticDataDependencyAddedEvent(
        @NotNull UUID id,
        @NotNull Instant createdOn,
        @NotNull ICause causedBy,
        @NotNull SemanticData semanticData,
        @NotNull SemanticDataDependency dependency) implements ISemanticDataEvent {
}
