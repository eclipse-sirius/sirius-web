...
/**
 * Integration tests of NodeDescriptionUserResizableMigrationParticipant.
 *
 * @author mcharfadi
 */
@Transactional
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class NodeDescriptionUserResizableMigrationParticipantTests extends AbstractIntegrationTests {
    ...
    public void givenAnOldViewDiagramNodeDescriptionUserResizableMigrationParticipantIsExecutedProperly() {
        var content = """
                         ...
                         "descriptions": [
                           {
                             ...
                             "data": {
                               "name": "NodeDescription#userResizable migration_upload",
                ...
                """;
        this.uploadDocument(MigrationIdentifiers.MIGRATION_NODE_DESCRIPTION_USER_RESIZABLE_STUDIO.toString(), "test_upload", content);
    }
