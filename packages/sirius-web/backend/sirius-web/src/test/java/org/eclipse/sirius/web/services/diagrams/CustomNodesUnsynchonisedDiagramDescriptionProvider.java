...
/**
 * Used to provide a view based diagram description to test unsynchronised custom nodes in diagrams.
 *
 * @author mcharfadi
 */
@Service
@Conditional(OnStudioTests.class)
public class CustomNodesUnsynchonisedDiagramDescriptionProvider implements IEditingContextProcessor {
    ...
    public CustomNodesUnsynchonisedDiagramDescriptionProvider(IDiagramIdProvider diagramIdProvider) {
    ...
    public String getCustomNodeDescriptionId() {
        return this.diagramIdProvider.getId(this.diagramDescription.getNodeDescriptions().get(0));
    }
    ...
    private View createView() {
        ...
        String resourcePath = UUID.nameUUIDFromBytes("CustomNodesUnsynchronisedDiagramDescription".getBytes()).toString();
        JsonResource resource = new JSONResourceFactory().createResourceFromPath(resourcePath);
        resource.eAdapters().add(new ResourceMetadataAdapter("CustomNodesUnsynchronisedDiagramDescription"));
