...
import org.eclipse.sirius.components.diagrams.tests.graphql.ResetRectangularNodeAppearanceMutationRunner;
...
public class EditRectangularNodeAppearanceControllerTests extends AbstractIntegrationTests {
    ...
    @Autowired
    private ResetRectangularNodeAppearanceMutationRunner resetRectangularNodeAppearanceMutationRunner;
    ...
    @DisplayName("Setting a diagram node inside label to bold and then resetting it to the default style")
    public void setNodeLabelBoldAndReset() {
        ...
        Runnable resetLabelBold = () -> {
            ...
            var input = new ResetRectangularNodeAppearanceInput(
                    UUID.randomUUID(),
                    PapayaIdentifiers.PAPAYA_EDITING_CONTEXT_ID.toString(),
                    diagramId.get(),
                    siriusWebApplicationNodeId.get(),
            ...
            this.resetRectangularNodeAppearanceMutationRunner.run(input);
        };
