...
public class TextfieldControllerTests extends AbstractIntegrationTests {
    ...
    public void givenTextFieldWidgetRepresentingAEIntegerObjectWhenItIsEditedThenItsValueIsUpdated() {
        var detailsEventInput = new DetailsEventInput(UUID.randomUUID(), PapayaIdentifiers.PAPAYA_PROJECT.toString(), List.of(PapayaIdentifiers.FIRST_TASK_OBJECT.toString()));
