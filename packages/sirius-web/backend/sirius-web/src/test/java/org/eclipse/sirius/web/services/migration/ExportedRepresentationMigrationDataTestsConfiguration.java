...
/**
 * The configuration specific to the {@link ExportedRepresentationMigrationDataTests} which register a custom {@link IRepresentationMigrationParticipant}.
 *
 * @author tgiraudet
 */
public class ExportedRepresentationMigrationDataTestsConfiguration {

    @Bean
    public IRepresentationMigrationParticipant addXPositionChangerMigrationParticipant() {
