...
import org.eclipse.sirius.components.view.builder.generated.form.ConditionalSelectDescriptionStyleBuilder;
...
import org.eclipse.sirius.components.view.builder.generated.form.SelectDescriptionStyleBuilder;
...
/**
 * Used to provide a view based form description to test select style.
 *
 * @author frouene
 */
@Service
...
public class FormWithStyledSelectDescriptionProvider implements IEditingContextProcessor {
    ...
    public FormWithStyledSelectDescriptionProvider(IFormIdProvider formIdProvider) {
    ...
    private View createView() {
        ...
        String resourcePath = UUID.nameUUIDFromBytes("FormWithStyledSelectDescription".getBytes()).toString();
        JsonResource resource = new JSONResourceFactory().createResourceFromPath(resourcePath);
        resource.eAdapters().add(new ResourceMetadataAdapter("FormWithStyledSelectDescription"));
    ...
    private FormDescription createFormDescription() {
        var superTypesReferenceStyle = new SelectDescriptionStyleBuilder()
                .bold(false)
        ...
        var conditionalSuperTypesReferenceStyle = new ConditionalSelectDescriptionStyleBuilder()
                .bold(true)
        ...
        this.formDescription = new FormDescriptionBuilder()
                .name("Form")
                .titleExpression("aql:'FormWithStyledSelect'")
                .domainType("domain:Entity")
