...
public class ProjectTemplateControllerIntegrationTests extends AbstractIntegrationTests {
    ...
    public void givenProjectToCreateFromTemplateWhenMutationIsPerformedThenTheProjectIsCreated() {
        ...
        var input = new CreateProjectFromTemplateInput(UUID.randomUUID(), StudioProjectTemplateProvider.STUDIO_TEMPLATE_NAME, StudioProjectTemplateProvider.STUDIO_TEMPLATE_ID, List.of(StudioProjectTemplateProvider.STUDIO_NATURE));
    ...
    public void givenPapayaProjectTemplateWhenMutationIsPerformedThenTheProjectIsCreated() {
        ...
        var input = new CreateProjectFromTemplateInput(UUID.randomUUID(), PapayaProjectTemplateProvider.BENCHMARK_PROJECT_TEMPLATE_NAME, PapayaProjectTemplateProvider.BENCHMARK_PROJECT_TEMPLATE_ID, List.of(PapayaProjectTemplateProvider.PAPAYA_NATURE));
        var result = this.createProjectFromTemplateMutationRunner.run(input);
