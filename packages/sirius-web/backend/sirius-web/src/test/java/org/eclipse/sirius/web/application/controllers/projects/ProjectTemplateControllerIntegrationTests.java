...
public class ProjectTemplateControllerIntegrationTests extends AbstractIntegrationTests {
    ...
    public void givenProjectToCreateFromTemplateWhenMutationIsPerformedThenTheProjectIsCreated() {
        ...
        var input = new CreateProjectInput(UUID.randomUUID(), "Studio", StudioProjectTemplateProvider.STUDIO_TEMPLATE_ID, List.of(StudioProjectTemplateProvider.STUDIO_NATURE), List.of());
    ...
    public void givenPapayaProjectTemplateWhenMutationIsPerformedThenTheProjectIsCreated() {
        ...
        var input = new CreateProjectInput(UUID.randomUUID(), "Papaya - Performance", PapayaProjectTemplateProvider.BENCHMARK_PROJECT_TEMPLATE_ID, List.of(PapayaProjectTemplateProvider.PAPAYA_NATURE), List.of());
        var result = this.createProjectMutationRunner.run(input);
