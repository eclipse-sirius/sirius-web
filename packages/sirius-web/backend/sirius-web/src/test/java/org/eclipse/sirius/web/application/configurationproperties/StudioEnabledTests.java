...
public class StudioEnabledTests extends AbstractIntegrationTests {
    @Autowired
    private List<IProjectTemplateProvider> projectTemplateProviders;

    @Test
    @DisplayName("Given Sirius Web studio features enabled, when project template providers are requested, then studio support is available")
    public void givenSiriusWebStudioFeaturesEnabledWhenProjectTemplateProvidersAreRequestedThenStudioSupportIsAvailable() {
