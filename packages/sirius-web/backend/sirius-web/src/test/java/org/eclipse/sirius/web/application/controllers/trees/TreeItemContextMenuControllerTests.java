...
public class TreeItemContextMenuControllerTests extends AbstractIntegrationTests {
    ...
    public void givenAStudioWhenTheContextMenuActionsAreRequestedOnAnEntityThenTheCorrectActionsAreReturned() {
        ...
        Runnable getContextMenuActions = () -> {
            ...
            FetchTreeItemContextMenuEntry helpFetchTreeItemContextMenuEntry = JsonPath.parse(result, configuration).read("$.data.viewer.editingContext.representation.description.contextMenu[" + helpIdIndex + "]", FetchTreeItemContextMenuEntry.class);
            ...
            SingleClickTreeItemContextMenuEntry toggleAbstractSingleClickTreeItemContextMenuEntry = JsonPath.parse(result, configuration).read("$.data.viewer.editingContext.representation.description.contextMenu[" + toggleAbstractActionIdIndex + "]",
