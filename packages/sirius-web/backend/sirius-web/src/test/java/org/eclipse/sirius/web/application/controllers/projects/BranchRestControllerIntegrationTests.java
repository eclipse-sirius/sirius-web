    ...
    public void givenSiriusWebRestAPIWhenWeAskForAllBranchesOfAProjectThenItShouldReturnAllBranchesOfAProject() {
        ...
        webTestClient
                ...
                .consumeWith(result -> {
                    ...
                    assertEquals(TestIdentifiers.UML_SAMPLE_PROJECT, restBranches.get(0).id());
                    assertEquals("Branch", restBranches.get(0).type());
                    assertEquals(TestIdentifiers.UML_SAMPLE_PROJECT, restBranches.get(0).owningProject().id());
                });
    }
    ...
    public void givenSiriusWebRestAPIWhenWeAskForASpecificBranchOfAProjectThenItShouldReturnThisBranch() {
        ...
        webTestClient
                ...
                .consumeWith(result -> {
                    ...
                    assertEquals(TestIdentifiers.UML_SAMPLE_PROJECT, restBranch.id());
                    assertEquals("Branch", restBranch.type());
                    assertEquals(TestIdentifiers.UML_SAMPLE_PROJECT, restBranch.owningProject().id());
                });
    }
