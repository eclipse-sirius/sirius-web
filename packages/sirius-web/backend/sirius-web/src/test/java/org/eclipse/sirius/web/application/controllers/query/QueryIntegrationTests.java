...
public class QueryIntegrationTests extends AbstractIntegrationTests {
    ...
    public void givenProjectWhenWeExecuteAnExpressionReturningCollectionOfObjectsThenTheResultIsReturned() {
        ...
        assertThat(labels)
                .isNotEmpty()
                .containsExactlyInAnyOrder("sirius-web-tests-data", "sirius-web-domain", "sirius-web-application", "sirius-web-infrastructure", "sirius-web-starter", "sirius-web", "graphql-java");
    }
