...
public class TestRepresentationDescriptionsProvider implements IRepresentationDescriptionsProvider {
    ...
    public List<RepresentationDescriptionMetadataDTO> handle(IEditingContext editingContext, Object object, IRepresentationDescription representationDescription) {
        return List.of(new RepresentationDescriptionMetadataDTO(representationDescription.getId(), representationDescription.getLabel(), "Test Representation", "Test documentation"));
    }
}
