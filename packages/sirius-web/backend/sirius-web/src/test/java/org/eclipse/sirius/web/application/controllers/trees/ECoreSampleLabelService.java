 ...
 * @author mcharfadi
 */
public class ECoreSampleLabelService extends DefaultLabelService implements ILabelServiceDelegate {

    public ECoreSampleLabelService(LabelFeatureProviderRegistry labelFeatureProviderRegistry, ComposedAdapterFactory composedAdapterFactory, List<IRepresentationImageProvider> representationImageProviders) {
    ...
    public StyledString getStyledLabel(Object object) {
        if (object instanceof EObject eObject) {
            ...
            var style = StyledStringFragmentStyle.newDefaultStyledStringFragmentStyle().backgroundColor("red").strikedout(true).build();
