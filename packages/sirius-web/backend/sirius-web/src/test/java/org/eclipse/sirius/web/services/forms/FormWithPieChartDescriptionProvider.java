...
/**
 * Used to provide a view based form description to test pie charts.
 *
 * @author sbegaudeau
 */
@Service
...
public class FormWithPieChartDescriptionProvider implements IEditingContextProcessor {
    ...
    public FormWithPieChartDescriptionProvider(IFormIdProvider formIdProvider) {
    ...
    private View createView() {
        ...
        String resourcePath = UUID.nameUUIDFromBytes("FormWithPieChartDescription".getBytes()).toString();
        JsonResource resource = new JSONResourceFactory().createResourceFromPath(resourcePath);
        resource.eAdapters().add(new ResourceMetadataAdapter("FormWithPieChartDescription"));
    ...
    private FormDescription createFormDescription() {
        var conditionalStyle = new FormBuilders().newConditionalPieChartDescriptionStyle()
        ...
        var style = new FormBuilders().newPieChartDescriptionStyle()
                .fontSize(16)
                .bold(false)
                .underline(false)
                .italic(false)
        ...
        var pieChartDescription = new FormBuilders().newPieChartDescription()
                .name("Pie Chart")
        ...
        this.formDescription = new FormDescriptionBuilder()
                .name("Form")
                .titleExpression("aql:'FormWithPieChart'")
                .domainType("domain:Domain")
