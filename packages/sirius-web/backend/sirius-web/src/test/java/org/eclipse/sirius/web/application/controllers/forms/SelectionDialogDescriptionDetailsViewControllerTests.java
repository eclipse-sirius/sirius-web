...
public class SelectionDialogDescriptionDetailsViewControllerTests extends AbstractIntegrationTests {
    ...
    @DisplayName("Given a selection dialog description, when we subscribe to its properties event, then the form is sent")
    public void givenSelectionDialogDescriptionWhenWeSubscribeToItsPropertiesEventsThenTheFormIsSent() {
