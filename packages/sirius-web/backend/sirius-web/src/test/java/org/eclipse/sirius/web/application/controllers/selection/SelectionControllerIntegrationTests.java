...
public class SelectionControllerIntegrationTests extends AbstractIntegrationTests {
    ...
    public void givenSemanticObjectWhenRequestingSelectionDescriptionThenTheSelectionDescriptionIsSent() {
        ...
        List<SelectionDialogVariable> selectionDialogVariables = List.of(new SelectionDialogVariable("targetObjectId", PapayaIdentifiers.PROJECT_OBJECT.toString()),
                new SelectionDialogVariable("sourceDiagramElementTargetObjectId", PapayaIdentifiers.FIRST_TASK_OBJECT.toString()));
        List<Map<String, Object>> variablesParameter = this.objectMapper.convertValue(selectionDialogVariables, new TypeReference<List<Map<String, Object>>>() { });
        Map<String, Object> variables = Map.of("editingContextId", PapayaIdentifiers.PAPAYA_PROJECT.toString(), "representationId", representationId, "variables", variablesParameter);
