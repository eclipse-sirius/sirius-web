 ...
 *******************************************************************************/
package org.eclipse.sirius.web.e2e.tests.diagramDecorator;
...
import org.eclipse.sirius.web.e2e.tests.diagramEdge.DiagramEdgeDomainProvider;
...
/**
 * The view provider for the decorator.spec.ts test suite.
 *
 * @author mcharfadi
 */
@Profile("e2e")
...
public class DiagramDecoratorViewProvider implements IE2EViewProvider {
    ...
    public List<View> createViews() {
        ...
        String resourcePath = UUID.nameUUIDFromBytes("DiagramDecoratorView".getBytes()).toString();
        JsonResource resource = new JSONResourceFactory().createResourceFromPath(resourcePath);
        resource.eAdapters().add(new ResourceMetadataAdapter("DiagramDecoratorView"));
    ...
    private DiagramDescription createDiagramDescription(IColorProvider colorProvider) {
        ...
        return new DiagramBuilders()
                ...
                .name(DiagramEdgeDomainProvider.DOMAIN_NAME + " - node decorator")
                .domainType(DiagramEdgeDomainProvider.DOMAIN_NAME + "::Root")
                .titleExpression(DiagramEdgeDomainProvider.DOMAIN_NAME + " decorator")
                ...
                .decoratorDescriptions(buildDecoratorDescription(nodeDescription1, nodeDescription2), buildDecoratorDescription(nodeDescription1, nodeDescription2))
                .toolbar(toolbar)
                .style(new DiagramBuilders().newDiagramStyleDescription().build())
                .build();
    }

    private NodeDecoratorDescription buildDecoratorDescription(NodeDescription nodeDescription1, NodeDescription nodeDescription2) {
        return new DiagramBuilders()
                .newNodeDecoratorDescription()
                .nodeDescriptions(nodeDescription1, nodeDescription2)
                .name("decorator")
                .position(DecoratorPosition.NORTH_WEST)
                .preconditionExpression("aql:true")
                .labelExpression("decorator")
                .iconURLExpression("aql:'icons/full/obj16/CheckboxDescription.svg'")
                .build();
    }
