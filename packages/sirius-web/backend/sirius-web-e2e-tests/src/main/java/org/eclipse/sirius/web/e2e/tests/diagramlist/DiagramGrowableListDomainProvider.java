...
/**
 * Used to contribute domains for diagram-growable-list.cy.ts tests.
 *
 * @author frouene
 */
@Profile("test")
@Service
public class DiagramGrowableListDomainProvider implements IDomainProvider {

    public static final String DOMAIN_NAME = "diagramGrowableList";
