...
/**
 * The view provider for edge on icon label test suite.
 *
 * @author frouene
 */
@Profile("test")
...
public class DiagramEdgeIconLabelViewProvider implements IE2EViewProvider {
    ...
    public List<View> createViews() {
        ...
        String resourcePath = UUID.nameUUIDFromBytes("DiagramEdgeIconLabel".getBytes()).toString();
        JsonResource resource = new JSONResourceFactory().createResourceFromPath(resourcePath);
        resource.eAdapters().add(new ResourceMetadataAdapter("DiagramEdgeIconLabelView"));
    ...
    private DiagramDescription createDiagramDescription(IColorProvider colorProvider) {
        ...
        var nodeDescription2 = this.getIconLabelNodeDescription(colorProvider, "Entity2");
    ...
    private NodeDescription getNodeDescription(IColorProvider colorProvider, String entityName) {
        return new DiagramBuilders()
                .newNodeDescription()
                .name(entityName)
                .domainType(DiagramEdgeIconLabelDomainProvider.DOMAIN_NAME + "::" + entityName)
                .semanticCandidatesExpression("aql:self.eContents()")
                .synchronizationPolicy(SynchronizationPolicy.SYNCHRONIZED)
                .collapsible(true)
                .userResizable(UserResizableDirection.BOTH)
                .keepAspectRatio(false)
                .insideLabel(new DiagramBuilders()
    ...
    private NodeDescription getIconLabelNodeDescription(IColorProvider colorProvider, String entityName) {
        return new DiagramBuilders()
                .newNodeDescription()
                .name(entityName)
                .domainType(DiagramEdgeIconLabelDomainProvider.DOMAIN_NAME + "::" + entityName)
    ...
    private EdgeDescription getEdgeDescription(IColorProvider colorProvider, DiagramElementDescription sourceDescription, DiagramElementDescription targetDescription) {
        return new DiagramBuilders()
                ...
                .targetExpression("aql:self.entity2LinkedToEntity2")
