...
@Profile("test")
@Service
public class DiagramSelfContainedDomainProvider implements IDomainProvider {

    public static final String DOMAIN_NAME = "diagramSelfContained";
    ...
    public List<Domain> getDomains(IEditingContext editingContext) {
        ...
        Relation selfContained = DomainFactory.eINSTANCE.createRelation();
        selfContained.setName("selfContained");
        selfContained.setContainment(true);
        selfContained.setOptional(true);
        selfContained.setMany(true);
        selfContained.setTargetType(entity1);
        entity1.getRelations().add(selfContained);
