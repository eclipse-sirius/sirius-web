...
package org.eclipse.sirius.web.e2e.tests.diagramnode;
...
/**
 * The view provider for the simple node test suite.
 *
 * @author frouene
 */
@Profile("test")
...
public class DiagramNodeViewProvider implements IE2EViewProvider {
    ...
    public List<View> createViews() {
        ...
        String resourcePath = UUID.nameUUIDFromBytes("diagramNodeView".getBytes()).toString();
        JsonResource resource = new JSONResourceFactory().createResourceFromPath(resourcePath);
        resource.eAdapters().add(new ResourceMetadataAdapter("diagramNodeView"));
    ...
    private DiagramDescription createDiagramDescription(IColorProvider colorProvider) {
        ...
        return new DiagramBuilders()
                ...
                .domainType(DiagramNodeDomainProvider.DOMAIN_NAME + "::Root")
    ...
    private NodeDescription getRectangularNodeDescription(IColorProvider colorProvider) {
        return new DiagramBuilders()
                ...
                .domainType(DiagramNodeDomainProvider.DOMAIN_NAME + "::Entity1")
                ...
                .insideLabel(this.getInsideLabel(colorProvider))
                .build();
    }

    private NodeDescription getIconLabelNodeDescription(IColorProvider colorProvider) {
        return new DiagramBuilders()
                .newNodeDescription()
                .name("IconLabelNodeStyle")
                .domainType(DiagramNodeDomainProvider.DOMAIN_NAME + "::Entity1")
                .semanticCandidatesExpression("aql:self.eContents()")
                .synchronizationPolicy(SynchronizationPolicy.SYNCHRONIZED)
                .collapsible(true)
    ...
    private InsideLabelDescription getInsideLabel(IColorProvider colorProvider) {
        return new DiagramBuilders()
