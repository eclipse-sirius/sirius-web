...
/**
 * Used to contribute domains for node creation tests.
 *
 * @author frouene
 */
@Profile("test")
@Service
public class DiagramNodeCreationDomainProvider implements IDomainProvider {

    public static final String DOMAIN_NAME = "diagramNodeCreation";
    ...
    public List<Domain> getDomains(IEditingContext editingContext) {
        ...
        Relation entity1LinkToEntity2 = DomainFactory.eINSTANCE.createRelation();
        entity1LinkToEntity2.setName("entity1LinkToEntity2");
        entity1LinkToEntity2.setContainment(false);
        entity1LinkToEntity2.setOptional(true);
        entity1LinkToEntity2.setMany(true);
