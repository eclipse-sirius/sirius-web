...
/**
 * {@link IContainmentFeatureNameProviderDelegate} used to test the delegation of the computation of feature names in an integration test.
 *
 * @author Arthur Daussy
 */
@Service
public class CustomTestContainmentFeatureNameProvider implements IContainmentFeatureNameProviderDelegate {

    @Override
    public boolean canHandle(Object child, Object container) {
