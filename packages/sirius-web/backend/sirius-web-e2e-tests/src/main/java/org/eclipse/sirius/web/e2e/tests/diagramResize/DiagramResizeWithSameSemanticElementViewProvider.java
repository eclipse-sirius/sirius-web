...
@Profile("test")
@Service
public class DiagramResizeWithSameSemanticElementViewProvider implements IE2EViewProvider {
    ...
    public List<View> createViews() {
        ...
        var diagramDescription = this.diagramDescription(colorProvider);
        ...
        String resourcePath = UUID.nameUUIDFromBytes("DiagramResizeWithSameSemanticElementView".getBytes()).toString();
        JsonResource resource = new JSONResourceFactory().createResourceFromPath(resourcePath);
        resource.eAdapters().add(new ResourceMetadataAdapter("DiagramResizeWithSameSemanticElementView"));
    ...
    private NodeDescriptionBuilder getNodeDescription(IColorProvider colorProvider) {
        return new DiagramBuilders()
                .newNodeDescription()
                .name("Node")
                .domainType(DiagramResizeDomainProvider.DOMAIN_NAME + "::Entity1")
