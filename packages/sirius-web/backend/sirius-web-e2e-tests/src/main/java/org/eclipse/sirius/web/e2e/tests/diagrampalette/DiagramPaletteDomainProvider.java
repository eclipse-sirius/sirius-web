...
/**
 * Used to contribute domains for diagram palette tests.
 *
 * @author frouene
 */
@Profile("e2e")
@Service
public class DiagramPaletteDomainProvider implements IDomainProvider {

    public static final String DOMAIN_NAME = "diagramPalette";
