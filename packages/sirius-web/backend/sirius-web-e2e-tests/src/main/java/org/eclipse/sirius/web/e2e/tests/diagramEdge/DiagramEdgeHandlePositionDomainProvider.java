...
/**
 * Used to contribute domains for handle position tests.
 *
 * @author frouene
 */
...
@Profile("test")
@Service
public class DiagramEdgeHandlePositionDomainProvider implements IDomainProvider {

    public static final String DOMAIN_NAME = "diagramEdgeHandlePosition";
