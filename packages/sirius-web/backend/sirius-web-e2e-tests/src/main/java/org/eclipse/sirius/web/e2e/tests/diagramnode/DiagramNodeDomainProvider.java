...
/**
 * Used to contribute domains for simple node tests.
 *
 * @author frouene
 */
@Profile("test")
@Service
public class DiagramNodeDomainProvider implements IDomainProvider {

    public static final String DOMAIN_NAME = "diagramNode";
