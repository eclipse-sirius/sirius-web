...
/**
 * Used to contribute domains for edge on icon label tests.
 *
 * @author frouene
 */
...
@Profile("test")
@Service
public class DiagramEdgeIconLabelDomainProvider implements IDomainProvider {

    public static final String DOMAIN_NAME = "diagramEdgeIconLabel";
    ...
    public List<Domain> getDomains(IEditingContext editingContext) {
        ...
        Relation entity2LinkedToEntity2 = DomainFactory.eINSTANCE.createRelation();
        entity2LinkedToEntity2.setName("entity2LinkedToEntity2");
        entity2LinkedToEntity2.setContainment(false);
        entity2LinkedToEntity2.setOptional(true);
        entity2LinkedToEntity2.setMany(true);
        entity2LinkedToEntity2.setTargetType(entity2);
        entity2.getRelations().add(entity2LinkedToEntity2);
