...
/**
 * Used to contribute domains for diagram-list.cy.ts tests.
 *
 * @author frouene
 */
@Profile("test")
@Service
public class DiagramListDomainProvider implements IDomainProvider {

    public static final String DOMAIN_NAME = "diagramList";
