...
public class ElasticsearchConfiguration {
    ...
    @Bean
    ElasticsearchClient elasticSearchClient(ElasticsearchTransport transport, ElasticsearchProperties properties) {
    ...
    ElasticsearchTemplate elasticsearchTemplate(Optional<ElasticsearchClient> optionalElasticsearchClient, ElasticsearchConverter converter) {
    ...
    ReactiveElasticsearchTemplate reactiveElasticsearchTemplate(Optional<ReactiveElasticsearchClient> optionalReactiveElasticsearchClient,
