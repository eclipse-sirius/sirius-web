...
public class GanttEventSubscriptionRunner implements ISubscriptionRunner<GanttEventInput> {
    ...
    public static final String GANTT_EVENT_SUBSCRIPTION = """
    ...
    @Override
    public GraphQLSubscriptionResult run(GanttEventInput input) {
        var rawResult = this.graphQLRequestor.subscribe(GANTT_EVENT_SUBSCRIPTION, input);
