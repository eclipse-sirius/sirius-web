 ...
 */
@Service
public class UpdateLibraryMutationRunner implements IMutationRunner<UpdateLibraryInput> {

    private static final String UPDATE_LIBRARY = """
    ...
    public UpdateLibraryMutationRunner(IGraphQLRequestor graphQLRequestor) {
