...
/**
 * Used to get the tooltip of a tree item.
 *
 * @author gdaniel
 */
@Service
public class TreeItemTooltipQueryRunner implements IQueryRunner {
    ...
    public TreeItemTooltipQueryRunner(IGraphQLRequestor graphQLRequestor) {
        this.graphQLRequestor = Objects.requireNonNull(graphQLRequestor);
    }

    @Override
    public GraphQLResult run(Map<String, Object> variables) {
        return this.graphQLRequestor.execute(TREE_ITEM_TOOLTIP_QUERY, variables);
    }
