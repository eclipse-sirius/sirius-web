...
public class CustomwidgetsPackageImpl extends EPackageImpl implements CustomwidgetsPackage {
     ...
     *
     * <p>
     * This method is used to initialize {@link CustomwidgetsPackage#eINSTANCE} when that field is accessed. Clients
    ...
    public static CustomwidgetsPackage init() {
        ...
        CustomwidgetsPackageImpl theCustomwidgetsPackage = registeredCustomwidgetsPackage instanceof CustomwidgetsPackageImpl ? (CustomwidgetsPackageImpl) registeredCustomwidgetsPackage
                : new CustomwidgetsPackageImpl();
    ...
    public void initializePackageContents() {
        ...
        this.sliderDescriptionEClass.getESuperTypes().add(theFormPackage.getWidgetDescription());
