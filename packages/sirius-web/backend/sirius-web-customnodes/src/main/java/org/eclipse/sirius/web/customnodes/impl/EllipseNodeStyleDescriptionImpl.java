 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.sirius.web.customnodes.impl.EllipseNodeStyleDescriptionImpl#getFontSize <em>Font
 * Size</em>}</li>
 * <li>{@link org.eclipse.sirius.web.customnodes.impl.EllipseNodeStyleDescriptionImpl#isItalic <em>Italic</em>}</li>
 * <li>{@link org.eclipse.sirius.web.customnodes.impl.EllipseNodeStyleDescriptionImpl#isBold <em>Bold</em>}</li>
 * <li>{@link org.eclipse.sirius.web.customnodes.impl.EllipseNodeStyleDescriptionImpl#isUnderline
 * <em>Underline</em>}</li>
 * <li>{@link org.eclipse.sirius.web.customnodes.impl.EllipseNodeStyleDescriptionImpl#isStrikeThrough <em>Strike
 * Through</em>}</li>
 * <li>{@link org.eclipse.sirius.web.customnodes.impl.EllipseNodeStyleDescriptionImpl#getBorderColor <em>Border
 * Color</em>}</li>
 * <li>{@link org.eclipse.sirius.web.customnodes.impl.EllipseNodeStyleDescriptionImpl#getBorderRadius <em>Border
 * Radius</em>}</li>
 * <li>{@link org.eclipse.sirius.web.customnodes.impl.EllipseNodeStyleDescriptionImpl#getBorderSize <em>Border
 * Size</em>}</li>
 * <li>{@link org.eclipse.sirius.web.customnodes.impl.EllipseNodeStyleDescriptionImpl#getBorderLineStyle <em>Border Line
 * Style</em>}</li>
...
public class EllipseNodeStyleDescriptionImpl extends StyleImpl implements EllipseNodeStyleDescription {
    ...
    protected EClass eStaticClass() {
        return CustomnodesPackage.Literals.ELLIPSE_NODE_STYLE_DESCRIPTION;
    }
    ...
    public void setFontSize(int newFontSize) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__FONT_SIZE, oldFontSize, this.fontSize));
    }
    ...
    public void setItalic(boolean newItalic) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__ITALIC, oldItalic, this.italic));
    }
    ...
    public void setBold(boolean newBold) {
        ...
        this.bold = newBold;
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__BOLD, oldBold, this.bold));
    }
    ...
    public void setUnderline(boolean newUnderline) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__UNDERLINE, oldUnderline, this.underline));
    }
    ...
    public void setStrikeThrough(boolean newStrikeThrough) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__STRIKE_THROUGH, oldStrikeThrough, this.strikeThrough));
    }
    ...
    public UserColor getBorderColor() {
        if (this.borderColor != null && this.borderColor.eIsProxy()) {
            ...
            if (this.borderColor != oldBorderColor) {
                if (this.eNotificationRequired())
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__BORDER_COLOR, oldBorderColor, this.borderColor));
            }
        }
    ...
    public void setBorderColor(UserColor newBorderColor) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__BORDER_COLOR, oldBorderColor, this.borderColor));
    }
    ...
    public void setBorderRadius(int newBorderRadius) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__BORDER_RADIUS, oldBorderRadius, this.borderRadius));
    }
    ...
    public void setBorderSize(int newBorderSize) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__BORDER_SIZE, oldBorderSize, this.borderSize));
    }
    ...
    public void setBorderLineStyle(LineStyle newBorderLineStyle) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__BORDER_LINE_STYLE, oldBorderLineStyle, this.borderLineStyle));
    }
    ...
    public UserColor getLabelColor() {
        if (this.labelColor != null && this.labelColor.eIsProxy()) {
            ...
            if (this.labelColor != oldLabelColor) {
                if (this.eNotificationRequired())
                    this.eNotify(new ENotificationImpl(this, Notification.RESOLVE, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__LABEL_COLOR, oldLabelColor, this.labelColor));
            }
        }
    ...
    public void setLabelColor(UserColor newLabelColor) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__LABEL_COLOR, oldLabelColor, this.labelColor));
    }
    ...
    public void setShowIcon(boolean newShowIcon) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__SHOW_ICON, oldShowIcon, this.showIcon));
    }
    ...
    public void setLabelIcon(String newLabelIcon) {
        ...
        if (this.eNotificationRequired())
            this.eNotify(new ENotificationImpl(this, Notification.SET, CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__LABEL_ICON, oldLabelIcon, this.labelIcon));
    }
        ...
        if (baseClass == LabelStyle.class) {
            switch (baseFeatureID) {
                case ViewPackage.LABEL_STYLE__FONT_SIZE:
                    return CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__FONT_SIZE;
                case ViewPackage.LABEL_STYLE__ITALIC:
                    return CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__ITALIC;
                case ViewPackage.LABEL_STYLE__BOLD:
                    return CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__BOLD;
                case ViewPackage.LABEL_STYLE__UNDERLINE:
                    return CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__UNDERLINE;
                case ViewPackage.LABEL_STYLE__STRIKE_THROUGH:
                    return CustomnodesPackage.ELLIPSE_NODE_STYLE_DESCRIPTION__STRIKE_THROUGH;
                default:
                    return -1;
            }
        }
