...
/**
 * Papaya project full table representation description.
 *
 * @author Jerome Gout
 */
@Service
public class ProjectTableRepresentationDescription implements IRepresentationDescriptionsProvider {

    @Override
    public boolean canHandle(IRepresentationDescription representationDescription) {
        return representationDescription.getId().equals(ProjectTableRepresentationDescriptionProvider.TABLE_DESCRIPTION_ID);
    }
