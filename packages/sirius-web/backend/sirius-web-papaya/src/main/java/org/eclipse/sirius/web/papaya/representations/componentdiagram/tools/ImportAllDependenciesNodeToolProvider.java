...
/**
 * Used to create the import all dependencies tool.
 *
 * @author sbegaudeau
 */
public class ImportAllDependenciesNodeToolProvider implements INodeToolProvider {
    @Override
                        ...
                        new ViewBuilders().newChangeContext()
                                ...
                                .children(
                                        new ViewBuilders().newFor()
                                                .expression("aql:self.allDependencies")
