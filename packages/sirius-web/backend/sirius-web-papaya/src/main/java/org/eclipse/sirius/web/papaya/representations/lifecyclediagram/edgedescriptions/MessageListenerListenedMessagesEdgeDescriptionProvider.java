...
public class MessageListenerListenedMessagesEdgeDescriptionProvider implements IEdgeDescriptionProvider {
    ...
    public EdgeDescription create() {
        ...
        return new DiagramBuilders().newEdgeDescription()
                ...
                .targetNodesExpression("aql:self.listenedMessages")
    ...
    public void link(DiagramDescription diagramDescription, IViewDiagramElementFinder cache) {
        ...
        messageListenerListenedMessagesEdgeDescription.getSourceNodeDescriptions().addAll(List.of(controllerNodeDescription, applicationServiceNodeDescription, domainServiceNodeDescription));
        messageListenerListenedMessagesEdgeDescription.getTargetNodeDescriptions().addAll(List.of(commandNodeDescription, eventNodeDescription));
