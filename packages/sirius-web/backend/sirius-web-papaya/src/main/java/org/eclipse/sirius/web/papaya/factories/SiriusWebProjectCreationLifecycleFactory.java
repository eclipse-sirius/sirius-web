...
public class SiriusWebProjectCreationLifecycleFactory implements IObjectFactory {
    ...
    public void link(IEObjectIndexer eObjectIndexer) {
        ...
        this.projectCreatedEvent.setCausedBy(this.createProjectInput);
        ...
        this.semanticDataCreatedEvent.setCausedBy(this.projectCreatedEvent);
        ...
        this.projectSemanticDataCreatedEvent.setCausedBy(this.semanticDataCreatedEvent);
    }
}
