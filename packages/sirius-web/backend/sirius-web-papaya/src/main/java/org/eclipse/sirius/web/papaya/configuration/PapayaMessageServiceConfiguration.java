 ...
 */
@Configuration
public class PapayaMessageServiceConfiguration {
    private static final String PATH = "messages/sirius-web-papaya";

    @Bean
    public MessageSourceAccessor papayaMessageSourceAccessor(@Value("${spring.mvc.locale:en_EN}") Locale locale) {
