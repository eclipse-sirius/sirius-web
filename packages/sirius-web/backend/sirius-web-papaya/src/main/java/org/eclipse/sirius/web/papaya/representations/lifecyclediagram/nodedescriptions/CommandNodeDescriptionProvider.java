...
/**
 * Used to create the command node description.
 *
 * @author sbegaudeau
 */
public class CommandNodeDescriptionProvider implements INodeDescriptionProvider {

    public static final String NAME = "Command";

    private final IColorProvider colorProvider;

    public CommandNodeDescriptionProvider(IColorProvider colorProvider) {
    ...
    public NodeDescription create() {
        ...
        return new DiagramBuilders().newNodeDescription()
                .name(NAME)
                .domainType("papaya::Command")
                .semanticCandidatesExpression("aql:self.commands")
    ...
    public void link(DiagramDescription diagramDescription, IViewDiagramElementFinder cache) {
        ...
        var commandNodeDescription = cache.getNodeDescription(NAME).orElse(null);
        applicationLayerNodeDescription.getChildrenDescriptions().add(commandNodeDescription);
    }
}
