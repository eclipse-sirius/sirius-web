 ...
 */
@Service
public class PapayaWorkbenchConfigurationService implements IWorkbenchConfigurationServiceDelegate {

    private final IPapayaCapableEditingContextPredicate papayaCapableEditingContextPredicate;

    public PapayaWorkbenchConfigurationService(IPapayaCapableEditingContextPredicate papayaCapableEditingContextPredicate) {
