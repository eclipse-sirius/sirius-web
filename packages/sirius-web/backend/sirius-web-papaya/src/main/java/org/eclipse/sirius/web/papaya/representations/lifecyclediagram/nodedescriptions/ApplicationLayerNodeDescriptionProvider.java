...
/**
 * Used to create the application layer node description.
 *
 * @author sbegaudeau
 */
public class ApplicationLayerNodeDescriptionProvider implements INodeDescriptionProvider {

    public static final String NAME = "Application Layer";

    private final IColorProvider colorProvider;

    public ApplicationLayerNodeDescriptionProvider(IColorProvider colorProvider) {
    ...
    public NodeDescription create() {
        ...
        var insideLabel = new DiagramBuilders().newInsideLabelDescription()
                .labelExpression("Application Layer")
        ...
        var nodeStyle = new DiagramBuilders().newRectangularNodeStyleDescription()
                ...
                .borderColor(this.colorProvider.getColor(PapayaColorPaletteProvider.APPLICATION_DARK))
                .borderSize(1)
                .borderRadius(0)
    ...
    public void link(DiagramDescription diagramDescription, IViewDiagramElementFinder cache) {
        ...
        var applicationLayerNodeDescription = cache.getNodeDescription(NAME).orElse(null);
        applicationConcernNodeDescription.getChildrenDescriptions().add(applicationLayerNodeDescription);
    }
}
