...
export const useViewsExplorerViewSubscription = (
  ...
  const input = {
    id: state.id,
    editingContextId,
    representationId: `viewsexplorer://?treeDescriptionId=views_explorer_form_description&expandedIds=[${expanded
  ...
  useSubscription(gql(getTreeEventSubscription(2, 'viewsExplorerEvent', 'ViewsExplorerEventInput')), {
    variables: { input },
