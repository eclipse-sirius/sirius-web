...
import {
  GQLViewsExplorerEventPayload,
  GQLViewsExplorerRefreshedEventPayload,
...
const isViewsRefreshedEventPayload = (
  payload: GQLViewsExplorerEventPayload
): payload is GQLViewsExplorerRefreshedEventPayload => payload && payload.__typename === 'TreeRefreshedEventPayload';
