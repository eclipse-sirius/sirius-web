...
export const QueryView = forwardRef<WorkbenchViewConfigurationSupplier | null, WorkbenchViewComponentProps>(
  (
    { editingContextId, readOnly, initialConfiguration }: WorkbenchViewComponentProps,
    queryViewConfigurationSupplierRef: ForwardedRef<WorkbenchViewConfigurationSupplier | null>
  ) => {
