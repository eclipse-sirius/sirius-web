...
import { RelatedElementsViewConfigurationSupplier, RelatedElementsViewState } from './RelatedElementsView.types';
...
export const RelatedElementsView = forwardRef<
  RelatedElementsViewConfigurationSupplier | null,
  WorkbenchViewComponentProps
>(
  (
    { editingContextId, readOnly }: WorkbenchViewComponentProps,
    _relatedElementsViewConfigurationSupplierRef: ForwardedRef<WorkbenchViewConfigurationSupplier | null>
  ) => {
