...
import { RelatedElementsViewHandle, RelatedElementsViewState } from './RelatedElementsView.types';
...
export const RelatedElementsView = forwardRef<RelatedElementsViewHandle | null, WorkbenchViewComponentProps>(
  (
    { editingContextId, readOnly }: WorkbenchViewComponentProps,
    _relatedElementsViewHandleRef: ForwardedRef<WorkbenchViewHandle | null>
  ) => {
