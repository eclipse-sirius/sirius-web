...
import { RepresentationsViewHandle, RepresentationsViewState } from './RepresentationsView.types';
...
export const RepresentationsView = forwardRef<RepresentationsViewHandle | null, WorkbenchViewComponentProps>(
  (
    { editingContextId, readOnly }: WorkbenchViewComponentProps,
    _representationsViewHandleRef: ForwardedRef<WorkbenchViewHandle | null>
  ) => {
