...
export const EditProjectNavbar = ({ workbenchConfigurationSupplier, readOnly }: EditProjectNavbarProps) => {
        ...
        <ContextMenuContainer>
          <Menu open anchorEl={projectMenuAnchor} data-testid="navbar-contextmenu" onClose={onCloseContextMenu}>
            ...
            <ShareProjectMenuItem
              projectId={project.id}
              workbenchConfigurationSupplier={workbenchConfigurationSupplier}
            />
