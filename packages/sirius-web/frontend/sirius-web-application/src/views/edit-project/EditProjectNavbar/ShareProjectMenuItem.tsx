...
export const ShareProjectMenuItem = ({ projectId, workbenchConfigurationSupplier }: ShareProjectMenuItemProps) => {
  ...
  return (
    <>
      ...
      {state.isOpen ? (
        <ShareProjectModal
          projectId={projectId}
          workbenchConfiguration={workbenchConfigurationSupplier?.getConfiguration() ?? null}
