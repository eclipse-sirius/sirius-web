...
export const isWorkbenchSearchCommand = (command: GQLOmniboxCommand): command is GQLWorkbenchSearchCommand =>
  command.__typename === 'WorkbenchSearchCommand';

export const isWorkbenchCommand = (command: GQLOmniboxCommand): command is GQLWorkbenchCommand =>
  command.__typename === 'WorkbenchCommand';
