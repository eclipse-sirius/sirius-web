...
import { StyleCustomization, StyleCustomizationTableProps } from './StyleCustomizationTable.types';
...
export const StyleCustomizationTable = ({}: StyleCustomizationTableProps) => {
  ...
  const columns = useMemo<MRT_ColumnDef<StyleCustomization>[]>(
    () => [
      {
  ...
  const table = useMaterialReactTable<StyleCustomization>({
    // Data
    columns,
    data: rows,
