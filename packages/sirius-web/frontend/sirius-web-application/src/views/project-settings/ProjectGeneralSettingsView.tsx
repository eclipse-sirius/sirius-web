...
import { ConfirmationSettingsContextValue } from '../../localSettings/ConfirmationSettingsContext.types';
...
export const ProjectGeneralSettingsView = ({}: ProjectSettingTabProps) => {
  ...
  } = useContext<ConfirmationSettingsContextValue>(ConfirmationSettingsContext);
