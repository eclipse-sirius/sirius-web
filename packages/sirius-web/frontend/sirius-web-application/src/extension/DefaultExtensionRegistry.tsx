...
const treePaletteOverriddenContributions: PaletteToolOverriddenContributionProps[] = [
  {
    canHandle: (representationDescriptionId: string, tool: GQLTool) =>
      representationDescriptionId === 'explorer_' && tool.id === 'new-root-object',
    component: NewRootObjectToolContribution,
  },
  {
    canHandle: (representationDescriptionId: string, tool: GQLTool) =>
      representationDescriptionId === 'explorer_' && tool.id === 'download-document',
    component: DownloadDocumentToolContribution,
  },
  {
    canHandle: (representationDescriptionId: string, tool: GQLTool) =>
      representationDescriptionId === 'explorer_' && tool.id === 'new-object',
    component: NewObjectToolContribution,
  },
  {
    canHandle: (representationDescriptionId: string, tool: GQLTool) =>
      representationDescriptionId === 'explorer_' && tool.id === 'new-representation',
    component: NewRepresentationToolContribution,
  },
  {
    canHandle: (representationDescriptionId: string, tool: GQLTool) =>
      representationDescriptionId === 'explorer_' && tool.id === 'duplicate-object',
    component: DuplicateObjectToolContribution,
  },
  {
    canHandle: (representationDescriptionId: string, tool: GQLTool) =>
      representationDescriptionId === 'explorer_' && tool.id === 'duplicate-representation',
    component: DuplicateRepresentationToolContribution,
  },
  {
    canHandle: (representationDescriptionId: string, tool: GQLTool) =>
      representationDescriptionId === 'explorer_' && tool.id === 'update-library',
    component: UpdateLibraryToolContribution,
  },
  {
    canHandle: (representationDescriptionId: string, tool: GQLTool) =>
      representationDescriptionId === 'explorer_' && tool.id === 'expand-all',
