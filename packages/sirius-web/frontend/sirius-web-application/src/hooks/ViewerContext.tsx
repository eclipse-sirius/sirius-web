...
export const ViewerContextProvider = ({ children }: ViewerContextProviderProps) => {
  // TODO: I'm not sure this will be extensible with graphql fragment to let downstream project contributes their own attribute to the getView graphql query.
