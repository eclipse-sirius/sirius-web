...
import { Panel, ReactFlowProps } from 'reactflow';
...
const usePapayaDiagramPanelStyles = makeStyles((theme) => ({
  papayaDiagramPanel: {
    display: 'flex',
...
const PapayaDiagramPanel = memo(() => {
  const classes = usePapayaDiagramPanelStyles();
  ...
  return (
    <Panel position="bottom-right">
      <Paper className={classes.papayaDiagramPanel}>
